...
#[tauri::command]
pub async fn terracotta_get_state() -> Result<theseus::api::terracotta::TerracottaState> {
	Ok(theseus::api::terracotta::get_state().await)
}
...
pub async fn terracotta_get_meta() -> Result<TerracottaMetaResponse> {
	let meta = theseus::api::terracotta::get_meta().await.map_err(
...
pub async fn terracotta_start(args: TerracottaStartArgs) -> Result<()> {
	Ok(theseus::api::terracotta::start_terracotta(args.binary_path, args.auto_download).await.map_err(
		|crate::api::TheseusSerializableError::Theseus,
	)?)
}
...
pub async fn terracotta_stop() -> Result<()> {
	Ok(theseus::api::terracotta::stop_terracotta().await.map_err(
		|crate::api::TheseusSerializableError::Theseus,
	)?)
}
...
pub async fn terracotta_host(args: TerracottaHostArgs) -> Result<()> {
	Ok(theseus::api::terracotta::start_hosting(
		args.room_code,
		args.player_name,
	)
	.await
	.map_err(|crate::api::TheseusSerializableError::Theseus|)?)
}
...
pub async fn terracotta_join(args: TerracottaJoinArgs) -> Result<()> {
	Ok(theseus::api::terracotta::start_joining(
		args.room_code,
		args.player_name,
	)
	.await
...
pub async fn terracotta_reset() -> Result<()> {
	Ok(theseus::api::terracotta::reset_state().await.map_err(
		|crate::api::TheseusSerializableError::Theseus,
	)?)
}
...
pub async fn terracotta_parse_room_code(
	...
	Ok(theseus::api::terracotta::parse_room_code(&args.room_code)
		.await
		.map_err(|crate::api::TheseusSerializableError::Theseus|)?)
}
...
pub async fn terracotta_get_platform_key() -> Result<String> {
	Ok(theseus::api::terracotta::terracotta_platform_key().to_string())
}
...
pub async fn terracotta_get_download_url(args: TerracottaDownloadUrlArgs) -> Result<String> {
	let key = theseus::api::terracotta::terracotta_platform_key();
	Ok(format!(
