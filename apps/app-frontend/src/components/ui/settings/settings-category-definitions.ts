...
export const settingsCategoryDefinitions: SettingsCategoryDefinition[] = [
	{
		id: 'interface',
		name: { id: 'app.settings.tabs.interface', defaultMessage: 'Interface & appearance' },
		group: 'launcher',
		onboardingId: 'settings-tab-interface',
	},
	{
		id: 'home-navigation',
		name: { id: 'app.settings.tabs.home-navigation', defaultMessage: 'Home & navigation' },
		group: 'launcher',
		onboardingId: 'settings-tab-home-navigation',
	},
	{
		id: 'language-translation',
		name: { id: 'app.settings.tabs.language-translation', defaultMessage: 'Language & translation' },
		group: 'launcher',
	...
	{
		id: 'java-performance',
		name: { id: 'app.settings.tabs.java-performance', defaultMessage: 'Java & performance' },
		group: 'game',
		onboardingId: 'settings-tab-java-performance',
	},
	{
		id: 'launch-defaults',
		name: { id: 'app.settings.tabs.launch-defaults', defaultMessage: 'Launch & instance defaults' },
		group: 'game',
		onboardingId: 'settings-tab-launch-defaults',
	},
	{
		id: 'content-downloads',
		name: { id: 'app.settings.tabs.content-downloads', defaultMessage: 'Content & downloads' },
		group: 'game',
		onboardingId: 'settings-tab-content-downloads',
	},
	{
		id: 'network-multiplayer',
		name: { id: 'app.settings.tabs.network-multiplayer', defaultMessage: 'Network & multiplayer' },
		group: 'game',
		onboardingId: 'settings-tab-network-multiplayer',
	},
	{
		id: 'storage-backups',
		name: { id: 'app.settings.tabs.storage-backups', defaultMessage: 'Storage & backups' },
		group: 'data-privacy',
		onboardingId: 'settings-tab-storage-backups',
	},
	{
		id: 'privacy-data',
		name: { id: 'app.settings.tabs.privacy-data', defaultMessage: 'Privacy & data sharing' },
		group: 'data-privacy',
	...
	{
		id: 'feature-flags',
		name: { id: 'settings.feature-flags.title', defaultMessage: 'Feature flags' },
		group: 'developer',
		developerOnly: true,
	},
]
