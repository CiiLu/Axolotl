 ...
 * Version: 0.56.0(13f0c872dcf352815cc28d92dfff496c9839ea5c)
...
globalThis._VSCODE_NLS_MESSAGES = [
	...
	'30 minutes',
	'60 minutes',
	'{0} minutes (dernière utilisation)',
	'Dernière durée personnalisée utilisée',
	'Personnalisé…',
	'Sélectionnez la durée de mise en veille pour les suggestions intégrées',
	'Durée en minutes (par exemple, 90)',
	'Saisissez la durée de la répétition en minutes',
	'Entrez un nombre positif',
	'Répétition des suggestions intégrées',
	'Annuler la répétition des suggestions intégrées',
	...
	'Désactivez les suggestions basées sur les mots lorsque des suggestions intégrées sont présentes.',
	...
	'Utilise l’algorithme de comparaison avancé du package externe `@vscode/diff` (JavaScript pur).',
	'Utilise l’algorithme de comparaison avancé du package externe `@vscode/diff` (WebAssembly).',
	...
	'Détermine si le widget de recherche se ferme après qu’une commande de navigation de recherche explicite a abouti à un résultat.',
	...
	'Le pointage est activé.',
	'Le pointage est désactivé.',
	'Le survol s’affiche lorsque vous maintenez la touche `{0}` ou `Alt` (le modificateur opposé à `#editor.multiCursorModifier#`)',
	...
	'Détermine si les info-bulles d’avertissement s’affichent, par exemple lorsque la segmentation du texte en unités lexicales est ignorée ou que le rendu est mis en pause.',
	...
	'Les suggestions rapides sont désactivées lorsque les complétions inline sont affichées',
	'Les suggestions rapides sont activées pour tous les types de jetons',
	'Les suggestions rapides s’affichent sous forme de texte fantôme pour tous les types de jetons',
	'Les suggestions rapides sont désactivées pour tous les types de jetons',
	'Les suggestions rapides sont désactivées pour tous les types de jetons lorsque des complétions inline sont affichées',
	...
	'Contrôle si les suggestions intégrées doivent être affichées automatiquement dans l’éditeur.',
	'Afficher la barre d’outils de suggestions intégrées chaque fois qu’une suggestion intégrée est affichée.',
	'Afficher la barre d’outils de suggestions intégrées lorsque vous pointez sur une suggestion intégrée.',
	'N’affichez jamais la barre d’outils de suggestions intégrées.',
	'Contrôle quand afficher la barre d’outils de suggestion intégrée.',
	'Contrôle s’il faut afficher la mise en surbrillance de la syntaxe pour les suggestions intégrées dans l’éditeur.',
	'Contrôle la façon dont les suggestions intégrées interagissent avec le widget de suggestion. Si cette option est activée, le widget de suggestion n’est pas affiché automatiquement lorsque des suggestions intégrées sont disponibles.',
	'Détermine si les suggestions intégrées sont supprimées en mode extrait.',
	'Contrôle le délai minimal en millisecondes après lequel les suggestions intégrées sont affichées après la saisie.',
	'Supprime les complétions en ligne pour les ID d’extension spécifiés, séparés par des virgules.',
	'Détermine si les informations de la requête doivent être envoyées par le fournisseur de suggestions intégrées.',
	'Contrôle s’il faut déclencher une commande lorsque le fournisseur de suggestions intégrées change.',
	"Contrôle l'affichage des suggestions intégrées en cas de conflit de suggestions.",
	'Contrôle la famille de polices des suggestions intégrées.',
	"Contrôle si l'affichage d'une suggestion déplace le code pour faire de la place à la suggestion en ligne.",
	'Détermine si les suggestions intégrées à longue distance sont affichées.',
	...
	'Contrôlez si les suggestions intégrées sont annoncées par un lecteur d’écran.',
	...
	'Contrôle si un double-clic à côté d’un crochet ou d’un guillemet sélectionne le contenu à l’intérieur.',
	...
	'Couleur d’arrière-plan de la mise en surbrillance de la ligne à la position du curseur lorsque l’éditeur n’est pas actif.',
	...
	'Couleur de premier plan pour les crochets correspondants',
	...
	'Indique si l’éditeur est en mode de composition',
	...
	'Indique si un diagnostic est présent dans la sélection actuelle de l’éditeur',
	'Méthode',
	'Fonction',
	'Constructeur',
	'Champ',
	...
	"{0} trouvé pour '{1}'",
	'Appuyer sur {0} pour l’aide sur l’accessibilité',
	'{0}, {1}',
	'{0}, {1}',
	'Déplier',
	...
	'Chargement en cours...',
	'Rendu suspendu pour une longue ligne pour des raisons de performances. Cela peut être configuré via `editor.stopRenderingLineAfter`. [Ne plus afficher](command:{0})',
	'La segmentation du texte en unités lexicales est ignorée pour des raisons de niveau de performance. Cela peut être configurée via `editor.maxTokenizationLineLength`. [Ne plus afficher](command:{0})',
	...
	'Déclenche une suggestion intégrée dans l’éditeur.',
	'Options pour déclencher des suggestions intégrées.',
	'Désolé, aucune suggestion intégrée n’est disponible.',
	'Accepter Word',
	'Accepter la ligne',
	'Accepter',
	'Accepter',
	...
	'Accepter le mot suivant de la suggestion intégrée',
	'Accepter la ligne suivante d’une suggestion intégrée',
	'Accepter la suggestion intégrée',
	'Accepter l’action alternative de suggestion intégrée',
	'Accéder à la modification inline suivante',
	'Masquer la suggestion intégrée',
	'Activer/désactiver l’affichage des suggestions intégrées réduit',
	'Indique si une suggestion intégrée est visible',
	'Indique si une action alternative pour la suggestion intégrée est visible.',
	'Indique si la suggestion intégrée commence par un espace blanc',
	'Indique si la suggestion intégrée commence par un espace blanc inférieur à ce qui serait inséré par l’onglet.',
	...
	'Atteindre la ligne. Taper un numéro de ligne, éventuellement suivi de deux-points et du numéro de colonne.',
	'Activer/désactiver le décalage à base zéro',
	'Accéder à la ligne {0}, colonne {1}. Appuyer sur Entrée pour parcourir.',
	'Ouvrez d’abord un éditeur de texte pour aller à une ligne ou à un décalage.',
	...
	'Indique si le taquet de tabulation de l’extrait de code actuel correspond à un choix',
	...
	'Si le volet d’informations du widget de suggestion dispose d’un focus',
	...
	'Supprimer uniquement le mot en conservant l’espace blanc environnant',
	'Supprimer le mot',
	'Supprimer le mot au niveau du curseur',
	...
	'Point d’arrêt',
	'Suggestion intégrée sur la ligne',
	...
	'{0}, utilisez la flèche droite pour accéder aux options',
	'Widget d’action',
	...
	'Indique si le champ de filtre du widget d’action est sélectionné',
	'Masquer le widget d’action',
	'Efface le filtre du widget d’action',
	...
	"Impossible d’inscrire '{0}'. Un paramètre ne doit pas déclarer à la fois 'policy' et 'policyReference'.",
	"Impossible d’inscrire '{0}'. Le {1} de stratégie associé est déjà inscrit auprès de {2}. Pour attacher un autre paramètre à la même stratégie, utilisez « policyReference ».",
	...
	'commandes similaires',
	'{0}, {1}',
	'Supprimer des derniers utilisés',
	...
	'Couleur de premier plan avec le contraste le plus élevé, destinée au texte ou aux icônes nécessitant une lisibilité maximale sur divers arrière-plans. Cette couleur est utilisée uniquement si elle n’est pas remplacée par un composant.',
	...
	'Couleur de bordure pour les segments de texte préformatés.',
	...
	'Couleur de la bordure du bouton secondaire.',
	...
	'Couleur de premier plan du sélecteur rapide pour les temps forts des correspondances sur l’élément ciblé.',
