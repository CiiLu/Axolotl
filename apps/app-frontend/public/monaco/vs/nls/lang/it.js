...
globalThis._VSCODE_NLS_MESSAGES = [
	...
	'30 minuti',
	'60 minuti',
	'{0} minuti (ultimo utilizzo)',
	'Ultima durata personalizzata usata',
	'Personalizza...',
	'Seleziona la durata del rinvio per i suggerimenti inline',
	'Durata in minuti (ad es. 90)',
	'Immettere la durata della sospensione in minuti',
	'Immettere un numero positivo',
	'Posponi suggerimenti inline',
	...
	'Disattiva i suggerimenti basati su Word quando sono presenti suggerimenti inline.',
	...
	"Usa l'algoritmo diff avanzato del pacchetto esterno `@vscode/diff` (JavaScript puro).",
	"Usa l'algoritmo diff avanzato del pacchetto esterno `@vscode/diff` (WebAssembly).",
	...
	'Controlla se il widget Trova si chiude dopo che un comando di navigazione di ricerca esplicito arriva su un risultato.',
	...
	'Passaggio del mouse abilitato.',
	'Passaggio del mouse disabilitato.',
	'Il passaggio del mouse viene mostrato tenendo premuto "{0}" o "Alt" (il modificatore opposto di "#editor.multiCursorModifier#")',
	...
	'Controlla se vengono mostrati gli avvisi di riga troppo lunga al passaggio del mouse, ad esempio quando la tokenizzazione viene saltata o il rendering è in pausa.',
	...
	'I suggerimenti rapidi sono disabilitati quando vengono visualizzati i completamenti inline',
	'I suggerimenti rapidi sono abilitati per tutti i tipi di token',
	'I suggerimenti rapidi vengono visualizzati come testo fantasma per tutti i tipi di token',
	'I suggerimenti rapidi sono disabilitati per tutti i tipi di token',
	'I suggerimenti rapidi sono disabilitati per tutti i tipi di token quando vengono visualizzati i completamenti inline',
	...
	"Controlla se mostrare automaticamente i suggerimenti inline nell'Editor.",
	'Mostra la barra degli strumenti relativa ai suggerimenti inline ogni volta che viene visualizzato un suggerimento inline.',
	'Mostra la barra degli strumenti relativa ai suggerimenti inline al passaggio del mouse su un suggerimento inline.',
	'Non mostrare mai la barra dei suggerimenti inline.',
	'Controlla quando mostrare la barra dei suggerimenti inline.',
	"Controlla se mostrare l'evidenziazione della sintassi per i suggerimenti inline nell'Editor.",
	'Controlla la modalità di interazione dei suggerimenti inline con il widget dei suggerimenti. Se questa opzione è abilitata, il widget non viene visualizzato automaticamente quando sono disponibili suggerimenti inline.',
	'Controlla la sospensione dei suggerimenti inline in modalità frammento.',
	...
	"Controlla l'invio delle informazioni sulla richiesta dal provider di suggerimenti inline.",
	...
	'Controlla la visualizzazione dei suggerimenti inline a lunga distanza.',
	...
	'Contenuto editor',
	"Controlla se i suggerimenti inline vengono annunciati da un'utilità per la lettura dello schermo.",
	...
	"Controlla se facendo doppio clic accanto a una parentesi o una virgoletta viene selezionato il contenuto all'interno.",
	...
	"Colore di sfondo per l'evidenziazione della riga alla posizione del cursore quando l'editor non è attivo.",
	...
	'Colore di primo piano delle parentesi corrispondenti',
	...
	"Indica se l'editor è in modalità composizione",
	...
	"Indica se è presente una diagnostica nella selezione dell'editor corrente",
	'Metodo',
	'Funzione',
	'Costruttore',
	'Campo',
	...
	"Elenco del tipo di modifica di incollaggio preferito per provare l'applicazione.\r\nVerrà applicata la prima modifica corrispondente alle preferenze.",
	'Incolla come...',
	'Incolla come testo',
	...
	"{0} trovati per '{1}'",
	"Premere {0} per la Guida all'accessibilità",
	'{0}, {1}',
	'{0}, {1}',
	'Espandi',
	...
	'Caricamento...',
	'Rendering in pausa per riga troppo lunga per motivi di prestazioni. Può essere configurato tramite `editor.stopRenderingLineAfter`. [Non mostrare più](command:{0})',
	'Per motivi di prestazioni la tokenizzazione viene ignorata per le righe lunghe. È possibile effettuare questa configurazione tramite `editor.maxTokenizationLineLength`. [Non mostrare più](command:{0})',
	'Aumenta livello di dettaglio al passaggio del mouse',
	'Riduci livello di dettaglio al passaggio del mouse',
	'Visualizza problema',
	...
	'Mostra suggerimento inline successivo',
	'Mostra suggerimento inline precedente',
	'Attiva suggerimento inline',
	'Accetta suggerimento inline per la parola successiva',
	'Accetta la riga successiva del suggerimento inline',
	'Accetta suggerimento inline',
	'Accetta azione alternativa del suggerimento inline',
	'Passa alla modifica inline successiva',
	'Nascondi suggerimento inline',
	'Mostra/Nascondi suggerimenti inline - Mostra compressi',
	'Indica se è visibile un suggerimento inline',
	"Indica se è visibile un'azione alternativa per il suggerimento inline.",
	'Se il suggerimento inline inizia con spazi vuoti',
	...
	'Passare alla riga specificata. Digitare un numero di riga, seguito facoltativamente dai due punti e dal numero di colonna.',
	'Attiva/Disattiva offset basato su zero',
	'Passare alla riga {0}, colonna {1}. Premere INVIO per spostarsi.',
	'Aprire prima un editor di testo per passare a una riga o an offset.',
	...
	'Indica se la tabulazione del frammento attuale è una scelta',
	...
	'Indica se il riquadro dei dettagli del widget suggerimenti è attivo',
	...
	'Elimina solo la parola lasciando gli spazi vuoti circostanti',
	'Elimina parola',
	'Elimina la parola evidenziata dal cursore',
	...
	'{0}, usare la freccia DESTRA per accedere alle opzioni',
	'Widget azione',
	'Cerca...',
	'Filtra elementi',
	...
	"Indica se l'input del filtro del widget azione ha lo stato attivo",
	'Nascondi widget azione',
	'Cancella filtro widget azioni',
	...
	"Non è possibile registrare '{0}'. Un'impostazione non deve dichiarare sia 'policy' che 'policyReference'.",
	"Non è possibile registrare '{0}'. Il criterio associato {1} è già registrato con {2}. Per allegare un'altra impostazione allo stesso criterio, usare 'policyReference'.",
	...
	'Colore di primo piano a contrasto massimo, pensato per testo o icone che necessitano della massima leggibilità su vari sfondi. Questo colore viene usato solo se non sottoposto a override da un componente.',
	...
	'Colore del bordo dei segmenti di testo preformattato.',
	...
	'Colore del bordo del pulsante secondario.',
	...
	"Colore di primo piano del selettore rapido per le evidenziazioni delle corrispondenze sull'elemento attivo.",
