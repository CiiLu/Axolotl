...
globalThis._VSCODE_NLS_MESSAGES = [
	...
	'30 minutos',
	'60 minutos',
	'{0} minutos (Último uso)',
	'Duración personalizada usada por última vez',
	'Personalizado...',
	'Seleccionar la duración de la pausa para las sugerencias insertadas',
	'Duración en minutos (por ejemplo, 90)',
	'Escriba la duración del aplazamiento en minutos',
	...
	'Desactive las sugerencias basadas en Word cuando haya sugerencias insertadas.',
	...
	'Usa el algoritmo de diferenciación avanzada del paquete `@vscode/diff` externo (JavaScript puro).',
	'Usa el algoritmo de diferenciación avanzada del paquete externo `@vscode/diff` (WebAssembly).',
	...
	'La característica de mantener el puntero está habilitada.',
	'La característica de mantener el puntero está deshabilitada.',
	'Mantener el puntero se muestra al mantener pulsada la tecla "{0}" o "Alt" (el modificador opuesto a "#editor.multiCursorModifier#")',
	...
	'Controla si se muestran los desplazamientos de advertencia de línea larga, como cuando se omite la tokenización o se pausa la representación.',
	...
	'Las sugerencias rápidas se deshabilitan cuando se muestran finalizaciones insertadas',
	'Las sugerencias rápidas están habilitadas para todos los tipos de token',
	'Las sugerencias rápidas se muestran como texto fantasma para todos los tipos de token',
	'Las sugerencias rápidas están deshabilitadas para todos los tipos de token',
	'Las sugerencias rápidas están deshabilitadas para todos los tipos de token cuando se muestran finalizaciones insertadas',
	...
	'Controla si se mostrarán sugerencias insertadas a larga distancia.',
	...
	'Controla si el editor debe cerrar automáticamente las comillas después de que el usuario agrega una comilla de apertura.',
	...
	'Controla si al hacer doble clic junto a un corchete o comilla se selecciona el contenido que hay dentro.',
	...
	'Color de fondo para el resaltado de línea en la posición del cursor cuando el editor no es prioritario.',
	...
	'Color de primer plano para corchetes coincidentes',
	...
	'Si el editor está en el modo de composición',
	...
	'Si hay algún diagnóstico presente en la selección actual del editor',
	'Método',
	'Función',
	'Constructor',
	'Campo',
	...
	'{0} encontrado para "{1}"',
	'Presione {0} para obtener ayuda de accesibilidad',
	'{0}, {1}',
	'{0}, {1}',
	'Desplegar',
	...
	'Cargando...',
	'Representación en pausa durante una línea larga por motivos de rendimiento. Esto se puede configurar mediante `editor.stopRenderingLineAfter`. [No volver a mostrar](command:{0})',
	'La tokenización se omite para las líneas largas por motivos de rendimiento. Esto se puede configurar mediante `editor.maxTokenizationLineLength`. [No volver a mostrar](command:{0})',
	...
	'Aceptar acción alternativa de sugerencia insertada',
	...
	'Línea {0}, de columna {1}: {2}',
	'Abra primero un editor de texto para ir a una línea o desplazamiento.',
	'Ir a línea. Escriba un número de línea, seguido opcionalmente de dos puntos y número de columna.',
	'Alternar colocación en capas con base cero',
	'Vaya a la línea {0}, columna {1}. Presione Entrar para navegar.',
	'Abra primero un editor de texto para ir a una línea o desplazamiento.',
	...
	'Si la tabulación del fragmento de código actual es una opción',
	...
	'Si el panel de detalles del widget de sugerencias está enfocado',
	...
	'Eliminar solo la palabra y dejar los espacios en blanco adyacentes',
	'Eliminar palabra',
	'Eliminar la palabra donde está el cursor',
	...
	'No se puede registrar "{0}". Una configuración no debe declarar "policy" y "policyReference" a la vez.',
	'No se puede registrar "{0}". La directiva asociada {1} ya está registrada con {2}. Para asociar otra configuración a la misma directiva, use "policyReference".',
	...
	'comandos similares',
	'{0}, {1}',
	'Eliminar de los elementos usados recientemente',
	...
	'Color de primer plano de contraste más alto, pensado para texto o iconos que necesitan la máxima legibilidad en varios fondos. Este color solo se usa si un componente no lo reemplaza.',
	...
	'Color de borde para segmentos de texto con formato previo.',
	...
	'Color de primer plano del selector rápido de los resaltados de coincidencia en el elemento enfocado.',
