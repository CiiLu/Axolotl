...
globalThis._VSCODE_NLS_MESSAGES = [
	...
	'30 минут',
	'60 минут',
	'{0} мин (последнее использование)',
	'Последняя использованная настраиваемая длительность',
	'Настроить...',
	'Выберите длительность откладывания для встроенных предложений',
	'Длительность в минутах (например, 90)',
	'Введите длительность отсрочки в минутах',
	...
	'Отключить предложения на основе слов при наличии встроенных предложений.',
	...
	'Использует усовершенствованный алгоритм сравнения из внешнего пакета `@vscode/diff` (на чистом JavaScript).',
	'Использует усовершенствованный алгоритм сравнения из внешнего пакета `@vscode/diff` (WebAssembly).',
	...
	'Управляет тем, закрывается ли виджет поиска после выполнения явной команды навигации по результатам.',
	...
	'Управляет отображением предупреждающих всплывающих подсказок для длинных строк, например, когда токенизация пропускается или отрисовка приостанавливается.',
	...
	'При отображении автозавершения быстрые предложения отключены',
	'Экспресс-предложения включены для всех типов токенов',
	'Экспресс-предложения отображаются как едва различимый текст для всех типов токенов',
	'Экспресс-предложения отключены для всех типов токенов',
	'При отображении автозавершения быстрые предложения отключены для всех типов токенов',
	...
	'Не показывать панель инструментов со встроенными предложениями.',
	'Определяет, когда отображать панель инструментов встроенных предложений.',
	...
	'Определяет, будет ли при двойном щелчке рядом со скобкой или кавычкой выделяться содержимое внутри них.',
	...
	'Цвет переднего плана для совпадающих скобок',
	...
	'Находится ли редактор в режиме создания',
	...
	'Присутствует ли диагностика в текущем выделении редактора',
	'Метод',
	'Функция',
	'Конструктор',
	'Поле',
	...
	'{0} найден для "{1}", в {2}',
	'{0} найден для "{1}"',
	'Нажмите {0} для получения справки по специальным возможностям',
	'{0}, {1}',
	'{0}, {1}',
	'Развернуть',
	...
	'Загрузка...',
	'Отрисовка приостановлена для длинной строки из соображений производительности. Это можно настроить с помощью параметра `editor.stopRenderingLineAfter`. [Больше не показывать](command:{0})',
	'Разметка пропускается для длинных строк по соображениям производительности. Это можно настроить с помощью `editor.maxTokenizationLineLength`. [Больше не показывать](command:{0})',
	...
	'Принять альтернативное действие встроенного предложения',
	...
	'Отображается ли альтернативное действие для встроенного предложения.',
	'Начинается ли встроенное предложение с пробела',
	'Проверяет, не является ли пробел перед встроенным предложением короче, чем текст, вставляемый клавишей TAB',
	...
	'Строка {0}, столбец {1}: {2}',
	'Чтобы перейти к строке или к смещению, сначала откройте текстовый редактор.',
	'Перейти к строке. Введите номер строки, за которым при необходимости следует двоеточие и номер столбца.',
	'Переключить смещение с нулевой базой',
	'Перейти к строке {0}, столбцу {1}. Нажмите клавишу ВВОД для перехода.',
	'Чтобы перейти к строке или к смещению, сначала откройте текстовый редактор.',
	...
	'Является ли текущая позиция табуляции фрагмента вариантом выбора',
	...
	'Находится ли фокус в области сведений мини-приложения рекомендаций',
	...
	'Удалить только слово, оставив окружающие пробелы',
	'Удалить слово',
	'Удалить слово в расположении курсора',
	'Ошибка в позиции',
	'Ошибка',
	...
	'Точка останова',
	'Встроенное предложение в строке',
	...
	'{0}, используйте стрелку вправо для доступа к параметрам',
	...
	'Находится ли в фокусе поле ввода фильтра мини-приложения действий',
	'Скрыть мини-приложение действия',
	'Очистить фильтр мини-приложения действий',
	...
	'Невозможно зарегистрировать "{0}". Настройка не должна одновременно определять "policy" и "policyReference".',
	'Невозможно зарегистрировать "{0}". Уже имеется регистрация {2} для связанной политики {1}. Чтобы добавить еще одну настройку к той же политике, используйте "policyReference".',
	...
	'похожие команды',
	'{0}, {1}',
	'Удалить из списка недавнего использования',
	...
	'Цвет переднего плана с максимальной контрастностью, предназначенный для текста или значков, которым нужна максимальная читаемость на разных фонах. Этот цвет используется, только если его не переопределяет компонент.',
	...
	'Цвет рамки для сегментов предварительно отформатированного текста.',
	...
	'Дополнительный цвет границы кнопки.',
	...
	'Цвет переднего плана средства быстрого выбора для выделения совпадений в элементе, находящемся в фокусе.',
