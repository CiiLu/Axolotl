...
globalThis._VSCODE_NLS_MESSAGES = [
	...
	'単語ベースの候補をオフにします。',
	'インライン候補がある場合は、Word ベースの候補をオフにします。',
	...
	'従来の差分アルゴリズムを使用します。',
	'高度な差分アルゴリズムを使用します。',
	'外部の `@vscode/diff` パッケージ (純粋な JavaScript) の高度な差分アルゴリズムを使用します。',
	'外部の `@vscode/diff` パッケージ (WebAssembly) の高度な差分アルゴリズムを使用します。',
	...
	'明示的な検索ナビゲーション コマンドが結果に移動した後に検索ウィジェットを閉じるかどうかを制御します。',
	...
	'ホバーが有効になっています。',
	'ホバーが無効になっています。',
	"'{0}' または 'Alt' ('#editor.multiCursorModifier#' の逆の修飾キー) を押している間、ホバーが表示されます",
	'ホバーを表示するかどうかを制御します。',
	...
	'トークン化がスキップされたときやレンダリングが一時停止されたときなど、長い行の警告ホバーを表示するかどうかを制御します。',
	...
	'クイック候補が無効になっています',
	'インライン入力候補が表示されている場合、クイック候補が無効になります',
	'すべてのトークンの種類に対してクイック候補が有効になっています',
	'クイック候補は、すべてのトークンの種類に対してゴースト テキストとして表示されます',
	'すべてのトークンの種類に対してクイック候補が無効になっています',
	'インライン入力候補が表示されている場合、すべてのトークンの種類に対してクイック候補が無効になります',
	'文字列内でクイック候補を有効にします。',
	'コメント内でクイック候補を有効にします。',
	...
	'インライン候補と提案ウィジェットの相互作用の方法を制御します。有効すると、インライン候補が使用可能な場合は、提案ウィジェットが自動的に表示されません。',
	'スニペット モード時にインライン候補を抑制するかどうかを制御します。',
	'入力後にインライン候補が表示されるまでの最小延期期間 (ミリ秒) を制御します。',
	'指定された拡張 ID のインライン補完を抑制します。 -- コンマ区切り。',
	'インライン候補プロバイダーから要求情報を送信するかどうかを制御します。',
	'インライン候補プロバイダーが変更されたときにコマンドをトリガーするかどうかを制御します。',
	'提案の競合がある場合にインライン候補を表示するかどうかを制御します。',
	'インライン候補のフォント ファミリを制御します。',
	'候補を表示すると、候補用のスペースを確保するためにコードがインラインに変更されるかどうかを制御します。',
	'遠距離インライン候補を表示するかどうかを制御します。',
	...
	'角かっこまたは引用符の横をダブルクリックして、内部のコンテンツを選択するかどうかを制御します。',
	...
	'カーソル位置の行を強調表示する背景色。',
	'エディターにフォーカスがない場合のカーソル位置での行の強調表示の背景色。',
	...
	'ホバーの詳細度を下げるためのアイコン。',
	'読み込んでいます...',
	'パフォーマンス上の理由から、長い行のためにレンダリングが一時停止されました。これは `editor.stopRenderingLineAfter` で設定できます。[今後表示しない](command:{0})',
	'パフォーマンス上の理由からトークン化はスキップされます。その長い行の長さは `editor.maxTokenizationLineLength` で構成できます。[今後表示しない](command:{0})',
	'ホバーの詳細レベルを上げる',
	'ホバーの詳細レベルを下げる',
	'問題の表示',
	...
	'インライン候補の次の行を承諾する',
	'インライン候補を採用する',
	'インライン候補の代替アクションを受け入れる',
	'次のインライン編集にジャンプ',
	'インライン候補を非表示にする',
	'インライン候補の折りたたみ表示の切り替え',
	'インライン候補を表示するかどうか',
	'インライン候補の代替アクションが表示されるかどうか。',
	...
	'行へジャンプします。行番号を入力し、必要に応じてコロンと列番号も入力します。',
	'ゼロベース オフセットの切り替え',
	'行 {0}、列 {1} に移動します。Enter キーを押して移動します。',
	'最初にテキスト エディターを開いて、行またはオフセットに移動します。',
	...
	'候補がフォーカスされているかどうか',
	'候補の詳細が表示されるかどうか',
	'候補のウィジェットの詳細ウィンドウにフォーカスがあるかどうか',
	'選択する複数の候補があるかどうか',
	...
	'削除',
	'{0}、無効になった理由: {1}',
	'{0}、右方向キーを使用してオプションにアクセスします',
	'アクション ウィジェット',
	'検索...',
	'項目のフィルター処理',
	'アクション バーの切り替え済みアクション項目の背景色。',
	'アクション ウィジェットの一覧が表示されるかどうか',
	'アクション ウィジェットのフィルター入力にフォーカスがあるかどうか',
	'アクション ウィジェットを非表示にする',
	'アクション ウィジェットのフィルターをクリア',
	'前のアクションを選択',
	'次のアクションを選択',
	'セクションを折りたたむ',
	'セクションの展開',
	...
	"'{0}' を登録できません。設定で 'policy' と 'policyReference' の両方を宣言することはできません。",
	"'{0}' を登録できません。関連付けられたポリシー {1} は既に {2} に登録されています。同じポリシーに別の設定をアタッチするには、'policyReference' を使用します。",
	...
	'さまざまな背景で最大の読みやすさを必要とするテキストまたはアイコンを対象とした、最もコントラストの高い前景色。この色は、コンポーネントによってオーバーライドされない場合にのみ使用されます。',
	...
	'フォーカスされた項目の一致ハイライトのクイックピッカーの前景色。',
