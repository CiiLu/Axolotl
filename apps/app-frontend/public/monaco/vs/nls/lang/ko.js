...
globalThis._VSCODE_NLS_MESSAGES = [
	...
	'레거시 비교 알고리즘을 사용합니다.',
	'고급 비교 알고리즘을 사용합니다.',
	'외부 `@vscode/diff` 패키지(순수 JavaScript)의 고급 diff 알고리즘을 사용합니다.',
	'외부 `@vscode/diff` 패키지(WebAssembly)의 고급 diff 알고리즘을 사용합니다.',
	...
	'명시적인 찾기 탐색 명령이 결과에 도달한 후 찾기 위젯을 닫을지 제어합니다.',
	...
	'마우스로 가리키기를 사용할 수 있습니다.',
	'마우스로 가리키기가 비활성화되었습니다.',
	"'{0}' 또는 'Alt'('#editor.multiCursorModifier#'의 반대 수정자)를 누르고 있을 때 가리키기가 표시됩니다.",
	'호버 표시 여부를 제어합니다.',
	...
	'토큰화가 건너뛰어지거나 렌더링이 일시 중지되는 등 긴 줄 경고 호버를 표시할지 제어합니다.',
	...
	'빠른 제안이 유령 텍스트로 표시됨',
	'빠른 제안이 사용 중지되었습니다.',
	'인라인 완성이 표시될 때는 빠른 제안이 사용하지 않도록 설정됩니다.',
	'모든 토큰 유형에 대해 빠른 제안이 활성화됨',
	'모든 토큰 유형에 대해 빠른 제안이 유령 텍스트로 표시됨',
	'모든 토큰 유형에 대해 빠른 제안이 비활성화됨',
	'인라인 완성이 표시될 때 모든 토큰 유형에 대해 빠른 제안이 사용하지 않도록 설정됩니다.',
	...
	'인라인 제안이 표시될 때마다 인라인 제안 도구 모음을 표시합니다.',
	'인라인 제안을 마우스로 가리키면 인라인 제안 도구 모음을 표시합니다.',
	'인라인 제안 도구 모음을 표시하지 않습니다.',
	'인라인 제안 도구 모음을 표시할 시기를 제어합니다.',
	...
	'편집기 콘텐츠',
	'화면 읽기 프로그램에서 인라인 제안을 읽어줄지 여부를 제어합니다.',
	...
	'대괄호나 따옴표 옆을 두 번 클릭하면 안쪽 내용을 선택할지 여부를 제어합니다.',
	...
	'편집기에 포커스가 없을 때 커서 위치의 선 강조 표시 배경색입니다.',
	...
	'로드 중...',
	'성능상의 이유로 긴 줄로 인해 렌더링이 일시 중지되었습니다. 이 설정은 `editor.stopRenderingLineAfter`를 통해 구성할 수 있습니다. [다시 표시 안 함](command:{0})',
	'성능상의 이유로 줄이 길면 토큰화가 생략됩니다. 이 항목은 `editor.maxTokenizationLineLength`를 통해 구성할 수 있습니다. [다시 표시 안 함](command:{0})',
	'가리키기 세부 정보 표시 증가',
	'가리키기 세부 정보 표시 감소',
	'문제 보기',
	'빠른 수정을 사용할 수 없음',
	...
	'줄로 이동합니다. 줄 번호를 입력하고, 필요하면 콜론과 열 번호도 이어서 입력할 수 있습니다.',
	'제로 기반 오프셋 토글',
	'줄 {0}, 열 {1}(으)로 이동합니다. 탐색하려면 Enter 키를 누릅니다.',
	'먼저 텍스트 편집기를 열어 줄이나 오프셋으로 이동합니다.',
	...
	'제안에 초점을 맞추는지 여부',
	'제안 세부 정보가 표시되는지 여부',
	'제안 위젯의 세부 정보 창에 포커스가 있는지 여부입니다.',
	...
	'제거',
	'{0}, 사용 안 함 이유: {1}',
	'{0} 님, 오른쪽 화살표를 눌러 옵션에 접근하세요',
	'작업 위젯',
	'검색...',
	'항목 필터링',
	'작업 표시줄에서 토글된 작업 항목의 배경색입니다.',
	'작업 위젯 목록 표시 여부',
	'작업 위젯 필터 입력에 포커스가 있는지 여부',
	'작업 위젯 숨기기',
	'작업 위젯 필터 지우기',
	'이전 작업 선택',
	'다음 작업 선택',
	...
	"'{0}'을(를) 등록할 수 없습니다. 설정에는 'policy'와 'policyReference'를 모두 선언할 수 없습니다.",
	"'{0}'을(를) 등록할 수 없습니다. 연결된 정책 {1}이(가) 이미 {2}에 등록되어 있습니다. 같은 정책에 다른 설정을 연결하려면 'policyReference'를 사용하세요.",
	...
	'다양한 배경에서 최대 가독성이 필요한 텍스트나 아이콘에 사용하는 고대비 전경색입니다. 이 색상은 구성 요소에서 재정의하지 않는 경우에만 적용됩니다.',
	...
	'포커스된 항목의 일치 항목 강조 표시를 위한 빠른 선택기 전경색입니다.',
