...
` +
	...
	const Yn = new wi()
	function Ct(t) {
		Zn(t) || Yn.onUnexpectedError(t)
	}
	function xi(t) {
		Zn(t) || Yn.onUnexpectedExternalError(t)
	}
	function en(t) {
	...
	const tn = 'Canceled'
	function Zn(t) {
		return t instanceof Kn ? !0 : t instanceof Error && t.name === tn && t.message === tn
	}
	...
	function yi(t, e = 'Unreachable') {
		throw new Error(e)
	}
	function Li(t, e = 'unexpected state') {
		if (!t) throw typeof e == 'string' ? new Y(`Assertion Failed: ${e}`) : e
	}
	function ht(t) {
		if (!t()) {
			debugger
			;(t(), Ct(new Y('Assertion Failed')))
		}
	}
	function nn(t, e) {
		let n = 0
	...
	;(function (t) {
		...
		t.flatMap = d
		function* w(...x) {
			for (const y of x) vi(y) ? yield* y : yield y
		}
		t.concat = w
		function _(x, y, S) {
			let V = S
	...
	function F(t, e, ...n) {
		return nr(typeof t == 'number' ? Ei(t, e) : e, n)
	}
	function Ei(t, e) {
		const n = Ci()?.[t]
		if (typeof n != 'string') {
	...
	const Mi = typeof ie?.versions?.electron == 'string' && ie?.type === 'renderer'
	if (typeof ie == 'object') {
		;((rn = ie.platform === 'win32'),
			(sn = ie.platform === 'darwin'),
			(an = ie.platform === 'linux'),
			an && ie.env.SNAP && ie.env.SNAP_REVISION,
		...
		if (t)
			try {
				...
				;((Et = e.userLocale),
					(sr = e.osLocale),
					(ln = e.resolvedLanguage || Oe),
					(ki = e.languagePack?.translationsConfigFile))
			} catch {}
		rr = !0
	} else
		typeof navigator == 'object' && !Mi
			? ((_e = navigator.userAgent),
				(rn = _e.indexOf('Windows') >= 0),
				(sn = _e.indexOf('Macintosh') >= 0),
				(_e.indexOf('Macintosh') >= 0 || _e.indexOf('iPad') >= 0 || _e.indexOf('iPhone') >= 0) &&
					navigator.maxTouchPoints &&
					navigator.maxTouchPoints > 0,
				(an = _e.indexOf('Linux') >= 0),
				_e?.indexOf('Mobi') >= 0,
				(on = !0),
				(ln = tr() || Oe),
				(Et = navigator.language.toLowerCase()),
				(sr = Et))
	...
	const dt = rn,
		...
		Ti = rr,
		Fi = on,
		Di = on && typeof ve.importScripts == 'function' ? ve.origin : void 0,
		xe = _e,
		Ii = typeof ve.postMessage == 'function' && !ve.importScripts
	;(() => {
		if (Ii) {
			const t = []
	...
	const Vi = !!(xe && xe.indexOf('Chrome') >= 0)
	;(xe && xe.indexOf('Firefox') >= 0,
		!Vi && xe && xe.indexOf('Safari') >= 0,
		xe && xe.indexOf('Edg/') >= 0,
		xe && xe.indexOf('Android') >= 0)
	let je
	const un = globalThis.vscode
	if (typeof un < 'u' && typeof un.process < 'u') {
		const t = un.process
		je = {
			get platform() {
				return t.platform
		...
		typeof process < 'u' && typeof process?.versions?.node == 'string'
			...
			: (je = {
					get platform() {
						return dt ? 'win32' : Pi ? 'darwin' : 'linux'
					},
					get arch() {},
					get env() {
						return {}
	...
	const kt = je.cwd,
		ir = je.env,
		Bi = je.platform,
		qi = globalThis.performance.now.bind(globalThis.performance)
	class Mt {
		static create(e) {
			return new Mt(e)
		}
		constructor(e) {
			;((this._now = e === !1 ? Date.now : qi),
	...
	;(function (t) {
		...
		t.onceIf = r
		function s(C, N, A) {
			return h((M, E = null, I) => C((H) => M.call(E, N(H)), null, I), A)
		}
		t.map = s
		function i(C, N, A) {
			return h(
		...
		t.forEach = i
		function o(C, N, A) {
			return h((M, E = null, I) => C((H) => N(H) && M.call(E, H), null, I), A)
		}
		t.filter = o
		function l(C) {
			return C
		...
		function u(...C) {
			return (N, A = null, M) => {
				const E = Ni(...C.map((I) => I((H) => N.call(A, H))))
				return m(E, M)
			}
		}
		t.any = u
					...
					onWillAddFirstListener() {
						K = C((b1) => {
							;(ee++,
								...
								(oe = () => {
									const w1 = G
									;((G = void 0), (se = void 0), (!M || ee > 1) && ct.fire(w1), (ee = 0))
								}),
								typeof A == 'number'
				...
				((H = {
					...
					timerId: setTimeout(() => {
						I &&
							...
							((H.warned = !0),
							console.warn(
								`[Event.buffer][${N}] potential LEAK detected: ${I.length} events buffered for ${ar / 1e3}s without being consumed. Buffered here:`,
							),
							H.stack.print())
					}, ar),
					warned: !1,
		...
		function x(C, N) {
			...
			return ((E.cancel = A), N && E.finally(() => lr(M, N)), E)
		}
		t.toPromise = x
		function y(C, N) {
			return C((A) => N.fire(A))
	...
	let hn = at,
		$i = -1
	const Jt = class Jt {
		constructor(e, n, r = (Jt._idPool++).toString(16).padStart(3, '0')) {
...
`),
	...
	class ge {
		constructor(e) {
			;((this._size = 0),
				...
				(this._leakageMon = this._options?.leakWarningThreshold
					? new mn(
							e?.onListenerError ?? Ct,
							this._options?.leakWarningThreshold ?? $i,
							this._options?.leakWarningName,
						)
					: void 0),
				(this._perfMon = this._options?._profName ? new hn(this._options._profName) : void 0),
			...
			return (
				(this._event ??= (e, n, r) => {
					if (this._leakageMon && this._size > this._leakageMon.threshold ** 2) {
						...
						return ((this._options?.onListenerError || Ct)(h), Ie.None)
					}
					...
					;(this._leakageMon &&
						...
						((s.stack = Pt.create()), (i = this._leakageMon.check(s.stack, this._size + 1))),
						this._listeners
							? this._listeners instanceof fn
								? ((this._deliveryQueue ??= new zi()), (this._listeners = [this._listeners, s]))
		...
		_deliver(e, n) {
			if (!e) return
			const r = this._options?.onListenerError || Ct
			if (!r) {
				e.value(n)
				return
			}
		...
		fire(e) {
			if (
				...
				if (this._listeners instanceof fn) this._deliver(this._listeners, e)
				else {
	...
	class ji {
		constructor(e, n) {
			;((this.lastCache = void 0),
				...
				typeof e == 'function'
					? ((this._fn = e), (this._computeKey = Oi))
	...
	;((Le.ambiguousCharacterData = new gn(() =>
		JSON.parse(
		...
		(Le.cache = new ji((e) => {
			...
			function r(m) {
				const f = new Map()
				for (let p = 0; p < m.length; p += 2) f.set(m[p], m[p + 1])
				return f
			}
			function s(m, f) {
				const p = new Map(m)
			...
			function i(m, f) {
				if (!m) return f
				const p = new Map()
				for (const [g, d] of m) f.has(g) && p.set(g, d)
				return p
			}
			const o = Le.ambiguousCharacterData.value
			let l = n.filter((m) => !m.startsWith('_') && Object.hasOwn(o, m))
	...
	class la {
		...
		async sendMessage(e, n, r) {
			...
			return new Promise((i, o) => {
				;((this._pendingReplies[s] = { resolve: i, reject: o }),
					this._send(new sa(this._workerId, s, e, n, r)))
			})
		}
		listen(e, n, r) {
			let s = null
			const i = new ge({
				onWillAddFirstListener: () => {
					;((s = String(++this._lastSentReq)),
						...
						this._send(new ia(this._workerId, s, e, n, r)))
				},
				onDidRemoveLastListener: () => {
					;(this._pendingEmitters.delete(s), this._send(new oa(this._workerId, s)), (s = null))
				},
			})
			return i.event
		}
		...
		_handleRequestMessage(e) {
			...
			this._handler.handleMessage(e.channel, e.method, e.args).then(
				(s) => {
					this._send(new cr(this._workerId, n, s, void 0))
				},
				(s) => {
					;(s.detail instanceof Error && (s.detail = en(s.detail)),
						this._send(new cr(this._workerId, n, void 0, en(s))))
				},
			)
		}
		_handleSubscribeEventMessage(e) {
			const n = e.req,
				r = this._handler.handleEvent(
					...
					this._send(new aa(this._workerId, n, s))
				})
	...
	function hr(t) {
		return t[0] === 'o' && t[1] === 'n' && ur(t.charCodeAt(2))
	}
	function mr(t) {
		return /^onDynamic/.test(t) && ur(t.charCodeAt(9))
	}
	class ua {
		constructor(e, n) {
			;((this._localChannels = new Map()),
				(this._remoteChannels = new Map()),
				(this._protocol = new la({
					sendMessage: (r, s) => {
						e(r, s)
					},
		...
		_handleMessage(e, n, r) {
			if (e === xn && n === ra) return this.initialize(r[0])
			const s = e === xn ? this.requestHandler : this._localChannels.get(e)
	...
	let fr = !1
	function ca(t) {
		if (fr) throw new Error('WebWorker already initialized!')
		fr = !0
		const e = new ua(
	...
	function ha(t, e) {
		e = dr(149417, e)
		for (let n = 0, r = t.length; n < r; n++) e = dr(t.charCodeAt(n), e)
		return e
	}
	class gr {
		constructor(e) {
	...
	function ma(t, e, n) {
		return new Me(new gr(t), new gr(e)).ComputeDiff(n).changes
	}
	class Ge {
		static Assert(e, n) {
	...
	class Me {
		...
		static _getElements(e) {
			...
			if (Me._isStringArray(n)) {
				...
				for (let s = 0, i = n.length; s < i; s++) r[s] = ha(n[s], 0)
				return [n, r, !0]
			}
		...
		ComputeDiffRecursive(e, n, r, s, i) {
			...
			if (u !== null) return u
			if (!i[0]) {
				const m = this.ComputeDiffRecursive(e, c, r, h, i)
				let f = []
				return (
					i[0]
						? (f = [new ke(c + 1, n - (c + 1) + 1, h + 1, s - (h + 1) + 1)])
						: (f = this.ComputeDiffRecursive(c + 1, n, h + 1, s, i)),
					this.ConcatenateChanges(m, f)
				)
			}
			return [new ke(e, n - e + 1, r, s - r + 1)]
		}
		WALKTRACE(e, n, r, s, i, o, l, u, c, h, m, f, p, g, d, w, _, v) {
			let L = null,
				k = null,
				D = new pr(),
				W = n,
			...
			do {
				...
				;(U === W || (U < x && c[U - 1] < c[U + 1])
					? ((m = c[U + 1]),
						(g = m - y - s),
						m < S && D.MarkNextChange(),
						(S = m),
						D.AddModifiedElement(m + 1, g),
						(y = U + 1 - e))
					: ((m = c[U - 1] + 1),
						(g = m - y - s),
						m < S && D.MarkNextChange(),
						(S = m - 1),
						D.AddOriginalElement(m, g + 1),
						(y = U - 1 - e)),
				...
				do {
					...
					;(U === W || (U < x && h[U - 1] >= h[U + 1])
						? ((m = h[U + 1] - 1),
							...
							m > S && D.MarkNextChange(),
							(S = m + 1),
							D.AddOriginalElement(m + 1, g + 1),
							(y = U + 1 - i))
						: ((m = h[U - 1]),
							(g = m - y - u),
							m > S && D.MarkNextChange(),
							(S = m),
							D.AddModifiedElement(m + 1, g + 1),
							(y = U - 1 - i)),
						V >= 0 && ((h = this.m_reverseHistory[V]), (i = h[0]), (W = 1), (x = h.length - 1)))
				} while (--V >= -1)
				k = D.getChanges()
			}
		...
		ComputeRecursionPoint(e, n, r, s, i, o, l) {
			...
			for (let y = 1; y <= g / 2 + 1; y++) {
				...
				for (let B = h; B <= m; B += 2) {
					;(B === h || (B < m && w[B - 1] < w[B + 1]) ? (u = w[B + 1]) : (u = w[B - 1] + 1),
						(c = u - (B - v) - k))
					const C = u
					...
					if (
						...
						return (
							...
							(o[0] = c),
							C <= _[B] && y <= 1448
								? this.WALKTRACE(v, h, m, k, L, f, p, D, w, _, u, n, i, c, s, o, x, l)
								: null
						)
				}
				const U = (S - e + (V - r) - y) / 2
				...
				if (y <= 1447) {
					let B = new Int32Array(m - h + 2)
					;((B[0] = v - h + 1),
						Xe.Copy2(w, h, B, 1, m - h + 1),
			...
			return this.WALKTRACE(v, h, m, k, L, f, p, D, w, _, u, n, i, c, s, o, x, l)
		}
		PrettifyChanges(e) {
			...
			for (let n = e.length - 1; n >= 0; n--) {
				...
				if (n > 0) {
					const m = e[n - 1]
					;((s = m.originalStart + m.originalLength), (i = m.modifiedStart + m.modifiedLength))
				}
			...
			if (this._hasStrings)
				for (let n = 1, r = e.length; n < r; n++) {
					const s = e[n - 1],
						...
						f = m - h
					if (o < 5 && c < 20 && f < 20) {
						const p = this._findBetterContiguousSequence(l, c, h, f, o)
						if (p) {
							const [g, d] = p
		...
		_findBetterContiguousSequence(e, n, r, s, i) {
			...
			for (let m = e; m < o; m++)
				for (let f = r; f < l; f++) {
					const p = this._contiguousSequenceScore(m, f, i)
					p > 0 && p > u && ((u = p), (c = m), (h = f))
				}
			return u > 0 ? [c, h] : null
		}
	...
	class R {
		...
		static intersectRanges(e, n) {
			...
			return (
				...
				i > c ? ((i = c), (o = h)) : i === c && (o = Math.min(o, h)),
				...
				for (; c < u; ) {
					...
					if (f === 13) {
						...
						switch (v) {
							...
							case 34:
							case 96:
								m === v ? (L = 1) : m === 39 || m === 34 || m === 96 ? (L = 0) : (L = 1)
								break
							case 42:
								L = m === 42 ? 1 : 0
								break
						...
						L === 1 && (s.push(Ft._createLink(r, l, i, h, c)), (_ = !0))
					} else if (f === 12) {
						let L
						;(v === 91 ? ((g = !0), (L = 0)) : (L = r.get(v)), L === 1 ? (_ = !0) : (f = 13))
					} else ((f = n.nextState(f, v)), f === 0 && (_ = !0))
					;(_ && ((f = 1), (p = !1), (g = !1), (w = !1), (h = c + 1), (m = v)), c++)
				}
				f === 13 && s.push(Ft._createLink(r, l, i, h, u))
			}
			return s
		}
	}
	...
	Yt.INSTANCE = new Yt()
	let _n = Yt
	const wr = Object.freeze(function (t, e) {
	...
	;(function (t) {
		function e(n) {
			return n === t.None || n === t.Cancelled || n instanceof It
				? !0
				: !n || typeof n != 'object'
					? !1
		...
		;((t.isCancellationToken = e),
			(t.None = Object.freeze({ isCancellationRequested: !1, onCancellationRequested: cn.None })),
			(t.Cancelled = Object.freeze({ isCancellationRequested: !0, onCancellationRequested: wr })))
	})(Dt || (Dt = {}))
	class It {
		constructor() {
	...
	class wa {
		...
		cancel() {
			this._token ? this._token instanceof It && this._token.cancel() : (this._token = Dt.Cancelled)
		}
		dispose(e = !1) {
			;(e && this.cancel(),
				this._parentListener?.dispose(),
				this._token ? this._token instanceof It && this._token.dispose() : (this._token = Dt.None))
		}
	}
	class vn {
		constructor() {
	...
	;(function () {
		const e = [
			...
			r = []
		for (const s of e) {
			const [i, o, l, u, c, h, m, f, p] = s
			if ((r[o] || ((r[o] = !0), (ya[l] = o), (La[l.toLowerCase()] = o)), !n[u])) {
				if (((n[u] = !0), !c))
					throw new Error(`String representation missing for key code ${u} around scan code ${l}`)
				;(Vt.define(u, c), Nn.define(u, f || c), Sn.define(u, p || f || c))
			}
			h && (xa[h] = u)
		}
	})()
	...
	function Aa(t, e) {
		if (t === null || typeof t != 'object') throw new yr(e, 'Object', t)
	}
	function J(t, e) {
		if (typeof t != 'string') throw new yr(e, 'string', t)
	}
	const Se = Bi === 'win32'
	function $(t) {
		return t === Z || t === ae
	...
	const te = {
				...
				for (let s = t.length - 1; s >= -1; s--) {
					...
					if (o === 1) $(h) && ((l = 1), (c = !0))
						...
						if (((c = !0), $(i.charCodeAt(1)))) {
							let m = 2,
								f = m
							for (; m < o && !$(i.charCodeAt(m)); ) m++
							if (m < o && m !== f) {
								const p = i.slice(f, m)
								for (f = m; m < o && $(i.charCodeAt(m)); ) m++
								if (m < o && m !== f) {
									for (f = m; m < o && !$(i.charCodeAt(m)); ) m++
									;(m === o || m !== f) && ((u = `\\\\${p}\\${i.slice(f, m)}`), (l = m))
								}
							}
						} else l = 1
					else
			...
			relative(t, e) {
				...
				if (f !== h) {
					...
					;(o > h && (t.charCodeAt(s + f) === ae ? (m = f) : f === 2 && (m = 3)),
						m === -1 && (m = 0))
				}
				let p = ''
				for (f = s + m + 1; f <= i; ++f)
			...
			toNamespacedPath(t) {
				...
				if (e.charCodeAt(0) === ae) {
					if (e.charCodeAt(1) === ae) {
						...
						if (n !== Ca && n !== Be) return `\\\\?\\UNC\\${e.slice(2)}`
					}
			...
			parse(t) {
				...
				if ($(s)) {
					if (((r = 1), $(t.charCodeAt(1)))) {
						let m = 2,
							f = m
						for (; m < n && !$(t.charCodeAt(m)); ) m++
						if (m < n && m !== f) {
							for (f = m; m < n && $(t.charCodeAt(m)); ) m++
							if (m < n && m !== f) {
								for (f = m; m < n && !$(t.charCodeAt(m)); ) m++
								m === n ? (r = m) : m !== f && (r = m + 1)
							}
				...
				for (; c >= r; --c) {
					...
					;(l === -1 && ((u = !1), (l = c + 1)),
						s === Be ? (i === -1 ? (i = c) : h !== 1 && (h = 1)) : i !== -1 && (h = -1))
				}
				return (
					l !== -1 &&
						(i === -1 || h === 0 || (h === 1 && i === l - 1 && i === o + 1)
		...
		ne = {
			resolve(...t) {
				...
				return ((e = Bt(e, !n, '/', Rn)), n ? `/${e}` : e.length > 0 ? e : '.')
			},
			normalize(t) {
			...
			relative(t, e) {
				...
				let u = -1,
					c = 0
				for (; c < l; c++) {
					const m = t.charCodeAt(n + c)
					if (m !== e.charCodeAt(i + c)) break
					m === Z && (u = c)
				}
				if (c === l)
					if (o > l) {
				...
				let h = ''
				for (c = n + u + 1; c <= r; ++c)
					(c === r || t.charCodeAt(c) === Z) && (h += h.length === 0 ? '..' : '/..')
			...
			parse(t) {
				...
				for (; u >= r; --u) {
					...
					;(o === -1 && ((l = !1), (o = u + 1)),
						h === Be ? (s === -1 ? (s = u) : c !== 1 && (c = 1)) : s !== -1 && (c = -1))
				}
				if (o !== -1) {
					const h = i === 0 && n ? 1 : i
					s === -1 || c === 0 || (c === 1 && s === o - 1 && s === i + 1)
						? (e.base = e.name = t.slice(h, o))
						: ((e.name = t.slice(h, s)), (e.base = t.slice(h, o)), (e.ext = t.slice(s, o)))
				}
	...
	class le {
		...
		static parse(e, n = !1) {
			const r = Ba.exec(e)
			return r
				? new Je(r[2] || j, qt(r[4] || j), qt(r[5] || j), qt(r[7] || j), qt(r[9] || j), n)
				: new Je(j, j, j, j, j)
		}
		static file(e) {
			let n = j
			...
			if (e) {
				if (e instanceof le) return e
				{
					...
					return (
						...
						(n._fsPath = e._sep === _r ? (e.fsPath ?? null) : null),
						n
					)
				}
			} else return e
	...
	class Je extends le {
		...
		toJSON() {
			const e = { $mid: 1 }
			return (
				this._fsPath && ((e.fsPath = this._fsPath), (e._sep = _r)),
	...
	function qa(t) {
		...
		for (let n = 0; n < t.length; n++) {
			const r = t.charCodeAt(n)
			r === 35 || r === 63
				? (e === void 0 && (e = t.substr(0, n)), (e += vr[r]))
				: e !== void 0 && (e += t[n])
		}
		return e !== void 0 ? e : t
	}
	...
	function qt(t) {
		return t.match(Rr) ? t.replace(Rr, (e) => Sr(e)) : t
	}
	class ue extends R {
		constructor(e, n, r, s) {
			;(super(e, n, r, s),
	...
	function Ka(t, e, n, r, s) {
		return Ya(t, e, n, r, s) && Za(t, e, n, r, s)
	}
	class eo {
		constructor(e, n) {
		...
		next(e) {
			...
			do {
				...
				if (s === this._prevMatchStartIndex && i === this._prevMatchLength) {
					if (i === 0) {
						ea(e, n, this._searchRegex.lastIndex) > 65535
				...
				if (
					...
					!this._wordSeparators || Ka(this._wordSeparators, e, n, s, i))
				)
					return r
			} while (r)
			return null
	...
	function no(t = '') {
		let e = '(-?\\d*\\.\\d\\w*)|([^'
		for (const n of to) t.indexOf(n) >= 0 || (e += '\\' + n)
	...
	function Fn(t, e, n, r, s) {
		if (((e = Bs(e)), s || (s = At.first(qs)), n.length > s.maxLen)) {
			let c = t - s.maxLen / 2
	...
	class so {
		static computeUnicodeHighlights(e, n, r) {
			...
			l === 'allNonBasicAscii'
				? (u = new RegExp('[^\\t\\n\\r\\x20-\\x7E]', 'g'))
				: (u = new RegExp(`${io(Array.from(l))}`, 'g'))
			const c = new eo(null, u),
				h = []
			let m = !1,
				f,
				p = 0,
			...
			e: for (let w = s, _ = i; w <= _; w++) {
				...
				do
					if (((f = c.next(v)), f)) {
						...
						if (y !== 0) {
							if ((y === 3 ? p++ : y === 2 ? g++ : y === 1 ? d++ : yi(), h.length >= 1e3)) {
								m = !0
								break e
							}
							h.push(new R(w, k + 1, w, D + 1))
						}
					}
				while (f)
			}
	...
	class Us {
		...
		getCandidateCodePoints() {
			...
			if (this.options.invisibleCharacters)
				for (const n of pt.codePoints) $s(String.fromCodePoint(n)) || e.add(n)
		...
		shouldHighlightNonBasicASCII(e, n) {
			...
			return !s && i
				? 0
				: this.options.invisibleCharacters && !$s(e) && pt.isInvisibleCharacter(r)
					? 2
...
` &&
	...
	class Os {
		...
		getTransformer() {
			return (this._transformer || (this._transformer = new zs(this.getValue())), this._transformer)
		}
		getLineAt(e) {
	...
	class po extends Os {
		constructor(e, n) {
			;(Li(n >= 1), super(), (this._getLineContent = e), (this._lineCount = n))
		}
		getValueOfRange(e) {
...
` + this._getLineContent(e.endLineNumber).substring(0, e.endColumn - 1)),
	...
	class Wt extends Os {
		constructor(e) {
			;(super(), (this.value = e), (this._t = new zs(this.value)))
		}
		getValueOfRange(e) {
	...
	class Ht {
		...
		constructor(e) {
			;((this.replacements = e),
				ht(() =>
					nn(e, (n, r) => n.range.getEndPosition().isBeforeOrEqual(r.range.getStartPosition())),
				))
		}
		mapPosition(e) {
			let n = 0,
		...
		apply(e) {
			...
			const s = zt(r, e.endPositionExclusive)
		...
		createCharSequence(e, n, r) {
			...
			for (let u = n; u <= r; u++) {
				const c = this.lines[u],
					...
					m = e ? this._endColumns[u] : c.length + 1
				for (let f = h; f < m; f++) ((s[l] = c.charCodeAt(f - 1)), (i[l] = u + 1), (o[l] = f), l++)
	...
	class tt {
		...
		static createFromDiffChange(e, n, r) {
			const s = n.getStartLineNumber(e.originalStart),
				...
				m = r.getEndColumn(e.modifiedStart + e.modifiedLength - 1)
			return new tt(s, i, o, l, u, c, h, m)
		}
	}
	function Lo(t) {
	...
	class yt {
		...
		static createFromDiffResult(e, n, r, s, i, o, l) {
			...
			if (
				...
				n.modifiedLength === 0
					? ((h = s.getStartLineNumber(n.modifiedStart) - 1), (m = 0))
					: ((h = s.getStartLineNumber(n.modifiedStart)),
						(m = s.getEndLineNumber(n.modifiedStart + n.modifiedLength - 1))),
				o &&
					n.originalLength > 0 &&
					n.originalLength < 20 &&
					n.modifiedLength > 0 &&
	...
	class _o {
		constructor(e, n, r) {
			;((this.shouldComputeCharChanges = r.shouldComputeCharChanges),
				...
				(this.original = new Xs(e)),
				(this.modified = new Xs(n)),
				(this.continueLineDiff = Qs(r.maxComputationTime)),
				(this.continueCharDiff = Qs(
		...
		computeDiff() {
			...
			const e = Gs(this.original, this.modified, this.continueLineDiff, this.shouldMakePrettyDiff),
				n = e.changes,
				r = e.quitEarly
			...
			for (let l = -1, u = n.length; l < u; l++) {
				const c = l + 1 < u ? n[l + 1] : null,
					...
					m = c ? c.modifiedStart : this.modifiedLines.length
				for (; i < h && o < m; ) {
...
`)
	...
	class No {
		compute(e, n, r = Lt.instance, s) {
			...
			let c = e.length,
				h = n.length
			function m(g, d) {
				;((g + 1 !== c || d + 1 !== h) && u.push(new Q(new T(g + 1, c), new T(d + 1, h))),
					(c = g),
					(h = d))
			}
			let f = e.length - 1,
				p = n.length - 1
			for (; f >= 0 && p >= 0; )
				o.get(f, p) === 3 ? (m(f, p), f--, p--) : o.get(f, p) === 1 ? f-- : p--
			return (m(-1, -1), u.reverse(), new Ae(u, !1))
		}
	}
	class Js {
		compute(e, n, r = Lt.instance) {
			...
			u.set(0, o(0, 0))
			const c = new Ro()
			c.set(0, u.get(0) === 0 ? null : new Ys(null, 0, 0, u.get(0)))
			let h = 0
			e: for (;;) {
				...
				for (h = d; h <= w; h += 2) {
					...
					const D = o(L, k)
					u.set(h, D)
					const W = L === _ ? c.get(h + 1) : c.get(h - 1)
					if (
						(c.set(h, D !== L ? new Ys(W, L, k, D - L) : W),
			...
			let p = s.length,
				g = i.length
			for (;;) {
				const d = m ? m.x + m.length : 0,
					w = m ? m.y + m.length : 0
				if (((d !== p || w !== g) && f.push(new Q(new T(d, p), new T(w, g))), !m)) break
				;((p = m.x), (g = m.y), (m = m.prev))
			}
	...
	class jt {
		...
		getBoundaryScore(e) {
			const n = ei(e > 0 ? this.elements[e - 1] : -1),
				r = ei(e < this.elements.length ? this.elements[e] : -1)
			if (n === 7 && r === 8) return 0
			if (n === 8) return 150
			let s = 0
			return (n !== r && ((s += 10), n === 0 && r === 1 && (s += 1)), (s += Ks(n)), (s += Ks(r)), s)
		}
		...
		extendToFullLines(e) {
			const n = Ze(this.firstElementOffsetByLineIdx, (s) => s <= e.start) ?? 0,
				r = mo(this.firstElementOffsetByLineIdx, (s) => e.endExclusive <= s) ?? this.elements.length
			return new T(n, r)
		}
	}
	function nt(t) {
	...
	const Co = { 0: 0, 1: 0, 2: 0, 3: 10, 4: 2, 5: 30, 6: 3, 7: 10, 8: 10 }
	function Ks(t) {
		return Co[t]
	}
	function ei(t) {
	...
	function Ao(t, e, n, r, s, i) {
		let { moves: o, excludedChanges: l } = ko(t, e, n, i)
		if (!i.isValid()) return []
		const u = t.filter((h) => !l.has(h)),
			c = Mo(u, r, s, e, n, i)
		return (
			co(o, c),
			(o = Po(o)),
...
`).length >= 15 && Eo(m, (p) => p.length >= 2) >= 2
	...
	function ko(t, e, n, r) {
		const s = [],
			i = t
				...
				.map((u) => new Ot(u.original, e, u)),
			o = new Set(
				t
					.filter((u) => u.original.isEmpty && u.modified.length >= 3)
					.map((u) => new Ot(u.modified, n, u)),
			),
			l = new Set()
		for (const u of i) {
			let c = -1,
			...
			if (
				(c > 0.9 &&
					h &&
					(o.delete(h), s.push(new ce(u.range, h.range)), l.add(u.source), l.add(h.source)),
				!r.isValid())
			)
	...
	function Mo(t, e, n, r, s, i) {
		...
		for (let f = 0; f < o.length; f++) {
			const p = o[f],
				g = m.findLastMonotonous((W) => W.original.startLineNumber <= p.original.startLineNumber),
			...
			k > 0 &&
				(h.addRange(new z(p.original.startLineNumber - k, p.original.startLineNumber)),
	...
	function ti(t, e, n) {
		...
		const s = new Js().compute(
			new jt([t], new R(1, 1, 1, t.length), !1),
			new jt([e], new R(1, 1, 1, e.length), !1),
			n,
		)
		let i = 0
		const o = Q.invert(s.diffs, t.length)
		for (const h of o)
			h.seq1Range.forEach((m) => {
				$n(t.charCodeAt(m)) || i++
			})
		function l(h) {
			let m = 0
			for (let f = 0; f < t.length; f++) $n(h.charCodeAt(f)) || m++
			return m
		}
	...
	function ni(t, e, n) {
		let r = n
		return ((r = ri(t, e, r)), (r = ri(t, e, r)), (r = Fo(t, e, r)), r)
	}
	function ri(t, e, n) {
	...
	function Fo(t, e, n) {
		...
		for (let r = 0; r < n.length; r++) {
			...
			i.seq1Range.isEmpty
				? (n[r] = si(i, t, e, l, u))
				: i.seq2Range.isEmpty && (n[r] = si(i.swap(), e, t, u, l).swap())
		}
		return n
	}
	function si(t, e, n, r, s) {
		...
		let u = 0,
			c = -1
		for (let h = -o; h <= l; h++) {
			const m = t.seq2Range.start + h,
				f = t.seq2Range.endExclusive + h,
				p = t.seq1Range.start + h,
				g = e.getBoundaryScore(p) + n.getBoundaryScore(m) + n.getBoundaryScore(f)
			g > c && ((c = g), (u = h))
		}
		return t.delta(u)
	}
	...
	function ii(t, e, n, r, s = !1) {
		...
		function u(h, m) {
			...
			const f = r(t, h.offset1),
				p = r(e, h.offset2)
			if (!f || !p) return
			let g = new Q(f, p)
			const d = g.intersect(m)
	...
	function Bo(t, e, n) {
		...
		do {
			...
			for (let u = 1; u < r.length; u++) {
				let m = function (p, g) {
					const d = new T(h.seq1Range.endExclusive, c.seq1Range.start)
				...
				const c = r[u],
					h = l[l.length - 1]
				m(h, c) ? ((i = !0), (l[l.length - 1] = l[l.length - 1].join(c))) : l.push(c)
			}
			r = l
		} while (s++ < 10 && i)
		const o = []
	...
	class ai {
		...
		getBoundaryScore(e) {
			const n = e === 0 ? 0 : oi(this.lines[e - 1]),
				r = e === this.lines.length ? 0 : oi(this.lines[e])
			return 1e3 - (n + r)
		}
		getText(e) {
...
`)
	...
	class qo {
		constructor() {
			;((this.dynamicProgrammingDiffing = new No()), (this.myersDiffingAlgorithm = new Js()))
		}
		computeDiff(e, n, r) {
			if (e.length <= 1 && ao(e, n, (x, y) => x === y)) return new wt([], [], !1)
			...
			const s = r.maxComputationTimeMs === 0 ? Lt.instance : new vo(r.maxComputationTimeMs),
			...
			const u = e.map((x) => l(x.trim())),
				...
				m = new ai(c, n),
				f =
					h.length + m.length < 1700
						? this.dynamicProgrammingDiffing.compute(h, m, s, (x, y) =>
								e[x] === n[y] ? (n[y].length === 0 ? 0.1 : 1 + Math.log(1 + n[y].length)) : 0.99,
							)
						: this.myersDiffingAlgorithm.compute(h, m, s)
			let p = f.diffs,
				g = f.hitTimeout
			;((p = ni(h, m, p)), (p = Vo(h, m, p)))
			const d = [],
				w = (x) => {
					if (i)
						for (let y = 0; y < x; y++) {
		...
		computeMoves(e, n, r, s, i, o, l, u) {
			return Ao(e, n, r, s, i, o).map((m) => {
				const f = this.refineDiff(
						n,
						r,
						new Q(m.original.toOffsetRange(), m.modified.toOffsetRange()),
						o,
						l,
						u,
					),
					p = Vn(f.mappings, new $t(n), new $t(r), !0)
				return new Ws(m, p)
			})
		}
		refineDiff(e, n, r, s, i, o) {
			const u = Uo(r).toRangeMapping2(e, n),
				c = new jt(e, u.originalRange, i),
				h = new jt(n, u.modifiedRange, i),
				m =
			...
			return (
				(f = ni(c, h, f)),
				(f = ii(c, h, f, (g, d) => g.findWordContaining(d))),
				o.extendToSubwords && (f = ii(c, h, f, (g, d) => g.findSubWordContaining(d), !0)),
				(f = Do(c, h, f)),
				(f = Bo(c, h, f)),
				{
					mappings: f.map(
						(g) => new he(c.translateRange(g.seq1Range), h.translateRange(g.seq2Range)),
					),
					hitTimeout: m.hitTimeout,
				}
			)
		}
	}
	...
	class Wo {
		...
		rewrite(e) {
			...
			return (
				typeof i == 'string' && (o += `&${$o}=${encodeURIComponent(i)}`),
				le.from({
					scheme: Fi ? this._preferredWebSchema : Te.vscodeRemoteResource,
					authority: `${r}:${s}`,
		...
		St = class St {
			...
			uriToBrowserUri(e) {
				return e.scheme === Te.vscodeRemote
					? Ho.rewrite(e)
					: e.scheme === Te.file &&
						  (Ti || Di === `${Te.vscodeFileResource}://${St.FALLBACK_AUTHORITY}`)
						? e.with({
	...
	function Go(t, e) {
		...
		const r = `${t}/${e}`,
			i = `${zo}/${r}`
		return jo.asBrowserUri(i).toString(!0)
	}
	class Xo {
		constructor(e) {
			this.replacements = e
		...
		compose(e) {
			...
			for (const l of r.replacements) {
				for (;;) {
					const m = s[0]
					if (!m || m.replaceRange.start + o + m.getNewLength() >= l.replaceRange.start) break
					;(s.shift(), i.push(m), (o += m.getNewLength() - m.replaceRange.length))
				}
				const u = o
				let c, h
				for (;;) {
					const m = s[0]
					if (!m || m.replaceRange.start + o > l.replaceRange.endExclusive) break
					;(c || (c = m), (h = m), s.shift(), (o += m.getNewLength() - m.replaceRange.length))
				}
				if (!c) i.push(l.delta(-o))
				else {
					const m = Math.min(c.replaceRange.start, l.replaceRange.start - u),
						f = l.replaceRange.start - (c.replaceRange.start + u)
					if (f > 0) {
						const w = c.slice(T.emptyAt(m), new T(0, f))
						i.push(w)
					}
					if (!h) throw new Y('Invariant violation: lastIntersecting is undefined')
					const p = h.replaceRange.endExclusive + o - l.replaceRange.endExclusive
					if (p > 0) {
						const w = h.slice(
							T.ofStartAndLength(h.replaceRange.endExclusive, 0),
							new T(h.getNewLength() - p, h.getNewLength()),
						)
						;(s.unshift(w), (o -= w.getNewLength() - w.replaceRange.length))
					}
					const g = new T(m, l.replaceRange.endExclusive - o),
	...
	class Yo extends Qo {
		...
		removeCommonSuffixPrefix(e) {
			const n = e.substring(this.replaceRange.start, this.replaceRange.endExclusive),
				r = pn(n, this.newText),
				s = Math.min(n.length - r, this.newText.length - r, bn(n, this.newText)),
	...
	go({ StringEdit: Gt, StringReplacement: Fe, TextReplacement: be, TextEdit: Ht, TextLength: Pe })
	let Hn, zn, On
	function ui() {
		return (Hn || (Hn = import(`${Go('@vscode/diff', 'dist/index.js')}`)), Hn)
	}
	function Zo(t) {
		return t
			? (On || (On = ui().then((e) => e.createDiffComputer({ useWasm: !0 }))), On)
			: (zn || (zn = ui().then((e) => e.createDiffComputer({ useWasm: !1 }))), zn)
	}
	async function ci(t) {
		const e = await Zo(t)
		return new Ko(e)
...
`),
			...
			if (r.computeMoves)
				for (const p of o.moves) {
					...
					f.push(new Ws(new ce(v, L), []))
				}
			return new wt(m, f, o.hitTimeout)
		}
	}
	const Xt = {
		getLegacy: () => new xo(),
		getDefault: () => new qo(),
		getAdvancedExternal: () => ci(!1),
		getAdvancedWasm: () => ci(!0),
	}
	function De(t, e) {
	...
	class fe {
		...
		static fromRGBA(e) {
			...
			const h = (l + o) / 2,
				m = o - l
			if (m > 0) {
				switch (((c = Math.min(h <= 0.5 ? m / (2 * h) : m / (2 - 2 * h), 1)), o)) {
					case n:
						u = (r - s) / m + (r < s ? 6 : 0)
						break
					case r:
		...
		static toRGBA(e) {
			...
			if (r === 0) o = l = u = s
				...
				const c = s < 0.5 ? s * (1 + r) : s + r - s * r,
					h = 2 * s - c
				;((o = fe._hue2rgb(h, c, n + 1 / 3)),
					(l = fe._hue2rgb(h, c, n)),
					(u = fe._hue2rgb(h, c, n - 1 / 3)))
			}
		...
		if (r.length > 0)
			for (const s of r) {
				...
				if (o === 'rgb') {
					...
					u = fi(_t(t, s), vt(l, c), !0)
				} else o === '#' && (u = e1(_t(t, s), o + l))
				u && e.push(u)
			}
		return e
	}
		...
		for (let s = 1; s <= r; s++) {
			...
			if (o) {
				...
				if (l.endColumn > l.startColumn) {
					const u = { range: l, ...l1(i.substring(o[0].length)), shouldBeInComments: !1 }
	...
	function o1(t, e) {
		...
		const s = Ja(e.markSectionHeaderRegex),
			i = new RegExp(e.markSectionHeaderRegex, `gdm${s ? 's' : ''}`)
		if (Xi(i)) return n
		for (let o = 1; o <= r; o += di - s1) {
			const l = Math.min(o + di - 1, r),
				u = []
			for (let m = o; m <= l; m++) u.push(t.getLineContent(m))
			const c = u.join(`
`)
			i.lastIndex = 0
			let h
			for (; (h = i.exec(c)) !== null; ) {
				const m = c.substring(0, h.index),
					f = (m.match(/\n/g) || []).length,
					p = o + f,
					g = h[0].split(`
`),
...
`) + 1,
	...
	class f1 {
		...
		$acceptNewModel(e) {
			this._models[e.url] = new d1(le.parse(e.url), e.lines, e.EOL, e.versionId)
		}
	...
	class d1 extends m1 {
		...
		getWordAtPosition(e, n) {
			const r = Fn(e.column, Bs(n), this._lines[e.lineNumber - 1], 0)
	...
	const We = class We {
		constructor(e = null) {
			;((this._foreignModule = e),
				...
				(this._workerTextModelSyncServer = new f1()))
		}
		dispose() {}
		async $ping() {
			return 'pong'
		...
		async $computeUnicodeHighlights(e, n, r) {
			...
			return s
				? so.computeUnicodeHighlights(s, n, r)
				: {
						ranges: [],
						hasMore: !1,
		...
		async $computeMoreMinimalEdits(e, n, r) {
			...
			for (let { range: u, text: c, eol: h } of n) {
				if ((typeof h == 'number' && (o = h), R.isEmpty(u) && !c)) continue
				const m = s.getValueInRange(u)
				if (((c = c.replace(/\r\n|\n|\r/g, s.eol)), m === c)) continue
				if (Math.max(c.length, m.length) > We._diffLimit) {
		...
		async $navigateValueSet(e, n, r, s, i) {
			...
			return _n.INSTANCE.navigateValueSet(n, u, c, h, r)
		}
		$fmr(e, n) {
	...
	let Gn = We
	typeof importScripts == 'function' && (globalThis.monaco = Oa())
	function g1(t) {
		switch (t) {
			case 'legacy':
				return Xt.getLegacy()
	...
	const Rt = class Rt {
		static getChannel(e) {
			return e.getChannel(Rt.CHANNEL_NAME)
		}
		static setChannel(e, n) {
			e.setChannel(Rt.CHANNEL_NAME, n)
		}
	}
	Rt.CHANNEL_NAME = 'editorWorkerHost'
	let Xn = Rt
	function p1(t) {
		let e
		const n = ca((r) => {
			const s = Xn.getChannel(r),
				o = {
					host: new Proxy(
						{},
						{
