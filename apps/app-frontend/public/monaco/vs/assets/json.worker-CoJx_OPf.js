...
` +
	...
	const ki = new yl()
	function xn(t) {
		Ri(t) || ki.onUnexpectedError(t)
	}
	function wl(t) {
		Ri(t) || ki.onUnexpectedExternalError(t)
	}
	function rr(t) {
		if (t instanceof Error) {
			...
			return {
				...
				message: n,
				stack: i,
				noTelemetry: vt.isErrorNoTelemetry(t),
				cause: r ? rr(r) : void 0,
				code: t.code,
			}
		}
	...
	const ir = 'Canceled'
	function Ri(t) {
		return t instanceof Ei ? !0 : t instanceof Error && t.name === ir && t.message === ir
	}
	...
	class re extends Error {
		constructor(e) {
			;(super(e || 'An unexpected bug occurred.'), Object.setPrototypeOf(this, re.prototype))
		}
	}
	function xl(t, e = 'Unreachable') {
		throw new Error(e)
	}
	function vl(t, e = 'unexpected state') {
		if (!t) throw typeof e == 'string' ? new re(`Assertion Failed: ${e}`) : e
	}
	function Xt(t) {
		if (!t()) {
			debugger
			;(t(), xn(new re('Assertion Failed')))
		}
	}
	function sr(t, e) {
		let n = 0
	...
	;(function (t) {
		...
		t.from = a
		function* o(v) {
			for (let S = v.length - 1; S >= 0; S--) yield v[S]
		}
		t.reverse = o
		function u(v) {
		...
		function h(v, S) {
			let C = 0
			for (const D of v) if (S(D, C++)) return !0
			return !1
		}
		t.some = h
		function f(v, S) {
			let C = 0
			for (const D of v) if (!S(D, C++)) return !1
			return !0
		}
		t.every = f
		function m(v, S) {
			for (const C of v) if (S(C)) return C
		}
		t.find = m
		function* g(v, S) {
			for (const C of v) S(C) && (yield C)
		}
		t.filter = g
		function* d(v, S) {
			let C = 0
			for (const D of v) yield S(D, C++)
		}
		t.map = d
		function* p(v, S) {
			let C = 0
		...
		t.flatMap = p
		function* y(...v) {
			for (const S of v) Nl(S) ? yield* S : yield S
		}
		t.concat = y
		function w(v, S, C) {
			let D = C
			for (const P of v) D = S(D, P)
			return D
		}
		t.reduce = w
		function x(v) {
		...
		t.length = x
		function* b(v, S, C = v.length) {
			for (
				S < -v.length && (S = 0),
					S < 0 && (S += v.length),
					C < 0 ? (C += v.length) : C > v.length && (C = v.length);
				S < C;
				S++
			)
				yield v[S]
		...
		t.slice = b
		function N(v, S = Number.POSITIVE_INFINITY) {
			const C = []
			if (S === 0) return [C, v]
			const D = v[Symbol.iterator]()
			for (let P = 0; P < S; P++) {
				const _ = D.next()
				if (_.done) return [C, t.empty()]
				C.push(_.value)
			}
			return [
				C,
		...
		async function L(v) {
			const S = []
			for await (const C of v) S.push(C)
			return S
		}
		t.asyncToArray = L
		async function R(v) {
			let S = []
			for await (const C of v) S = S.concat(C)
			return S
		}
		t.asyncToArrayFlat = R
	})(vn || (vn = {}))
	function Ef(t, e) {}
	function Ti(t) {
		if (vn.is(t)) {
	...
	const Yn = class Yn {
		...
		add(e) {
			if (!e || e === lt.None) return e
			if (e === this) throw new Error('Cannot register a disposable on itself!')
			return (
				this._isDisposed
					? Yn.DISABLE_DISPOSED_WARNING ||
						console.warn(
							new Error(
	...
	Yn.DISABLE_DISPOSED_WARNING = !1
	let Yt = Yn
	const _i = class _i {
		constructor() {
			;((this._store = new Yt()), this._store)
		}
		dispose() {
			this._store.dispose()
		}
	...
	const jt = class jt {
		constructor(e) {
			;((this.element = e), (this.next = jt.Undefined), (this.prev = jt.Undefined))
		}
	}
	...
	class Al {
		...
		clear() {
			...
			for (; e !== K.Undefined; ) {
				const n = e.next
				;((e.prev = K.Undefined), (e.next = K.Undefined), (e = n))
			}
			;((this._first = K.Undefined), (this._last = K.Undefined), (this._size = 0))
		}
		unshift(e) {
		...
		_insert(e, n) {
			const r = new K(e)
			if (this._first === K.Undefined) ((this._first = r), (this._last = r))
			else if (n) {
				const s = this._last
		...
		_remove(e) {
			if (e.prev !== K.Undefined && e.next !== K.Undefined) {
				...
				e.prev === K.Undefined && e.next === K.Undefined
					? ((this._first = K.Undefined), (this._last = K.Undefined))
					: e.next === K.Undefined
						? ((this._last = this._last.prev), (this._last.next = K.Undefined))
						: e.prev === K.Undefined &&
							((this._first = this._first.next), (this._first.prev = K.Undefined))
			this._size -= 1
		}
		*[Symbol.iterator]() {
			let e = this._first
	...
	function Pi(t, e) {
		...
		return (
			...
			Rl && (n = '［' + n.replace(/[aouei]/g, '$&$&') + '］'),
			n
		)
	}
	function U(t, e, ...n) {
		return Pi(typeof t == 'number' ? El(t, e) : e, n)
	}
	function El(t, e) {
		const n = kl()?.[t]
		if (typeof n != 'string') {
	...
	const We = globalThis
	let ye
	typeof We.vscode < 'u' && typeof We.vscode.process < 'u'
		? (ye = We.vscode.process)
		: typeof process < 'u' && typeof process?.versions?.node == 'string' && (ye = process)
	const Ml = typeof ye?.versions?.electron == 'string' && ye?.type === 'renderer'
	if (typeof ye == 'object') {
		;((ar = ye.platform === 'win32'),
			(or = ye.platform === 'darwin'),
			(lr = ye.platform === 'linux'),
			lr && ye.env.SNAP && ye.env.SNAP_REVISION,
			ye.env.CI || ye.env.BUILD_ARTIFACTSTAGINGDIRECTORY || ye.env.GITHUB_WORKSPACE,
			(Ln = Lt),
			(cr = Lt))
		const t = ye.env.VSCODE_NLS_CONFIG
		if (t)
			try {
				const e = JSON.parse(t)
				;((Ln = e.userLocale),
					(Ii = e.osLocale),
					(cr = e.resolvedLanguage || Lt),
					(Tl = e.languagePack?.translationsConfigFile))
			} catch {}
		Ci = !0
	} else
		typeof navigator == 'object' && !Ml
			? ((je = navigator.userAgent),
				(ar = je.indexOf('Windows') >= 0),
				(or = je.indexOf('Macintosh') >= 0),
				(je.indexOf('Macintosh') >= 0 || je.indexOf('iPad') >= 0 || je.indexOf('iPhone') >= 0) &&
					navigator.maxTouchPoints &&
					navigator.maxTouchPoints > 0,
				(lr = je.indexOf('Linux') >= 0),
				je?.indexOf('Mobi') >= 0,
				(ur = !0),
				(cr = Mi() || Lt),
	...
	const Zt = ar,
		...
		Cl = Ci,
		Il = ur,
		Fl = ur && typeof We.importScripts == 'function' ? We.origin : void 0,
		De = je,
		Vl = typeof We.postMessage == 'function' && !We.importScripts
	;(() => {
		if (Vl) {
			const t = []
			...
			return (n) => {
				const r = ++e
				;(t.push({ id: r, callback: n }), We.postMessage({ vscodeScheduleAsyncWork: r }, '*'))
			}
		}
		return (t) => setTimeout(t)
	})()
	const Dl = !!(De && De.indexOf('Chrome') >= 0)
	;(De && De.indexOf('Firefox') >= 0,
		!Dl && De && De.indexOf('Safari') >= 0,
		De && De.indexOf('Edg/') >= 0,
		De && De.indexOf('Android') >= 0)
	let Nt
	const fr = globalThis.vscode
	if (typeof fr < 'u' && typeof fr.process < 'u') {
		const t = fr.process
		Nt = {
			get platform() {
				return t.platform
		...
		typeof process < 'u' && typeof process?.versions?.node == 'string'
			...
			: (Nt = {
					get platform() {
						return Zt ? 'win32' : Pl ? 'darwin' : 'linux'
					},
					get arch() {},
					get env() {
						return {}
	...
	const Nn = Nt.cwd,
		Fi = Nt.env,
		Ol = Nt.platform,
		$l = globalThis.performance.now.bind(globalThis.performance)
	class _n {
		static create(e) {
			return new _n(e)
		}
		constructor(e) {
			;((this._now = e === !1 ? Date.now : $l),
	...
	const Bl = 100,
		Vi = 6e4
	function Di() {
		return !!Fi.VSCODE_DEV
	}
	var hr
	;(function (t) {
		t.None = () => lt.None
		function e(E, T, F) {
			return m(E, () => {}, 0, void 0, T ?? !0, void 0, F)
		}
		t.defer = e
		function n(E) {
			return (T, F = null, V) => {
				...
				return (
					(O = E(
						(q) => {
							if (!I) return (O ? O.dispose() : (I = !0), T.call(F, q))
						},
						null,
						V,
					)),
		...
		t.once = n
		function r(E, T) {
			return t.once(t.filter(E, T))
		}
		t.onceIf = r
		function i(E, T, F) {
			return h((V, I = null, O) => E((q) => V.call(I, T(q)), null, O), F)
		}
		t.map = i
		function s(E, T, F) {
			return h(
		...
		t.forEach = s
		function a(E, T, F) {
			return h((V, I = null, O) => E((q) => T(q) && V.call(I, q), null, O), F)
		}
		t.filter = a
		function o(E) {
			return E
		...
		function u(...E) {
			return (T, F = null, V) => {
				const I = _l(...E.map((O) => O((q) => T.call(F, q))))
				return f(I, V)
			}
		}
		t.any = u
		...
		function m(E, T, F = 100, V = !1, I = !1, O, q) {
			let G,
				Y,
				pe,
				ce = 0,
			...
			const wt = {
					...
					onWillAddFirstListener() {
						G = E((kf) => {
							;(ce++,
								(Y = T(Y, kf)),
								V && !pe && (Jt.fire(Y), (Y = void 0)),
								(xe = () => {
									const Rf = Y
									;((Y = void 0), (pe = void 0), (!V || ce > 1) && Jt.fire(Rf), (ce = 0))
								}),
								typeof F == 'number'
									? (pe && clearTimeout(pe), (pe = setTimeout(xe, F)))
									: pe === void 0 && ((pe = null), queueMicrotask(xe)))
						})
					},
				...
				Jt = new Te(wt)
			return (q?.add(Jt), Jt.event)
		}
		t.debounce = m
		function g(E, T = 0, F, V) {
			return t.debounce(E, (I, O) => (I ? (I.push(O), I) : [O]), T, void 0, F ?? !0, void 0, V)
		}
		t.accumulate = g
		function d(E, T, F = 100, V = !0, I = !0, O, q) {
			let G,
				Y,
				pe,
				ce = 0
			const xe = {
					...
					onWillAddFirstListener() {
						G = E((Jt) => {
							;(ce++,
								(Y = T(Y, Jt)),
								pe === void 0 &&
									(V && (wt.fire(Y), (Y = void 0), (ce = 0)),
									typeof F == 'number'
										? (pe = setTimeout(() => {
												;(I && ce > 0 && wt.fire(Y), (Y = void 0), (pe = void 0), (ce = 0))
											}, F))
										: ((pe = 0),
											queueMicrotask(() => {
												;(I && ce > 0 && wt.fire(Y), (Y = void 0), (pe = void 0), (ce = 0))
				...
				wt = new Te(xe)
			return (q?.add(wt), wt.event)
		}
		t.throttle = d
		function p(E, T = (V, I) => V === I, F) {
			let V = !0,
				I
			return a(
				E,
		...
		t.latch = p
		function y(E, T, F) {
			return [t.filter(E, T, F), t.filter(E, (V) => !T(V), F)]
		}
		t.split = y
		function w(E, T, F = !1, V = [], I) {
			let O = V.slice(),
				q
			Di() &&
				((q = {
					...
					timerId: setTimeout(() => {
						O &&
							...
							((q.warned = !0),
							console.warn(
								`[Event.buffer][${T}] potential LEAK detected: ${O.length} events buffered for ${Vi / 1e3}s without being consumed. Buffered here:`,
							),
							q.stack.print())
					}, Vi),
					warned: !1,
				}),
				I && I.add(Qt(() => clearTimeout(q.timerId))))
			const G = () => {
				q && clearTimeout(q.timerId)
			}
			let Y = E((xe) => {
				O
					? (O.push(xe),
						Di() &&
							...
							((q.warned = !0),
							console.warn(
								`[Event.buffer][${T}] potential LEAK detected: ${O.length} events buffered without being consumed. Buffered here:`,
							),
							q.stack.print()))
					: ce.fire(xe)
			})
			I && I.add(Y)
			const pe = () => {
					;(O?.forEach((xe) => ce.fire(xe)), (O = null), G())
				},
				ce = new Te({
					onWillAddFirstListener() {
						Y || ((Y = E((xe) => ce.fire(xe))), I && I.add(Y))
					},
					onDidAddFirstListener() {
						O && (F ? setTimeout(pe) : pe())
					},
					onDidRemoveLastListener() {
						;(Y && Y.dispose(), (Y = null), G())
					},
				})
			return (I && I.add(ce), ce.event)
		}
		t.buffer = w
		function x(E, T) {
			return (V, I, O) => {
		...
		class N {
			...
			forEach(T) {
				return (this.steps.push((F) => (T(F), F)), this)
			}
			filter(T) {
				return (this.steps.push((F) => (T(F) ? F : b)), this)
			}
			reduce(T, F) {
				let V = F
				return (this.steps.push((I) => ((V = T(V, I)), V)), this)
			}
			latch(T = (F, V) => F === V) {
				let F = !0,
					V
				return (
					this.steps.push((I) => {
						const O = F || !T(I, V)
						return ((F = !1), (V = I), O ? I : b)
					}),
					this
				)
			}
			evaluate(T) {
				for (const F of this.steps) if (((T = F(T)), T === b)) break
				return T
			}
		}
		function L(E, T, F = (V) => V) {
			const V = (...G) => q.fire(F(...G)),
				I = () => E.on(T, V),
				O = () => E.removeListener(T, V),
				q = new Te({ onWillAddFirstListener: I, onDidRemoveLastListener: O })
			return q.event
		}
		t.fromNodeEventEmitter = L
		function R(E, T, F = (V) => V) {
			const V = (...G) => q.fire(F(...G)),
				I = () => E.addEventListener(T, V),
				O = () => E.removeEventListener(T, V),
				q = new Te({ onWillAddFirstListener: I, onDidRemoveLastListener: O })
			return q.event
		}
		t.fromDOMEventEmitter = R
		function v(E, T) {
			let F, V
			...
			return ((I.cancel = F), T && I.finally(() => Oi(V, T)), I)
		}
		t.toPromise = v
		function S(E, T) {
			return E((F) => T.fire(F))
		...
		class D {
			constructor(T, F) {
				...
				;((this.emitter = new Te(V)), F && F.add(this.emitter))
			}
			beginUpdate(T) {
				this._counter++
			}
		...
		function P(E, T) {
			return new D(E, T).emitter.event
		}
		t.fromObservable = P
		function _(E) {
			return (T, F, V) => {
				...
				const q = {
					...
					endUpdate() {
						;(I--, I === 0 && (E.reportChanges(), O && ((O = !1), T.call(F))))
					},
				...
				;(E.addObserver(q), E.reportChanges())
				const G = {
					dispose() {
						E.removeObserver(q)
					},
	...
	const Wt = class Wt {
		constructor(e) {
			;((this.listenerCount = 0),
				...
				(this.durations = []),
				(this.name = `${e}_${Wt._idPool++}`),
				Wt.all.add(this))
		}
		start(e) {
			;((this._stopWatch = new _n()), (this.listenerCount = e))
		}
		stop() {
			if (this._stopWatch) {
	...
	;((Wt.all = new Set()), (Wt._idPool = 0))
	let mr = Wt,
		Ul = -1
	const Zn = class Zn {
		constructor(e, n, r = (Zn._idPool++).toString(16).padStart(3, '0')) {
		...
		check(e, n) {
			...
			if (
				...
				const [s, a] = this.getMostFrequentStack(),
					o = /^[0-9a-f]+$/i.test(this.name) ? void 0 : this.name,
					u = `[${this.name}] potential listener LEAK detected, having ${n} listeners already. MOST frequent listener (${a}):`
				;(console.warn(u), console.warn(s))
				const c = a / n > 0.3 ? 'dominated' : 'popular',
					h = new An(c, u, s, n, o)
...
`),
	...
	class ql extends An {
		constructor(e, n, r, i, s) {
			;(super(e, n, r, i, s), (this.name = 'ListenerRefusalError'))
		}
	}
	class gr {
		constructor(e) {
	...
	class Te {
		constructor(e) {
			;((this._size = 0),
				...
				(this._leakageMon = this._options?.leakWarningThreshold
					? new dr(
							e?.onListenerError ?? xn,
							this._options?.leakWarningThreshold ?? Ul,
							this._options?.leakWarningName,
						)
					: void 0),
				(this._perfMon = this._options?._profName ? new mr(this._options._profName) : void 0),
				...
				(this._event ??= (e, n, r) => {
					if (this._leakageMon && this._size > this._leakageMon.threshold ** 2) {
						...
						const u = this._leakageMon.getMostFrequentStack() ?? ['UNKNOWN stack', -1],
							c = u[1] / this._size > 0.3 ? 'dominated' : 'popular',
							h = new ql(
								c,
						...
						return ((this._options?.onListenerError || xn)(h), lt.None)
					}
					...
					;(this._leakageMon &&
						...
						((i.stack = Sn.create()), (s = this._leakageMon.check(i.stack, this._size + 1))),
						this._listeners
							? this._listeners instanceof gr
								? ((this._deliveryQueue ??= new Wl()), (this._listeners = [this._listeners, i]))
		...
		_deliver(e, n) {
			if (!e) return
			const r = this._options?.onListenerError || xn
			if (!r) {
				e.value(n)
				return
			}
		...
		fire(e) {
			if (
				...
				if (this._listeners instanceof gr) this._deliver(this._listeners, e)
				else {
	...
	function pr(t, e) {
		e instanceof Yt ? e.add(t) : Array.isArray(e) && e.push(t)
	}
	function Oi(t, e) {
		if (e instanceof Yt) e.delete(t)
	...
	class zl {
		constructor(e, n) {
			;((this.lastCache = void 0),
				...
				typeof e == 'function'
					? ((this._fn = e), (this._computeKey = Hl))
	...
	class br {
		constructor(e) {
			;((this.executor = e), (this._state = ut.Uninitialized))
		}
		get value() {
			if (this._state === ut.Uninitialized) {
				...
				try {
					...
					this._state = ut.Completed
				}
			} else if (this._state === ut.Running)
	...
	const qe = class qe {
		static getInstance(e) {
			return qe.cache.get(Array.from(e).join(','))
		}
		static getLocales() {
	...
	;((qe.ambiguousCharacterData = new br(() =>
		JSON.parse(
		...
		(qe.cache = new zl((e) => {
			...
			function r(f) {
				const m = new Map()
				for (let g = 0; g < f.length; g += 2) m.set(f[g], f[g + 1])
				return m
			}
			function i(f, m) {
				const g = new Map(f)
				for (const [d, p] of m) g.set(d, p)
				return g
			}
			function s(f, m) {
				if (!f) return m
				const g = new Map()
				for (const [d, p] of f) m.has(d) && g.set(d, p)
				return g
			}
			const a = qe.ambiguousCharacterData.value
			let o = n.filter((f) => !f.startsWith('_') && Object.hasOwn(a, f))
		...
		(qe._locales = new br(() =>
			Object.keys(qe.ambiguousCharacterData.value).filter((e) => !e.startsWith('_')),
		)))
	let Kt = qe
	const Ht = class Ht {
		static getRawData() {
		...
		static getData() {
			return (
				this._data || (this._data = new Set([...Object.values(Ht.getRawData())].flat())),
				this._data
			)
		}
		static isInvisibleCharacter(e) {
			return Ht.getData().has(e)
		}
	...
	class lu {
		...
		async sendMessage(e, n, r) {
			...
			return new Promise((s, a) => {
				;((this._pendingReplies[i] = { resolve: s, reject: a }),
					this._send(new iu(this._workerId, i, e, n, r)))
			})
		}
		listen(e, n, r) {
			let i = null
			const s = new Te({
				onWillAddFirstListener: () => {
					;((i = String(++this._lastSentReq)),
						...
						this._send(new su(this._workerId, i, e, n, r)))
				},
				onDidRemoveLastListener: () => {
					;(this._pendingEmitters.delete(i), this._send(new ou(this._workerId, i)), (i = null))
				},
			})
			return s.event
		}
		...
		_handleRequestMessage(e) {
			...
			this._handler.handleMessage(e.channel, e.method, e.args).then(
				...
				(i) => {
					;(i.detail instanceof Error && (i.detail = rr(i.detail)),
						this._send(new Bi(this._workerId, n, void 0, rr(i))))
				},
			)
		}
		_handleSubscribeEventMessage(e) {
			const n = e.req,
				r = this._handler.handleEvent(
					...
					this._send(new au(this._workerId, n, i))
				})
	...
	function Ui(t) {
		return t[0] === 'o' && t[1] === 'n' && $i(t.charCodeAt(2))
	}
	function qi(t) {
		return /^onDynamic/.test(t) && $i(t.charCodeAt(9))
	}
	class uu {
		constructor(e, n) {
			;((this._localChannels = new Map()),
				(this._remoteChannels = new Map()),
				(this._protocol = new lu({
					sendMessage: (r, i) => {
						e(r, i)
					},
		...
		_handleMessage(e, n, r) {
			if (e === vr && n === ru) return this.initialize(r[0])
			const i = e === vr ? this.requestHandler : this._localChannels.get(e)
	...
	let ji = !1
	function cu(t) {
		if (ji) throw new Error('WebWorker already initialized!')
		ji = !0
		const e = new uu(
	...
	function hu(t, e, n) {
		return new et(new Hi(t), new Hi(e)).ComputeDiff(n).changes
	}
	class _t {
		static Assert(e, n) {
	...
	class et {
		constructor(e, n, r = null) {
			...
			const [i, s, a] = et._getElements(e),
				[o, u, c] = et._getElements(n)
			;((this._hasStrings = a && c),
		...
		static _getElements(e) {
			...
			if (et._isStringArray(n)) {
				const r = new Int32Array(n.length)
				for (let i = 0, s = n.length; i < s; i++) r[i] = fu(n[i], 0)
				return [n, r, !0]
			}
		...
		ElementsAreStrictEqual(e, n) {
			...
			const r = et._getStrictElement(this._originalSequence, e),
				i = et._getStrictElement(this._modifiedSequence, n)
			return r === i
		}
		...
		ComputeDiffRecursive(e, n, r, i, s) {
			...
			if (e > n || r > i) {
				...
				return (
					r <= i
						? (_t.Assert(e === n + 1, 'originalStart should only be one more than originalEnd'),
							(f = [new Ke(e, 0, r, i - r + 1)]))
						: e <= n
							? (_t.Assert(r === i + 1, 'modifiedStart should only be one more than modifiedEnd'),
								(f = [new Ke(e, n - e + 1, r, 0)]))
							: (_t.Assert(e === n + 1, 'originalStart should only be one more than originalEnd'),
								_t.Assert(r === i + 1, 'modifiedStart should only be one more than modifiedEnd'),
								(f = [])),
					f
			...
			if (u !== null) return u
			if (!s[0]) {
				const f = this.ComputeDiffRecursive(e, c, r, h, s)
				let m = []
				return (
					s[0]
						? (m = [new Ke(c + 1, n - (c + 1) + 1, h + 1, i - (h + 1) + 1)])
						: (m = this.ComputeDiffRecursive(c + 1, n, h + 1, i, s)),
					this.ConcatenateChanges(f, m)
				)
			}
			return [new Ke(e, n - e + 1, r, i - r + 1)]
		}
		WALKTRACE(e, n, r, i, s, a, o, u, c, h, f, m, g, d, p, y, w, x) {
			let b = null,
				N = null,
				L = new zi(),
				R = n,
			...
			do {
				...
				;(P === R || (P < v && c[P - 1] < c[P + 1])
					...
					: ((f = c[P - 1] + 1),
						...
						(S = P - 1 - e)),
					D >= 0 && ((c = this.m_forwardHistory[D]), (e = c[0]), (R = 1), (v = c.length - 1)))
			} while (--D >= -1)
			if (((b = L.getReverseChanges()), x[0])) {
				let P = g[0] + 1,
					_ = y[0] + 1
				if (b !== null && b.length > 0) {
					const E = b[b.length - 1]
					;((P = Math.max(P, E.getOriginalEnd())), (_ = Math.max(_, E.getModifiedEnd())))
				}
				N = [new Ke(P, m - P + 1, _, p - _ + 1)]
			} else {
				;((L = new zi()),
					(R = a),
					(v = o),
					(S = g[0] - y[0] - u),
					(C = 1073741824),
					(D = w ? this.m_reverseHistory.length - 1 : this.m_reverseHistory.length - 2))
				do {
					const P = S + s
					;(P === R || (P < v && h[P - 1] >= h[P + 1])
						? ((f = h[P + 1] - 1),
						...
						: ((f = h[P - 1]),
							...
							(S = P - 1 - s)),
						D >= 0 && ((h = this.m_reverseHistory[D]), (s = h[0]), (R = 1), (v = h.length - 1)))
				} while (--D >= -1)
				N = L.getChanges()
			}
		...
		ComputeRecursionPoint(e, n, r, i, s, a, o) {
			...
			for (let S = 1; S <= d / 2 + 1; S++) {
				let C = 0,
					D = 0
				;((h = this.ClipDiagonalBound(x - S, S, x, p)),
					(f = this.ClipDiagonalBound(x + S, S, x, p)))
				for (let _ = h; _ <= f; _ += 2) {
					;(_ === h || (_ < f && y[_ - 1] < y[_ + 1]) ? (u = y[_ + 1]) : (u = y[_ - 1] + 1),
						(c = u - (_ - x) - N))
					const E = u
					...
					if (
						((y[_] = u),
						u + c > C + D && ((C = u), (D = c)),
						!v && Math.abs(_ - b) <= S - 1 && u >= w[_])
					)
						return (
							(s[0] = u),
							(a[0] = c),
							E <= w[_] && S <= 1448
								? this.WALKTRACE(x, h, f, N, b, m, g, L, y, w, u, n, s, c, i, a, v, o)
								: null
						)
				}
				const P = (C - e + (D - r) - S) / 2
				if (this.ContinueProcessingPredicate !== null && !this.ContinueProcessingPredicate(C, P))
					return (
						(o[0] = !0),
						(s[0] = C),
						(a[0] = D),
				...
				if (S <= 1447) {
					...
					;((_[0] = x - h + 1),
						St.Copy2(y, h, _, 1, f - h + 1),
						this.m_forwardHistory.push(_),
						(_ = new Int32Array(g - m + 2)),
						(_[0] = b - m + 1),
						St.Copy2(w, m, _, 1, g - m + 1),
						this.m_reverseHistory.push(_))
				}
			}
			return this.WALKTRACE(x, h, f, N, b, m, g, L, y, w, u, n, s, c, i, a, v, o)
		}
		PrettifyChanges(e) {
			...
			if (this._hasStrings)
				for (let n = 1, r = e.length; n < r; n++) {
					const i = e[n - 1],
						...
						m = f - h
					if (a < 5 && c < 20 && m < 20) {
						const g = this._findBetterContiguousSequence(o, c, h, m, a)
						if (g) {
							const [d, p] = g
		...
		ConcatenateChanges(e, n) {
			...
			if (this.ChangesOverlap(e[e.length - 1], n[0], r)) {
				...
				return (
					St.Copy(e, 0, i, 0, e.length - 1),
					(i[e.length - 1] = r[0]),
					St.Copy(n, 1, i, e.length, n.length - 1),
					i
				)
			} else {
				const i = new Array(e.length + n.length)
				return (St.Copy(e, 0, i, 0, e.length), St.Copy(n, 0, i, e.length, n.length), i)
			}
		}
	...
	let J = class xt {
			...
			with(e = this.lineNumber, n = this.column) {
				return e === this.lineNumber && n === this.column ? this : new xt(e, n)
			}
			delta(e = 0, n = 0) {
			...
			isBeforeOrEqual(e) {
				return xt.isBeforeOrEqual(this, e)
			}
			...
			clone() {
				return new xt(this.lineNumber, this.column)
			}
			toString() {
				return '(' + this.lineNumber + ',' + this.column + ')'
			}
			static lift(e) {
				return new xt(e.lineNumber, e.column)
			}
		...
		j = class se {
			...
			static intersectRanges(e, n) {
				...
				return (
					...
					s > c ? ((s = c), (a = h)) : s === c && (a = Math.min(a, h)),
					r > s || (r === s && i > a) ? null : new se(r, i, s, a)
				)
			}
			equalsRange(e) {
	...
	class Lr {
		constructor(e) {
			const n = Gi(e)
			;((this._defaultValue = n), (this._asciiMap = Lr._createAsciiMap(n)), (this._map = new Map()))
		}
	...
	function pu() {
		if (tn === null) {
			tn = new Lr(0)
			const t = ` 	<>'"、。｡､，．：；‘〈「『〔（［｛｢｣｝］）〕』」〉’｀～…|`
			for (let n = 0; n < t.length; n++) tn.set(t.charCodeAt(n), 1)
			const e = '.,;:'
			for (let n = 0; n < e.length; n++) tn.set(e.charCodeAt(n), 2)
		}
		return tn
	}
	class kn {
				...
				for (; c < u; ) {
					...
					if (m === 13) {
						...
						switch (x) {
							...
							case 34:
							case 96:
								f === x ? (b = 1) : f === 39 || f === 34 || f === 96 ? (b = 0) : (b = 1)
								break
							case 42:
								b = f === 42 ? 1 : 0
								break
						...
						b === 1 && (i.push(kn._createLink(r, o, s, h, c)), (w = !0))
					} else if (m === 12) {
						let b
						;(x === 91 ? ((d = !0), (b = 0)) : (b = r.get(x)), b === 1 ? (w = !0) : (m = 13))
					} else ((m = n.nextState(m, x)), m === 0 && (w = !0))
					;(w && ((m = 1), (g = !1), (d = !1), (y = !1), (h = c + 1), (f = x)), c++)
				}
				m === 13 && i.push(kn._createLink(r, o, s, h, u))
			}
			return i
		}
	}
	...
	;(function (t) {
		function e(n) {
			return n === t.None || n === t.Cancelled || n instanceof En
				? !0
				: !n || typeof n != 'object'
					? !1
		...
		;((t.isCancellationToken = e),
			(t.None = Object.freeze({ isCancellationRequested: !1, onCancellationRequested: hr.None })),
	...
	class En {
		...
		get onCancellationRequested() {
			return this._isCancelled
				? Ji
				: (this._emitter || (this._emitter = new Te()), this._emitter.event)
		}
		dispose() {
	...
	class yu {
		...
		get token() {
			return (this._token || (this._token = new En()), this._token)
		}
		cancel() {
			this._token ? this._token instanceof En && this._token.cancel() : (this._token = Rn.Cancelled)
		}
		dispose(e = !1) {
			;(e && this.cancel(),
				this._parentListener?.dispose(),
				this._token ? this._token instanceof En && this._token.dispose() : (this._token = Rn.None))
		}
	}
	class Sr {
		constructor() {
	...
	;(function () {
		const e = [
			...
			r = []
		for (const i of e) {
			const [s, a, o, u, c, h, f, m, g] = i
			if ((r[a] || ((r[a] = !0), (xu[o] = a), (vu[o.toLowerCase()] = a)), !n[u])) {
				if (((n[u] = !0), !c))
					throw new Error(`String representation missing for key code ${u} around scan code ${o}`)
				;(Tn.define(u, c), Ar.define(u, m || c), kr.define(u, g || m || c))
			}
			h && (wu[h] = u)
		}
	})()
	...
	;(function (t) {
		...
		t.toString = e
		function n(o) {
			return Tn.strToKeyCode(o)
		}
		t.fromString = n
		function r(o) {
			return Ar.keyCodeToStr(o)
		}
		t.toUserSettingsUS = r
		function i(o) {
			return kr.keyCodeToStr(o)
		}
		t.toUserSettingsGeneral = i
		function s(o) {
			return Ar.strToKeyCode(o) || kr.strToKeyCode(o)
		}
	...
	function Ru(t, e) {
		if (t === null || typeof t != 'object') throw new Qi(e, 'Object', t)
	}
	function ne(t, e) {
		if (typeof t != 'string') throw new Qi(e, 'string', t)
	}
	const ze = Ol === 'win32'
	function W(t) {
		return t === le || t === we
				...
				if (!(a === c - 1 || o === 1))
					if (o === 2) {
						if (
							i.length < 2 ||
							s !== 2 ||
							i.charCodeAt(i.length - 1) !== ct ||
							i.charCodeAt(i.length - 2) !== ct
						) {
							if (i.length > 2) {
						...
						(i.length > 0 ? (i += `${n}${t.slice(a + 1, c)}`) : (i = t.slice(a + 1, c)),
							(s = c - a - 1))
				;((a = c), (o = 0))
			} else u === ct && o !== -1 ? ++o : (o = -1)
		}
	...
	const fe = {
			resolve(...t) {
				...
				for (let i = t.length - 1; i >= -1; i--) {
					let s
					if (i >= 0) {
						if (((s = t[i]), ne(s, `paths[${i}]`), s.length === 0)) continue
					} else
						e.length === 0
							? (s = Nn())
							: ((s = Fi[`=${e}`] || Nn()),
								(s === void 0 ||
									(s.slice(0, 2).toLowerCase() !== e.toLowerCase() && s.charCodeAt(2) === we)) &&
									(s = `${e}\\`))
					const a = s.length
					let o = 0,
						u = '',
					...
					if (a === 1) W(h) && ((o = 1), (c = !0))
						...
						Ge(h) &&
							s.charCodeAt(1) === He &&
							((u = s.slice(0, 2)), (o = 2), a > 2 && W(s.charCodeAt(2)) && ((c = !0), (o = 3)))
					if (u.length > 0)
						if (e.length > 0) {
					...
					if (r) {
						if (e.length > 0) break
					} else if (((n = `${s.slice(o)}\\${n}`), (r = c), c && e.length > 0)) break
				}
				return ((n = Mn(n, !r, '\\', W)), r ? `${e}\\${n}` : `${e}${n}` || '.')
			},
			normalize(t) {
				ne(t, 'path')
				const e = t.length
				...
				if (e === 1) return Rr(s) ? '\\' : t
				if (W(s))
					if (((i = !0), W(t.charCodeAt(1)))) {
						let o = 2,
							u = o
						for (; o < e && !W(t.charCodeAt(o)); ) o++
						if (o < e && o !== u) {
							const c = t.slice(u, o)
							for (u = o; o < e && W(t.charCodeAt(o)); ) o++
							if (o < e && o !== u) {
								for (u = o; o < e && !W(t.charCodeAt(o)); ) o++
					...
					Ge(s) &&
						t.charCodeAt(1) === He &&
						((r = t.slice(0, 2)), (n = 2), e > 2 && W(t.charCodeAt(2)) && ((i = !0), (n = 3)))
				let a = n < e ? Mn(t.slice(n), !i, '\\', W) : ''
				if (
					(a.length === 0 && !i && (a = '.'),
					a.length > 0 && W(t.charCodeAt(e - 1)) && (a += '\\'),
					!i && r === void 0 && t.includes(':'))
				) {
					if (a.length >= 2 && Ge(a.charCodeAt(0)) && a.charCodeAt(1) === He) return `.\\${a}`
					let o = t.indexOf(':')
					do if (o === e - 1 || W(t.charCodeAt(o + 1))) return `.\\${a}`
			...
			isAbsolute(t) {
				...
				return W(n) || (e > 2 && Ge(n) && t.charCodeAt(1) === He && W(t.charCodeAt(2)))
			},
			join(...t) {
				...
				for (let s = 0; s < t.length; ++s) {
					const a = t[s]
					;(ne(a, 'path'), a.length > 0 && (e === void 0 ? (e = n = a) : (e += `\\${a}`)))
				}
				if (e === void 0) return '.'
				let r = !0,
					i = 0
				...
				if (r) {
					for (; i < e.length && W(e.charCodeAt(i)); ) i++
					i >= 2 && (e = `\\${e.slice(i)}`)
				}
				return fe.normalize(e)
			},
			relative(t, e) {
				if ((ne(t, 'from'), ne(e, 'to'), t === e)) return ''
				...
				if (n.length !== t.length || r.length !== e.length) {
					...
					const y = d.length,
						...
						x = y < w ? y : w
					let b
					for (b = 0; b < x && d[b].toLowerCase() === p[b].toLowerCase(); b++);
					return b === 0
						? r
						: b === x
							? w > x
				...
				let i = 0
				for (; i < t.length && t.charCodeAt(i) === we; ) i++
				let s = t.length
				for (; s - 1 > i && t.charCodeAt(s - 1) === we; ) s--
				const a = s - i
				let o = 0
				for (; o < e.length && e.charCodeAt(o) === we; ) o++
				let u = e.length
				for (; u - 1 > o && e.charCodeAt(u - 1) === we; ) u--
				const c = u - o,
					h = a < c ? a : c
				let f = -1,
					m = 0
				...
				if (m !== h) {
					...
					if (c > h) {
						if (e.charCodeAt(o + m) === we) return r.slice(o + m + 1)
						if (m === 2) return r.slice(o + m)
					}
					;(a > h && (t.charCodeAt(i + m) === we ? (f = m) : m === 2 && (f = 3)),
						f === -1 && (f = 0))
				}
				let g = ''
				for (m = i + f + 1; m <= s; ++m)
					(m === s || t.charCodeAt(m) === we) && (g += g.length === 0 ? '..' : '\\..')
				return (
					(o += f),
					g.length > 0 ? `${g}${r.slice(o, u)}` : (r.charCodeAt(o) === we && ++o, r.slice(o, u))
				)
			},
			toNamespacedPath(t) {
				...
				if (e.charCodeAt(0) === we) {
					if (e.charCodeAt(1) === we) {
						const n = e.charCodeAt(2)
						if (n !== ku && n !== ct) return `\\\\?\\UNC\\${e.slice(2)}`
					}
				} else if (Ge(e.charCodeAt(0)) && e.charCodeAt(1) === He && e.charCodeAt(2) === we)
					return `\\\\?\\${e}`
				return e
			},
			dirname(t) {
				...
				if (W(i)) {
					...
					Ge(i) && t.charCodeAt(1) === He && ((n = e > 2 && W(t.charCodeAt(2)) ? 3 : 2), (r = n))
				let s = -1,
					a = !0
				for (let o = e - 1; o >= r; --o)
					if (W(t.charCodeAt(o))) {
			...
			basename(t, e) {
				;(e !== void 0 && ne(e, 'suffix'), ne(t, 'path'))
				let n = 0,
					r = -1,
					i = !0,
					s
				if (
					(t.length >= 2 && Ge(t.charCodeAt(0)) && t.charCodeAt(1) === He && (n = 2),
			...
			extname(t) {
				...
				let e = 0,
					...
					s = !0,
					a = 0
				t.length >= 2 && t.charCodeAt(1) === He && Ge(t.charCodeAt(0)) && (e = r = 2)
			...
			parse(t) {
				...
				let r = 0,
					i = t.charCodeAt(0)
				if (n === 1) return W(i) ? ((e.root = e.dir = t), e) : ((e.base = e.name = t), e)
				if (W(i)) {
					if (((r = 1), W(t.charCodeAt(1)))) {
						let f = 2,
							m = f
						for (; f < n && !W(t.charCodeAt(f)); ) f++
						if (f < n && f !== m) {
							for (m = f; f < n && W(t.charCodeAt(f)); ) f++
							if (f < n && f !== m) {
								for (m = f; f < n && !W(t.charCodeAt(f)); ) f++
								f === n ? (r = f) : f !== m && (r = f + 1)
							}
				...
				} else if (Ge(i) && t.charCodeAt(1) === He) {
					if (n <= 2) return ((e.root = e.dir = t), e)
					if (((r = 2), W(t.charCodeAt(2)))) {
		...
		he = {
			resolve(...t) {
				...
				for (let r = t.length - 1; r >= 0 && !n; r--) {
					const i = t[r]
					;(ne(i, `paths[${r}]`),
						i.length !== 0 && ((e = `${i}/${e}`), (n = i.charCodeAt(0) === le)))
				}
				if (!n) {
					const r = Tu()
					;((e = `${r}/${e}`), (n = r.charCodeAt(0) === le))
				}
				return ((e = Mn(e, !n, '/', Rr)), n ? `/${e}` : e.length > 0 ? e : '.')
			},
			normalize(t) {
				if ((ne(t, 'path'), t.length === 0)) return '.'
			...
			isAbsolute(t) {
				return (ne(t, 'path'), t.length > 0 && t.charCodeAt(0) === le)
			},
			join(...t) {
				if (t.length === 0) return '.'
				const e = []
			...
			relative(t, e) {
				...
				for (; c < o; c++) {
					...
					if (f !== e.charCodeAt(s + c)) break
					f === le && (u = c)
				}
				if (c === o)
					if (a > o) {
						if (e.charCodeAt(s + c) === le) return e.slice(s + c + 1)
						if (c === 0) return e.slice(s + c)
					} else i > o && (t.charCodeAt(n + c) === le ? (u = c) : c === 0 && (u = 0))
				let h = ''
				for (c = n + u + 1; c <= r; ++c)
					(c === r || t.charCodeAt(c) === le) && (h += h.length === 0 ? '..' : '/..')
	...
	;((he.win32 = fe.win32 = fe), (he.posix = fe.posix = he), ze ? fe.normalize : he.normalize)
	const Mu = ze ? fe.join : he.join
	;(ze ? fe.resolve : he.resolve,
		ze ? fe.relative : he.relative,
		ze ? fe.dirname : he.dirname,
		ze ? fe.basename : he.basename,
		ze ? fe.extname : he.extname,
		ze ? fe.sep : he.sep)
	const Pu = /^\w[\w\d+.-]*$/,
		Cu = /^\//,
		Iu = /^\/\//
	function Fu(t, e) {
		...
		if (t.scheme && !Pu.test(t.scheme)) {
			const n = [...t.scheme.matchAll(/[^\w\d+.-]/gu)],
				r = n.length > 0 ? ` Found '${n[0][0]}' at index ${n[0].index} (${n.length} total)` : ''
			throw new Error(
				`[UriError]: Scheme contains illegal characters.${r} (len:${t.scheme.length})`,
			)
		}
		if (t.path) {
			if (t.authority) {
	...
	let Je = class nr {
		...
		static parse(e, n = !1) {
			const r = Ou.exec(e)
			return r
				? new kt(r[2] || Z, Pn(r[4] || Z), Pn(r[5] || Z), Pn(r[7] || Z), Pn(r[9] || Z), n)
				: new kt(Z, Z, Z, Z, Z)
		}
		static file(e) {
			let n = Z
			if ((Zt && (e = e.replace(/\\/g, Me)), e[0] === Me && e[1] === Me)) {
				const r = e.indexOf(Me, 2)
				r === -1
					? ((n = e.substring(2)), (e = Me))
					: ((n = e.substring(2, r)), (e = e.substring(r) || Me))
			}
			return new kt('file', n, e, Z, Z)
		}
		static from(e, n) {
		...
		static joinPath(e, ...n) {
			...
			return (
				Zt && e.scheme === 'file'
					? (r = nr.file(fe.join(Er(e, !0), ...n)).path)
					: (r = he.join(e.path, ...n)),
				e.with({ path: r })
			)
		}
			...
			if (e) {
				if (e instanceof nr) return e
				{
					...
					return (
						...
						(n._fsPath = e._sep === Zi ? (e.fsPath ?? null) : null),
						n
					)
				}
			} else return e
	...
	class kt extends Je {
		...
		toString(e = !1) {
			return e
				? Tr(this, !0)
				: (this._formatted || (this._formatted = Tr(this, !1)), this._formatted)
		}
		toJSON() {
			const e = { $mid: 1 }
			return (
				this._fsPath && ((e.fsPath = this._fsPath), (e._sep = Zi)),
	...
	function $u(t) {
		...
		for (let n = 0; n < t.length; n++) {
			const r = t.charCodeAt(n)
			r === 35 || r === 63
				? (e === void 0 && (e = t.substr(0, n)), (e += Ki[r]))
				: e !== void 0 && (e += t[n])
		}
		return e !== void 0 ? e : t
	}
	...
	function Tr(t, e) {
		...
		if ((i && ((r += i), (r += ':')), (s || i === 'file') && ((r += Me), (r += Me)), s)) {
			...
			;((s = s.toLowerCase()),
				(c = s.lastIndexOf(':')),
				c === -1 ? (r += n(s, !1, !0)) : ((r += n(s.substr(0, c), !1, !0)), (r += s.substr(c))))
		}
		if (a) {
	...
	function ts(t) {
		try {
			...
			return t.length > 3 ? t.substr(0, 3) + ts(t.substr(3)) : t
		}
	}
	const ns = /(%[0-9A-Za-z][0-9A-Za-z])+/g
	function Pn(t) {
		return t.match(ns) ? t.replace(ns, (e) => ts(e)) : t
	}
	class ve extends j {
		constructor(e, n, r, i) {
			;(super(e, n, r, i),
		...
		equalsSelection(e) {
			return ve.selectionsEqual(this, e)
		}
		...
		setEndPosition(e, n) {
			return this.getDirection() === 0
				? new ve(this.startLineNumber, this.startColumn, e, n)
				: new ve(e, n, this.startLineNumber, this.startColumn)
		}
		getPosition() {
		...
		setStartPosition(e, n) {
			return this.getDirection() === 0
				? new ve(e, n, this.endLineNumber, this.endColumn)
				: new ve(this.endLineNumber, this.endColumn, e, n)
		}
		static fromPositions(e, n = e) {
			return new ve(e.lineNumber, e.column, n.lineNumber, n.column)
		}
		static fromRange(e, n) {
			return n === 0
				? new ve(e.startLineNumber, e.startColumn, e.endLineNumber, e.endColumn)
				: new ve(e.endLineNumber, e.endColumn, e.startLineNumber, e.startColumn)
		}
		...
		static createWithDirection(e, n, r, i, s) {
			return s === 0 ? new ve(e, n, r, i) : new ve(r, i, e, n)
		}
	}
	...
	const Bu = {
			...
			screenCut: l('screen-cut', 60543),
			ask: l('ask', 60544),
			openai: l('openai', 60545),
			claude: l('claude', 60546),
			openInWindow: l('open-in-window', 60547),
			newSession: l('new-session', 60548),
			terminalSecure: l('terminal-secure', 60549),
			chatImport: l('chat-import', 60550),
			chatExport: l('chat-export', 60551),
			shareWindow: l('share-window', 60552),
			circleSlashCompact: l('circle-slash-compact', 60553),
			copilotCompact: l('copilot-compact', 60554),
			folderOpenedCompact: l('folder-opened-compact', 60555),
			folderCompact: l('folder-compact', 60556),
			gearCompact: l('gear-compact', 60557),
			gitBranchCompact: l('git-branch-compact', 60558),
			libraryCompact: l('library-compact', 60559),
			recordKeysCompact: l('record-keys-compact', 60560),
			remoteCompact: l('remote-compact', 60561),
			repoForkedCompact: l('repo-forked-compact', 60562),
			repoCompact: l('repo-compact', 60563),
			shieldCompact: l('shield-compact', 60564),
			sparkleCompact: l('sparkle-compact', 60565),
			symbolColorCompact: l('symbol-color-compact', 60566),
			windowCompact: l('window-compact', 60567),
			errorCompact: l('error-compact', 60568),
			warningCompact: l('warning-compact', 60569),
			passCompact: l('pass-compact', 60570),
			important: l('important', 60571),
			importantCompact: l('important-compact', 60572),
			rocketCompact: l('rocket-compact', 60573),
			unpin: l('unpin', 60574),
			addCompact: l('add-compact', 60575),
			attachCompact: l('attach-compact', 60576),
			beakerCompact: l('beaker-compact', 60577),
			checkCompact: l('check-compact', 60578),
			checklistCompact: l('checklist-compact', 60579),
			chevronDownCompact: l('chevron-down-compact', 60580),
			chevronLeftCompact: l('chevron-left-compact', 60581),
			chevronRightCompact: l('chevron-right-compact', 60582),
			chevronUpCompact: l('chevron-up-compact', 60583),
			circleFilledCompact: l('circle-filled-compact', 60584),
			circleSmallFilledCompact: l('circle-small-filled-compact', 60585),
			closeCompact: l('close-compact', 60586),
			collapseAllCompact: l('collapse-all-compact', 60587),
			commentCompact: l('comment-compact', 60588),
			commentUnresolvedCompact: l('comment-unresolved-compact', 60589),
			debugConnectedCompact: l('debug-connected-compact', 60590),
			debugDisconnectCompact: l('debug-disconnect-compact', 60591),
			editCompact: l('edit-compact', 60592),
			fileMediaCompact: l('file-media-compact', 60593),
			gitFetch: l('git-fetch', 60594),
			lightbulbCompact: l('lightbulb-compact', 60595),
			loadingCompact: l('loading-compact', 60596),
			passFilledCompact: l('pass-filled-compact', 60597),
			projectCompact: l('project-compact', 60598),
			refreshCompact: l('refresh-compact', 60599),
			searchCompact: l('search-compact', 60600),
			sessionInProgressCompact: l('session-in-progress-compact', 60601),
			syncCompact: l('sync-compact', 60602),
			terminalCompact: l('terminal-compact', 60603),
			vmPending: l('vm-pending', 60604),
			worktreeCompact: l('worktree-compact', 60605),
			developerTools: l('developer-tools', 60606),
			cloudCompact: l('cloud-compact', 60607),
			agentCompact: l('agent-compact', 60608),
			askCompact: l('ask-compact', 60609),
			settingsCompact: l('settings-compact', 60610),
			vmCompact: l('vm-compact', 60611),
			runCompact: l('run-compact', 60612),
			gitPullRequestComment: l('git-pull-request-comment', 60613),
			gitPullRequestError: l('git-pull-request-error', 60614),
			rightPanelHide: l('right-panel-hide', 60615),
			rightPanelShow: l('right-panel-show', 60616),
			vscodeInsidersOutline: l('vscode-insiders-outline', 60617),
			vscodeOutline: l('vscode-outline', 60618),
			voiceMode: l('voice-mode', 60619),
			voiceModeCompact: l('voice-mode-compact', 60620),
		},
		Uu = {
	...
	;(function (t) {
		const e = new Map()
		;(e.set(0, $.symbolMethod),
			e.set(1, $.symbolFunction),
			e.set(2, $.symbolConstructor),
			e.set(3, $.symbolField),
			e.set(4, $.symbolVariable),
			e.set(5, $.symbolClass),
			e.set(6, $.symbolStruct),
			e.set(7, $.symbolInterface),
			e.set(8, $.symbolModule),
			e.set(9, $.symbolProperty),
			e.set(10, $.symbolEvent),
			e.set(11, $.symbolOperator),
			e.set(12, $.symbolUnit),
			e.set(13, $.symbolValue),
			e.set(15, $.symbolEnum),
			e.set(14, $.symbolConstant),
			e.set(15, $.symbolEnum),
			e.set(16, $.symbolEnumMember),
			e.set(17, $.symbolKeyword),
			e.set(28, $.symbolSnippet),
			e.set(18, $.symbolText),
			e.set(19, $.symbolColor),
			e.set(20, $.symbolFile),
			e.set(21, $.symbolReference),
			e.set(22, $.symbolCustomColor),
			e.set(23, $.symbolFolder),
			e.set(24, $.symbolTypeParameter),
			e.set(25, $.account),
			e.set(26, $.issues),
			e.set(27, $.tools))
		function n(a) {
			let o = e.get(a)
			return (
				o || (console.info('No codicon found for CompletionItemKind ' + a), (o = $.symbolProperty)),
				o
			)
		}
		t.toIcon = n
		function r(a) {
			switch (a) {
				case 0:
					return U(763, 'Method')
				case 1:
					return U(764, 'Function')
				case 2:
					return U(765, 'Constructor')
				case 3:
					return U(766, 'Field')
				case 4:
					return U(767, 'Variable')
				case 5:
					return U(768, 'Class')
				case 6:
					return U(769, 'Struct')
				case 7:
					return U(770, 'Interface')
				case 8:
					return U(771, 'Module')
				case 9:
					return U(772, 'Property')
				case 10:
					return U(773, 'Event')
				case 11:
					return U(774, 'Operator')
				case 12:
					return U(775, 'Unit')
				case 13:
					return U(776, 'Value')
				case 14:
					return U(777, 'Constant')
				case 15:
					return U(778, 'Enum')
				case 16:
					return U(779, 'Enum Member')
				case 17:
					return U(780, 'Keyword')
				case 18:
					return U(781, 'Text')
				case 19:
					return U(782, 'Color')
				case 20:
					return U(783, 'File')
				case 21:
					return U(784, 'Reference')
				case 22:
					return U(785, 'Custom Color')
				case 23:
					return U(786, 'Folder')
				case 24:
					return U(787, 'Type Parameter')
				case 25:
					return U(788, 'User')
				case 26:
					return U(789, 'Issue')
	...
	;((function (t) {
		...
		U(814, 'string'),
		U(815, 'struct'),
		U(816, 'type parameter'),
		U(817, 'variable'))
	var hs
	;(function (t) {
		const e = new Map()
		;(e.set(0, $.symbolFile),
			e.set(1, $.symbolModule),
			e.set(2, $.symbolNamespace),
			e.set(3, $.symbolPackage),
			e.set(4, $.symbolClass),
			e.set(5, $.symbolMethod),
			e.set(6, $.symbolProperty),
			e.set(7, $.symbolField),
			e.set(8, $.symbolConstructor),
			e.set(9, $.symbolEnum),
			e.set(10, $.symbolInterface),
			e.set(11, $.symbolFunction),
			e.set(12, $.symbolVariable),
			e.set(13, $.symbolConstant),
			e.set(14, $.symbolString),
			e.set(15, $.symbolNumber),
			e.set(16, $.symbolBoolean),
			e.set(17, $.symbolArray),
			e.set(18, $.symbolObject),
			e.set(19, $.symbolKey),
			e.set(20, $.symbolNull),
			e.set(21, $.symbolEnumMember),
			e.set(22, $.symbolStruct),
			e.set(23, $.symbolEvent),
			e.set(24, $.symbolOperator),
			e.set(25, $.symbolTypeParameter))
		function n(s) {
			let a = e.get(s)
			return (
				a || (console.info('No codicon found for SymbolKind ' + s), (a = $.symbolProperty)),
				a
			)
		}
		t.toIcon = n
	...
	;((zt.CtrlCmd = 2048), (zt.Shift = 1024), (zt.Alt = 512), (zt.WinCtrl = 256))
	let Fr = zt
	function Hu() {
		return {
			editor: void 0,
			languages: void 0,
			CancellationTokenSource: yu,
			Emitter: Te,
			KeyCode: Mr,
			KeyMod: Fr,
			Position: J,
	...
	function Ku(t, e, n, r, i) {
		return Yu(t, e, n, r, i) && Zu(t, e, n, r, i)
	}
	class ec {
		constructor(e, n) {
		...
		next(e) {
			...
			do {
				...
				if (i === this._prevMatchStartIndex && s === this._prevMatchLength) {
					if (s === 0) {
						eu(e, n, this._searchRegex.lastIndex) > 65535
				...
				if (
					...
					!this._wordSeparators || Ku(this._wordSeparators, e, n, i, s))
				)
					return r
			} while (r)
			return null
	...
	function nc(t = '') {
		let e = '(-?\\d*\\.\\d\\w*)|([^'
		for (const n of tc) t.indexOf(n) >= 0 || (e += '\\' + n)
	...
	const da = new Al()
	da.unshift({ maxLen: 1e3, windowSize: 15, timeBudget: 150 })
	function Vr(t, e, n, r, i) {
		if (((e = ma(e)), i || (i = vn.first(da)), n.length > i.maxLen)) {
			let c = t - i.maxLen / 2
			return (c < 0 ? (c = 0) : (r += c), (n = n.substring(c, t + i.maxLen / 2)), Vr(t, e, n, r, i))
		}
		const s = Date.now(),
			a = t - 1 - r
		let o = -1,
	...
	class ic {
		static computeUnicodeHighlights(e, n, r) {
			...
			o === 'allNonBasicAscii'
				? (u = new RegExp('[^\\t\\n\\r\\x20-\\x7E]', 'g'))
				: (u = new RegExp(`${sc(Array.from(o))}`, 'g'))
			const c = new ec(null, u),
				h = []
			let f = !1,
				m,
				g = 0,
			...
			e: for (let y = i, w = s; y <= w; y++) {
				...
				do
					if (((m = c.next(x)), m)) {
						...
						const R = x.substring(N, L)
						let v = Vr(N + 1, ha, x, 0)
						v && v.endColumn <= N + 1 && (v = null)
						const S = a.shouldHighlightNonBasicASCII(R, v ? v.word : null)
						if (S !== 0) {
							if ((S === 3 ? g++ : S === 2 ? d++ : S === 1 ? p++ : xl(), h.length >= 1e3)) {
								f = !0
								break e
							}
							h.push(new j(y, N + 1, y, L + 1))
						}
					}
				while (m)
			}
			...
			switch (r.shouldHighlightNonBasicASCII(e, null)) {
				...
				case 3: {
					const s = e.codePointAt(0),
						...
						o = Kt.getLocales().filter(
							(u) => !Kt.getInstance(new Set([...n.allowedLocales, u])).isAmbiguous(s),
						)
	...
	function sc(t, e) {
		return `[${Gl(t.map((r) => String.fromCodePoint(r)).join(''))}]`
	}
	class ga {
		constructor(e) {
			;((this.options = e),
				(this.allowedCodePoints = new Set(e.allowedCodePoints)),
				(this.ambiguousCharacters = Kt.getInstance(new Set(e.allowedLocales))))
		}
		getCandidateCodePoints() {
			if (this.options.nonBasicASCII) return 'allNonBasicAscii'
			const e = new Set()
			if (this.options.invisibleCharacters)
				for (const n of en.codePoints) pa(String.fromCodePoint(n)) || e.add(n)
				...
				for (const a of n) {
					...
					;((i = i || u),
						!u &&
							...
							!en.isInvisibleCharacter(o) &&
							(s = !0))
				}
			return !i && s
				? 0
				: this.options.invisibleCharacters && !pa(e) && en.isInvisibleCharacter(r)
					? 2
...
` ||
	...
	const Gt = class Gt {
		...
		filter(e) {
			return new Gt((n) => this.iterate((r) => (e(r) ? n(r) : !0)))
		}
		map(e) {
			return new Gt((n) => this.iterate((r) => n(e(r))))
		}
		findLast(e) {
			let n
		...
		findLastMaxBy(e) {
			let n,
				r = !0
			return (this.iterate((i) => ((r || Dr.isGreaterThan(e(i, n))) && ((r = !1), (n = i)), !0)), n)
		}
	}
	Gt.empty = new Gt((e) => {})
	let ya = Gt
	class B {
		...
		clip(e) {
			if (this.isEmpty) throw new re(`Invalid clipping range: ${this.toString()}`)
		...
		joinRightTouching(e) {
			if (this.endExclusive !== e.start)
				throw new re(`Invalid join: ${this.toString()} and ${e.toString()}`)
			return new B(this.start, e.endExclusive)
		}
		withMargin(e, n) {
			return (n === void 0 && (n = e), new B(this.start - e, this.endExclusive + n))
		}
	}
	function Et(t, e) {
		const n = Tt(t, e)
	...
	function Tt(t, e, n = 0, r = t.length) {
		let i = n,
			s = r
		for (; i < s; ) {
	...
	function Or(t, e, n = 0, r = t.length) {
		let i = n,
			s = r
		for (; i < s; ) {
			const a = Math.floor((i + s) / 2)
	...
	const er = class er {
		...
		findLastMonotonous(e) {
			...
			const n = Tt(this._array, e, this._findLastMonotonousLastIdx)
			return ((this._findLastMonotonousLastIdx = n + 1), n === -1 ? void 0 : this._array[n])
		}
	}
	er.assertInvariants = !1
	let Cn = er
	const ke = class ke {
		static ofLength(e, n) {
			return new ke(e, e + n)
		...
		static fromRange(e) {
			return new ke(e.startLineNumber, e.endLineNumber)
		}
		static fromRangeInclusive(e) {
			return new ke(e.startLineNumber, e.endLineNumber + 1)
		}
		static joinMany(e) {
			if (e.length === 0) return []
			let n = new Oe(e[0].slice())
			for (let r = 1; r < e.length; r++) n = n.getUnion(new Oe(e[r].slice()))
			return n.ranges
		}
		static join(e) {
			if (e.length === 0) throw new re('lineRanges cannot be empty')
		...
		static deserialize(e) {
			return new ke(e[0], e[1])
		}
		constructor(e, n) {
			if (e > n) throw new re(`startLineNumber ${e} cannot be after endLineNumberExclusive ${n}`)
		...
		delta(e) {
			return new ke(this.startLineNumber + e, this.endLineNumberExclusive + e)
		}
		deltaLength(e) {
			return new ke(this.startLineNumber, this.endLineNumberExclusive + e)
		}
		get length() {
		...
		addMargin(e, n) {
			return new ke(this.startLineNumber - e, this.endLineNumberExclusive + n)
		}
	}
	ke.compareByStart = Rt((e) => e.startLineNumber, rn)
	let z = ke
	class Oe {
		constructor(e = []) {
		...
		addRange(e) {
			if (e.length === 0) return
			const n = Or(this._normalizedRanges, (i) => i.endLineNumberExclusive >= e.startLineNumber),
				r = Tt(this._normalizedRanges, (i) => i.startLineNumber <= e.endLineNumberExclusive) + 1
		...
		contains(e) {
			const n = Et(this._normalizedRanges, (r) => r.startLineNumber <= e)
			return !!n && n.endLineNumberExclusive > e
		}
		intersects(e) {
			const n = Et(this._normalizedRanges, (r) => r.startLineNumber < e.endLineNumberExclusive)
		...
		subtractFrom(e) {
			const n = Or(this._normalizedRanges, (a) => a.endLineNumberExclusive >= e.startLineNumber),
				r = Tt(this._normalizedRanges, (a) => a.startLineNumber <= e.endLineNumberExclusive) + 1
			if (n === r) return new Oe([e])
			const i = []
			let s = e.startLineNumber
			for (let a = n; a < r; a++) {
				const o = this._normalizedRanges[a]
				;(o.startLineNumber > s && i.push(new z(s, o.startLineNumber)),
					(s = o.endLineNumberExclusive))
			}
			return (s < e.endLineNumberExclusive && i.push(new z(s, e.endLineNumberExclusive)), new Oe(i))
		}
		toString() {
		...
		getWithDelta(e) {
			return new Oe(this._normalizedRanges.map((n) => n.delta(e)))
		}
	}
	const Ve = class Ve {
		static betweenPositions(e, n) {
			return e.lineNumber === n.lineNumber
				? new Ve(0, n.column - e.column)
				: new Ve(n.lineNumber - e.lineNumber, n.column - 1)
		}
		static fromPosition(e) {
			return new Ve(e.lineNumber - 1, e.column - 1)
		}
		static ofRange(e) {
			return Ve.betweenPositions(e.getStartPosition(), e.getEndPosition())
		}
		static ofText(e) {
			let n = 0,
				r = 0
...
`
		...
		add(e) {
			return e.lineCount === 0
				? new Ve(this.lineCount, this.columnCount + e.columnCount)
				: new Ve(this.lineCount + e.lineCount, e.columnCount)
		}
		createRange(e) {
		...
		addToPosition(e) {
			return this.lineCount === 0
				? new J(e.lineNumber, e.column + this.columnCount)
				: new J(e.lineNumber + this.lineCount, this.columnCount + 1)
		}
		toString() {
	...
	class mc {
		...
		getStringReplacement(e) {
			return new ft.deps.StringReplacement(this.getOffsetRange(e.range), e.text)
		}
		getTextReplacement(e) {
			return new ft.deps.TextReplacement(this.getRange(e.replaceRange), e.newText)
		}
		getTextEdit(e) {
			const n = e.replacements.map((r) => this.getTextReplacement(r))
			return new ft.deps.TextEdit(n)
		}
	}
	const Si = class Si {
		static get deps() {
...
` &&
		...
		_validatePosition(e) {
			...
			return e.column - 1 > r ? new J(e.lineNumber, r + 1) : e
		}
		getPosition(e) {
			const n = Tt(this.lineStartOffsetByLineIdx, (s) => s <= e),
				r = n + 1,
		...
		get textLength() {
			...
			return new ft.deps.TextLength(e, this.text.length - this.lineStartOffsetByLineIdx[e])
		}
		getLineLength(e) {
	...
	class xa {
		...
		getTransformer() {
			return (this._transformer || (this._transformer = new wa(this.getValue())), this._transformer)
		}
		getLineAt(e) {
	...
	class gc extends xa {
		constructor(e, n) {
			;(vl(n >= 1), super(), (this._getLineContent = e), (this._lineCount = n))
		}
		getValueOfRange(e) {
...
` + this._getLineContent(e.endLineNumber).substring(0, e.endColumn - 1)),
	...
	class Fn extends xa {
		constructor(e) {
			;(super(), (this.value = e), (this._t = new wa(this.value)))
		}
		getValueOfRange(e) {
	...
	let pc = class Ai {
		static fromStringEdit(e, n) {
			const r = e.replacements.map((i) => Pe.fromStringReplacement(i, n))
			return new Ai(r)
		}
		static fromParallelReplacementsUnsorted(e) {
			const n = e.slice().sort(Rt((r) => r.range, j.compareRangesUsingStarts))
			return new Ai(n)
		}
		constructor(e) {
			;((this.replacements = e),
				Xt(() =>
					sr(e, (n, r) => n.range.getEndPosition().isBeforeOrEqual(r.range.getStartPosition())),
				))
		}
		mapPosition(e) {
			let n = 0,
			...
			for (const s of this.replacements) {
				...
				const o = s.range.getEndPosition(),
					u = tt.ofText(s.text)
				if (e.isBefore(o)) {
					const c = new J(a.lineNumber + n, a.column + (a.lineNumber + n === r ? i : 0)),
						h = u.addToPosition(c)
					return Vn(c, h)
				}
				;(a.lineNumber + n !== r && (i = 0),
					(n += u.lineCount - (s.range.endLineNumber - s.range.startLineNumber)),
					u.lineCount === 0
						? o.lineNumber !== a.lineNumber
							? (i += u.columnCount - (o.column - 1))
							: (i += u.columnCount - (o.column - a.column))
						: (i = u.columnCount),
					(r = o.lineNumber + n))
			}
			return new J(e.lineNumber + n, e.column + (e.lineNumber + n === r ? i : 0))
		}
		mapRange(e) {
			function n(a) {
			...
			const i = n(this.mapPosition(e.getStartPosition())),
				s = r(this.mapPosition(e.getEndPosition()))
			return Vn(i, s)
		}
		apply(e) {
			let n = '',
			...
			for (const s of this.replacements) {
				const a = s.range,
					o = a.getStartPosition(),
					u = a.getEndPosition(),
					c = Vn(r, o)
				;(c.isEmpty() || (n += e.getValueOfRange(c)), (n += s.text), (r = u))
			}
			const i = Vn(r, e.endPositionExclusive)
		...
		getNewRanges() {
			...
			for (const s of this.replacements) {
				const a = tt.ofText(s.text),
					...
					u = a.createRange(o)
				;(e.push(u),
					(r = u.endLineNumber - s.range.endLineNumber),
					(i = u.endColumn - s.range.endColumn),
					(n = s.range.endLineNumber))
			}
			return e
		}
		toReplacement(e) {
			if (this.replacements.length === 0) throw new re()
			if (this.replacements.length === 1) return this.replacements[0]
			const n = this.replacements[0].range.getStartPosition(),
				r = this.replacements[this.replacements.length - 1].range.getEndPosition()
			let i = ''
			for (let s = 0; s < this.replacements.length; s++) {
				const a = this.replacements[s]
				if (((i += a.text), s < this.replacements.length - 1)) {
					const o = this.replacements[s + 1],
						u = j.fromPositions(a.range.getEndPosition(), o.range.getStartPosition()),
						c = e.getValueOfRange(u)
					i += c
				}
			}
			return new Pe(j.fromPositions(n, r), i)
		}
		toString(e) {
			return e === void 0
...
`)
				: typeof e == 'string'
					? this.toString(new Fn(e))
					: this.replacements.length === 0
						? ''
						: this.replacements.map((n) => {
								const i = e.getValueOfRange(n.range),
									s = j.fromPositions(
										new J(Math.max(1, n.range.startLineNumber - 1), 1),
										n.range.getStartPosition(),
									)
								let a = e.getValueOfRange(s)
								a.length > 10 && (a = '...' + a.substring(a.length - 10))
								const o = j.fromPositions(
									n.range.getEndPosition(),
									new J(n.range.endLineNumber + 1, 1),
								)
								let u = e.getValueOfRange(o)
								...
								return c.length === 0 ? `${a}❰${h}❱${u}` : `${a}❰${c}↦${h}❱${u}`
							}).join(`
`)
		}
	}
		...
		static joinReplacements(e, n) {
			...
			for (let a = 0; a < e.length; a++) {
				...
				if (((s += o.text), a < e.length - 1)) {
					const u = e[a + 1],
						c = j.fromPositions(o.range.getEndPosition(), u.range.getStartPosition()),
						h = n.getValueOfRange(c)
					s += h
				}
			}
			return new Pe(j.fromPositions(r, i), s)
		}
...
`,
				...
				i = yr(n, r),
				s = tt.ofText(n.substring(0, i)).addToPosition(this.range.getStartPosition()),
				a = r.substring(i),
				o = j.fromPositions(s, this.range.getEndPosition())
			return new Pe(o, a)
		}
...
`,
				...
				i = wr(n, r),
				s = tt.ofText(n.substring(0, n.length - i)).addToPosition(this.range.getStartPosition()),
				a = r.substring(0, r.length - i),
				o = j.fromPositions(this.range.getStartPosition(), s)
			return new Pe(o, a)
		}
		toString() {
	...
	function Vn(t, e) {
		...
		if (!t.isBeforeOrEqual(e)) throw new re('start must be before end')
	...
	class Le {
		static inverse(e, n, r) {
			...
			let s = 1,
				a = 1
			for (const u of e) {
				const c = new Le(new z(s, u.original.startLineNumber), new z(a, u.modified.startLineNumber))
				;(c.modified.isEmpty || i.push(c),
					(s = u.original.endLineNumberExclusive),
					(a = u.modified.endLineNumberExclusive))
			}
			const o = new Le(new z(s, n + 1), new z(a, r + 1))
		...
		toRangeMapping2(e, n) {
			if (
				va(this.original.endLineNumberExclusive, e) &&
				va(this.modified.endLineNumberExclusive, n)
			)
				return new Ne(
					new j(this.original.startLineNumber, 1, this.original.endLineNumberExclusive, 1),
					new j(this.modified.startLineNumber, 1, this.modified.endLineNumberExclusive, 1),
			...
			if (!this.original.isEmpty && !this.modified.isEmpty)
				return new Ne(
					j.fromPositions(
						new J(this.original.startLineNumber, 1),
						Mt(new J(this.original.endLineNumberExclusive - 1, Number.MAX_SAFE_INTEGER), e),
					),
					j.fromPositions(
						new J(this.modified.startLineNumber, 1),
						Mt(new J(this.modified.endLineNumberExclusive - 1, Number.MAX_SAFE_INTEGER), n),
					),
				)
			if (this.original.startLineNumber > 1 && this.modified.startLineNumber > 1)
				return new Ne(
					j.fromPositions(
						Mt(new J(this.original.startLineNumber - 1, Number.MAX_SAFE_INTEGER), e),
						Mt(new J(this.original.endLineNumberExclusive - 1, Number.MAX_SAFE_INTEGER), e),
					),
					j.fromPositions(
						Mt(new J(this.modified.startLineNumber - 1, Number.MAX_SAFE_INTEGER), n),
						Mt(new J(this.modified.endLineNumberExclusive - 1, Number.MAX_SAFE_INTEGER), n),
					),
				)
			throw new re()
	...
	function Mt(t, e) {
		if (t.lineNumber < 1) return new J(1, 1)
		if (t.lineNumber > e.length) return new J(e.length, e[e.length - 1].length + 1)
		const n = e[t.lineNumber - 1]
		return t.column > n.length + 1 ? new J(t.lineNumber, n.length + 1) : t
	}
	function va(t, e) {
	...
	class Xe extends Le {
		static fromRangeMappings(e) {
			const n = z.join(e.map((i) => z.fromRangeInclusive(i.originalRange))),
				r = z.join(e.map((i) => z.fromRangeInclusive(i.modifiedRange)))
			return new Xe(n, r, e)
		}
		constructor(e, n, r) {
		...
		static assertSorted(e) {
			for (let n = 1; n < e.length; n++) {
				...
				if (
					...
					throw new re('Range mappings must be sorted')
			}
		}
		constructor(e, n) {
	...
	function bc(t, e, n) {
		...
		;(t.modifiedRange.endColumn === 1 &&
			...
			t.modifiedRange.startColumn - 1 >= n.getLineLength(t.modifiedRange.startLineNumber) &&
				...
				(r = 1))
		const s = new z(t.originalRange.startLineNumber + r, t.originalRange.endLineNumber + 1 + i),
			a = new z(t.modifiedRange.startLineNumber + r, t.modifiedRange.endLineNumber + 1 + i)
		return new Xe(s, a, [t])
	}
	const yc = 3
	class wc {
		computeDiff(e, n, r) {
			...
			for (const u of s.changes) {
				...
				u.originalEndLineNumber === 0
					? (c = new z(u.originalStartLineNumber + 1, u.originalStartLineNumber + 1))
					: (c = new z(u.originalStartLineNumber, u.originalEndLineNumber + 1))
				let h
				u.modifiedEndLineNumber === 0
					? (h = new z(u.modifiedStartLineNumber + 1, u.modifiedStartLineNumber + 1))
					: (h = new z(u.modifiedStartLineNumber, u.modifiedEndLineNumber + 1))
				let f = new Xe(
					c,
					h,
					u.charChanges?.map(
			...
			return (
				...
				new nn(a, [], s.quitEarly)
			)
		}
	}
	function La(t, e, n, r) {
		return new et(t, e, n).ComputeDiff(r)
	}
	let Na = class {
		constructor(e) {
			const n = [],
				r = []
			for (let i = 0, s = e.length; i < s; i++) ((n[i] = Br(e[i], 1)), (r[i] = Ur(e[i], 1)))
		...
		createCharSequence(e, n, r) {
			...
			for (let u = n; u <= r; u++) {
				...
				for (let m = h; m < f; m++) ((i[o] = c.charCodeAt(m - 1)), (s[o] = u + 1), (a[o] = m), o++)
				!e && u < r && ((i[o] = 10), (s[o] = u + 1), (a[o] = c.length + 1), o++)
			}
			return new xc(i, s, a)
		}
	}
		...
		static createFromDiffResult(e, n, r, i, s, a, o) {
			...
			if (
				...
				if (g.getElements().length > 0 && d.getElements().length > 0) {
					let p = La(g, d, s, !0).changes
					;(o && (p = vc(p)), (m = []))
					for (let y = 0, w = p.length; y < w; y++) m.push(Pt.createFromDiffChange(p[y], g, d))
				}
			}
			return new sn(u, c, h, f, m)
		}
	}
	class Lc {
		constructor(e, n, r) {
			;((this.shouldComputeCharChanges = r.shouldComputeCharChanges),
				...
				(this.original = new Na(e)),
				(this.modified = new Na(n)),
				(this.continueLineDiff = _a(r.maxComputationTime)),
				(this.continueCharDiff = _a(
		...
		computeDiff() {
			...
			const e = La(this.original, this.modified, this.continueLineDiff, this.shouldMakePrettyDiff),
				n = e.changes,
				r = e.quitEarly
		...
		_pushTrimWhitespaceCharChange(e, n, r, i, s, a, o) {
			...
			let u
			;(this.shouldComputeCharChanges && (u = [new Pt(n, r, n, i, s, a, s, o)]),
				e.push(new sn(n, n, s, s, u)))
		}
		_mergeTrimWhitespaceCharChange(e, n, r, i, s, a, o) {
			...
			return c.originalEndLineNumber === 0 || c.modifiedEndLineNumber === 0
				? !1
				: c.originalEndLineNumber === n && c.modifiedEndLineNumber === s
					? (this.shouldComputeCharChanges &&
							c.charChanges &&
							c.charChanges.push(new Pt(n, r, n, i, s, a, s, o)),
						!0)
					: c.originalEndLineNumber + 1 === n && c.modifiedEndLineNumber + 1 === s
						? ((c.originalEndLineNumber = n),
							(c.modifiedEndLineNumber = s),
							this.shouldComputeCharChanges &&
								c.charChanges &&
								c.charChanges.push(new Pt(n, r, n, i, s, a, s, o)),
							!0)
	...
	class Qe {
		static trivial(e, n) {
			return new Qe([new ee(B.ofLength(e.length), B.ofLength(n.length))], !1)
		}
		static trivialTimedOut(e, n) {
			return new Qe([new ee(B.ofLength(e.length), B.ofLength(n.length))], !0)
		}
		constructor(e, n) {
	...
	class ee {
		static invert(e, n) {
			...
			return (
				lc(e, (i, s) => {
					r.push(
						ee.fromOffsetPairs(
							i ? i.getEndExclusives() : Ye.zero,
							s
								? s.getStarts()
								: new Ye(n, (i ? i.seq2Range.endExclusive - i.seq1Range.endExclusive : 0) + n),
						),
					)
				}),
				r
		...
		static fromOffsetPairs(e, n) {
			return new ee(new B(e.offset1, n.offset1), new B(e.offset2, n.offset2))
		}
		static assertSorted(e) {
			let n
			for (const r of e) {
				if (
					...
					throw new re('Sequence diffs must be sorted')
				n = r
			}
		}
		constructor(e, n) {
		...
		swap() {
			return new ee(this.seq2Range, this.seq1Range)
		}
		toString() {
			return `${this.seq1Range} <-> ${this.seq2Range}`
		}
		join(e) {
			return new ee(this.seq1Range.join(e.seq1Range), this.seq2Range.join(e.seq2Range))
		}
		delta(e) {
			return e === 0 ? this : new ee(this.seq1Range.delta(e), this.seq2Range.delta(e))
		}
		deltaStart(e) {
			return e === 0 ? this : new ee(this.seq1Range.deltaStart(e), this.seq2Range.deltaStart(e))
		}
		deltaEnd(e) {
			return e === 0 ? this : new ee(this.seq1Range.deltaEnd(e), this.seq2Range.deltaEnd(e))
		}
		intersect(e) {
			const n = this.seq1Range.intersect(e.seq1Range),
				r = this.seq2Range.intersect(e.seq2Range)
			if (!(!n || !r)) return new ee(n, r)
		}
		getStarts() {
	...
	const pt = class pt {
		...
		delta(e) {
			return e === 0 ? this : new pt(this.offset1 + e, this.offset2 + e)
		}
		equals(e) {
			return this.offset1 === e.offset1 && this.offset2 === e.offset2
		}
	}
	;((pt.zero = new pt(0, 0)), (pt.max = new pt(Number.MAX_SAFE_INTEGER, Number.MAX_SAFE_INTEGER)))
	let Ye = pt
	const tr = class tr {
		isValid() {
			return !0
...
`)
	...
	let Dn = bn
	class _c {
		compute(e, n, r = an.instance, i) {
			if (e.length === 0 || n.length === 0) return Qe.trivial(e, n)
			const s = new qr(e.length, n.length),
				a = new qr(e.length, n.length),
				o = new qr(e.length, n.length)
			for (let d = 0; d < e.length; d++)
				for (let p = 0; p < n.length; p++) {
					if (!r.isValid()) return Qe.trivialTimedOut(e, n)
					const y = d === 0 ? 0 : s.get(d - 1, p),
						w = p === 0 ? 0 : s.get(d, p - 1)
					let x
					e.getElement(d) === n.getElement(p)
						? (d === 0 || p === 0 ? (x = 0) : (x = s.get(d - 1, p - 1)),
							d > 0 && p > 0 && a.get(d - 1, p - 1) === 3 && (x += o.get(d - 1, p - 1)),
							(x += i ? i(d, p) : 1))
						: (x = -1)
					const b = Math.max(y, w, x)
					if (b === x) {
						const N = d > 0 && p > 0 ? o.get(d - 1, p - 1) : 0
						;(o.set(d, p, N + 1), a.set(d, p, 3))
					} else
			...
			let c = e.length,
				h = n.length
			function f(d, p) {
				;((d + 1 !== c || p + 1 !== h) && u.push(new ee(new B(d + 1, c), new B(p + 1, h))),
					(c = d),
					(h = p))
			}
			let m = e.length - 1,
			...
			return (f(-1, -1), u.reverse(), new Qe(u, !1))
		}
	}
	class Sa {
		compute(e, n, r = an.instance) {
			if (e.length === 0 || n.length === 0) return Qe.trivial(e, n)
			const i = e,
				s = n
			function a(p, y) {
			...
			u.set(0, a(0, 0))
			const c = new Ac()
			c.set(0, u.get(0) === 0 ? null : new Aa(null, 0, 0, u.get(0)))
			let h = 0
			e: for (;;) {
				if ((o++, !r.isValid())) return Qe.trivialTimedOut(i, s)
				const p = -Math.min(o, s.length + (o % 2)),
					y = Math.min(o, i.length + (o % 2))
				for (h = p; h <= y; h += 2) {
					const w = h === y ? -1 : u.get(h + 1),
						x = h === p ? -1 : u.get(h - 1) + 1,
						b = Math.min(Math.max(w, x), i.length),
						N = b - h
					if (b > i.length || N > s.length) continue
					const L = a(b, N)
					u.set(h, L)
					const R = b === w ? c.get(h + 1) : c.get(h - 1)
					if (
						(c.set(h, L !== b ? new Aa(R, b, N, L - b) : R),
			...
			for (;;) {
				const p = f ? f.x + f.length : 0,
					y = f ? f.y + f.length : 0
				if (((p !== g || y !== d) && m.push(new ee(new B(p, g), new B(y, d))), !f)) break
	...
	class On {
			...
			for (let i = this.range.startLineNumber; i <= this.range.endLineNumber; i++) {
				...
				const u =
					i === this.range.endLineNumber
						...
						: s.length
				for (let c = 0; c < u; c++) this.elements.push(s.charCodeAt(c))
				i < this.range.endLineNumber &&
		...
		getBoundaryScore(e) {
			const n = Ea(e > 0 ? this.elements[e - 1] : -1),
				r = Ea(e < this.elements.length ? this.elements[e] : -1)
			if (n === 7 && r === 8) return 0
			if (n === 8) return 150
			let i = 0
			return (n !== r && ((i += 10), n === 0 && r === 1 && (i += 1)), (i += Ra(n)), (i += Ra(r)), i)
		}
		translateOffset(e, n = 'right') {
			const r = Tt(this.firstElementOffsetByLineIdx, (s) => s <= e),
		...
		translateRange(e) {
			...
			return r.isBefore(n) ? j.fromPositions(r, r) : j.fromPositions(n, r)
		}
		findWordContaining(e) {
			if (e < 0 || e >= this.elements.length || !Ct(this.elements[e])) return
			let n = e
			for (; n > 0 && Ct(this.elements[n - 1]); ) n--
			let r = e
			for (; r < this.elements.length && Ct(this.elements[r]); ) r++
			return new B(n, r)
		}
		findSubWordContaining(e) {
			if (e < 0 || e >= this.elements.length || !Ct(this.elements[e])) return
			let n = e
			for (; n > 0 && Ct(this.elements[n - 1]) && !ka(this.elements[n]); ) n--
			let r = e
			for (; r < this.elements.length && Ct(this.elements[r]) && !ka(this.elements[r]); ) r++
			return new B(n, r)
		}
		countLinesIn(e) {
			return (
		...
		extendToFullLines(e) {
			const n = Et(this.firstElementOffsetByLineIdx, (i) => i <= e.start) ?? 0,
				r = hc(this.firstElementOffsetByLineIdx, (i) => e.endExclusive <= i) ?? this.elements.length
			return new B(n, r)
		}
	}
	function Ct(t) {
	...
	const kc = { 0: 0, 1: 0, 2: 0, 3: 10, 4: 2, 5: 30, 6: 3, 7: 10, 8: 10 }
	function Ra(t) {
		return kc[t]
	}
	function Ea(t) {
	...
	function Rc(t, e, n, r, i, s) {
		let { moves: a, excludedChanges: o } = Tc(t, e, n, s)
		if (!s.isValid()) return []
...
`).length >= 15 && Ec(f, (g) => g.length >= 2) >= 2
	...
	function Tc(t, e, n, r) {
		const i = [],
			s = t
				...
				.map((u) => new Dn(u.original, e, u)),
			a = new Set(
				t
					.filter((u) => u.original.isEmpty && u.modified.length >= 3)
					.map((u) => new Dn(u.modified, n, u)),
			),
			o = new Set()
		for (const u of s) {
			let c = -1,
	...
	function Mc(t, e, n, r, i, s) {
		...
		for (const m of t)
			for (let g = m.original.startLineNumber; g < m.original.endLineNumberExclusive - 2; g++) {
				...
				o.add(d, { range: new z(g, g + 3) })
			}
		const u = []
		t.sort(Rt((m) => m.modified.startLineNumber, rn))
		for (const m of t) {
			let g = []
			for (let d = m.modified.startLineNumber; d < m.modified.endLineNumberExclusive - 2; d++) {
				...
				;(o.forEach(p, ({ range: x }) => {
					for (const N of g)
						if (
							N.originalLineRange.endLineNumberExclusive + 1 === x.endLineNumberExclusive &&
							N.modifiedLineRange.endLineNumberExclusive + 1 === y.endLineNumberExclusive
						) {
							;((N.originalLineRange = new z(
								N.originalLineRange.startLineNumber,
								x.endLineNumberExclusive,
							)),
								(N.modifiedLineRange = new z(
					...
					const b = { modifiedLineRange: y, originalLineRange: x }
					;(u.push(b), w.push(b))
				}),
					(g = w))
			}
		...
		u.sort(fc(Rt((m) => m.modifiedLineRange.length, rn)))
		const c = new Oe(),
			h = new Oe()
		for (const m of u) {
			const g = m.modifiedLineRange.startLineNumber - m.originalLineRange.startLineNumber,
				d = c.subtractFrom(m.modifiedLineRange),
			...
			for (const w of y.ranges) {
				...
				const x = w,
					b = w.delta(-g)
				;(a.push(new Le(b, x)), c.addRange(x), h.addRange(b))
			}
		}
		a.sort(Rt((m) => m.original.startLineNumber, rn))
		const f = new Cn(t)
		for (let m = 0; m < a.length; m++) {
			const g = a[m],
				d = f.findLastMonotonous((R) => R.original.startLineNumber <= g.original.startLineNumber),
				p = Et(t, (R) => R.modified.startLineNumber <= g.modified.startLineNumber),
				y = Math.max(
				...
				w = f.findLastMonotonous(
					(R) => R.original.startLineNumber < g.original.endLineNumberExclusive,
				),
				x = Et(t, (R) => R.modified.startLineNumber < g.modified.endLineNumberExclusive),
				b = Math.max(
					w.original.endLineNumberExclusive - g.original.endLineNumberExclusive,
					x.modified.endLineNumberExclusive - g.modified.endLineNumberExclusive,
				)
			let N
			for (N = 0; N < y; N++) {
				const R = g.original.startLineNumber - N - 1,
					v = g.modified.startLineNumber - N - 1
				if (
					R > r.length ||
					v > i.length ||
					c.contains(v) ||
			...
			N > 0 &&
				(h.addRange(new z(g.original.startLineNumber - N, g.original.startLineNumber)),
				c.addRange(new z(g.modified.startLineNumber - N, g.modified.startLineNumber)))
			let L
			for (L = 0; L < b; L++) {
				const R = g.original.endLineNumberExclusive + L,
			...
			;(L > 0 &&
				(h.addRange(
					new z(g.original.endLineNumberExclusive, g.original.endLineNumberExclusive + L),
				),
				c.addRange(
					new z(g.modified.endLineNumberExclusive, g.modified.endLineNumberExclusive + L),
				)),
				(N > 0 || L > 0) &&
					(a[m] = new Le(
						new z(g.original.startLineNumber - N, g.original.endLineNumberExclusive + L),
						new z(g.modified.startLineNumber - N, g.modified.endLineNumberExclusive + L),
					)))
		}
		return a
	}
	function Ta(t, e, n) {
		...
		const i = new Sa().compute(
			new On([t], new j(1, 1, 1, t.length), !1),
			new On([e], new j(1, 1, 1, e.length), !1),
			n,
		)
		let s = 0
		const a = ee.invert(i.diffs, t.length)
		for (const h of a)
		...
		function o(h) {
			let f = 0
			for (let m = 0; m < t.length; m++) jr(h.charCodeAt(m)) || f++
			return f
		}
	...
	function Pc(t) {
		...
		t.sort(Rt((n) => n.original.startLineNumber, rn))
		const e = [t[0]]
		...
		return (
			(e = e.filter((r) => {
				const i =
						...
						) || new Le(new z(1, 1), new z(1, 1)),
					s = Et(t, (o) => o.modified.startLineNumber < r.modified.endLineNumberExclusive)
				return i !== s
			})),
			e
		)
	...
	function Ma(t, e, n) {
		let r = n
		return ((r = Pa(t, e, r)), (r = Pa(t, e, r)), (r = Ic(t, e, r)), r)
	}
	function Pa(t, e, n) {
		...
		for (let s = 1; s < n.length; s++) {
			...
			if (o.seq1Range.isEmpty || o.seq2Range.isEmpty) {
				...
				if ((c--, c === u)) {
					r[r.length - 1] = new ee(
						new B(a.seq1Range.start, o.seq1Range.endExclusive - u),
						new B(a.seq2Range.start, o.seq2Range.endExclusive - u),
					)
					continue
				}
				o = o.delta(-c)
		...
		for (let s = 0; s < r.length - 1; s++) {
			...
			if (o.seq1Range.isEmpty || o.seq2Range.isEmpty) {
				...
				if (c === u) {
					r[s + 1] = new ee(
						new B(o.seq1Range.start + u, a.seq1Range.endExclusive),
						new B(o.seq2Range.start + u, a.seq2Range.endExclusive),
					)
					continue
				}
				c > 0 && (o = o.delta(c))
	...
	function Ic(t, e, n) {
		...
		for (let r = 0; r < n.length; r++) {
			const i = r > 0 ? n[r - 1] : void 0,
				...
				o = new B(i ? i.seq1Range.endExclusive + 1 : 0, a ? a.seq1Range.start - 1 : t.length),
				u = new B(i ? i.seq2Range.endExclusive + 1 : 0, a ? a.seq2Range.start - 1 : e.length)
			s.seq1Range.isEmpty
				? (n[r] = Ca(s, t, e, o, u))
				: s.seq2Range.isEmpty && (n[r] = Ca(s.swap(), e, t, u, o).swap())
		}
		return n
	}
	...
	function Fc(t, e, n) {
		...
		for (const i of n) {
			...
			i.seq2Range.start - s.seq2Range.endExclusive <= 2
				? (r[r.length - 1] = new ee(s.seq1Range.join(i.seq1Range), s.seq2Range.join(i.seq2Range)))
				: r.push(i)
		}
		return r
	}
	function Ia(t, e, n, r, i = !1) {
		const s = ee.invert(n, t.length),
			a = []
		let o = new Ye(0, 0)
		function u(h, f) {
			...
			for (; s.length > 0; ) {
				const x = s[0]
				if (!(x.seq1Range.intersects(d.seq1Range) || x.seq2Range.intersects(d.seq2Range))) break
				const N = r(t, x.seq1Range.start),
					L = r(e, x.seq2Range.start),
					R = new ee(N, L),
					v = R.intersect(x)
				if (
					...
					(d = d.join(R)),
					d.seq1Range.endExclusive >= x.seq1Range.endExclusive)
				)
					s.shift()
				else break
			}
	...
	function Dc(t, e, n) {
		...
		do {
			...
			for (let o = 1; o < r.length; o++) {
				let h = function (m, g) {
					const d = new B(c.seq1Range.endExclusive, u.seq1Range.start)
					return (
		...
		do {
			...
			for (let u = 1; u < r.length; u++) {
				let f = function (g, d) {
					...
					const x = t.countLinesIn(g.seq1Range),
						b = g.seq1Range.length,
						N = e.countLinesIn(g.seq2Range),
						L = g.seq2Range.length,
						R = t.countLinesIn(d.seq1Range),
						v = d.seq1Range.length,
						S = e.countLinesIn(d.seq2Range),
						C = d.seq2Range.length,
						D = 130
					function P(_) {
						return Math.min(_, D)
					}
					return (
						Math.pow(Math.pow(P(x * 40 + b), 1.5) + Math.pow(P(N * 40 + L), 1.5), 1.5) +
							Math.pow(Math.pow(P(R * 40 + v), 1.5) + Math.pow(P(S * 40 + C), 1.5), 1.5) >
						(D ** 1.5) ** 1.5 * 1.3
					)
				}
				const c = r[u],
					h = o[o.length - 1]
				f(h, c) ? ((s = !0), (o[o.length - 1] = o[o.length - 1].join(c))) : o.push(c)
			}
			r = o
		} while (i++ < 10 && s)
		const a = []
		return (
			uc(r, (o, u, c) => {
				...
				const m = t.extendToFullLines(u.seq1Range),
					g = t.getText(new B(m.start, u.seq1Range.start))
				f(g) && (h = h.deltaStart(-g.length))
				const d = t.getText(new B(u.seq1Range.endExclusive, m.endExclusive))
				f(d) && (h = h.deltaEnd(d.length))
				const p = ee.fromOffsetPairs(
						o ? o.getEndExclusives() : Ye.zero,
						c ? c.getStarts() : Ye.max,
					),
					y = h.intersect(p)
	...
	class Fa {
		...
		getBoundaryScore(e) {
			const n = e === 0 ? 0 : Va(this.lines[e - 1]),
				r = e === this.lines.length ? 0 : Va(this.lines[e])
			return 1e3 - (n + r)
		}
		getText(e) {
...
`)
	...
	class $c {
		constructor() {
			;((this.dynamicProgrammingDiffing = new _c()), (this.myersDiffingAlgorithm = new Sa()))
		}
		computeDiff(e, n, r) {
			if (e.length <= 1 && ac(e, n, (v, S) => v === S)) return new nn([], [], !1)
			if ((e.length === 1 && e[0].length === 0) || (n.length === 1 && n[0].length === 0))
				return new nn(
					[
						new Xe(new z(1, e.length + 1), new z(1, n.length + 1), [
							new Ne(
			...
			const i = r.maxComputationTimeMs === 0 ? an.instance : new Nc(r.maxComputationTimeMs),
				s = !r.ignoreTrimWhitespace,
				a = new Map()
			function o(v) {
				let S = a.get(v)
				return (S === void 0 && ((S = a.size), a.set(v, S)), S)
			}
			const u = e.map((v) => o(v.trim())),
				...
				m =
					h.length + f.length < 1700
						? this.dynamicProgrammingDiffing.compute(h, f, i, (v, S) =>
								e[v] === n[S] ? (n[S].length === 0 ? 0.1 : 1 + Math.log(1 + n[S].length)) : 0.99,
							)
						: this.myersDiffingAlgorithm.compute(h, f, i)
			let g = m.diffs,
				d = m.hitTimeout
			;((g = Ma(h, f, g)), (g = Dc(h, f, g)))
			const p = [],
				y = (v) => {
					if (s)
						for (let S = 0; S < v; S++) {
							const C = w + S,
								D = x + S
							if (e[C] !== n[D]) {
								const P = this.refineDiff(e, n, new ee(new B(C, C + 1), new B(D, D + 1)), i, s, r)
								for (const _ of P.mappings) p.push(_)
								P.hitTimeout && (d = !0)
							}
						}
				}
			let w = 0,
				x = 0
			for (const v of g) {
				Xt(() => v.seq1Range.start - w === v.seq2Range.start - x)
				const S = v.seq1Range.start - w
				;(y(S), (w = v.seq1Range.endExclusive), (x = v.seq2Range.endExclusive))
				const C = this.refineDiff(e, n, v, i, s, r)
				C.hitTimeout && (d = !0)
				for (const D of C.mappings) p.push(D)
			}
			y(e.length - w)
			const b = new In(e),
				N = new In(n),
			...
			let R = []
			return (
				r.computeMoves && (R = this.computeMoves(L, e, n, u, c, i, s, r)),
				Xt(() => {
					function v(C, D) {
						if (C.lineNumber < 1 || C.lineNumber > D.length) return !1
						const P = D[C.lineNumber - 1]
						return !(C.column < 1 || C.column > P.length + 1)
					}
					function S(C, D) {
						return !(
							C.startLineNumber < 1 ||
							C.startLineNumber > D.length + 1 ||
							C.endLineNumberExclusive < 1 ||
							C.endLineNumberExclusive > D.length + 1
						)
					}
					for (const C of L) {
						if (!C.innerChanges) return !1
						for (const D of C.innerChanges)
							if (
								!(
									v(D.modifiedRange.getStartPosition(), n) &&
									v(D.modifiedRange.getEndPosition(), n) &&
									v(D.originalRange.getStartPosition(), e) &&
									v(D.originalRange.getEndPosition(), e)
								)
							)
								return !1
						if (!S(C.modified, n) || !S(C.original, e)) return !1
					}
					return !0
				}),
				new nn(L, R, d)
		...
		computeMoves(e, n, r, i, s, a, o, u) {
			return Rc(e, n, r, i, s, a).map((f) => {
				const m = this.refineDiff(
						n,
						r,
						new ee(f.original.toOffsetRange(), f.modified.toOffsetRange()),
						a,
						o,
						u,
					),
					g = $r(m.mappings, new In(n), new In(r), !0)
				return new ba(f, g)
			})
		}
		refineDiff(e, n, r, i, s, a) {
			const u = Bc(r).toRangeMapping2(e, n),
				c = new On(e, u.originalRange, s),
				h = new On(n, u.modifiedRange, s),
				f =
					c.length + h.length < 500
						? this.dynamicProgrammingDiffing.compute(c, h, i)
						: this.myersDiffingAlgorithm.compute(c, h, i)
			let m = f.diffs
			return (
				(m = Ma(c, h, m)),
				(m = Ia(c, h, m, (d, p) => d.findWordContaining(p))),
				a.extendToSubwords && (m = Ia(c, h, m, (d, p) => d.findSubWordContaining(p), !0)),
				(m = Fc(c, h, m)),
				(m = Oc(c, h, m)),
				{
					mappings: m.map(
						(d) => new Ne(c.translateRange(d.seq1Range), h.translateRange(d.seq2Range)),
					),
	...
	function Bc(t) {
		return new Le(
			new z(t.seq1Range.start + 1, t.seq1Range.endExclusive + 1),
			new z(t.seq2Range.start + 1, t.seq2Range.endExclusive + 1),
		)
	}
	var nt
	;(function (t) {
	...
	class qc {
		...
		get _remoteResourcesPath() {
			return he.join(this._serverRootPath, nt.vscodeRemoteResource)
		}
		rewrite(e) {
			if (this._delegate)
				try {
			...
			const i = this._ports[n],
				s = this._connectionTokens[n]
			let a = `path=${encodeURIComponent(e.path)}`
			return (
				typeof s == 'string' && (a += `&${Uc}=${encodeURIComponent(s)}`),
				Je.from({
					scheme: Il ? this._preferredWebSchema : nt.vscodeRemoteResource,
					authority: `${r}:${i}`,
	...
	const jc = new qc(),
		...
		yn = class yn {
			...
			uriToBrowserUri(e) {
				return e.scheme === nt.vscodeRemote
					? jc.rewrite(e)
					: e.scheme === nt.file &&
						  (Cl || Fl === `${nt.vscodeFileResource}://${yn.FALLBACK_AUTHORITY}`)
						? e.with({
								scheme: nt.vscodeFileResource,
								authority: e.authority || yn.FALLBACK_AUTHORITY,
								query: null,
								fragment: null,
							})
						: e
			...
			toUri(e) {
				...
				if (globalThis._VSCODE_FILE_ROOT) {
					...
					if (/^\w[\w\d+.-]*:\/\//.test(n)) return Je.joinPath(Je.parse(n, !0), e)
					const r = Mu(n, e)
					return Je.file(r)
				}
	...
	;(function (t) {
		...
		function r(s) {
			...
			typeof s == 'string'
				...
				: s instanceof URL
					? (a = s.searchParams)
					: Je.isUri(s) && (a = new URL(s.toString(!0)).searchParams)
			const o = a?.get(n)
			if (o) return e.get(o)
		}
	...
	function Gc(t, e) {
		...
		const r = `${t}/${e}`,
			s = `${Wc}/${r}`
		return zc.asBrowserUri(s).toString(!0)
	}
	class Jc {
		constructor(e) {
			this.replacements = e
			...
			for (const r of e) {
				if (!(r.replaceRange.start >= n))
					throw new re(`Edits must be disjoint and sorted. Found ${r} after ${n}`)
		...
		compose(e) {
			...
			const i = [...n.replacements],
				s = []
			let a = 0
			for (const o of r.replacements) {
				for (;;) {
					const f = i[0]
					if (!f || f.replaceRange.start + a + f.getNewLength() >= o.replaceRange.start) break
				...
				for (;;) {
					const f = i[0]
					if (!f || f.replaceRange.start + a > o.replaceRange.endExclusive) break
					;(c || (c = f), (h = f), i.shift(), (a += f.getNewLength() - f.replaceRange.length))
				}
				if (!c) s.push(o.delta(-a))
				else {
					const f = Math.min(c.replaceRange.start, o.replaceRange.start - u),
						m = o.replaceRange.start - (c.replaceRange.start + u)
					if (m > 0) {
						const y = c.slice(B.emptyAt(f), new B(0, m))
						s.push(y)
					}
					if (!h) throw new re('Invariant violation: lastIntersecting is undefined')
					const g = h.replaceRange.endExclusive + a - o.replaceRange.endExclusive
					if (g > 0) {
						const y = h.slice(
							B.ofStartAndLength(h.replaceRange.endExclusive, 0),
							new B(h.getNewLength() - g, h.getNewLength()),
						)
						;(i.unshift(y), (a -= y.getNewLength() - y.replaceRange.length))
					}
					const d = new B(f, o.replaceRange.endExclusive - a),
						p = o.slice(d, new B(0, o.getNewLength()))
					s.push(p)
				}
			}
			for (;;) {
		...
		getNewRanges() {
			...
			let n = 0
			for (const r of this.replacements)
				(e.push(B.ofStartAndLength(r.replaceRange.start + n, r.getNewLength())),
					(n += r.getLengthDelta()))
			return e
		}
		isEmpty() {
		...
		applyToOffsetOrUndefined(e) {
			...
			for (const r of this.replacements)
				if (r.replaceRange.start <= e) {
					if (e < r.replaceRange.endExclusive) return
	...
	class Xc {
		...
		delta(e) {
			return this.slice(this.replaceRange.delta(e), new B(0, this.getNewLength()))
		}
		getLengthDelta() {
		...
		getRangeAfterReplace() {
			return new B(this.replaceRange.start, this.replaceRange.start + this.getNewLength())
		}
	}
	class Qc extends Jc {
		apply(e) {
			...
			for (const i of this.replacements)
				(n.push(e.substring(r, i.replaceRange.start)),
					n.push(i.newText),
					(r = i.replaceRange.endExclusive))
			return (n.push(e.substring(r)), n.join(''))
		}
		removeCommonSuffixPrefix(e) {
			const n = []
			for (const r of this.replacements) {
				const i = r.removeCommonSuffixPrefix(e)
				i.isEmpty || n.push(i)
			}
			return new $n(n)
		}
	...
	class Yc extends Xc {
		...
		removeCommonSuffixPrefix(e) {
			const n = e.substring(this.replaceRange.start, this.replaceRange.endExclusive),
				r = yr(n, this.newText),
				i = Math.min(n.length - r, this.newText.length - r, wr(n, this.newText)),
				s = new B(this.replaceRange.start + r, this.replaceRange.endExclusive - i),
		...
		removeCommonPrefix(e) {
			...
			return r === 0
				? this
				: this.slice(this.replaceRange.deltaStart(r), new B(r, this.newText.length))
		}
		removeCommonSuffix(e) {
			const n = this.replaceRange.substring(e),
				r = wr(n, this.newText)
			return r === 0
				? this
				: this.slice(this.replaceRange.deltaEnd(-r), new B(0, this.newText.length - r))
		}
		toJson() {
			return { txt: this.newText, pos: this.replaceRange.start, len: this.replaceRange.length }
		}
	}
	const bt = class bt extends Qc {
		static replace(e, n) {
			return new bt([new rt(e, n)])
		}
		static compose(e) {
			if (e.length === 0) return bt.empty
			let n = e[0]
			for (let r = 1; r < e.length; r++) n = n.compose(e[r])
			return n
		}
		constructor(e) {
			super(e)
	...
	class rt extends Yc {
		...
		tryJoinTouching(e) {
			return new rt(this.replaceRange.joinRightTouching(e.replaceRange), this.newText + e.newText)
		}
		slice(e, n) {
			return new rt(e, n ? n.substring(this.newText) : this.newText)
		}
	}
	dc({ StringEdit: $n, StringReplacement: rt, TextReplacement: Pe, TextEdit: pc, TextLength: tt })
	let Hr, zr, Gr
	function Oa() {
		return (Hr || (Hr = import(`${Gc('@vscode/diff', 'dist/index.js')}`)), Hr)
	}
	function Zc(t) {
		return t
			? (Gr || (Gr = Oa().then((e) => e.createDiffComputer({ useWasm: !0 }))), Gr)
			: (zr || (zr = Oa().then((e) => e.createDiffComputer({ useWasm: !1 }))), zr)
	}
	async function $a(t) {
		const e = await Zc(t)
		return new Kc(e)
...
`),
				...
				a = this._computer.computeDiff(i.value, s.value, {
				...
				c = []
			let h = 0
			for (const g of a.edits.replacements) {
				const d = g.range.start + h,
					p = d + g.newText.length,
					y = o.getRange(new B(g.range.start, g.range.endExclusive)),
					w = u.getRange(new B(d, p))
				;(c.push(new Ne(y, w)), (h += g.newText.length - (g.range.endExclusive - g.range.start)))
			}
			const f = $r(c, i, s),
				m = []
			if (r.computeMoves)
				for (const g of a.moves) {
					const d = o.getPosition(g.range.original.start),
						p = o.getPosition(g.range.original.endExclusive),
						y = u.getPosition(g.range.modified.start),
						w = u.getPosition(g.range.modified.endExclusive),
						x = new z(d.lineNumber, p.lineNumber),
						b = new z(y.lineNumber, w.lineNumber)
					m.push(new ba(new Le(x, b), []))
				}
			return new nn(f, m, a.hitTimeout)
		}
	}
	const Bn = {
		getLegacy: () => new wc(),
		getDefault: () => new $c(),
		getAdvancedExternal: () => $a(!1),
		getAdvancedWasm: () => $a(!0),
	}
	function it(t, e) {
	...
	class A {
		constructor(e, n, r, i = 1) {
			;((this._rgbaBrand = void 0),
				...
				(this.a = it(Math.max(Math.min(1, i), 0), 3)))
		}
		static equals(e, n) {
	...
	class Re {
		constructor(e, n, r, i) {
			;((this._hslaBrand = void 0),
				...
				(this.s = it(Math.max(Math.min(1, n), 0), 3)),
				(this.l = it(Math.max(Math.min(1, r), 0), 3)),
				(this.a = it(Math.max(Math.min(1, i), 0), 3)))
		}
		static equals(e, n) {
		...
		static toRGBA(e) {
			...
			if (r === 0) a = o = u = i
				...
				const c = i < 0.5 ? i * (1 + r) : i + r - i * r,
					h = 2 * i - c
				;((a = Re._hue2rgb(h, c, n + 1 / 3)),
					(o = Re._hue2rgb(h, c, n)),
					(u = Re._hue2rgb(h, c, n - 1 / 3)))
			}
	...
	class It {
		constructor(e, n, r, i) {
			;((this._hsvaBrand = void 0),
				(this.h = Math.max(Math.min(360, e), 0) | 0),
				(this.s = it(Math.max(Math.min(1, n), 0), 3)),
				(this.v = it(Math.max(Math.min(1, r), 0), 3)),
				(this.a = it(Math.max(Math.min(1, i), 0), 3)))
		}
		static equals(e, n) {
				...
				o === 0
					...
					: s === n
						...
						: s === r
							? (c = (i - n) / o + 2)
							: (c = (n - r) / o + 4),
				new It(Math.round(c * 60), u, s, e.a)
			)
		}
		static toRGBA(e) {
	...
	let Un =
		((Q = class {
			...
			constructor(e) {
				if (e)
					...
					else if (e instanceof Re) ((this._hsla = e), (this.rgba = Re.toRGBA(e)))
					else if (e instanceof It) ((this._hsva = e), (this.rgba = It.toRGBA(e)))
			...
			equals(e) {
				return (
					...
					Re.equals(this.hsla, e.hsla) &&
					It.equals(this.hsva, e.hsva)
				)
			}
			...
			lighten(e) {
				return new Q(new Re(this.hsla.h, this.hsla.s, this.hsla.l + this.hsla.l * e, this.hsla.a))
			}
			darken(e) {
				return new Q(new Re(this.hsla.h, this.hsla.s, this.hsla.l - this.hsla.l * e, this.hsla.a))
			}
			...
			opposite() {
				return new Q(new A(255 - this.rgba.r, 255 - this.rgba.g, 255 - this.rgba.b, this.rgba.a))
			}
			mix(e, n = 0.5) {
		...
		(Q.white = new Q(new A(255, 255, 255, 1))),
		(Q.black = new Q(new A(0, 0, 0, 1))),
		(Q.red = new Q(new A(255, 0, 0, 1))),
		(Q.blue = new Q(new A(0, 0, 255, 1))),
		(Q.green = new Q(new A(0, 255, 0, 1))),
		(Q.cyan = new Q(new A(0, 255, 255, 1))),
		(Q.lightgrey = new Q(new A(211, 211, 211, 1))),
		(Q.transparent = new Q(new A(0, 0, 0, 0))),
		Q)
	;(function (t) {
		;(function (e) {
			;(function (n) {
				...
				function f(p) {
					...
					if (p.startsWith('rgba(')) {
						...
						const w = parseInt(y.groups?.r ?? '0'),
							x = parseInt(y.groups?.g ?? '0'),
							b = parseInt(y.groups?.b ?? '0'),
							N = parseFloat(y.groups?.a ?? '0')
						return new t(new A(w, x, b, N))
					}
					if (p.startsWith('rgb(')) {
				...
				function g(p) {
					...
					if (y === 7) {
						const w = 16 * d(p.charCodeAt(1)) + d(p.charCodeAt(2)),
							x = 16 * d(p.charCodeAt(3)) + d(p.charCodeAt(4)),
							b = 16 * d(p.charCodeAt(5)) + d(p.charCodeAt(6))
						return new t(new A(w, x, b, 1))
					}
					if (y === 9) {
						const w = 16 * d(p.charCodeAt(1)) + d(p.charCodeAt(2)),
							x = 16 * d(p.charCodeAt(3)) + d(p.charCodeAt(4)),
							b = 16 * d(p.charCodeAt(5)) + d(p.charCodeAt(6)),
							N = 16 * d(p.charCodeAt(7)) + d(p.charCodeAt(8))
						return new t(new A(w, x, b, N / 255))
					}
					if (y === 4) {
						const w = d(p.charCodeAt(1)),
							x = d(p.charCodeAt(2)),
							b = d(p.charCodeAt(3))
						return new t(new A(16 * w + w, 16 * x + x, 16 * b + b))
					}
					if (y === 5) {
						const w = d(p.charCodeAt(1)),
							x = d(p.charCodeAt(2)),
							b = d(p.charCodeAt(3)),
							N = d(p.charCodeAt(4))
						return new t(new A(16 * w + w, 16 * x + x, 16 * b + b, (16 * N + N) / 255))
					}
					return null
				}
				n.parseHex = g
	...
	function e1(t, e) {
		if (!t) return
		const n = Un.Format.CSS.parseHex(e)
		if (n) return { range: t, color: Jr(n.rgba.r, n.rgba.g, n.rgba.b, n.rgba.a) }
	}
	function Ua(t, e, n) {
		if (!t || e.length !== 1) return
		const i = e[0].values(),
			s = Ba(i)
		return { range: t, color: Jr(s[0], s[1], s[2], n ? s[3] : 1) }
	}
	function qa(t, e, n) {
		if (!t || e.length !== 1) return
		const i = e[0].values(),
			s = Ba(i),
			a = new Un(new Re(s[0], s[1] / 100, s[2] / 100, n ? s[3] : 1))
		return { range: t, color: Jr(a.rgba.r, a.rgba.g, a.rgba.b, a.rgba.a) }
	}
	function ln(t, e) {
		...
		if (r.length > 0)
			for (const i of r) {
				...
				if (a === 'rgb') {
					...
					u = qa(on(t, i), ln(o, c), !0)
				} else a === '#' && (u = e1(on(t, i), a + o))
				u && e.push(u)
			}
		return e
	}
	function n1(t) {
		return !t || typeof t.getValue != 'function' || typeof t.positionAt != 'function' ? [] : t1(t)
	}
	const r1 = /^-+|-+$/g,
		ja = 100,
		i1 = 5
		...
		for (let i = 1; i <= r; i++) {
			...
			if (a) {
				...
				if (o.endColumn > o.startColumn) {
					const u = { range: o, ...l1(s.substring(a[0].length)), shouldBeInComments: !1 }
	...
	function o1(t, e) {
		...
		const i = Qu(e.markSectionHeaderRegex),
			s = new RegExp(e.markSectionHeaderRegex, `gdm${i ? 's' : ''}`)
		if (Jl(s)) return n
		for (let a = 1; a <= r; a += ja - i1) {
			const o = Math.min(a + ja - 1, r),
				u = []
...
`) + 1,
					x = h.index - w + 1,
					b = d[d.length - 1],
					N = p === 1 ? x + h[0].length : b.length + 1,
					L = { startLineNumber: g, startColumn: x, endLineNumber: y, endColumn: N },
					R = (h.groups ?? {}).label ?? '',
					v = ((h.groups ?? {}).separator ?? '') !== '',
					S = { range: L, text: R, hasSeparatorLine: v, shouldBeInComments: !0 }
	...
	function l1(t) {
		...
		return ((t = t.replace(r1, '')), { text: t, hasSeparatorLine: e })
	}
	class Wa {
		get isRejected() {
	...
	class u1 {
		...
		_ensureNoFinalValue() {
			if (this._finalValue)
				throw new re('ProducerConsumer: cannot produce after final value has been set')
		}
		...
		static tee(e) {
			...
			const i = new Wa(),
				s = async () => {
					if (!(!n || !r))
						try {
							for await (const u of e) (n.emitOne(u), r.emitOne(u))
						} catch (u) {
				...
				a = new ge(async (u) => ((n = u), s(), i.p)),
				o = new ge(async (u) => ((r = u), s(), i.p))
			return [a, o]
		}
		map(e) {
			return ge.map(this, e)
		}
		static coalesce(e) {
			return ge.filter(e, (n) => !!n)
		}
		coalesce() {
			return ge.coalesce(this)
		}
		static filter(e, n) {
			return new ge(async (r) => {
		...
		onEvents(e) {
			...
			for (const r of n)
				(this._acceptDeleteRange(r.range),
					this._acceptInsertText(new J(r.range.startLineNumber, r.range.startColumn), r.text))
	...
	class m1 {
		...
		$acceptNewModel(e) {
			this._models[e.url] = new d1(Je.parse(e.url), e.lines, e.EOL, e.versionId)
		}
	...
	class d1 extends h1 {
		...
		getWordAtPosition(e, n) {
			const r = Vr(e.column, ma(n), this._lines[e.lineNumber - 1], 0)
			return r ? new j(e.lineNumber, r.startColumn, e.lineNumber, r.endColumn) : null
		}
		words(e) {
			const n = this._lines,
	...
	const yt = class yt {
		constructor(e = null) {
			;((this._foreignModule = e),
				...
				(this._workerTextModelSyncServer = new m1()))
		}
		dispose() {}
		async $ping() {
			return 'pong'
		...
		async $computeUnicodeHighlights(e, n, r) {
			...
			return i
				? ic.computeUnicodeHighlights(i, n, r)
				: {
						ranges: [],
						hasMore: !1,
		...
		async $computeMoreMinimalEdits(e, n, r) {
			...
			n = n.slice(0).sort((u, c) => {
				if (u.range && c.range) return j.compareRangesUsingStarts(u.range, c.range)
				const h = u.range ? 0 : 1,
					f = c.range ? 0 : 1
				return h - f
			})
			...
			for (let u = 1; u < n.length; u++)
				j.getEndPosition(n[o].range).equals(j.getStartPosition(n[u].range))
					? ((n[o].range = j.fromPositions(
							j.getStartPosition(n[o].range),
							j.getEndPosition(n[u].range),
						)),
						(n[o].text += n[u].text))
					: (o++, (n[o] = n[u]))
			n.length = o + 1
			for (let { range: u, text: c, eol: h } of n) {
				if ((typeof h == 'number' && (a = h), j.isEmpty(u) && !c)) continue
				const f = i.getValueInRange(u)
				if (((c = c.replace(/\r\n|\n|\r/g, i.eol)), f === c)) continue
				if (Math.max(c.length, f.length) > yt._diffLimit) {
					s.push({ range: u, text: c })
					continue
				}
				const m = hu(f, c, r),
					g = i.offsetAt(j.lift(u).getStartPosition())
				for (const d of m) {
			...
			e: for (const u of e) {
				...
				if (c) {
					for (const h of c.words(a))
						if (!(h === n || !isNaN(Number(h))) && (o.add(h), o.size > yt._suggestionsLimit))
							break e
				}
			}
		...
		async $navigateValueSet(e, n, r, i, s) {
			...
			const u = a.getValueInRange(n),
				c = a.getWordAtPosition({ lineNumber: n.startLineNumber, column: n.startColumn }, o)
			if (!c) return null
			const h = a.getValueInRange(c)
			return _r.INSTANCE.navigateValueSet(n, u, c, h, r)
		}
		$fmr(e, n) {
	...
	function g1(t) {
		switch (t) {
			...
			case 'advanced-external':
				return Bn.getAdvancedExternal()
			case 'advanced-wasm':
				return Bn.getAdvancedWasm()
		}
	}
	const wn = class wn {
		static getChannel(e) {
			return e.getChannel(wn.CHANNEL_NAME)
		}
		static setChannel(e, n) {
			e.setChannel(wn.CHANNEL_NAME, n)
		}
	}
	wn.CHANNEL_NAME = 'editorWorkerHost'
	let Qr = wn
	function p1(t) {
		let e
		const n = cu((r) => {
			const i = Qr.getChannel(r),
				a = {
					host: new Proxy(
						{},
						{
	...
	function Yr(t, e = !1) {
		...
		function m(b, N) {
			...
			for (; L < b; ) {
				...
				if (v >= 48 && v <= 57) R = R * 16 + v - 48
				else if (v >= 65 && v <= 70) R = R * 16 + v - 65 + 10
				else if (v >= 97 && v <= 102) R = R * 16 + v - 97 + 10
				else break
				;(r++, L++)
			}
			return (L < b && (R = -1), R)
		...
		function d() {
			...
			else for (r++; r < t.length && Ft(t.charCodeAt(r)); ) r++
			if (r < t.length && t.charCodeAt(r) === 46)
				if ((r++, r < t.length && Ft(t.charCodeAt(r))))
					for (r++; r < t.length && Ft(t.charCodeAt(r)); ) r++
			...
			if (r < t.length && (t.charCodeAt(r) === 69 || t.charCodeAt(r) === 101))
				if (
					...
					r < t.length && Ft(t.charCodeAt(r)))
				) {
					for (r++; r < t.length && Ft(t.charCodeAt(r)); ) r++
					N = r
				} else f = 3
			return t.substring(b, N)
		}
		function p() {
			let b = '',
				N = r
...
`
		...
		function y() {
			if (((i = ''), (f = 0), (s = r), (u = o), (h = c), r >= n)) return ((s = n), (a = 17))
...
`)),
			...
			switch (b) {
				...
				case 47:
					...
					if (t.charCodeAt(r + 1) === 47) {
						for (r += 2; r < n && !un(t.charCodeAt(r)); ) r++
						return ((i = t.substring(N, r)), (a = 12))
					}
					if (t.charCodeAt(r + 1) === 42) {
						...
						for (; r < L; ) {
							...
							;(r++, un(v) && (v === 13 && t.charCodeAt(r) === 10 && r++, o++, (c = r)))
						}
						return (R || (r++, (f = 1)), (i = t.substring(N, r)), (a = 13))
					}
					return ((i += String.fromCharCode(b)), r++, (a = 16))
				case 45:
					if (((i += String.fromCharCode(b)), r++, r === n || !Ft(t.charCodeAt(r)))) return (a = 16)
				case 48:
				case 49:
				case 50:
				case 51:
	...
	const Ee = new Array(20).fill(0).map((t, e) => ' '.repeat(e)),
		Vt = 200,
		Ja = {
			' ': {
				'\n': new Array(Vt).fill(0).map(
					(t, e) =>
						`
` + ' '.repeat(e),
				),
				'\r': new Array(Vt).fill(0).map((t, e) => '\r' + ' '.repeat(e)),
				'\r\n': new Array(Vt).fill(0).map(
					(t, e) =>
						`\r
` + ' '.repeat(e),
...
`,
	...
	function w1(t, e, n) {
		let r, i, s, a, o
		if (e) {
			for (a = e.offset, o = a + e.length, s = a; s > 0 && !Xa(t, s - 1); ) s--
			let L = o
			for (; L < t.length && !Xa(t, L); ) L++
			;((i = t.substring(s, L)), (r = x1(i, n)))
		...
		let h = 0,
			f = 0,
			m
		n.insertSpaces ? (m = Ee[n.tabSize || 4] ?? Dt(Ee[1], n.tabSize || 4)) : (m = '	')
		const g = m === '	' ? '	' : ' '
		let d = Yr(i, !1),
			p = !1
		function y() {
			if (h > 1) return Dt(u, h) + Dt(m, r + f)
			const L = m.length * (r + f)
			return !c || L > Ja[g][u].length ? u + Dt(m, r + f) : L <= 0 ? u : Ja[g][u][L]
		}
		function w() {
			let L = d.scan()
			for (h = 0; L === 15 || L === 14; )
		...
		function b(L, R, v) {
			!p &&
				(!e || (R < o && v > a)) &&
				t.substring(R, v) !== L &&
				x.push({ offset: R, length: v - R, content: L })
		}
		let N = w()
		if ((n.keepLines && h > 0 && b(Dt(u, h), 0, 0), N !== 17)) {
			let L = d.getTokenOffset() + s,
				R = m.length * r < 20 && n.insertSpaces ? Ee[m.length * r] : Dt(m, r)
			b(R, s, L)
		}
		for (; N !== 17; ) {
			...
			if (R === 2)
				(N !== 1 && f--,
					(n.keepLines && h > 0) || (!n.keepLines && N !== 1)
						? (v = y())
						: n.keepLines && (v = Ee[1]))
			else if (R === 4)
				(N !== 3 && f--,
					(n.keepLines && h > 0) || (!n.keepLines && N !== 3)
						? (v = y())
						: n.keepLines && (v = Ee[1]))
			else {
				switch (N) {
					case 3:
					case 1:
						;(f++, (n.keepLines && h > 0) || !n.keepLines ? (v = y()) : (v = Ee[1]))
						break
					case 5:
						;(n.keepLines && h > 0) || !n.keepLines ? (v = y()) : (v = Ee[1])
						break
					case 12:
						v = y()
						break
					case 13:
						...
						break
					case 6:
						n.keepLines && h > 0 ? (v = y()) : S || (v = Ee[1])
						break
					case 10:
						n.keepLines && h > 0 ? (v = y()) : R === 6 && !S && (v = '')
						break
					case 7:
					case 8:
					case 9:
			...
			R === 17 && (n.keepLines && h > 0 ? (v = y()) : (v = n.insertFinalNewline ? u : ''))
...
`.indexOf(t.charAt(e)) !== -1
		...
		return (
			_1(
				t,
				{
					...
					onLiteralValue: a,
					onError: (u, c, h) => {
						e.push({ error: u, offset: c, length: h })
					},
				},
				n,
			),
	...
	function Kr(t) {
		switch (t.type) {
			case 'array':
				return t.children.map(Kr)
			case 'object':
				const e = Object.create(null)
				for (let n of t.children) {
					const r = n.children[1]
					r && (e[n.children[0].value] = Kr(r))
				}
				return e
			case 'null':
			case 'string':
	...
	function _1(t, e, n = qn.DEFAULT) {
		...
		function L(_, E = [], T = []) {
			if ((w(_), E.length + T.length > 0)) {
				let F = r.getToken()
				for (; F !== 17; ) {
					if (E.indexOf(F) !== -1) {
						N()
						break
					} else if (T.indexOf(F) !== -1) break
					F = N()
				}
			}
		}
		function R(_) {
			...
			return (_ ? d(E) : (h(E), i.push(E)), N(), !0)
		}
		function v() {
			switch (r.getToken()) {
				case 11:
					const _ = r.getTokenValue()
					let E = Number(_)
					;(isNaN(E) && (L(2), (E = 0)), d(E))
					break
				case 7:
		...
		function S() {
			return r.getToken() !== 10
				? (L(3, [], [2, 5]), !1)
				: (R(!1),
					r.getToken() === 6 ? (p(':'), N(), P() || L(4, [], [2, 5])) : L(5, [], [2, 5]),
					i.pop(),
					!0)
		}
		function C() {
			...
			for (; r.getToken() !== 2 && r.getToken() !== 17; ) {
				if (r.getToken() === 5) {
					if ((_ || L(4, [], []), p(','), N(), r.getToken() === 2 && b)) break
				} else _ && L(6, [], [])
				;(S() || L(4, [], [2, 5]), (_ = !0))
			}
			return (f(), r.getToken() !== 2 ? L(7, [2], []) : N(), !0)
		}
		function D() {
			;(m(), N())
			let _ = !0,
			...
			for (; r.getToken() !== 4 && r.getToken() !== 17; ) {
				if (r.getToken() === 5) {
					if ((E || L(4, [], []), p(','), N(), r.getToken() === 4 && b)) break
				} else E && L(6, [], [])
				;(_ ? (i.push(0), (_ = !1)) : i[i.length - 1]++, P() || L(4, [], [4, 5]), (E = !0))
			}
			return (g(), _ || i.pop(), r.getToken() !== 4 ? L(8, [4], []) : N(), !0)
		}
		function P() {
			switch (r.getToken()) {
				case 3:
	...
	function Ot(t, e) {
		...
		if (Array.isArray(t)) {
			...
			for (n = 0; n < t.length; n++) if (!Ot(t[n], e[n])) return !1
		} else {
			const i = []
			for (r in t) i.push(r)
			i.sort()
			const s = []
			for (r in e) s.push(r)
			if ((s.sort(), !Ot(i, s))) return !1
			for (n = 0; n < i.length; n++) if (!Ot(t[i[n]], e[i[n]])) return !1
		}
		return !0
	}
	function me(t) {
	...
	;(function (t) {
		function e(r, i) {
			return (
				r === Number.MAX_VALUE && (r = Wn.MAX_VALUE),
				i === Number.MAX_VALUE && (i = Wn.MAX_VALUE),
				{ line: r, character: i }
			)
		}
		t.create = e
	...
	;(function (t) {
		function e(r, i, s, a) {
			if (k.uinteger(r) && k.uinteger(i) && k.uinteger(s) && k.uinteger(a))
		...
		function n(r) {
			let i = r
			return k.objectLiteral(i) && te.is(i.start) && te.is(i.end)
		}
		t.is = n
	})(H || (H = {}))
	var $t
	;(function (t) {
		...
		function n(r) {
			let i = r
			return k.objectLiteral(i) && H.is(i.range) && (k.string(i.uri) || k.undefined(i.uri))
		}
		t.is = n
	})($t || ($t = {}))
	var so
	;(function (t) {
		...
		function n(r) {
			...
			return (
				k.objectLiteral(i) &&
				H.is(i.targetRange) &&
				k.string(i.targetUri) &&
				H.is(i.targetSelectionRange) &&
				(H.is(i.originSelectionRange) || k.undefined(i.originSelectionRange))
			)
		}
		t.is = n
	})(so || (so = {}))
	...
	;(function (t) {
		...
		function n(r) {
			...
			return (
				k.objectLiteral(i) &&
				k.numberRange(i.red, 0, 1) &&
				k.numberRange(i.green, 0, 1) &&
				k.numberRange(i.blue, 0, 1) &&
				k.numberRange(i.alpha, 0, 1)
			)
		}
		t.is = n
	})(ti || (ti = {}))
	...
	;(function (t) {
		...
		function n(r) {
			const i = r
			return k.objectLiteral(i) && H.is(i.range) && ti.is(i.color)
		}
		t.is = n
	})(ao || (ao = {}))
	var oo
	;(function (t) {
		...
		function n(r) {
			...
			return (
				k.objectLiteral(i) &&
				k.string(i.label) &&
				(k.undefined(i.textEdit) || Be.is(i)) &&
				(k.undefined(i.additionalTextEdits) || k.typedArray(i.additionalTextEdits, Be.is))
			)
		}
		t.is = n
	})(oo || (oo = {}))
	...
	;(function (t) {
		function e(r, i, s, a, o, u) {
			const c = { startLine: r, endLine: i }
			return (
				k.defined(s) && (c.startCharacter = s),
				k.defined(a) && (c.endCharacter = a),
				k.defined(o) && (c.kind = o),
				k.defined(u) && (c.collapsedText = u),
				c
			)
		}
		t.create = e
		function n(r) {
			...
			return (
				k.objectLiteral(i) &&
				k.uinteger(i.startLine) &&
				k.uinteger(i.startLine) &&
				(k.undefined(i.startCharacter) || k.uinteger(i.startCharacter)) &&
				(k.undefined(i.endCharacter) || k.uinteger(i.endCharacter)) &&
				(k.undefined(i.kind) || k.string(i.kind))
			)
		}
		t.is = n
	})(lo || (lo = {}))
	...
	;(function (t) {
		...
		function n(r) {
			let i = r
			return k.defined(i) && $t.is(i.location) && k.string(i.message)
		}
		t.is = n
	})(ni || (ni = {}))
	var _e
	...
	;(function (t) {
		function e(r, i, s, a, o, u) {
			...
			return (
				k.defined(s) && (c.severity = s),
				k.defined(a) && (c.code = a),
				k.defined(o) && (c.source = o),
				k.defined(u) && (c.relatedInformation = u),
				c
			)
		}
		t.create = e
		function n(r) {
			...
			return (
				...
				H.is(s.range) &&
				k.string(s.message) &&
				(k.number(s.severity) || k.undefined(s.severity)) &&
				(k.integer(s.code) || k.string(s.code) || k.undefined(s.code)) &&
				(k.undefined(s.codeDescription) ||
					k.string((i = s.codeDescription) === null || i === void 0 ? void 0 : i.href)) &&
				(k.string(s.source) || k.undefined(s.source)) &&
				(k.undefined(s.relatedInformation) || k.typedArray(s.relatedInformation, ni.is))
			)
		}
		t.is = n
	})(Ze || (Ze = {}))
	...
	;(function (t) {
		function e(r, i, ...s) {
			...
			return (k.defined(s) && s.length > 0 && (a.arguments = s), a)
		}
		t.create = e
		function n(r) {
			let i = r
	...
	;(function (t) {
		...
		function i(s) {
			const a = s
			return k.objectLiteral(a) && k.string(a.newText) && H.is(a.range)
		}
		t.is = i
	})(Be || (Be = {}))
	var ri
	;(function (t) {
		...
		function n(r) {
			...
			return (
				k.objectLiteral(i) &&
				k.string(i.label) &&
				(k.boolean(i.needsConfirmation) || i.needsConfirmation === void 0) &&
				(k.string(i.description) || i.description === void 0)
			)
		}
		t.is = n
	})(ri || (ri = {}))
	...
	;(function (t) {
		...
		function i(s) {
			const a = s
			return Be.is(a) && (ri.is(a.annotationId) || Ut.is(a.annotationId))
		}
		t.is = i
	})(fo || (fo = {}))
	var ii
	;(function (t) {
		...
		function n(r) {
			let i = r
			return k.defined(i) && ui.is(i.textDocument) && Array.isArray(i.edits)
		}
		t.is = n
	})(ii || (ii = {}))
	var si
	;(function (t) {
		...
		function n(r) {
			...
			return (
				...
				k.string(i.uri) &&
				(i.options === void 0 ||
					((i.options.overwrite === void 0 || k.boolean(i.options.overwrite)) &&
						(i.options.ignoreIfExists === void 0 || k.boolean(i.options.ignoreIfExists)))) &&
				(i.annotationId === void 0 || Ut.is(i.annotationId))
			)
		}
		t.is = n
	})(si || (si = {}))
	...
	;(function (t) {
		...
		function n(r) {
			...
			return (
				...
				k.string(i.uri) &&
				(i.options === void 0 ||
					((i.options.recursive === void 0 || k.boolean(i.options.recursive)) &&
						(i.options.ignoreIfNotExists === void 0 || k.boolean(i.options.ignoreIfNotExists)))) &&
				(i.annotationId === void 0 || Ut.is(i.annotationId))
			)
		}
		t.is = n
			...
			return (
				...
				(r.documentChanges === void 0 ||
					r.documentChanges.every((i) =>
						k.string(i.kind) ? si.is(i) || ai.is(i) || oi.is(i) : ii.is(i),
					))
			)
		}
		t.is = e
	...
	;(function (t) {
		function e(n) {
			const r = n
			return k.objectLiteral(n) && mt.is(r.kind) && k.string(r.value)
		}
		t.is = e
	})(hn || (hn = {}))
	var Se
	...
	;(function (t) {
		function e(n) {
			...
			return (
				r &&
				(k.string(r.detail) || r.detail === void 0) &&
				(k.string(r.description) || r.description === void 0)
			)
		}
		t.is = e
	})(wo || (wo = {}))
	...
	;(function (t) {
		function e(n) {
			...
			return (
				!!r &&
				k.objectLiteral(r) &&
				(hn.is(r.contents) || Hn.is(r.contents) || k.typedArray(r.contents, Hn.is)) &&
				(n.range === void 0 || H.is(n.range))
			)
		}
		t.is = e
	})(vo || (vo = {}))
	...
	;(function (t) {
		function e(n, r, ...i) {
			let s = { label: n }
			return (
				k.defined(r) && (s.documentation = r),
				k.defined(i) ? (s.parameters = i) : (s.parameters = []),
				s
			)
		}
		t.create = e
	...
	;(function (t) {
		function e(r, i, s, a, o, u) {
			let c = { name: r, detail: i, kind: s, range: a, selectionRange: o }
		...
		function n(r) {
			...
			return (
				...
				k.number(i.kind) &&
				H.is(i.range) &&
				H.is(i.selectionRange) &&
				(i.detail === void 0 || k.string(i.detail)) &&
				(i.deprecated === void 0 || k.boolean(i.deprecated)) &&
	...
	;(function (t) {
		...
		function n(r) {
			...
			return (
				k.defined(i) &&
				k.typedArray(i.diagnostics, Ze.is) &&
				(i.only === void 0 || k.typedArray(i.only, k.string)) &&
				(i.triggerKind === void 0 || i.triggerKind === zn.Invoked || i.triggerKind === zn.Automatic)
			)
		}
		t.is = n
	})(Mo || (Mo = {}))
	...
	;(function (t) {
		function e(r, i, s) {
			let a = { title: r },
				o = !0
			return (
				typeof i == 'string' ? ((o = !1), (a.kind = i)) : Bt.is(i) ? (a.command = i) : (a.edit = i),
				o && s !== void 0 && (a.kind = s),
				a
			)
		}
		...
		function n(r) {
			...
			return (
				i &&
				k.string(i.title) &&
				(i.diagnostics === void 0 || k.typedArray(i.diagnostics, Ze.is)) &&
				(i.kind === void 0 || k.string(i.kind)) &&
				(i.edit !== void 0 || i.command !== void 0) &&
				(i.command === void 0 || Bt.is(i.command)) &&
				(i.isPreferred === void 0 || k.boolean(i.isPreferred)) &&
				(i.edit === void 0 || li.is(i.edit))
			)
		}
		t.is = n
	})(Po || (Po = {}))
	...
	;(function (t) {
		...
		function n(r) {
			let i = r
			return k.defined(i) && H.is(i.range) && (k.undefined(i.command) || Bt.is(i.command))
		}
		t.is = n
	})(Co || (Co = {}))
	var Io
	...
	;(function (t) {
		...
		function n(r) {
			let i = r
			return k.objectLiteral(i) && H.is(i.range) && (i.parent === void 0 || t.is(i.parent))
		}
		t.is = n
	})(Gn || (Gn = {}))
	var Vo
	...
	;(function (t) {
		...
		function n(r) {
			const i = r
			return i != null && H.is(i.range) && k.string(i.text)
		}
		t.is = n
	})($o || ($o = {}))
	var Bo
	;(function (t) {
		...
		function n(r) {
			...
			return (
				i != null &&
				H.is(i.range) &&
				k.boolean(i.caseSensitiveLookup) &&
				(k.string(i.variableName) || i.variableName === void 0)
			)
		}
		t.is = n
	})(Bo || (Bo = {}))
	...
	;(function (t) {
		...
		function n(r) {
			const i = r
			return i != null && H.is(i.range) && (k.string(i.expression) || i.expression === void 0)
		}
		t.is = n
	})(Uo || (Uo = {}))
	var qo
	;(function (t) {
		...
		function n(r) {
			const i = r
			return k.defined(i) && H.is(r.stoppedLocation)
		}
		t.is = n
	})(qo || (qo = {}))
	var fi
	...
	;(function (t) {
		...
		function n(r) {
			...
			return (
				k.objectLiteral(i) &&
				(i.tooltip === void 0 || k.string(i.tooltip) || hn.is(i.tooltip)) &&
				(i.location === void 0 || $t.is(i.location)) &&
				(i.command === void 0 || Bt.is(i.command))
			)
		}
		t.is = n
	...
	;(function (t) {
		...
		function n(r) {
			...
			return (
				(k.objectLiteral(i) &&
					te.is(i.position) &&
					(k.string(i.label) || k.typedArray(i.label, hi.is)) &&
					(i.kind === void 0 || fi.is(i.kind)) &&
					i.textEdits === void 0) ||
				(k.typedArray(i.textEdits, Be.is) &&
					(i.tooltip === void 0 || k.string(i.tooltip) || hn.is(i.tooltip)) &&
					(i.paddingLeft === void 0 || k.boolean(i.paddingLeft)) &&
					(i.paddingRight === void 0 || k.boolean(i.paddingRight)))
			)
		}
		t.is = n
	})(jo || (jo = {}))
	...
	;(function (t) {
		function e(n) {
			const r = n
			return k.objectLiteral(r) && ei.is(r.uri) && k.string(r.name)
		}
		t.is = e
	})(Qo || (Qo = {}))
	var Yo
	;(function (t) {
		...
		function n(s) {
			...
			return !!(
				k.defined(a) &&
				k.string(a.uri) &&
				(k.undefined(a.languageId) || k.string(a.languageId)) &&
				k.uinteger(a.lineCount) &&
				k.func(a.getText) &&
				k.func(a.positionAt) &&
				k.func(a.offsetAt)
			)
		...
		function r(s, a) {
			...
			for (let h = u.length - 1; h >= 0; h--) {
				...
				if (g <= c) o = o.substring(0, m) + f.newText + o.substring(g, o.length)
...
` &&
		...
		update(e, n) {
			for (let r of e)
				if (mn.isIncremental(r)) {
					...
					if (u - o === h.length) for (let m = 0, g = h.length; m < g; m++) c[m + o + 1] = h[m]
					else
						h.length < 1e4
							? c.splice(o + 1, u - o, ...h)
							: (this._lineOffsets = c = c.slice(0, o + 1).concat(h, c.slice(u + 1)))
					const f = r.text.length - (a - s)
					if (f !== 0) for (let m = o + 1 + h.length, g = c.length; m < g; m++) c[m] = c[m] + f
				} else if (mn.isFull(r)) ((this._content = r.text), (this._lineOffsets = void 0))
				else throw new Error('Unknown change event received')
			this._version = n
		}
		getLineOffsets() {
			return (
				this._lineOffsets === void 0 && (this._lineOffsets = Zo(this._content, !0)),
				this._lineOffsets
			)
		}
		positionAt(e) {
	...
	;(function (t) {
		function e(i, s, a, o) {
			return new mn(i, s, a, o)
		}
		t.create = e
		function n(i, s, a) {
			if (i instanceof mn) return (i.update(s, a), i)
		...
		function r(i, s) {
			...
			for (const h of o) {
				...
				;(f > u && c.push(a.substring(u, f)),
					h.newText.length && c.push(h.newText),
	...
	;(function (t) {
		t.LATEST = {
			textDocument: {
				completion: {
					completionItem: {
						documentationFormat: [mt.Markdown, mt.PlainText],
	...
	var C1 = /{([^}]+)}/g
	function I1(t, e) {
		return Object.keys(e).length === 0 ? t : t.replace(C1, (n, r) => e[r] ?? n)
	}
	const F1 = {
		'color-hex': {
	...
	class pi {
		...
		include(e) {
			return (this.focusOffset === -1 || rl(e, this.focusOffset)) && e !== this.exclude
		}
		newSub() {
			return new pi(-1, this.exclude)
		}
	}
	class dn {
		constructor() {}
	...
	class il {
		...
		getNodeFromOffset(e, n = !1) {
			if (this.root) return A1(this.root, e, n)
		}
		visit(e) {
			if (this.root) {
				const n = (r) => {
		...
		validate(e, n, r = _e.Warning, i) {
			if (this.root && n) {
				const s = new de()
				return (
					ue(this.root, n, s, dn.instance, new nl(i ?? sl(n))),
					s.problems.map((a) => {
						const o = H.create(
							e.positionAt(a.location.offset),
							e.positionAt(a.location.offset + a.location.length),
						)
						return Ze.create(o, a.message, a.severity ?? r, a.code)
					})
				)
			}
		}
		getMatchingSchemas(e, n = -1, r) {
			if (this.root && e) {
				const i = new pi(n, r),
					s = sl(e),
					a = new nl(s)
				return (ue(this.root, e, new de(), i, a), i.schemas)
			}
			return []
		}
	}
	function sl(t, e = Fe.v2020_12) {
		let n = t.$schema
		return n ? (U1[n] ?? e) : e
	}
	function ue(t, e, n, r, i) {
		if (!t || !r.include(t)) return
		if (t.type === 'property') return ue(t.valueNode, e, n, r, i)
		const s = t
		switch ((a(), s.type)) {
			case 'object':
				h(s)
		...
		function a() {
			function f(x) {
				return s.type === x || (x === 'integer' && s.type === 'number' && s.isInteger)
			}
			if (
				...
				for (const x of e.allOf) {
					const b = new de(),
						N = r.newSub()
					;(ue(s, Ae(x), b, N, i), n.merge(b), r.merge(N))
				}
			const m = Ae(e.not)
			if (m) {
				const x = new de(),
			...
			const g = (x, b) => {
				...
				for (const R of x) {
					const v = Ae(R),
						S = new de(),
						C = r.newSub()
					if ((ue(s, v, S, C, i), S.hasProblems() || N.push(v), !L))
						L = { schema: v, validationResult: S, matchingSchemas: C }
					else if (!b && !S.hasProblems() && !L.validationResult.hasProblems())
						(L.matchingSchemas.merge(C),
							(L.validationResult.propertiesMatches += S.propertiesMatches),
							(L.validationResult.propertiesValueMatches += S.propertiesValueMatches),
							L.validationResult.mergeProcessedProperties(S))
					else {
						const D = S.compare(L.validationResult)
						D > 0
							? (L = { schema: v, validationResult: S, matchingSchemas: C })
							: D === 0 && (L.matchingSchemas.merge(C), L.validationResult.mergeEnumValues(S))
					}
				}
				return (
					N.length > 1 &&
					...
					L && (n.merge(L.validationResult), r.merge(L.matchingSchemas)),
					N.length
				)
			}
			...
			const d = (x) => {
				...
				p = (x, b, N) => {
					...
					;(ue(s, L, R, v, i),
						r.merge(v),
						n.mergeProcessedProperties(R),
						R.hasProblems() ? N && d(N) : b && d(b))
				},
				y = Ae(e.if)
			if ((y && p(y, Ae(e.then), Ae(e.else)), Array.isArray(e.enum))) {
				const x = gt(s)
				let b = !1
				for (const N of e.enum)
					if (Ot(x, N)) {
						b = !0
						break
					}
					...
					b ||
						n.problems.push({
							...
							message:
								...
								M(
									'Value is not accepted. Valid values: {0}.',
									e.enum.map((N) => JSON.stringify(N)).join(', '),
								),
						}))
			}
			if (Ce(e.const)) {
			...
			if (w || e.deprecated) {
				w = w || M('Value is deprecated')
				let x = s.parent?.type === 'property' ? s.parent : s
				n.problems.push({
		...
		function o(f) {
			const m = f.value
			function g(N) {
				const L = /^(-?\d+)(?:\.(\d+))?(?:e([-+]\d+))?$/.exec(N.toString())
				return (
					L && {
						value: Number(L[1] + (L[2] || '')),
						multiplier: (L[2]?.length || 0) - (parseInt(L[3]) || 0),
					}
				)
			}
			if (me(e.multipleOf)) {
				let N = -1
				if (Number.isInteger(e.multipleOf)) N = m % e.multipleOf
				else {
					let L = g(e.multipleOf),
						R = g(m)
					if (L && R) {
						const v = 10 ** Math.abs(R.multiplier - L.multiplier)
						;(R.multiplier < L.multiplier ? (R.value *= v) : (L.value *= v),
							(N = R.value % L.value))
					}
				}
				N !== 0 &&
			...
			me(w) &&
				...
				n.problems.push({
					location: { offset: f.offset, length: f.length },
					message: M('Value is above the exclusive maximum of {0}.', w),
				})
			const x = p(e.minimum, e.exclusiveMinimum)
			me(x) &&
				m < x &&
				n.problems.push({
					location: { offset: f.offset, length: f.length },
					message: M('Value is below the minimum of {0}.', x),
				})
			...
			if (m !== void 0) {
				...
				for (; d < w; d++) {
					const x = m[d],
						...
						N = new de(),
						L = f.items[d]
					;(L && (ue(L, b, N, r, i), n.mergePropertyMatch(N)), n.processedProperties.add(String(d)))
				}
			}
			if (g !== void 0 && d < f.items.length)
				if (typeof g == 'boolean')
					...
					for (; d < f.items.length; d++) {
						const w = new de()
						;(ue(f.items[d], g, w, r, i),
							n.mergePropertyMatch(w),
							n.processedProperties.add(String(d)))
					}
			const p = Ae(e.contains)
			if (p) {
				let w = 0
				for (let x = 0; x < f.items.length; x++) {
					const b = f.items[x],
						N = new de()
					;(ue(b, p, N, dn.instance, i),
						N.hasProblems() ||
							(w++, i.schemaDraft >= Fe.v2020_12 && n.processedProperties.add(String(x))))
				}
				;(w === 0 &&
					!me(e.minContains) &&
					n.problems.push({
				...
				for (let w = 0; w < f.items.length; w++) {
					if (!n.processedProperties.has(String(w)))
						if (y === !1)
							...
							const x = new de()
							;(ue(f.items[w], e.unevaluatedItems, x, r, i), n.mergePropertyMatch(x))
						}
			...
			if (
				...
				let x = function () {
					for (let b = 0; b < w.length - 1; b++) {
						const N = w[b]
						for (let L = b + 1; L < w.length; L++) if (Ot(N, w[L])) return !0
					}
					return !1
				}
				const w = gt(f)
		...
		function h(f) {
			...
			if (Array.isArray(e.required)) {
				for (const b of e.required)
					if (!m[b]) {
						const N = f.parent && f.parent.type === 'property' && f.parent.keyNode,
							L = N ? { offset: N.offset, length: N.length } : { offset: f.offset, length: 1 }
						n.problems.push({ location: L, message: M('Missing property "{0}".', b) })
					}
			}
			const d = (b) => {
			...
			if (e.properties)
				for (const b of Object.keys(e.properties)) {
					d(b)
					const N = e.properties[b],
						L = m[b]
					if (L)
						if ($e(N))
							if (N) (n.propertiesMatches++, n.propertiesValueMatches++)
							else {
								const R = L.parent
								n.problems.push({
									location: { offset: R.keyNode.offset, length: R.keyNode.length },
									message: e.errorMessage || M('Property {0} is not allowed.', b),
								})
							}
						else {
							const R = new de()
							;(ue(L, N, R, r, i), n.mergePropertyMatch(R))
						}
				}
									...
									if ($e(S))
										if (S) (n.propertiesMatches++, n.propertiesValueMatches++)
											...
											n.problems.push({
												...
												message: e.errorMessage || M('Property {0} is not allowed.', R),
											})
										}
									else {
										const C = new de()
										;(ue(v, S, C, r, i), n.mergePropertyMatch(C))
									}
								}
							}
						L.forEach(d)
				...
				for (const b of g) {
					...
					if (N) {
						if (p === !1) {
							...
							const L = new de()
							;(ue(N, p, L, r, i), n.mergePropertyMatch(L))
						}
					}
				}
			...
			if (y !== void 0) {
				const b = []
				for (const N of g)
					if (!n.processedProperties.has(N)) {
						b.push(N)
						const L = m[N]
						if (L) {
							if (y === !1) {
								...
								n.problems.push({
									location: { offset: R.keyNode.offset, length: R.keyNode.length },
									message: e.errorMessage || M('Property {0} is not allowed.', N),
								})
							} else if (y !== !0) {
								const R = new de()
								;(ue(L, y, R, r, i), n.mergePropertyMatch(R))
							}
						}
					}
				b.forEach(d)
			...
			if (e.dependencies) for (const b in e.dependencies) m[b] && x(b, e.dependencies[b])
			const w = Ae(e.propertyNames)
			if (w)
				for (const b of f.properties) {
					const N = b.keyNode
					N && ue(N, w, n, dn.instance, i)
				}
			function x(b, N) {
				if (Array.isArray(N))
					for (const L of N)
						m[L]
							...
							: n.problems.push({
									location: { offset: f.offset, length: f.length },
									message: M('Object is missing property {0} required by property {1}.', L, b),
								})
				else {
					const L = Ae(N)
					if (L) {
						const R = new de()
						;(ue(f, L, R, r, i), n.mergePropertyMatch(R))
					}
				}
			}
		}
	...
	function j1(t, e) {
		...
		function u(R, v, S, C, D = _e.Error) {
			if (n.length === 0 || S !== r) {
				const P = H.create(t.positionAt(S), t.positionAt(C))
				;(n.push(Ze.create(P, R, D, v, t.languageId)), (r = S))
			}
		}
		function c(R, v, S = void 0, C = [], D = []) {
			let P = s.getTokenOffset(),
				_ = s.getTokenOffset() + s.getTokenLength()
			if (P === _ && P > 0) {
				for (P--; P > 0 && /\s/.test(i.charAt(P)); ) P--
				_ = P + 1
			}
			if ((u(R, v, P, _), S && f(S, !1), C.length + D.length > 0)) {
				let E = s.getToken()
				for (; E !== 17; ) {
					if (C.indexOf(E) !== -1) {
						o()
						break
					} else if (D.indexOf(E) !== -1) break
					E = o()
				}
			}
			return S
		...
		function h() {
			switch (s.getTokenError()) {
				case 4:
					return (c(M('Invalid unicode sequence in string.'), X.InvalidUnicode), !0)
				case 5:
					return (c(M('Invalid escape character in string.'), X.InvalidEscapeCharacter), !0)
				case 3:
					return (c(M('Unexpected end of number.'), X.UnexpectedEndOfNumber), !0)
				case 1:
					return (c(M('Unexpected end of comment.'), X.UnexpectedEndOfComment), !0)
				case 2:
					return (c(M('Unexpected end of string.'), X.UnexpectedEndOfString), !0)
				case 6:
					return (
						c(
		...
		function f(R, v) {
			return ((R.length = s.getTokenOffset() + s.getTokenLength() - R.offset), v && o(), R)
		}
		function m(R) {
			if (s.getToken() !== 3) return
			const v = new D1(R, s.getTokenOffset())
			o()
			let S = !1
			for (; s.getToken() !== 4 && s.getToken() !== 17; ) {
				if (s.getToken() === 5) {
					S || c(M('Value expected'), X.ValueExpected)
					const D = s.getTokenOffset()
					if ((o(), s.getToken() === 4)) {
						S && u(M('Trailing comma'), X.TrailingComma, D, D + 1)
						continue
					}
				} else S && c(M('Expected comma'), X.CommaExpected)
				const C = b(v)
				;(C ? v.items.push(C) : c(M('Value expected'), X.ValueExpected, void 0, [], [4, 5]),
					(S = !0))
			}
			return s.getToken() !== 4
				? c(M('Expected comma or closing bracket'), X.CommaOrCloseBacketExpected, v)
				: f(v, !0)
		}
		const g = new gi(void 0, 0, 0)
		function d(R, v) {
			const S = new $1(R, s.getTokenOffset(), g)
			let C = y(S)
			if (!C)
				if (s.getToken() === 16) {
					c(M('Property keys must be doublequoted'), X.PropertyKeysMustBeDoublequoted)
					const P = new gi(S, s.getTokenOffset(), s.getTokenLength())
					;((P.value = s.getTokenValue()), (C = P), o())
				} else return
			if (((S.keyNode = C), C.value !== '//')) {
				const P = v[C.value]
				P
					? (u(
						...
						st(P) &&
							u(
								...
								X.DuplicateKey,
								P.keyNode.offset,
								P.keyNode.offset + P.keyNode.length,
								_e.Warning,
							),
						(v[C.value] = !0))
					: (v[C.value] = S)
			...
			if (s.getToken() === 6) ((S.colonOffset = s.getTokenOffset()), o())
				...
				(c(M('Colon expected'), X.ColonExpected),
				s.getToken() === 10 &&
					t.positionAt(C.offset + C.length).line < t.positionAt(s.getTokenOffset()).line)
			)
				return ((S.length = C.length), S)
			const D = b(S)
			return D
				? ((S.valueNode = D), (S.length = D.offset + D.length - S.offset), S)
				: c(M('Value expected'), X.ValueExpected, S, [], [2, 5])
		}
		function p(R) {
			if (s.getToken() !== 1) return
			const v = new B1(R, s.getTokenOffset()),
				S = Object.create(null)
			o()
			let C = !1
			for (; s.getToken() !== 2 && s.getToken() !== 17; ) {
				if (s.getToken() === 5) {
					C || c(M('Property expected'), X.PropertyExpected)
					const P = s.getTokenOffset()
					if ((o(), s.getToken() === 2)) {
						C && u(M('Trailing comma'), X.TrailingComma, P, P + 1)
						continue
					}
				} else C && c(M('Expected comma'), X.CommaExpected)
				const D = d(v, S)
				;(D
					? v.properties.push(D)
					: c(M('Property expected'), X.PropertyExpected, void 0, [], [2, 5]),
					(C = !0))
			}
			return s.getToken() !== 2
				? c(M('Expected comma or closing brace'), X.CommaOrCloseBraceExpected, v)
				: f(v, !0)
		}
		function y(R) {
			if (s.getToken() !== 10) return
			const v = new gi(R, s.getTokenOffset())
			return ((v.value = s.getTokenValue()), f(v, !0))
		}
		function w(R) {
			if (s.getToken() !== 11) return
			const v = new O1(R, s.getTokenOffset())
			if (s.getTokenError() === 0) {
				const S = s.getTokenValue()
				try {
					const C = JSON.parse(S)
					if (!me(C)) return c(M('Invalid number format.'), X.Undefined, v)
					v.value = C
				} catch {
					return c(M('Invalid number format.'), X.Undefined, v)
				}
				v.isInteger = S.indexOf('.') === -1
			}
			return f(v, !0)
		}
		function x(R) {
			switch (s.getToken()) {
				case 7:
					return f(new V1(R, s.getTokenOffset()), !0)
				case 8:
					return f(new el(R, !0, s.getTokenOffset()), !0)
				case 9:
					return f(new el(R, !1, s.getTokenOffset()), !0)
				default:
					return
			}
		}
		function b(R) {
			return m(R) || p(R) || y(R) || w(R) || x(R)
		}
		let N
		return (
			o() !== 17 &&
				((N = b(N)),
				N
					? s.getToken() !== 17 && c(M('End of file expected.'), X.Undefined)
					: c(M('Expected a JSON object, array or literal.'), X.Undefined)),
			new il(N, n, a)
		)
	}
	function yi(t, e, n) {
...
`
				for (let a = 0; a < i.length; a++) {
					const o = i[a]
					;((s += r + JSON.stringify(o) + ': ' + yi(t[o], r, n)),
						a < i.length - 1 && (s += ','),
						(s += `
`))
				}
	...
	class W1 {
		...
		doComplete(e, n, r) {
			...
			if (
				...
				c = H.create(e.positionAt(o.offset), e.positionAt(o.offset + o.length))
			else {
				let m = a - u.length
				;(m > 0 && s[m - 1] === '"' && m--, (c = H.create(e.positionAt(m), n)))
			}
			const h = new Map(),
				f = {
					add: (m) => {
						...
						if (d)
							...
							;((m.textEdit = Be.replace(c, m.insertText)),
								(m.label = g),
								h.set(g, m),
								i.items.push(m))
						}
			...
			return this.schemaService.getSchemaForResource(e.uri, r).then((m) => {
				...
				if (o && o.type === 'object') {
					...
					o.properties.forEach((L) => {
						;(!y || y !== L) && h.set(L.keyNode.value, ci.create('__'))
					})
					let b = ''
					;(d && (b = this.evaluateSeparatorAfter(e, e.offsetAt(c.end))),
						m
							? this.getPropertyCompletions(m, r, o, d, b, f)
							: this.getSchemaLessPropertyCompletions(r, o, p, f))
					const N = bi(o)
					;(this.contributions.forEach((L) => {
						const R = L.collectPropertyCompletions(e.uri, N, u, d, b === '', f)
						R && g.push(R)
					}),
						!m &&
							u.length > 0 &&
						...
						if (f.getNumberOfProposals() === 0) {
							...
							o &&
								(o.type === 'string' ||
									...
									o.type === 'null') &&
								(x = o.offset + o.length)
							const b = this.evaluateSeparatorAfter(e, x)
		...
		getSchemaLessValueCompletions(e, n, r, i, s) {
			...
			const o = this.evaluateSeparatorAfter(i, a),
				u = (c) => {
					;(c.parent &&
						!rl(c.parent, r, !0) &&
						s.add({
							kind: this.getSuggestionKind(c.type),
							label: this.getLabelTextForMatchingNode(c, i),
							insertText: this.getInsertTextForMatchingNode(c, i, o),
							insertTextFormat: ae.Snippet,
							documentation: '',
						}),
						c.type === 'boolean' && this.addBooleanValueCompletion(!c.value, o, s))
				}
			if (n.type === 'property' && r > (n.colonOffset || 0)) {
				const c = n.valueNode
				if (c && (r > c.offset + c.length || c.type === 'object' || c.type === 'array')) return
			...
			if (n.type === 'array')
				if (n.parent && n.parent.type === 'property') {
					const c = n.parent.keyNode.value
					e.visit(
						(h) => (
							h.type === 'property' &&
								h.keyNode.value === c &&
		...
		getValueCompletions(e, n, r, i, s, a, o) {
			...
			if (r && (c !== void 0 || r.type === 'array')) {
						...
						if (r.type === 'array' && g.schema.items) {
							...
							if (g.schema.uniqueItems) {
								...
								;(r.children.forEach((y) => {
									y.type !== 'array' && y.type !== 'object' && p.add(this.getLabelForValue(gt(y)))
								}),
									(d = {
										...a,
										add(y) {
				...
				;(c === '$schema' && !r.parent && this.addDollarSchemaCompletions(f, a),
					o.boolean &&
			...
			if (!n)
				...
				if ((!u || r <= u.offset + u.length) && n.parent) {
					...
					this.contributions.forEach((h) => {
						const f = h.collectValueCompletions(i.uri, c, o, s)
						f && a.push(f)
					})
				}
			}
...
` + d,
		...
		collectTypes(e, n) {
			if (Array.isArray(e.enum) || Ce(e.const)) return
			const r = e.type
		...
		getInsertTextForSnippetValue(e, n) {
			return (
				yi(e, '', (i) => (typeof i == 'string' && i[0] === '^' ? i.substr(1) : JSON.stringify(i))) +
				n
			)
		}
			...
			if (n) {
				if (Array.isArray(n.defaultSnippets)) {
					if (n.defaultSnippets.length === 1) {
						const c = n.defaultSnippets[0].body
						Ce(c) && (o = this.getInsertTextForSnippetValue(c, ''))
					}
				...
				if (
					(n.enum &&
						...
						(u += n.enum.length)),
					Ce(n.const) && (o || (o = this.getInsertTextForGuessedValue(n.const, '')), u++),
					Ce(n.default) && (o || (o = this.getInsertTextForGuessedValue(n.default, '')), u++),
					...
					let c = Array.isArray(n.type) ? n.type[0] : n.type
...
\r\v":{[,]}`.indexOf(i.charAt(r)) === -1;
		...
		fromMarkup(e) {
			if (e && this.doesSupportMarkdown()) return { kind: mt.Markdown, value: e }
		}
		doesSupportMarkdown() {
			if (!Ce(this.supportsMarkdown)) {
				const e =
					this.clientCapabilities.textDocument?.completion?.completionItem?.documentationFormat
				this.supportsMarkdown = Array.isArray(e) && e.indexOf(mt.Markdown) !== -1
			}
			return this.supportsMarkdown
		}
		doesSupportsCommitCharacters() {
			return (
				Ce(this.supportsCommitCharacters) ||
	...
	class H1 {
		...
		doHover(e, n, r) {
			...
			const o = H.create(e.positionAt(a.offset), e.positionAt(a.offset + a.length)),
				u = (h) => ({ contents: h, range: o }),
				c = bi(s)
			for (let h = this.contributions.length - 1; h >= 0; h--) {
				const m = this.contributions[h].getInfoContribution(e.uri, c)
				...
				if (h && s) {
					...
					f.every((w) => {
						if (
							...
							w.schema &&
							((m = m || w.schema.title),
							(g = g || w.schema.markdownDescription || wi(w.schema.description)),
							w.schema.enum)
						) {
							const x = w.schema.enum.indexOf(gt(s))
							;(w.schema.markdownEnumDescriptions
								? (d = w.schema.markdownEnumDescriptions[x])
								: w.schema.enumDescriptions && (d = wi(w.schema.enumDescriptions[x])),
								d && ((p = w.schema.enum[x]), typeof p != 'string' && (p = JSON.stringify(p))))
						}
						return !0
					})
					let y = ''
...
$3`,
	...
	class G1 {
		...
		configure(e) {
			e &&
				...
				(this.commentSeverity = e.allowComments ? void 0 : _e.Error))
		}
		doValidation(e, n, r, i) {
			...
			const s = [],
				a = {},
				o = (c) => {
					const h = c.range.start.line + ' ' + c.range.start.character + ' ' + c.message
					a[h] || ((a[h] = !0), s.push(c))
				},
				u = (c) => {
					let h = r?.trailingCommas ? Jn(r.trailingCommas) : _e.Error,
						f = r?.comments ? Jn(r.comments) : this.commentSeverity,
						m = r?.schemaValidation ? Jn(r.schemaValidation) : _e.Warning,
						g = r?.schemaRequest ? Jn(r.schemaRequest) : _e.Warning
					if (c) {
						const d = (p, y) => {
							if (n.root && g) {
								const w = n.root,
									x = w.type === 'object' ? w.properties[0] : void 0
								if (x && x.keyNode.value === '$schema') {
									const b = x.valueNode || x,
										N = H.create(e.positionAt(b.offset), e.positionAt(b.offset + b.length))
									o(Ze.create(N, p, g, y))
								} else {
									const b = H.create(e.positionAt(w.offset), e.positionAt(w.offset + 1))
									o(Ze.create(b, p, g, y))
								}
							}
						}
						if (c.errors.length) d(c.errors[0], X.SchemaResolveError)
						else if (m) {
							for (const y of c.warnings) d(y, X.SchemaUnsupportedFeature)
							const p = n.validate(e, c.schema, m, r?.schemaDraft)
							p && p.forEach(o)
						}
						;(al(c.schema) && (f = void 0), ol(c.schema) && (h = void 0))
					}
					for (const d of n.syntaxErrors) {
						if (d.code === X.TrailingComma) {
					...
					if (typeof f == 'number') {
						...
						n.comments.forEach((p) => {
							o(Ze.create(p, d, f, X.CommentNotPermitted))
						})
					}
					return s
				}
			if (i) {
				const c = i.id || 'schemaservice://untitled/' + J1++
				return this.jsonSchemaService
					.registerExternalSchema({ uri: c, schema: i })
					.getResolvedSchema()
					.then((f) => u(f))
			}
			return this.jsonSchemaService.getSchemaForResource(e.uri, n).then((c) => u(c))
		}
	...
	function al(t) {
		if (t && typeof t == 'object') {
			if ($e(t.allowComments)) return t.allowComments
			if (t.allOf)
	...
	function ol(t) {
		if (t && typeof t == 'object') {
			if ($e(t.allowTrailingCommas)) return t.allowTrailingCommas
			const e = t
			if ($e(e.allowsTrailingCommas)) return e.allowsTrailingCommas
			if (t.allOf)
	...
	function ie(t) {
		return t < ll
			...
			: t <= X1
				? t - ll
				: (t < Xn && (t += Xn - Q1), t >= Xn && t <= Y1 ? t - Xn + 10 : 0)
	}
	function Z1(t) {
		if (t[0] === '#')
			switch (t.length) {
	...
	class K1 {
		...
		findDocumentSymbols(e, n, r = { resultLimit: Number.MAX_VALUE }) {
			...
			if (
				(a === 'vscode://defaultsettings/keybindings.json' ||
					cn(a.toLowerCase(), '/user/keybindings.json')) &&
				i.type === 'array'
			) {
				const m = []
					...
					if (g.type === 'object') {
						for (const d of g.properties)
							if (d.keyNode.value === 'key' && d.valueNode) {
								const p = $t.create(e.uri, at(e, g))
								if (
									(m.push({ name: ul(d.valueNode), kind: Ue.Function, location: p }), s--, s <= 0)
								)
			...
			return (c && r && r.onResultLimitExceeded && r.onResultLimitExceeded(a), h)
		}
						...
						m.properties.forEach((d) => {
							...
							if (p)
								if (s > 0) {
									...
									;(g.push(b), u.push({ result: x, node: p }))
								} else h = !0
						})
			}
			for (; c < u.length; ) {
				...
				if (i) {
					...
					for (const c of o)
						if (
							...
							const h = String(c.node.offset)
							if (!u[h]) {
								const f = Z1(gt(c.node))
								if (f) {
									const m = at(e, c.node)
		...
		getColorPresentations(e, n, r, i) {
			...
			return (
				r.alpha === 1
					? (h = `#${c(a)}${c(o)}${c(u)}`)
					: (h = `#${c(a)}${c(o)}${c(u)}${c(Math.round(r.alpha * 255))}`),
				s.push({ label: h, textEdit: Be.replace(i, JSON.stringify(h)) }),
				s
			)
		}
	}
	function at(t, e) {
		return H.create(t.positionAt(e.offset), t.positionAt(e.offset + e.length))
	}
	function ul(t) {
		return gt(t) || M('<empty>')
	}
	...
	for (const t in xi.schemas) {
		const e = xi.schemas[t]
				...
				470: (i) => {
					...
					var o = {
						resolve: function () {
							for (var u, c = '', h = !1, f = arguments.length - 1; f >= -1 && !h; f--) {
								...
								;(f >= 0 ? (m = arguments[f]) : (u === void 0 && (u = process.cwd()), (m = u)),
									s(m),
									m.length !== 0 && ((c = m + '/' + c), (h = m.charCodeAt(0) === 47)))
							}
						...
						relative: function (u, c) {
							if ((s(u), s(c), u === c || (u = o.resolve(u)) === (c = o.resolve(c)))) return ''
							for (var h = 1; h < u.length && u.charCodeAt(h) === 47; ++h);
							for (var f = u.length, m = f - h, g = 1; g < c.length && c.charCodeAt(g) === 47; ++g);
							for (var d = c.length - g, p = m < d ? m : d, y = -1, w = 0; w <= p; ++w) {
								if (w === p) {
									if (d > p) {
										if (c.charCodeAt(g + w) === 47) return c.slice(g + w + 1)
										if (w === 0) return c.slice(g + w)
									} else m > p && (u.charCodeAt(h + w) === 47 ? (y = w) : w === 0 && (y = 0))
									break
								}
								var x = u.charCodeAt(h + w)
								if (x !== c.charCodeAt(g + w)) break
								x === 47 && (y = w)
							}
							var b = ''
							for (w = h + y + 1; w <= f; ++w)
							...
							return b.length > 0
								? b + c.slice(g + y)
								: ((g += y), c.charCodeAt(g) === 47 && ++g, c.slice(g))
						},
						...
						dirname: function (u) {
							if ((s(u), u.length === 0)) return '.'
							for (
								var c = u.charCodeAt(0), h = c === 47, f = -1, m = !0, g = u.length - 1;
								g >= 1;
								--g
							)
								if ((c = u.charCodeAt(g)) === 47) {
									if (!m) {
										f = g
										break
									}
							...
							if (c !== void 0 && c.length > 0 && c.length <= u.length) {
								...
								for (h = u.length - 1; h >= 0; --h) {
									...
									if (y === 47) {
										...
										(p === -1 && ((g = !1), (p = h + 1)),
											d >= 0 &&
												(y === c.charCodeAt(d) ? --d == -1 && (m = h) : ((d = -1), (m = p))))
								}
						...
						extname: function (u) {
							s(u)
							for (var c = -1, h = 0, f = -1, m = !0, g = 0, d = u.length - 1; d >= 0; --d) {
								var p = u.charCodeAt(d)
								if (p !== 47)
									(f === -1 && ((m = !1), (f = d + 1)),
										p === 46 ? (c === -1 ? (c = d) : g !== 1 && (g = 1)) : c !== -1 && (g = -1))
								else if (!m) {
									h = d + 1
									break
								}
							}
							return c === -1 || f === -1 || g === 0 || (g === 1 && c === f - 1 && c === h + 1)
								? ''
								: u.slice(c, f)
						},
						format: function (u) {
						...
						parse: function (u) {
							...
							var h,
								...
								m = f === 47
							m ? ((c.root = '/'), (h = 1)) : (h = 0)
							for (var g = -1, d = 0, p = -1, y = !0, w = u.length - 1, x = 0; w >= h; --w)
								if ((f = u.charCodeAt(w)) !== 47)
									(p === -1 && ((y = !1), (p = w + 1)),
										f === 46 ? (g === -1 ? (g = w) : x !== 1 && (x = 1)) : g !== -1 && (x = -1))
								else if (!y) {
									d = w + 1
									break
								}
							return (
								g === -1 || p === -1 || x === 0 || (x === 1 && g === p - 1 && g === d + 1)
									? p !== -1 && (c.base = c.name = d === 0 && m ? u.slice(1, p) : u.slice(d, p))
									: (d === 0 && m
											? ((c.name = u.slice(1, g)), (c.base = u.slice(1, p)))
											: ((c.name = u.slice(d, g)), (c.base = u.slice(d, p))),
										(c.ext = u.slice(g, p))),
								d > 0 ? (c.dir = u.slice(0, d - 1)) : m && (c.dir = '/'),
								c
							)
						},
						sep: '/',
		...
		;((() => {
			...
			class m {
				...
				constructor(_, E, T, F, V, I = !1) {
					typeof _ == 'object'
						...
						: ((this.scheme = (function (O, q) {
								return O || q ? O : 'file'
							})(_, I)),
							(this.authority = E || c),
							(this.path = (function (O, q) {
								switch (O) {
									case 'https':
									case 'http':
									case 'file':
				...
				with(_) {
					if (!_) return this
					let { scheme: E, authority: T, path: F, query: V, fragment: I } = _
					return (
						E === void 0 ? (E = this.scheme) : E === null && (E = c),
						T === void 0 ? (T = this.authority) : T === null && (T = c),
						F === void 0 ? (F = this.path) : F === null && (F = c),
						V === void 0 ? (V = this.query) : V === null && (V = c),
						I === void 0 ? (I = this.fragment) : I === null && (I = c),
						E === this.scheme &&
						T === this.authority &&
						F === this.path &&
						V === this.query &&
				...
				static parse(_, E = !1) {
					const T = f.exec(_)
					return T
						? new d(T[2] || c, R(T[4] || c), R(T[5] || c), R(T[7] || c), R(T[9] || c), E)
						: new d(c, c, c, c, c)
				}
				static file(_) {
					let E = c
					if ((i && (_ = _.replace(/\\/g, h)), _[0] === h && _[1] === h)) {
						const T = _.indexOf(h, 2)
						T === -1
							? ((E = _.substring(2)), (_ = h))
							: ((E = _.substring(2, T)), (_ = _.substring(T) || h))
					}
					return new d('file', E, _, c, c)
				}
				static from(_) {
					const E = new d(_.scheme, _.authority, _.path, _.query, _.fragment)
					return (u(E, !0), E)
				}
				toString(_ = !1) {
					return b(this, _)
				...
				static revive(_) {
					if (_) {
						...
						{
							const E = new d(_)
							return ((E._formatted = _.external), (E._fsPath = _._sep === g ? _.fsPath : null), E)
						}
					}
					return _
				}
			...
			class d extends m {
				...
				toJSON() {
					const _ = { $mid: 1 }
					return (
						this._fsPath && ((_.fsPath = this._fsPath), (_._sep = g)),
			...
			function y(P, _, E) {
				...
				for (let V = 0; V < P.length; V++) {
					...
					if (
						...
						(F !== -1 && ((T += encodeURIComponent(P.substring(F, V))), (F = -1)),
							T !== void 0 && (T += P.charAt(V)))
					else {
						T === void 0 && (T = P.substr(0, V))
						const O = p[I]
						O !== void 0
							? (F !== -1 && ((T += encodeURIComponent(P.substring(F, V))), (F = -1)), (T += O))
							: F === -1 && (F = V)
					}
				}
				return (F !== -1 && (T += encodeURIComponent(P.substring(F))), T !== void 0 ? T : P)
			}
			function w(P) {
				let _
				...
				return (
					(E =
						P.authority && P.path.length > 1 && P.scheme === 'file'
							? `//${P.authority}${P.path}`
							: P.path.charCodeAt(0) === 47 &&
								  ((P.path.charCodeAt(1) >= 65 && P.path.charCodeAt(1) <= 90) ||
										(P.path.charCodeAt(1) >= 97 && P.path.charCodeAt(1) <= 122)) &&
								  P.path.charCodeAt(2) === 58
								? P.path[1].toLowerCase() + P.path.substr(2)
								: P.path),
					i && (E = E.replace(/\//g, '\\')),
					E
				)
			...
			function b(P, _) {
				const E = _ ? w : y
				let T = '',
					{ scheme: F, authority: V, path: I, query: O, fragment: q } = P
				if ((F && ((T += F), (T += ':')), (V || F === 'file') && ((T += h), (T += h)), V)) {
					let G = V.indexOf('@')
					if (G !== -1) {
						const Y = V.substr(0, G)
						;((V = V.substr(G + 1)),
							(G = Y.lastIndexOf(':')),
							G === -1
								? (T += E(Y, !1, !1))
								: ((T += E(Y.substr(0, G), !1, !1)), (T += ':'), (T += E(Y.substr(G + 1), !1, !0))),
							(T += '@'))
					}
					;((V = V.toLowerCase()),
						(G = V.lastIndexOf(':')),
						G === -1 ? (T += E(V, !1, !0)) : ((T += E(V.substr(0, G), !1, !0)), (T += V.substr(G))))
				}
				if (I) {
					if (I.length >= 3 && I.charCodeAt(0) === 47 && I.charCodeAt(2) === 58) {
						const G = I.charCodeAt(1)
						G >= 65 && G <= 90 && (I = `/${String.fromCharCode(G + 32)}:${I.substr(3)}`)
					} else if (I.length >= 2 && I.charCodeAt(1) === 58) {
						const G = I.charCodeAt(0)
						G >= 65 && G <= 90 && (I = `${String.fromCharCode(G + 32)}:${I.substr(2)}`)
					}
					T += E(I, !0, !1)
				}
				return (
			...
			function R(P) {
				return P.match(L) ? P.replace(L, (_) => N(_)) : P
			}
			var v = n(470)
			const S = v.posix || v,
				C = '/'
			var D
			;(function (P) {
				;((P.joinPath = function (_, ...E) {
					return _.with({ path: S.join(_.path, ...E) })
				}),
					(P.resolvePath = function (_, ...E) {
						let T = _.path,
							F = !1
						T[0] !== C && ((T = C + T), (F = !0))
						let V = S.resolve(T, ...E)
						return (F && V[0] === C && !_.authority && (V = V.substring(1)), _.with({ path: V }))
					}),
					(P.dirname = function (_) {
						if (_.path.length === 0 || _.path === C) return _
						let E = S.dirname(_.path)
						return (E.length === 1 && E.charCodeAt(0) === 46 && (E = ''), _.with({ path: E }))
					}),
					(P.basename = function (_) {
						return S.basename(_.path)
					}),
					(P.extname = function (_) {
						return S.extname(_.path)
					}))
			})(D || (D = {}))
		})(),
			(cl = r))
	})()
	const { URI: qt, Utils: Cf } = cl
	function tf(t, e) {
		...
		constructor(e, n, r) {
			...
			try {
				for (let i of e) {
					...
					;(s || (i = i.substring(1)),
						i.length > 0 &&
							(i[0] === rf && (i = i.substring(1)),
							this.globWrappers.push({
								regexp: tf('**/' + i, { extended: !0, globstar: !0 }),
								include: s,
							})))
				}
				n && ((n = hl(n)), n.endsWith('/') || (n = n + '/'), (this.folderUri = n))
			} catch {
	...
	class af {
		constructor(e, n, r) {
			;((this.service = e),
				...
				(this.anchors = void 0),
				r && (this.unresolvedSchema = this.service.promise.resolve(new gn(r))))
		}
		getUnresolvedSchema() {
			return (
		...
		getSectionRecursive(e, n) {
			...
			if (n.patternProperties) {
				for (const i of Object.keys(n.patternProperties))
					if (jn(i)?.test(r)) return this.getSectionRecursive(e, n.patternProperties[i])
			} else {
	...
	class of {
		...
		loadSchema(e) {
			if (!this.requestService) {
				const n = M("Unable to load schema from '{0}'. No schema request service available", pn(e))
				return this.promise.resolve(new gn({}, [n]))
			}
			return (
				...
				this.requestService(e).then(
					(n) => {
						if (!n) {
							const a = M("Unable to load schema from '{0}': No content.", pn(e))
							return new gn({}, [a])
						}
						const r = []
					...
					(n) => {
						...
						return (
							i.length > 1 && (r = i[1]),
							cn(r, '.') && (r = r.substr(0, r.length - 1)),
							new gn({}, [M("Unable to load schema from '{0}': {1}.", pn(e), r)])
						)
					},
				)
			)
		...
		resolveSchemaContent(e, n) {
			const r = e.errors.slice(0),
				i = e.schema
			let s = i.$schema ? ot(i.$schema) : void 0
			if (s === 'http://json-schema.org/draft-03/schema')
				return this.promise.resolve(new fl({}, [M('Draft-03 schemas are not supported.')], [], s))
			let a = new Set()
			const o = this.contextService,
				u = (p, y) => {
					...
					return (
						...
						y
							.split('/')
							.some((x) => ((x = x.replace(/~1/g, '/').replace(/~0/g, '~')), (w = w[x]), !w)),
						w
					)
				},
				c = (p, y, w) => (y.anchors || (y.anchors = d(p)), y.anchors.get(w)),
				h = (p, y) => {
				...
				f = (p, y, w, x) => {
					...
					;(x === void 0 || x.length === 0
						...
						: x.charAt(0) === '/'
							? (b = u(y, x))
							: (b = c(y, w, x)),
						b ? h(p, b) : r.push(M("$ref '{0}' in '{1}' can not be resolved.", x || '', w.uri)))
				},
				m = (p, y, w, x) => {
					;(o &&
						!/^[A-Za-z][A-Za-z0-9+\-.+]*:\/\/.*/.test(y) &&
						(y = o.resolveRelativePath(y, x.uri)),
						(y = ot(y)))
					const b = this.getOrAddSchemaHandle(y)
					return b.getUnresolvedSchema().then((N) => {
						if ((x.dependencies.add(y), N.errors.length)) {
							const L = w ? y + '#' + w : y
							r.push(M("Problems loading reference '{0}': {1}", L, N.errors[0]))
						}
						return (f(p, N.schema, b, w), g(p, N.schema, b))
					})
				},
				g = (p, y, w) => {
					const x = []
					return (
						this.traverseNodes(p, (b) => {
							...
							for (; b.$ref; ) {
								const L = b.$ref,
									R = L.split('#', 2)
								if ((delete b.$ref, R[0].length > 0)) {
									x.push(m(b, R[0], R[1], w))
									return
								} else if (!N.has(L)) {
									const v = R[1]
									;(f(b, y, w, v), N.add(L))
				...
				d = (p) => {
					...
					return (
						this.traverseNodes(p, (w) => {
							const x = w.$id || w.id,
								b = to(x) && x.charAt(0) === '#' ? x.substring(1) : w.$anchor
							;(b && (y.has(b) ? r.push(M("Duplicate anchor declaration: '{0}'", b)) : y.set(b, w)),
		...
		traverseNodes(e, n) {
			...
			const r = new Set(),
				i = (...h) => {
					for (const f of h) st(f) && u.push(f)
				},
				s = (...h) => {
					for (const f of h)
						if (st(f))
				...
				a = (...h) => {
					for (const f of h) if (Array.isArray(f)) for (const m of f) st(m) && u.push(m)
				},
				o = (h) => {
					if (Array.isArray(h)) for (const f of h) st(f) && u.push(f)
					else st(h) && u.push(h)
				},
				u = [e]
			let c = u.pop()
			for (; c; )
				(r.has(c) ||
					...
					a(c.anyOf, c.allOf, c.oneOf, c.prefixItems),
					o(c.items)),
					(c = u.pop()))
		}
		...
		getMatchingSchemas(e, n, r) {
			if (r) {
				const i = r.id || 'schemaservice://untitled/matchingSchemas/' + lf++
	...
	function hl(t) {
		try {
			return qt.parse(t).with({ fragment: null, query: null }).toString(!0)
		} catch {
			return t
		}
	}
			...
			switch (o) {
				...
				case 13: {
					...
					a.getTokenError() === 1 && d + 1 < t.lineCount
						? a.setPosition(t.offsetAt(te.create(d + 1, 0)))
						: d < p && (u({ startLine: d, endLine: p, kind: fn.Comment }), (s = d))
					break
				}
				case 12: {
					const p = t
					...
					if (p) {
						...
						if (p[1]) {
							const w = { startLine: y, endLine: y, kind: fn.Region }
							i.push(w)
						} else {
							let w = i.length - 1
							for (; w >= 0 && i[w].kind !== fn.Region; ) w--
							if (w >= 0) {
								const x = i[w]
								;((i.length = w),
									y > x.startLine &&
										s !== x.startLine &&
										((x.endLine = y), u(x), (s = x.startLine)))
							}
						}
					}
					break
	...
	function cf(t, e, n) {
		function r(o) {
			...
			let f
			for (let m = h.length - 1; m >= 0; m--) f = Gn.create(h[m], f)
			return (f || (f = Gn.create(H.create(o, o))), f)
		}
		function i(o, u) {
			return H.create(t.positionAt(o), t.positionAt(u))
		}
		const s = ht(t.getText(), !0)
		function a(o, u) {
...
`,
		...
		return E1(t.getText(), r, i).map((s) =>
			Be.replace(H.create(t.positionAt(s.offset), t.positionAt(s.offset + s.length)), s.content),
		)
	}
	var oe
	;(function (t) {
		...
		addChildProperty(e) {
			if (((e.parent = this), this.childrenProperties.length > 0)) {
				...
				;(e.noKeyName
					...
					: (n = hf(this.childrenProperties, e, ff)),
					n < 0 && (n = n * -1 - 1),
	...
	function mf(t, e) {
		const n = { ...e, keepLines: !1 },
			r = Ie.applyEdits(t, vi(t, n, void 0)),
			i = Ie.create('test://test.json', 'json', 0, r),
			s = df(i),
			a = gf(i, s),
			o = vi(a, n, void 0),
			u = Ie.applyEdits(a, o)
		return [Be.replace(H.create(te.create(0, 0), t.positionAt(t.getText().length)), u)]
	}
	function df(t) {
		const e = t.getText(),
			n = ht(e, !1)
		...
		for (; (o = n.scan()) !== 17; ) {
			...
			if (
				(x === !0 &&
					...
					o !== 12 &&
					o !== 13 &&
					((d = n.getTokenStartLine()), (x = !1)),
				n.getTokenStartLine() !== u)
			) {
				for (let b = u; b < n.getTokenStartLine(); b++) {
					const N = t.getText(H.create(te.create(b, 0), te.create(b + 1, 0))).length
					c = c + N
				}
			...
			switch (o) {
				case 10: {
					if (h === void 0 || h === 1 || (h === 5 && y[y.length - 1] === oe.Object)) {
						const b = new Qn(n.getTokenValue(), d)
				...
				case 3: {
					if (
						...
						y[y.length - 1] === oe.Object)
					)
						i = s
					else if (y[y.length - 1] === oe.Array) {
						const b = new Qn(n.getTokenValue(), d)
						;((b.noKeyName = !0), (a = s), (s = i.addChildProperty(b)), (i = s))
					}
					;(y.push(oe.Array), (s.type = oe.Array), (d = n.getTokenStartLine()), d++)
					break
				}
				case 1: {
					...
					;((s.type = oe.Object), y.push(oe.Object), (i = s), (d = n.getTokenStartLine()), d++)
					break
				}
				case 4: {
				...
				case 5: {
					;((p = n.getTokenStartLine()),
						s.endLineNumber === void 0 &&
							(y[y.length - 1] === oe.Object ||
								(y[y.length - 1] === oe.Array && (h === 2 || h === 4))) &&
							((s.endLineNumber = p), (s.commaIndex = n.getTokenOffset() - c), (s.commaLine = p)),
				...
				case 13: {
					;(h === 5 &&
						...
						((y[y.length - 1] === oe.Array && (f === 2 || f === 4)) ||
							y[y.length - 1] === oe.Object) &&
						((y[y.length - 1] === oe.Array && (f === 2 || f === 4)) ||
							y[y.length - 1] === oe.Object) &&
						((s.endLineNumber = void 0), (w = !0)),
						(h === 1 || h === 3) && m === n.getTokenStartLine() && (x = !0))
					break
				}
			}
			o !== 14 &&
				...
				(h = o),
				(m = n.getTokenStartLine()),
				(g = n.getTokenOffset() + n.getTokenLength() - c))
		}
		return r
	}
	function gf(t, e) {
		if (e.childrenProperties.length === 0) return t
		const n = Ie.create('test://test.json', 'json', 0, t.getText()),
			r = []
		for (ml(r, e, e.beginningLineNumber); r.length > 0; ) {
			const i = r.shift(),
				s = i.propertyTreeArray
			let a = i.beginningLineNumber
			for (let o = 0; o < s.length; o++) {
				const u = s[o],
					c = H.create(te.create(u.beginningLineNumber, 0), te.create(u.endLineNumber + 1, 0)),
					h = t.getText(c),
					f = Ie.create('test://test.json', 'json', 0, h)
				if (u.lastProperty === !0 && o !== s.length - 1) {
					const d = u.lineWhereToAddComma - u.beginningLineNumber,
						p = u.indexWhereToAddComa,
						y = { range: H.create(te.create(d, p), te.create(d, p)), text: ',' }
					Ie.update(f, [y], 1)
				} else if (u.lastProperty === !1 && o === s.length - 1) {
					const d = u.commaIndex,
						y = u.commaLine - u.beginningLineNumber,
						w = { range: H.create(te.create(y, d), te.create(y, d + 1)), text: '' }
					Ie.update(f, [w], 1)
				}
				const m = u.endLineNumber - u.beginningLineNumber + 1,
					g = { range: H.create(te.create(a, 0), te.create(a + m, 0)), text: f.getText() }
				;(Ie.update(n, [g], 1), ml(r, u, a), (a = a + m))
			}
		}
		return n
	}
	function ml(t, e, n) {
		if (e.childrenProperties.length !== 0)
			if (e.type === oe.Object) {
				...
				;((n = n + i), t.push(new gl(n, e.childrenProperties)))
			} else e.type === oe.Array && dl(t, e, n)
	}
	function dl(t, e, n) {
		for (const r of e.childrenProperties) {
			if (r.type === oe.Object) {
				...
				t.push(new gl(n + r.beginningLineNumber - e.beginningLineNumber + s, r.childrenProperties))
			}
			r.type === oe.Array && dl(t, r, n + r.beginningLineNumber - e.beginningLineNumber)
		}
	}
	class gl {
		constructor(e, n) {
	...
	function bf(t, e) {
		return H.create(t.positionAt(e.offset + 1), t.positionAt(e.offset + e.length - 1))
	}
	function yf(t, e) {
		const n = wf(e)
		return n ? Li(n, t.root) : null
	}
	function Li(t, e) {
		if (!e) return null
		if (t.length === 0) return e
		...
		if (e && e.type === 'object') {
			...
			return r ? Li(t, r.valueNode) : null
		} else if (e && e.type === 'array' && n.match(/^(0|[1-9][0-9]*)$/)) {
			const r = Number.parseInt(n),
				i = e.items[r]
			return i ? Li(t, i) : null
		}
		return null
	}
	function wf(t) {
		return t === '#' ? [] : t[0] !== '#' || t[1] !== '/' ? null : t.substring(2).split(/\//).map(xf)
	}
	function xf(t) {
	...
	function vf(t) {
		const e = t.promiseConstructor || Promise,
			n = new of(t.schemaRequestService, t.workspaceContext, e)
		n.setSchemaContributions(xi)
		const r = new W1(n, t.contributions, e, t.clientCapabilities),
			i = new H1(n, t.contributions, e),
			s = new K1(n),
			a = new G1(n, e)
		return {
			configure: (o) => {
			...
			parseJSONDocument: (o) => j1(o, { collectComments: !0 }),
			newJSONDocument: (o, u) => q1(o, u),
			...
			getFoldingRanges: uf,
			getSelectionRanges: cf,
			findDefinition: () => Promise.resolve([]),
			findLinks: pf,
			format: (o, u, c) => vi(o, c, u),
			sort: (o, u) => mf(o, u),
		}
	}
	let pl
	...
	class Lf {
		constructor(e, n) {
			;((this._ctx = e),
				...
				(this._languageService = vf({
					...
					schemaRequestService: n.enableSchemaRequest ? pl : void 0,
		...
		_getTextDocument(e) {
			...
			for (let r of n)
				if (r.uri.toString() === e) return Ie.create(e, this._languageId, r.version, r.getValue())
			return null
		}
	}
	const Nf = 47,
		Ni = 46
	function _f(t) {
		return t.charCodeAt(0) === Nf
	}
	function Sf(t, e) {
		if (_f(e)) {
			const n = qt.parse(t),
				r = e.split('/')
			return n.with({ path: bl(r) }).toString()
		}
		return Af(t, e)
	}
	function bl(t) {
