define('vs/language/css/css.worker', [
	'../../initialize-DL0l1TGY',
	'../../index-049xrXrp',
	'../../main-DsK8pnKg',
], function (Sr, d, f) {
	...
	;(function (r) {
		;((r[(r.Ident = 0)] = 'Ident'),
			(r[(r.AtKeyword = 1)] = 'AtKeyword'),
			(r[(r.String = 2)] = 'String'),
			(r[(r.BadString = 3)] = 'BadString'),
			(r[(r.UnquotedString = 4)] = 'UnquotedString'),
			(r[(r.Hash = 5)] = 'Hash'),
			(r[(r.Num = 6)] = 'Num'),
			(r[(r.Percentage = 7)] = 'Percentage'),
			(r[(r.Dimension = 8)] = 'Dimension'),
			(r[(r.UnicodeRange = 9)] = 'UnicodeRange'),
			(r[(r.CDO = 10)] = 'CDO'),
			(r[(r.CDC = 11)] = 'CDC'),
			(r[(r.Colon = 12)] = 'Colon'),
			(r[(r.SemiColon = 13)] = 'SemiColon'),
			(r[(r.CurlyL = 14)] = 'CurlyL'),
			(r[(r.CurlyR = 15)] = 'CurlyR'),
			(r[(r.ParenthesisL = 16)] = 'ParenthesisL'),
			(r[(r.ParenthesisR = 17)] = 'ParenthesisR'),
			(r[(r.BracketL = 18)] = 'BracketL'),
			(r[(r.BracketR = 19)] = 'BracketR'),
			(r[(r.Whitespace = 20)] = 'Whitespace'),
			(r[(r.Includes = 21)] = 'Includes'),
			(r[(r.Dashmatch = 22)] = 'Dashmatch'),
			(r[(r.SubstringOperator = 23)] = 'SubstringOperator'),
			(r[(r.PrefixOperator = 24)] = 'PrefixOperator'),
			(r[(r.SuffixOperator = 25)] = 'SuffixOperator'),
			(r[(r.Delim = 26)] = 'Delim'),
			(r[(r.EMS = 27)] = 'EMS'),
			(r[(r.EXS = 28)] = 'EXS'),
			(r[(r.Length = 29)] = 'Length'),
			(r[(r.Angle = 30)] = 'Angle'),
			(r[(r.Time = 31)] = 'Time'),
			(r[(r.Freq = 32)] = 'Freq'),
			(r[(r.Exclamation = 33)] = 'Exclamation'),
			(r[(r.Resolution = 34)] = 'Resolution'),
			(r[(r.Comma = 35)] = 'Comma'),
			(r[(r.Charset = 36)] = 'Charset'),
			(r[(r.EscapedJavaScript = 37)] = 'EscapedJavaScript'),
			(r[(r.BadEscapedJavaScript = 38)] = 'BadEscapedJavaScript'),
			(r[(r.Comment = 39)] = 'Comment'),
			(r[(r.SingleLineComment = 40)] = 'SingleLineComment'),
			(r[(r.EOF = 41)] = 'EOF'),
			(r[(r.ContainerQueryLength = 42)] = 'ContainerQueryLength'),
			(r[(r.CustomToken = 43)] = 'CustomToken'))
	})(o || (o = {}))
	class Qt {
		constructor(e) {
			;((this.source = e), (this.len = e.length), (this.position = 0))
		}
		substring(e, t = this.position) {
		...
		advanceIfChars(e) {
			...
			let t = 0
			for (; t < e.length; t++) if (this.source.charCodeAt(this.position + t) !== e[t]) return !1
	...
	;((F.em = o.EMS),
		...
		(F.dpi = o.Resolution),
		(F.dpcm = o.Resolution),
		(F.cqw = o.ContainerQueryLength),
		(F.cqh = o.ContainerQueryLength),
		(F.cqi = o.ContainerQueryLength),
		(F.cqb = o.ContainerQueryLength),
		(F.cqmin = o.ContainerQueryLength),
		(F.cqmax = o.ContainerQueryLength))
	class Ce {
		constructor() {
			;((this.stream = new Qt('')),
		...
		scanUnquotedString() {
			const e = this.stream.pos(),
				t = []
			return this._unquotedString(t) ? this.finishToken(e, o.UnquotedString, t.join('')) : null
		}
		scan() {
			const e = this.trivia()
			if (e !== null) return e
			const t = this.stream.pos()
			return this.stream.eos() ? this.finishToken(t, o.EOF) : this.scanNext(t)
		}
		tryScanUnicode() {
			const e = this.stream.pos()
			if (!this.stream.eos() && this._unicodeRange()) return this.finishToken(e, o.UnicodeRange)
			this.stream.goBackTo(e)
		}
		scanNext(e) {
			if (this.stream.advanceIfChars([Er, dn, se, se])) return this.finishToken(e, o.CDO)
			if (this.stream.advanceIfChars([se, se, _r])) return this.finishToken(e, o.CDC)
			let t = []
			if (this.ident(t)) return this.finishToken(e, o.Ident, t.join(''))
			if (this.stream.advanceIfChar(Ir))
				if (((t = ['@']), this._name(t))) {
					const i = t.join('')
					return i === '@charset'
						? this.finishToken(e, o.Charset, i)
						: this.finishToken(e, o.AtKeyword, i)
				} else return this.finishToken(e, o.Delim)
			if (this.stream.advanceIfChar(Dr))
				return (
					(t = ['#']),
					this._name(t) ? this.finishToken(e, o.Hash, t.join('')) : this.finishToken(e, o.Delim)
				)
			if (this.stream.advanceIfChar(dn)) return this.finishToken(e, o.Exclamation)
			if (this._number()) {
				const i = this.stream.pos()
				if (((t = [this.stream.substring(e, i)]), this.stream.advanceIfChar(Fr)))
					return this.finishToken(e, o.Percentage)
				if (this.ident(t)) {
					const s = this.stream.substring(i).toLowerCase(),
						a = F[s]
					return typeof a < 'u'
						? this.finishToken(e, a, t.join(''))
						: this.finishToken(e, o.Dimension, t.join(''))
				}
				return this.finishToken(e, o.Num)
			}
			t = []
			let n = this._string(t)
			return n !== null
				? this.finishToken(e, n, t.join(''))
				: ((n = G[this.stream.peekChar()]),
					typeof n < 'u'
						? (this.stream.advance(1), this.finishToken(e, n))
						: this.stream.peekChar(0) === xr && this.stream.peekChar(1) === Se
							? (this.stream.advance(2), this.finishToken(e, o.Includes))
							: this.stream.peekChar(0) === kr && this.stream.peekChar(1) === Se
								? (this.stream.advance(2), this.finishToken(e, o.Dashmatch))
								: this.stream.peekChar(0) === rt && this.stream.peekChar(1) === Se
									? (this.stream.advance(2), this.finishToken(e, o.SubstringOperator))
									: this.stream.peekChar(0) === Cr && this.stream.peekChar(1) === Se
										? (this.stream.advance(2), this.finishToken(e, o.PrefixOperator))
										: this.stream.peekChar(0) === zr && this.stream.peekChar(1) === Se
											? (this.stream.advance(2), this.finishToken(e, o.SuffixOperator))
											: (this.stream.nextChar(), this.finishToken(e, o.Delim)))
		}
		trivia() {
			for (;;) {
				const e = this.stream.pos()
				if (this._whitespace()) {
					if (!this.ignoreWhitespace) return this.finishToken(e, o.Whitespace)
				} else if (this.comment()) {
					if (!this.ignoreComment) return this.finishToken(e, o.Comment)
				} else return null
			}
		}
		comment() {
			if (this.stream.advanceIfChars([an, rt])) {
				let e = !1,
					t = !1
				return (
					this.stream.advanceWhileChar((n) =>
						t && n === an ? ((e = !0), !1) : ((t = n === rt), !0),
					),
		...
		_number() {
			let e = 0,
				t
			return (
				this.stream.peekChar() === hn && (e = 1),
				(t = this.stream.peekChar(e)),
				t >= ve && t <= ye
					? (this.stream.advance(e + 1),
						this.stream.advanceWhileChar((n) => (n >= ve && n <= ye) || (e === 0 && n === hn)),
						!0)
					: !1
			)
		}
		_newline(e) {
			const t = this.stream.peekChar()
			switch (t) {
				case ce:
				case xe:
				case le:
...
`),
		...
		_escape(e, t) {
			let n = this.stream.peekChar()
			if (n === it) {
				;(this.stream.advance(1), (n = this.stream.peekChar()))
				let i = 0
				for (; i < 6 && ((n >= ve && n <= ye) || (n >= Ae && n <= Zt) || (n >= Ne && n <= tn)); )
					(this.stream.advance(1), (n = this.stream.peekChar()), i++)
				if (i > 0) {
					try {
						const s = parseInt(this.stream.substring(this.stream.pos() - i), 16)
						s && e.push(String.fromCharCode(s))
					} catch {}
					return (n === st || n === ot ? this.stream.advance(1) : this._newline([]), !0)
				}
				if (n !== ce && n !== xe && n !== le)
		...
		_stringChar(e, t) {
			const n = this.stream.peekChar()
			return n !== 0 && n !== e && n !== it && n !== ce && n !== xe && n !== le
				? (this.stream.advance(1), t.push(String.fromCharCode(n)), !0)
				: !1
		}
		_string(e) {
			if (this.stream.peekChar() === cn || this.stream.peekChar() === ln) {
				const t = this.stream.nextChar()
				for (e.push(String.fromCharCode(t)); this._stringChar(t, e) || this._escape(e, !0); );
				return this.stream.peekChar() === t
					? (this.stream.nextChar(), e.push(String.fromCharCode(t)), o.String)
					: o.BadString
			}
			return null
		}
		...
		ident(e) {
			const t = this.stream.pos()
			if (this._minus(e)) {
				if (this._minus(e) || this._identFirstChar(e) || this._escape(e)) {
		...
		_identFirstChar(e) {
			const t = this.stream.peekChar()
			return t === rn || (t >= Ae && t <= en) || (t >= Ne && t <= nn) || (t >= 128 && t <= 65535)
				? (this.stream.advance(1), e.push(String.fromCharCode(t)), !0)
				: !1
		}
		_minus(e) {
			const t = this.stream.peekChar()
			return t === se ? (this.stream.advance(1), e.push(String.fromCharCode(t)), !0) : !1
		}
		_identChar(e) {
			const t = this.stream.peekChar()
			return t === rn ||
		...
		_unicodeRange() {
			if (this.stream.advanceIfChar(Lr)) {
				const e = (n) => (n >= ve && n <= ye) || (n >= Ae && n <= Zt) || (n >= Ne && n <= tn),
					t = this.stream.advanceWhileChar(e) + this.stream.advanceWhileChar((n) => n === Wr)
				if (t >= 1 && t <= 6)
					if (this.stream.advanceIfChar(se)) {
						const n = this.stream.advanceWhileChar(e)
						if (n >= 1 && n <= 6) return !0
					} else return !0
			}
			return !1
	...
	function I(r, e) {
		...
		for (let t = 0; t < e.length; t++) if (r[t] !== e[t]) return !1
		return !0
	}
	function pn(r, e) {
	...
	function $r(r, e, t = 4) {
		let n = Math.abs(r.length - e.length)
		if (n > t) return 0
		let i = [],
			s = [],
			a,
			c
		for (a = 0; a < e.length + 1; ++a) s.push(0)
		for (a = 0; a < r.length + 1; ++a) i.push(s)
		for (a = 1; a < r.length + 1; ++a)
			for (c = 1; c < e.length + 1; ++c)
				r[a - 1] === e[c - 1]
					? (i[a][c] = i[a - 1][c - 1] + 1)
					: (i[a][c] = Math.max(i[a - 1][c], i[a][c - 1]))
		return i[r.length][e.length] - Math.sqrt(n)
	}
	function mn(r, e = !0) {
		return r ? (r.length < 140 ? r : r.slice(0, 140) + (e ? '…' : '')) : ''
	}
	function Ur(r, e) {
		const t = e.exec(r)
	...
	;(function (r) {
		;((r[(r.Undefined = 0)] = 'Undefined'),
			...
			(r[(r.Stylesheet = 2)] = 'Stylesheet'),
			(r[(r.Ruleset = 3)] = 'Ruleset'),
			(r[(r.Selector = 4)] = 'Selector'),
			(r[(r.SimpleSelector = 5)] = 'SimpleSelector'),
			(r[(r.SelectorInterpolation = 6)] = 'SelectorInterpolation'),
			(r[(r.SelectorCombinator = 7)] = 'SelectorCombinator'),
			(r[(r.SelectorCombinatorParent = 8)] = 'SelectorCombinatorParent'),
			(r[(r.SelectorCombinatorSibling = 9)] = 'SelectorCombinatorSibling'),
			(r[(r.SelectorCombinatorAllSiblings = 10)] = 'SelectorCombinatorAllSiblings'),
			(r[(r.SelectorCombinatorShadowPiercingDescendant = 11)] =
				'SelectorCombinatorShadowPiercingDescendant'),
			(r[(r.Page = 12)] = 'Page'),
			(r[(r.PageBoxMarginBox = 13)] = 'PageBoxMarginBox'),
			(r[(r.ClassSelector = 14)] = 'ClassSelector'),
			(r[(r.IdentifierSelector = 15)] = 'IdentifierSelector'),
			(r[(r.ElementNameSelector = 16)] = 'ElementNameSelector'),
			(r[(r.PseudoSelector = 17)] = 'PseudoSelector'),
			(r[(r.AttributeSelector = 18)] = 'AttributeSelector'),
			(r[(r.Declaration = 19)] = 'Declaration'),
			(r[(r.Declarations = 20)] = 'Declarations'),
			(r[(r.Property = 21)] = 'Property'),
			(r[(r.Expression = 22)] = 'Expression'),
			(r[(r.BinaryExpression = 23)] = 'BinaryExpression'),
			(r[(r.Term = 24)] = 'Term'),
			(r[(r.Operator = 25)] = 'Operator'),
			(r[(r.Value = 26)] = 'Value'),
			(r[(r.StringLiteral = 27)] = 'StringLiteral'),
			(r[(r.URILiteral = 28)] = 'URILiteral'),
			(r[(r.EscapedValue = 29)] = 'EscapedValue'),
			(r[(r.Function = 30)] = 'Function'),
			(r[(r.NumericValue = 31)] = 'NumericValue'),
			(r[(r.HexColorValue = 32)] = 'HexColorValue'),
			(r[(r.RatioValue = 33)] = 'RatioValue'),
			(r[(r.MixinDeclaration = 34)] = 'MixinDeclaration'),
			(r[(r.MixinReference = 35)] = 'MixinReference'),
			(r[(r.VariableName = 36)] = 'VariableName'),
			(r[(r.VariableDeclaration = 37)] = 'VariableDeclaration'),
			(r[(r.Prio = 38)] = 'Prio'),
			(r[(r.Interpolation = 39)] = 'Interpolation'),
			(r[(r.NestedProperties = 40)] = 'NestedProperties'),
			(r[(r.ExtendsReference = 41)] = 'ExtendsReference'),
			(r[(r.SelectorPlaceholder = 42)] = 'SelectorPlaceholder'),
			(r[(r.Debug = 43)] = 'Debug'),
			(r[(r.If = 44)] = 'If'),
			(r[(r.Else = 45)] = 'Else'),
			(r[(r.For = 46)] = 'For'),
			(r[(r.Each = 47)] = 'Each'),
			(r[(r.While = 48)] = 'While'),
			(r[(r.MixinContentReference = 49)] = 'MixinContentReference'),
			(r[(r.MixinContentDeclaration = 50)] = 'MixinContentDeclaration'),
			(r[(r.Media = 51)] = 'Media'),
			(r[(r.Keyframe = 52)] = 'Keyframe'),
			(r[(r.FontFace = 53)] = 'FontFace'),
			(r[(r.Import = 54)] = 'Import'),
			(r[(r.Namespace = 55)] = 'Namespace'),
			(r[(r.Invocation = 56)] = 'Invocation'),
			(r[(r.FunctionDeclaration = 57)] = 'FunctionDeclaration'),
			(r[(r.ReturnStatement = 58)] = 'ReturnStatement'),
			(r[(r.MediaQuery = 59)] = 'MediaQuery'),
			(r[(r.MediaCondition = 60)] = 'MediaCondition'),
			(r[(r.MediaFeature = 61)] = 'MediaFeature'),
			(r[(r.FunctionParameter = 62)] = 'FunctionParameter'),
			(r[(r.FunctionArgument = 63)] = 'FunctionArgument'),
			(r[(r.KeyframeSelector = 64)] = 'KeyframeSelector'),
			(r[(r.ViewPort = 65)] = 'ViewPort'),
			(r[(r.Document = 66)] = 'Document'),
			(r[(r.AtApplyRule = 67)] = 'AtApplyRule'),
			(r[(r.CustomPropertyDeclaration = 68)] = 'CustomPropertyDeclaration'),
			(r[(r.CustomPropertySet = 69)] = 'CustomPropertySet'),
			(r[(r.ListEntry = 70)] = 'ListEntry'),
			(r[(r.Supports = 71)] = 'Supports'),
			(r[(r.SupportsCondition = 72)] = 'SupportsCondition'),
			(r[(r.NamespacePrefix = 73)] = 'NamespacePrefix'),
			(r[(r.GridLine = 74)] = 'GridLine'),
			(r[(r.Plugin = 75)] = 'Plugin'),
			(r[(r.UnknownAtRule = 76)] = 'UnknownAtRule'),
			(r[(r.Use = 77)] = 'Use'),
			(r[(r.ModuleConfiguration = 78)] = 'ModuleConfiguration'),
			(r[(r.Forward = 79)] = 'Forward'),
			(r[(r.ForwardVisibility = 80)] = 'ForwardVisibility'),
			(r[(r.Module = 81)] = 'Module'),
			(r[(r.UnicodeRange = 82)] = 'UnicodeRange'),
			(r[(r.Layer = 83)] = 'Layer'),
			(r[(r.LayerNameList = 84)] = 'LayerNameList'),
			(r[(r.LayerName = 85)] = 'LayerName'),
			(r[(r.PropertyAtRule = 86)] = 'PropertyAtRule'),
			(r[(r.Container = 87)] = 'Container'))
	})(p || (p = {}))
	var S
	;(function (r) {
		;((r[(r.Mixin = 0)] = 'Mixin'),
			(r[(r.Rule = 1)] = 'Rule'),
			(r[(r.Variable = 2)] = 'Variable'),
			(r[(r.Function = 3)] = 'Function'),
			(r[(r.Keyframe = 4)] = 'Keyframe'),
			(r[(r.Unknown = 5)] = 'Unknown'),
			(r[(r.Module = 6)] = 'Module'),
			(r[(r.Forward = 7)] = 'Forward'),
			(r[(r.ForwardVisibility = 8)] = 'ForwardVisibility'),
			(r[(r.Property = 9)] = 'Property'))
	})(S || (S = {}))
	function at(r, e) {
		let t = null
		return !r || e < r.offset || e > r.end
			? null
			: (r.accept((n) =>
					n.offset === -1 && n.length === -1
						? !0
						: n.offset <= e && n.end >= e
							? (t ? n.length <= t.length && (t = n) : (t = n), !0)
							: !1,
				),
				t)
	}
	...
	function Vr(r) {
		const e = r.findParent(p.Declaration),
			t = e && e.getValue()
	...
	class b {
		...
		constructor(e = -1, t = -1, n) {
			;((this.parent = null), (this.offset = e), (this.length = t), n && (this.nodeType = n))
		}
		set type(e) {
			this.nodeType = e
		}
		get type() {
			return this.nodeType || p.Undefined
		}
		getTextProvider() {
			let e = this
		...
		accept(e) {
			if (e(this) && this.children) for (const t of this.children) t.accept(e)
		}
		acceptVisitor(e) {
		...
		attachTo(e, t = -1) {
			return (e && e.adoptChild(this, t), this)
		}
		collectIssues(e) {
		...
		hasIssue(e) {
			return Array.isArray(this.issues) && this.issues.some((t) => t.getRule() === e)
		}
		isErroneous(e = !1) {
			return this.issues && this.issues.length > 0
				? !0
				: e && Array.isArray(this.children) && this.children.some((t) => t.isErroneous(!0))
		}
		setNode(e, t, n = -1) {
			return t ? (t.attachTo(this, n), (this[e] = t), !0) : !1
		}
		addChild(e) {
			return e
		...
		addChildren(e) {
			for (const t of e) this.addChild(t)
		}
		findFirstChildBeforeOffset(e) {
			if (this.children) {
				let t = null
		...
		findChildAtOffset(e, t) {
			const n = this.findFirstChildBeforeOffset(e)
		...
		findAParent(...e) {
			let t = this
			for (; t && !e.some((n) => t.type === n); ) t = t.parent
			return t
		}
		setData(e, t) {
	...
	class T extends b {
		constructor(e, t = -1) {
			;(super(-1, -1), this.attachTo(e, t), (this.offset = -1), (this.length = -1))
		}
	}
	class Br extends b {
		constructor(e, t) {
		...
		setRangeStart(e) {
			return this.setNode('rangeStart', e)
		}
		getRangeStart() {
			return this.rangeStart
		}
		setRangeEnd(e) {
			return this.setNode('rangeEnd', e)
		}
		getRangeEnd() {
	...
	class U extends b {
		constructor(e, t) {
			;(super(e, t), (this.isCustomProperty = !1))
		}
		get type() {
			return p.Identifier
		}
	...
	class oe extends E {
		...
		getSelectors() {
			return (this.selectors || (this.selectors = new T(this)), this.selectors)
		}
		isNested() {
			return !!this.parent && this.parent.findParent(p.Declarations) !== null
		}
	}
	class ke extends b {
		constructor(e, t) {
	...
	class jr extends E {
		...
		get type() {
			return p.CustomPropertySet
		}
	}
	class V extends ht {
		constructor(e, t) {
			;(super(e, t), (this.property = null))
		}
		get type() {
		...
		getFullPropertyName() {
			const e = this.property ? this.property.getName() : 'unknown'
			if (this.parent instanceof ct && this.parent.getParent() instanceof gn) {
				const t = this.parent.getParent().getParent()
				if (t instanceof V) return t.getFullPropertyName() + e
			}
			return e
		}
		getNonPrefixedPropertyName() {
			const e = this.getFullPropertyName()
			if (e && e.charAt(0) === '-') {
				const t = e.indexOf('-', 1)
	...
	class qr extends V {
		...
		get type() {
			return p.CustomPropertyDeclaration
		}
		setPropertySet(e) {
	...
	class Gr extends b {
		...
		getArguments() {
			return (this.arguments || (this.arguments = new T(this)), this.arguments)
		}
	}
	class Fe extends Gr {
		constructor(e, t) {
	...
	class Yr extends E {
		...
		getVariables() {
			return (this.variables || (this.variables = new T(this)), this.variables)
		}
	}
	class Xr extends E {
		constructor(e, t) {
	...
	class Le extends E {
		...
		getParameters() {
			return (this.parameters || (this.parameters = new T(this)), this.parameters)
		}
	}
	class Zr extends E {
		constructor(e, t) {
	...
	class ni extends b {
		...
		getMembers() {
			return (this.members || (this.members = new T(this)), this.members)
		}
		getParameters() {
			return (this.parameters || (this.parameters = new T(this)), this.parameters)
		}
	...
	class oi extends E {
		...
		get type() {
			return p.PropertyAtRule
		}
		setName(e) {
			return e ? (e.attachTo(this), (this.name = e), !0) : !1
		}
		getName() {
			return this.name
		}
	...
	class bt extends b {
		...
		getValue() {
			...
			for (
				let i = 0, s = e.length;
				i < s && ((n = e.charCodeAt(i)), (bi <= n && n <= wi) || n === gi);
				i++
			)
				t += 1
			return { value: e.substring(0, t), unit: t < e.length ? e.substring(t) : void 0 }
		}
	}
	class $e extends ht {
		constructor(e, t) {
			;(super(e, t), (this.needsSemicolon = !0))
		}
		get type() {
	...
	class vi extends b {
		...
		get type() {
			return p.MixinContentReference
		}
		getArguments() {
			return (this.arguments || (this.arguments = new T(this)), this.arguments)
		}
	...
	class yi extends E {
		...
		get type() {
			return p.MixinContentDeclaration
		}
		getParameters() {
			return (this.parameters || (this.parameters = new T(this)), this.parameters)
		}
	...
	class Ue extends b {
		...
		get type() {
			return p.MixinReference
		}
		getNamespaces() {
			return (this.namespaces || (this.namespaces = new T(this)), this.namespaces)
		}
		setIdentifier(e) {
			return this.setNode('identifier', e, 0)
		}
	...
	class xi extends b {
		getConditions() {
			return (this.conditions || (this.conditions = new T(this)), this.conditions)
		}
	}
	class Ci extends b {
		setVariable(e) {
	...
	class kn {
		constructor(e, t, n, i, s = e.offset, a = e.length) {
			;((this.node = e),
				(this.rule = t),
				(this.level = n),
	...
	const u = {
		NumberExpected: new x('css-numberexpected', d.t('number expected')),
		ConditionExpected: new x('css-conditionexpected', d.t('condition expected')),
		RuleOrSelectorExpected: new x(
			'css-ruleorselectorexpected',
			d.t('at-rule or selector expected'),
		),
		DotExpected: new x('css-dotexpected', d.t('dot expected')),
		ColonExpected: new x('css-colonexpected', d.t('colon expected')),
		SemiColonExpected: new x('css-semicolonexpected', d.t('semi-colon expected')),
		TermExpected: new x('css-termexpected', d.t('term expected')),
		ExpressionExpected: new x('css-expressionexpected', d.t('expression expected')),
		OperatorExpected: new x('css-operatorexpected', d.t('operator expected')),
		IdentifierExpected: new x('css-identifierexpected', d.t('identifier expected')),
		PercentageExpected: new x('css-percentageexpected', d.t('percentage expected')),
		URIOrStringExpected: new x('css-uriorstringexpected', d.t('uri or string expected')),
		URIExpected: new x('css-uriexpected', d.t('URI expected')),
		VariableNameExpected: new x('css-varnameexpected', d.t('variable name expected')),
		VariableValueExpected: new x('css-varvalueexpected', d.t('variable value expected')),
		PropertyValueExpected: new x('css-propertyvalueexpected', d.t('property value expected')),
		LeftCurlyExpected: new x('css-lcurlyexpected', d.t('{ expected')),
		RightCurlyExpected: new x('css-rcurlyexpected', d.t('} expected')),
		LeftSquareBracketExpected: new x('css-rbracketexpected', d.t('[ expected')),
		RightSquareBracketExpected: new x('css-lbracketexpected', d.t('] expected')),
		LeftParenthesisExpected: new x('css-lparentexpected', d.t('( expected')),
		RightParenthesisExpected: new x('css-rparentexpected', d.t(') expected')),
		CommaExpected: new x('css-commaexpected', d.t('comma expected')),
		PageDirectiveOrDeclarationExpected: new x(
			'css-pagedirordeclexpected',
			d.t('page directive or declaraton expected'),
		),
		UnknownAtRule: new x('css-unknownatrule', d.t('at-rule unknown')),
		UnknownKeyword: new x('css-unknownkeyword', d.t('unknown keyword')),
		SelectorExpected: new x('css-selectorexpected', d.t('selector expected')),
		StringLiteralExpected: new x('css-stringliteralexpected', d.t('string literal expected')),
		WhitespaceExpected: new x('css-whitespaceexpected', d.t('whitespace expected')),
		MediaQueryExpected: new x('css-mediaqueryexpected', d.t('media query expected')),
		IdentifierOrWildcardExpected: new x(
			'css-idorwildcardexpected',
			d.t('identifier or wildcard expected'),
		),
		WildcardExpected: new x('css-wildcardexpected', d.t('wildcard expected')),
		IdentifierOrVariableExpected: new x(
			'css-idorvarexpected',
			d.t('identifier or variable expected'),
		),
	}
	var Fn
	;(function (r) {
		r.LATEST = {
			textDocument: {
				completion: {
					completionItem: { documentationFormat: [f.MarkupKind.Markdown, f.MarkupKind.PlainText] },
				},
				hover: { contentFormat: [f.MarkupKind.Markdown, f.MarkupKind.PlainText] },
			},
		}
	})(Fn || (Fn = {}))
	var De
	...
	const En = { E: 'Edge', FF: 'Firefox', S: 'Safari', C: 'Chrome', IE: 'IE', O: 'Opera' }
	function _n(r) {
		switch (r) {
			case 'experimental':
...
`
	...
	function ne(r, e, t) {
		...
		if (
			(e
				? (n = { kind: 'markdown', value: Fi(r, t) })
				: (n = { kind: 'plaintext', value: ki(r, t) }),
			n.value !== '')
		)
			return n
	}
	...
	function ki(r, e) {
		if (!r.description || r.description === '') return ''
		if (typeof r.description != 'string') return r.description.value
		let t = ''
		if (e?.documentation !== !1) {
			;(r.status && (t += _n(r.status)), (t += r.description))
			const n = In(r.browsers)
			;(n &&
				(t +=
					`
(` +
...
`),
				(t += r.references.map((n) => `${n.name}: ${n.url}`).join(' | '))),
			t
		)
	}
	function Fi(r, e) {
		...
		let t = ''
		if (e?.documentation !== !1) {
			;(r.status && (t += _n(r.status)),
				typeof r.description == 'string'
					? (t += Ve(r.description))
					: (t +=
							r.description.kind === f.MarkupKind.Markdown
								? r.description.value
								: Ve(r.description.value)))
			const n = In(r.browsers)
			;(n &&
				(t +=
					`
...
`),
			...
			: r
					.map((e) => {
						...
						const n = e.match(/([A-Z]+)(\d+)?/),
							i = n[1],
							s = n[2]
						return (i in En && (t += En[i]), s && (t += ' ' + s), t)
					})
					.join(', ')
	}
	const Ei = /(^#([0-9A-F]{3}){1,2}$)|(^#([0-9A-F]{4}){1,2}$)/i,
		_i = [
			{
				label: 'rgb',
				func: 'rgb($red, $green, $blue)',
				insertText: 'rgb(${1:red}, ${2:green}, ${3:blue})',
				desc: d.t('Creates a Color from red, green, and blue values.'),
			},
			{
				label: 'rgba',
				func: 'rgba($red, $green, $blue, $alpha)',
				insertText: 'rgba(${1:red}, ${2:green}, ${3:blue}, ${4:alpha})',
				desc: d.t('Creates a Color from red, green, blue, and alpha values.'),
			},
			{
				label: 'rgb relative',
				func: 'rgb(from $color $red $green $blue)',
				insertText: 'rgb(from ${1:color} ${2:r} ${3:g} ${4:b})',
				desc: d.t('Creates a Color from the red, green, and blue values of another Color.'),
			},
			{
				label: 'hsl',
				func: 'hsl($hue, $saturation, $lightness)',
				insertText: 'hsl(${1:hue}, ${2:saturation}, ${3:lightness})',
				desc: d.t('Creates a Color from hue, saturation, and lightness values.'),
			},
			{
				label: 'hsla',
				func: 'hsla($hue, $saturation, $lightness, $alpha)',
				insertText: 'hsla(${1:hue}, ${2:saturation}, ${3:lightness}, ${4:alpha})',
				desc: d.t('Creates a Color from hue, saturation, lightness, and alpha values.'),
			},
			{
				label: 'hsl relative',
			...
			},
			{
				...
				desc: d.t('Creates a Color from hue, white, and black values.'),
			},
			{
				label: 'hwb relative',
				func: 'hwb(from $color $hue $white $black)',
				insertText: 'hwb(from ${1:color} ${2:h} ${3:w} ${4:b})',
				desc: d.t('Creates a Color from the hue, white, and black values of another Color.'),
			},
			{
				label: 'lab',
				func: 'lab($lightness $a $b)',
				insertText: 'lab(${1:lightness} ${2:a} ${3:b})',
				desc: d.t('Creates a Color from lightness, a, and b values.'),
			},
			{
				label: 'lab relative',
				func: 'lab(from $color $lightness $a $b)',
				insertText: 'lab(from ${1:color} ${2:l} ${3:a} ${4:b})',
				desc: d.t('Creates a Color from the lightness, a, and b values of another Color.'),
			},
			{
				label: 'oklab',
			...
			},
			{
				...
				desc: d.t('Creates a Color from lightness, chroma, and hue values.'),
			},
			{
				label: 'lch relative',
				func: 'lch(from $color $lightness $chroma $hue)',
				insertText: 'lch(from ${1:color} ${2:l} ${3:c} ${4:h})',
				desc: d.t('Creates a Color from the lightness, chroma, and hue values of another Color.'),
			},
			{
				label: 'oklch',
			...
			},
			{
				...
				desc: d.t('Creates a Color in a specific color space from red, green, and blue values.'),
			},
			{
			...
			},
			{
				...
				desc: d.t('Mix two colors together in a rectangular color space.'),
			},
			{
				label: 'color-mix hue',
				...
				desc: d.t('Mix two colors together in a polar color space.'),
			},
		],
		Ii = /^(rgb|rgba|hsl|hsla|hwb)$/i,
		Be = {
			aliceblue: '#f0f8ff',
			antiquewhite: '#faebd7',
			aqua: '#00ffff',
		...
		Di = new RegExp(`^(${Object.keys(Be).join('|')})$`, 'i'),
		St = {
			currentColor:
		...
		zi = new RegExp(`^(${Object.keys(St).join('|')})$`, 'i')
	function re(r, e) {
		const n = r.getText().match(/^([-+]?[0-9]*\.?[0-9]+)(%?)$/)
		if (n) {
			n[2] && (e = 100)
			const i = parseFloat(n[1]) / e
			if (i >= 0 && i <= 1) return i
		}
		throw new Error()
	}
	function Dn(r) {
		const e = r.getText(),
			t = e.match(/^([-+]?[0-9]*\.?[0-9]+)(deg|rad|grad|turn)?$/)
		if (t)
			switch (t[2]) {
				case 'deg':
					return parseFloat(e) % 360
				case 'rad':
					return ((parseFloat(e) * 180) / Math.PI) % 360
				case 'grad':
					return (parseFloat(e) * 0.9) % 360
				case 'turn':
					return (parseFloat(e) * 360) % 360
				default:
					if (typeof t[2] > 'u') return parseFloat(e) % 360
			}
		throw new Error()
	}
	function Ri(r) {
		const e = r.getName()
		return e ? Ii.test(e) : !1
	}
	function zn(r) {
		return Ei.test(r) || Di.test(r) || zi.test(r)
	}
	const Rn = 48,
		Mi = 57,
		Oi = 65,
	...
	function _(r) {
		return r < Rn
			...
			: r <= Mi
				? r - Rn
				: (r < Ke && (r += Ke - Oi), r >= Ke && r <= Pi ? r - Ke + 10 : 0)
	}
	function Mn(r) {
		if (r[0] !== '#') return null
		switch (r.length) {
			case 4:
				return {
					red: (_(r.charCodeAt(1)) * 17) / 255,
					green: (_(r.charCodeAt(2)) * 17) / 255,
					blue: (_(r.charCodeAt(3)) * 17) / 255,
					alpha: 1,
				}
			case 5:
				return {
					...
					green: (_(r.charCodeAt(2)) * 17) / 255,
					blue: (_(r.charCodeAt(3)) * 17) / 255,
					alpha: (_(r.charCodeAt(4)) * 17) / 255,
				}
			case 7:
				return {
					red: (_(r.charCodeAt(1)) * 16 + _(r.charCodeAt(2))) / 255,
					green: (_(r.charCodeAt(3)) * 16 + _(r.charCodeAt(4))) / 255,
					blue: (_(r.charCodeAt(5)) * 16 + _(r.charCodeAt(6))) / 255,
					alpha: 1,
				}
			case 9:
				return {
					...
					green: (_(r.charCodeAt(3)) * 16 + _(r.charCodeAt(4))) / 255,
					blue: (_(r.charCodeAt(5)) * 16 + _(r.charCodeAt(6))) / 255,
					alpha: (_(r.charCodeAt(7)) * 16 + _(r.charCodeAt(8))) / 255,
				}
		}
		return null
	}
	function On(r, e, t, n = 1) {
		if (((r = r / 60), e === 0)) return { red: t, green: t, blue: t, alpha: n }
		{
			const i = (c, l, h) => {
					for (; h < 0; ) h += 6
					for (; h >= 6; ) h -= 6
					return h < 1 ? (l - c) * h + c : h < 3 ? l : h < 4 ? (l - c) * (4 - h) + c : c
				},
				s = t <= 0.5 ? t * (e + 1) : t + e - t * e,
				a = t * 2 - s
			return { red: i(a, s, r + 2), green: i(a, s, r), blue: i(a, s, r - 2), alpha: n }
		}
	}
	function Pn(r) {
		const e = r.red,
		...
		const h = (a + s) / 2,
			m = s - a
		if (m > 0) {
			switch (((l = Math.min(h <= 0.5 ? m / (2 * h) : m / (2 - 2 * h), 1)), s)) {
				case e:
					c = (t - n) / m + (t < n ? 6 : 0)
					break
				case t:
		...
		return { h: c, s: l, l: h, a: i }
	}
	function Ti(r, e, t, n = 1) {
		if (e + t >= 1) {
			const l = e / (e + t)
			return { red: l, green: l, blue: l, alpha: n }
		}
		const i = On(r, 1, 0.5, n)
		let s = i.red
		;((s *= 1 - e - t), (s += e))
		let a = i.green
		;((a *= 1 - e - t), (a += e))
		let c = i.blue
		return ((c *= 1 - e - t), (c += e), { red: s, green: a, blue: c, alpha: n })
	}
	function Ai(r) {
		const e = Pn(r),
			t = Math.min(r.red, r.green, r.blue),
			n = 1 - Math.max(r.red, r.green, r.blue)
		return { h: e.h, w: t, b: n, a: e.a }
	}
	function Ni(r) {
		if (r.type === p.HexColorValue) {
			const e = r.getText()
			return Mn(e)
		} else if (r.type === p.Function) {
			const e = r,
				t = e.getName()
			let n = e.getArguments().getChildren()
			if (n.length === 1) {
				const i = n[0].getChildren()
				if (
					i.length === 1 &&
					i[0].type === p.Expression &&
					((n = i[0].getChildren()), n.length === 3)
				) {
					const s = n[2]
					if (s instanceof ft) {
						const a = s.getLeft(),
							c = s.getRight(),
							l = s.getOperator()
						a && c && l && l.matches('/') && (n = [n[0], n[1], a, c])
					}
				}
			}
			if (!t || n.length < 3 || n.length > 4) return null
			try {
				const i = n.length === 4 ? re(n[3], 1) : 1
				if (t === 'rgb' || t === 'rgba')
					return { red: re(n[0], 255), green: re(n[1], 255), blue: re(n[2], 255), alpha: i }
				if (t === 'hsl' || t === 'hsla') {
					const s = Dn(n[0]),
						a = re(n[1], 100),
						c = re(n[2], 100)
		...
		} else if (r.type === p.Identifier) {
			if (r.parent && r.parent.type !== p.Term) return null
			const e = r.parent
			if (e && e.parent && e.parent.type === p.BinaryExpression) {
				const i = e.parent
				if (i.parent && i.parent.type === p.ListEntry && i.parent.key === i) return null
			}
			const t = r.getText().toLowerCase()
	...
	class qe {
		constructor(e = new Ce()) {
			;((this.keyframeRegex = /^@(\-(webkit|ms|moz|o)\-)?keyframes$/i),
				(this.scanner = e),
				(this.token = { type: o.EOF, offset: -1, len: 0, text: '' }),
				(this.prevToken = void 0))
		}
		peekIdent(e) {
			return (
				o.Ident === this.token.type &&
		...
		peekKeyword(e) {
			return (
				o.AtKeyword === this.token.type &&
				e.length === this.token.text.length &&
				e === this.token.text.toLowerCase()
			)
		}
		peekDelim(e) {
			return o.Delim === this.token.type && e === this.token.text
		}
		peek(e) {
		...
		acceptUnicodeRange() {
			const e = this.scanner.tryScanUnicode()
			return e ? ((this.prevToken = e), (this.token = this.scanner.scan()), !0) : !1
		}
		mark() {
		...
		acceptOneKeyword(e) {
			if (o.AtKeyword === this.token.type) {
				for (const t of e)
					if (t.length === this.token.text.length && t === this.token.text.toLowerCase())
		...
		_parseRegexp(e) {
			let t = this.createNode(p.Identifier)
			do;
			while (this.acceptRegexp(e))
			return this.finish(t)
		}
		acceptUnquotedString() {
			const e = this.scanner.pos()
			this.scanner.goBackTo(this.token.offset)
			const t = this.scanner.scanUnquotedString()
			return t ? ((this.token = t), this.consumeToken(), !0) : (this.scanner.goBackTo(e), !1)
		}
		resync(e, t) {
			for (;;) {
				if (e && e.indexOf(this.token.type) !== -1) return (this.consumeToken(), !0)
				if (t && t.indexOf(this.token.type) !== -1) return !0
				if (this.token.type === o.EOF) return !1
				this.token = this.scanner.scan()
			}
		}
		createNode(e) {
			return new b(this.token.offset, this.token.len, e)
		}
		create(e) {
			return new e(this.token.offset, this.token.len)
		}
		finish(e, t, n, i) {
			if (!(e instanceof T) && (t && this.markError(e, t, n, i), this.prevToken)) {
				const s = this.prevToken.offset + this.prevToken.len
		...
		markError(e, t, n, i) {
			;(this.token !== this.lastErrorToken &&
				(e.addIssue(new kn(e, t, L.Error, void 0, this.token.offset, this.token.len)),
		...
		parseStylesheet(e) {
			...
			return this.internalParse(n, this._parseStylesheet, i)
		}
		internalParse(e, t, n) {
			;(this.scanner.setSource(e), (this.token = this.scanner.scan()))
			const i = t.bind(this)()
			return (i && (n ? (i.textProvider = n) : (i.textProvider = (s, a) => e.substr(s, a))), i)
		}
		_parseStylesheet() {
			const e = this.create(Kr)
			...
			do {
				...
				do {
					n = !1
					const i = this._parseStylesheetStatement()
					for (
						i &&
						(e.addChild(i),
						(n = !0),
						...
						!this.peek(o.EOF) &&
							...
							!this.accept(o.SemiColon) &&
							this.markError(e, u.SemiColonExpected));
						this.accept(o.SemiColon) || this.accept(o.CDO) || this.accept(o.CDC);
					)
						((n = !0), (t = !1))
				} while (n)
				if (this.peek(o.EOF)) break
				;(t ||
					(this.peek(o.AtKeyword)
						? this.markError(e, u.UnknownAtRule)
						: this.markError(e, u.RuleOrSelectorExpected),
					(t = !0)),
					this.consumeToken())
			} while (!this.peek(o.EOF))
		...
		_parseStylesheetStatement(e = !1) {
			return this.peek(o.AtKeyword) ? this._parseStylesheetAtStatement(e) : this._parseRuleset(e)
		}
		_parseStylesheetAtStatement(e = !1) {
			return (
				this._parseImport() ||
				this._parseMedia(e) ||
				this._parsePage() ||
		...
		_tryParseRuleset(e) {
			...
			if (this._parseSelector(e)) {
				for (; this.accept(o.Comma) && this._parseSelector(e); );
				if (this.accept(o.CurlyL)) return (this.restoreAtMark(t), this._parseRuleset(e))
			}
			return (this.restoreAtMark(t), null)
		}
		_parseRuleset(e = !1) {
			const t = this.create(oe),
				n = t.getSelectors()
			if (!n.addChild(this._parseSelector(e))) return null
			for (; this.accept(o.Comma); )
				if (!n.addChild(this._parseSelector(e))) return this.finish(t, u.SelectorExpected)
		...
		_needsSemicolonAfter(e) {
			switch (e.type) {
				...
				case p.Each:
				case p.While:
				case p.MixinDeclaration:
				case p.FunctionDeclaration:
				case p.MixinContentDeclaration:
					return !1
				case p.ExtendsReference:
				case p.MixinContentReference:
				case p.ReturnStatement:
				case p.MediaQuery:
				case p.Debug:
				case p.Import:
				case p.AtApplyRule:
				case p.CustomPropertyDeclaration:
					return !0
				case p.VariableDeclaration:
					return e.needsSemicolon
				case p.MixinReference:
					return !e.getContent()
				case p.Declaration:
		...
		_parseDeclarations(e) {
			const t = this.create(ct)
			if (!this.accept(o.CurlyL)) return null
			let n = e()
			for (; t.addChild(n) && !this.peek(o.CurlyR); ) {
				if (this._needsSemicolonAfter(n) && !this.accept(o.SemiColon))
					return this.finish(t, u.SemiColonExpected, [o.SemiColon, o.CurlyR])
				for (
					n &&
					this.prevToken &&
					this.prevToken.type === o.SemiColon &&
					(n.semicolonPosition = this.prevToken.offset);
					this.accept(o.SemiColon);
				);
				n = e()
			}
			return this.accept(o.CurlyR)
				? this.finish(t)
				: this.finish(t, u.RightCurlyExpected, [o.CurlyR, o.SemiColon])
		}
		_parseBody(e, t) {
			return e.setDeclarations(this._parseDeclarations(t))
				? this.finish(e)
				: this.finish(e, u.LeftCurlyExpected, [o.CurlyR, o.SemiColon])
		}
		_parseSelector(e) {
			const t = this.create(ke)
			let n = !1
			for (
					...
					? (this.prevToken && (n.colonPosition = this.prevToken.offset),
						n.setValue(this._parseExpr())
							? (n.addChild(this._parsePrio()),
								this.peek(o.SemiColon) && (n.semicolonPosition = this.token.offset),
								this.finish(n))
							: this.finish(n, u.PropertyValueExpected))
					: this.finish(n, u.ColonExpected, [o.Colon], e || [o.SemiColon])
				: null
		}
		_tryParseCustomPropertyDeclaration(e) {
			if (!this.peekRegExp(o.Ident, /^--/)) return null
			const t = this.create(qr)
			if (!t.setProperty(this._parseProperty())) return null
			if (!this.accept(o.Colon)) return this.finish(t, u.ColonExpected, [o.Colon])
			this.prevToken && (t.colonPosition = this.prevToken.offset)
			const n = this.mark()
			if (this.peek(o.CurlyL)) {
				const s = this.create(jr),
					a = this._parseDeclarations(this._parseRuleSetDeclaration.bind(this))
				if (
					s.setDeclarations(a) &&
					!a.isErroneous(!0) &&
					(s.addChild(this._parsePrio()), this.peek(o.SemiColon))
				)
					return (
						this.finish(s),
						t.setPropertySet(s),
			...
			const i = this._parseExpr()
			return i &&
				!i.isErroneous(!0) &&
				(this._parsePrio(), this.peekOne(...(e || []), o.SemiColon, o.EOF))
				? (t.setValue(i),
					this.peek(o.SemiColon) && (t.semicolonPosition = this.token.offset),
					this.finish(t))
				: (this.restoreAtMark(n),
					t.addChild(this._parseCustomPropertyValue(e)),
					t.addChild(this._parsePrio()),
					B(t.colonPosition) && this.token.offset === t.colonPosition + 1
						? this.finish(t, u.PropertyValueExpected)
						: this.finish(t))
		}
		_parseCustomPropertyValue(e = [o.CurlyR]) {
			const t = this.create(b),
				n = () => s === 0 && a === 0 && c === 0,
				i = () => e.indexOf(this.token.type) !== -1
			let s = 0,
				a = 0,
				c = 0
			e: for (;;) {
				switch (this.token.type) {
					...
					case o.CurlyR:
						if ((s--, s < 0)) {
							if (i() && a === 0 && c === 0) break e
							return this.finish(t, u.LeftCurlyExpected)
						}
						break
					case o.ParenthesisL:
						a++
					...
					case o.ParenthesisR:
						if ((a--, a < 0)) {
							if (i() && c === 0 && s === 0) break e
							return this.finish(t, u.LeftParenthesisExpected)
						}
						break
					case o.BracketL:
						c++
						break
					case o.BracketR:
						if ((c--, c < 0)) return this.finish(t, u.LeftSquareBracketExpected)
						break
					case o.BadString:
						break e
					case o.EOF:
						let l = u.RightCurlyExpected
						return (
							c > 0
								? (l = u.RightSquareBracketExpected)
								: a > 0 && (l = u.RightParenthesisExpected),
							this.finish(t, l)
						)
				}
				this.consumeToken()
		...
		_tryToParseDeclaration(e) {
			const t = this.mark()
			return this._parseProperty() && this.accept(o.Colon)
				? (this.restoreAtMark(t), this._parseDeclaration(e))
				: (this.restoreAtMark(t), null)
		}
		_parseProperty() {
			const e = this.create(dt),
				t = this.mark()
			return (this.acceptDelim('*') || this.acceptDelim('_')) && this.hasWhitespace()
				? (this.restoreAtMark(t), null)
		...
		_parseCharset() {
			if (!this.peek(o.Charset)) return null
			const e = this.create(b)
			return (
				this.consumeToken(),
				this.accept(o.String)
					? this.accept(o.SemiColon)
						? this.finish(e)
						: this.finish(e, u.SemiColonExpected)
					: this.finish(e, u.IdentifierExpected)
			)
		}
		_parseImport() {
			if (!this.peekKeyword('@import')) return null
			const e = this.create(pt)
			return (
				this.consumeToken(),
				!e.addChild(this._parseURILiteral()) && !e.addChild(this._parseStringLiteral())
					? this.finish(e, u.URIOrStringExpected)
					: this._completeParseImport(e)
			)
		}
		_completeParseImport(e) {
			if (this.acceptIdent('layer') && this.accept(o.ParenthesisL)) {
				if (!e.addChild(this._parseLayerName()))
					return this.finish(e, u.IdentifierExpected, [o.SemiColon])
				if (!this.accept(o.ParenthesisR))
					return this.finish(e, u.RightParenthesisExpected, [o.ParenthesisR], [])
			}
			return this.acceptIdent('supports') &&
				this.accept(o.ParenthesisL) &&
				(e.addChild(this._tryToParseDeclaration() || this._parseSupportsCondition()),
				!this.accept(o.ParenthesisR))
				? this.finish(e, u.RightParenthesisExpected, [o.ParenthesisR], [])
				: (!this.peek(o.SemiColon) &&
						!this.peek(o.EOF) &&
		...
		_parseNamespace() {
			...
			const e = this.create(ii)
			return (
				this.consumeToken(),
				!e.addChild(this._parseURILiteral()) &&
				(e.addChild(this._parseIdent()),
				!e.addChild(this._parseURILiteral()) && !e.addChild(this._parseStringLiteral()))
					? this.finish(e, u.URIExpected, [o.SemiColon])
					: this.accept(o.SemiColon)
						? this.finish(e)
						: this.finish(e, u.SemiColonExpected)
			)
		...
		_parseViewPort() {
			if (
				...
				return null
			const e = this.create(Zr)
			return (this.consumeToken(), this._parseBody(e, this._parseRuleSetDeclaration.bind(this)))
		}
		_parseKeyframe() {
			if (!this.peekRegExp(o.AtKeyword, this.keyframeRegex)) return null
			const e = this.create(bn),
				t = this.create(b)
			return (
				this.consumeToken(),
				e.setKeyword(this.finish(t)),
				t.matches('@-ms-keyframes') && this.markError(t, u.UnknownKeyword),
				e.setIdentifier(this._parseKeyframeIdent())
					? this._parseBody(e, this._parseKeyframeSelector.bind(this))
					: this.finish(e, u.IdentifierExpected, [o.CurlyR])
			)
		}
		_parseKeyframeIdent() {
			return this._parseIdent([S.Keyframe])
		}
		_parseKeyframeSelector() {
			const e = this.create(wn)
			let t = !1
			if ((e.addChild(this._parseIdent()) && (t = !0), this.accept(o.Percentage) && (t = !0), !t))
				return null
			for (; this.accept(o.Comma); )
				if (
					((t = !1),
					e.addChild(this._parseIdent()) && (t = !0),
					this.accept(o.Percentage) && (t = !0),
					!t)
				)
					return this.finish(e, u.PercentageExpected)
		...
		_tryParseKeyframeSelector() {
			const e = this.create(wn),
				t = this.mark()
			let n = !1
			if ((e.addChild(this._parseIdent()) && (n = !0), this.accept(o.Percentage) && (n = !0), !n))
				return null
			for (; this.accept(o.Comma); )
				if (
					((n = !1),
					e.addChild(this._parseIdent()) && (n = !0),
					this.accept(o.Percentage) && (n = !0),
					!n)
				)
					return (this.restoreAtMark(t), null)
			return this.peek(o.CurlyL)
				? this._parseBody(e, this._parseRuleSetDeclaration.bind(this))
				: (this.restoreAtMark(t), null)
		}
		_parsePropertyAtRule() {
			if (!this.peekKeyword('@property')) return null
			const e = this.create(oi)
			return (
				this.consumeToken(),
				!this.peekRegExp(o.Ident, /^--/) || !e.setName(this._parseIdent([S.Property]))
					? this.finish(e, u.IdentifierExpected)
					: this._parseBody(e, this._parseDeclaration.bind(this))
			)
		}
		_parseLayer(e = !1) {
			if (!this.peekKeyword('@layer')) return null
			const t = this.create(si)
			this.consumeToken()
			const n = this._parseLayerNameList()
			return (
				n && t.setNames(n),
				(!n || n.getChildren().length === 1) && this.peek(o.CurlyL)
					? this._parseBody(t, this._parseLayerDeclaration.bind(this, e))
					: this.accept(o.SemiColon)
						? this.finish(t)
						: this.finish(t, u.SemiColonExpected)
			)
		}
		...
		_parseLayerNameList() {
			const e = this.createNode(p.LayerNameList)
			if (!e.addChild(this._parseLayerName())) return null
			for (; this.accept(o.Comma); )
				if (!e.addChild(this._parseLayerName())) return this.finish(e, u.IdentifierExpected)
			return this.finish(e)
		}
		_parseLayerName() {
			const e = this.createNode(p.LayerName)
			...
			for (; !this.hasWhitespace() && this.acceptDelim('.'); )
				if (this.hasWhitespace() || !e.addChild(this._parseIdent()))
					return this.finish(e, u.IdentifierExpected)
			return this.finish(e)
		}
		_parseSupports(e = !1) {
			if (!this.peekKeyword('@supports')) return null
			const t = this.create(ut)
			return (
				this.consumeToken(),
		...
		_parseSupportsCondition() {
			const e = this.create(Ee)
			if (this.acceptIdent('not')) e.addChild(this._parseSupportsConditionInParens())
			else if (
				(e.addChild(this._parseSupportsConditionInParens()),
				this.peekRegExp(o.Ident, /^(and|or)$/i))
			) {
				const t = this.token.text.toLowerCase()
				for (; this.acceptIdent(t); ) e.addChild(this._parseSupportsConditionInParens())
			}
			return this.finish(e)
		}
		_parseSupportsConditionInParens() {
			const e = this.create(Ee)
			if (this.accept(o.ParenthesisL))
				return (
					this.prevToken && (e.lParent = this.prevToken.offset),
					!e.addChild(this._tryToParseDeclaration([o.ParenthesisR])) &&
					!this._parseSupportsCondition()
						? this.finish(e, u.ConditionExpected)
						: this.accept(o.ParenthesisR)
							? (this.prevToken && (e.rParent = this.prevToken.offset), this.finish(e))
							: this.finish(e, u.RightParenthesisExpected, [o.ParenthesisR], [])
				)
			if (this.peek(o.Ident)) {
				const t = this.mark()
				if ((this.consumeToken(), !this.hasWhitespace() && this.accept(o.ParenthesisL))) {
					let n = 1
					for (; this.token.type !== o.EOF && n !== 0; )
						(this.token.type === o.ParenthesisL ? n++ : this.token.type === o.ParenthesisR && n--,
							this.consumeToken())
					return this.finish(e)
				} else this.restoreAtMark(t)
			}
			return this.finish(e, u.LeftParenthesisExpected, [], [o.ParenthesisL])
		}
		...
		_parseMedia(e = !1) {
			if (!this.peekKeyword('@media')) return null
			const t = this.create(mt)
			return (
				this.consumeToken(),
				t.addChild(this._parseMediaQueryList())
					? this._parseBody(t, this._parseMediaDeclaration.bind(this, e))
					: this.finish(t, u.MediaQueryExpected)
			)
		}
		_parseMediaQueryList() {
			const e = this.create(vn)
			if (!e.addChild(this._parseMediaQuery())) return this.finish(e, u.MediaQueryExpected)
			for (; this.accept(o.Comma); )
				if (!e.addChild(this._parseMediaQuery())) return this.finish(e, u.MediaQueryExpected)
			return this.finish(e)
		}
		_parseMediaQuery() {
			const e = this.create(yn),
				t = this.mark()
			if ((this.acceptIdent('not'), this.peek(o.ParenthesisL)))
				(this.restoreAtMark(t), e.addChild(this._parseMediaCondition()))
			else {
				if ((this.acceptIdent('only'), !e.addChild(this._parseIdent()))) return null
				this.acceptIdent('and') && e.addChild(this._parseMediaCondition())
			}
			return this.finish(e)
		}
		_parseRatio() {
			...
			return this._parseNumeric()
				? this.acceptDelim('/')
					? this._parseNumeric()
						? this.finish(t)
						: this.finish(t, u.NumberExpected)
					: (this.restoreAtMark(e), null)
				: null
		}
		_parseMediaCondition() {
			const e = this.create(ci)
			this.acceptIdent('not')
			let t = !0
			for (; t; ) {
				if (!this.accept(o.ParenthesisL))
					return this.finish(e, u.LeftParenthesisExpected, [], [o.CurlyL])
				if (
					(this.peek(o.ParenthesisL) || this.peekIdent('not')
						? e.addChild(this._parseMediaCondition())
						: e.addChild(this._parseMediaFeature()),
					!this.accept(o.ParenthesisR))
				)
					return this.finish(e, u.RightParenthesisExpected, [], [o.CurlyL])
				t = this.acceptIdent('and') || this.acceptIdent('or')
			}
			return this.finish(e)
		}
		_parseMediaFeature() {
			const e = [o.ParenthesisR],
				t = this.create(hi)
			if (t.addChild(this._parseMediaFeatureName())) {
				if (this.accept(o.Colon)) {
					if (!t.addChild(this._parseMediaFeatureValue()))
						return this.finish(t, u.TermExpected, [], e)
				} else if (this._parseMediaFeatureRangeOperator()) {
					if (!t.addChild(this._parseMediaFeatureValue()))
						return this.finish(t, u.TermExpected, [], e)
					if (this._parseMediaFeatureRangeOperator() && !t.addChild(this._parseMediaFeatureValue()))
						return this.finish(t, u.TermExpected, [], e)
				}
			} else if (t.addChild(this._parseMediaFeatureValue())) {
				if (!this._parseMediaFeatureRangeOperator())
					return this.finish(t, u.OperatorExpected, [], e)
				if (!t.addChild(this._parseMediaFeatureName()))
					return this.finish(t, u.IdentifierExpected, [], e)
				if (this._parseMediaFeatureRangeOperator() && !t.addChild(this._parseMediaFeatureValue()))
					return this.finish(t, u.TermExpected, [], e)
			} else return this.finish(t, u.IdentifierExpected, [], e)
			return this.finish(t)
		}
		_parseMediaFeatureRangeOperator() {
			return this.acceptDelim('<') || this.acceptDelim('>')
				? (this.hasWhitespace() || this.acceptDelim('='), !0)
				: !!this.acceptDelim('=')
		}
		...
		_parsePage() {
			...
			const e = this.create(di)
			if ((this.consumeToken(), e.addChild(this._parsePageSelector()))) {
				for (; this.accept(o.Comma); )
					if (!e.addChild(this._parsePageSelector())) return this.finish(e, u.IdentifierExpected)
			}
			return this._parseBody(e, this._parsePageDeclaration.bind(this))
		}
		_parsePageMarginBox() {
			if (!this.peek(o.AtKeyword)) return null
			const e = this.create(pi)
			return (
				this.acceptOneKeyword(Ui) || this.markError(e, u.UnknownAtRule, [], [o.CurlyL]),
				this._parseBody(e, this._parseRuleSetDeclaration.bind(this))
			)
		}
		_parsePageSelector() {
			if (!this.peek(o.Ident) && !this.peek(o.Colon)) return null
			const e = this.create(b)
			return (
				e.addChild(this._parseIdent()),
				this.accept(o.Colon) && !e.addChild(this._parseIdent())
					? this.finish(e, u.IdentifierExpected)
					: this.finish(e)
			)
		}
		_parseDocument() {
			...
			const e = this.create(ai)
			return (
				this.consumeToken(),
				this.resync([], [o.CurlyL]),
		...
		_parseContainer(e = !1) {
			if (!this.peekKeyword('@container')) return null
			const t = this.create(li)
			return (
				this.consumeToken(),
				t.addChild(this._parseIdent()),
				t.addChild(this._parseContainerQuery()),
				this._parseBody(t, this._parseContainerDeclaration.bind(this, e))
			)
		}
		_parseContainerQuery() {
			const e = this.create(b)
			if (this.acceptIdent('not')) e.addChild(this._parseContainerQueryInParens())
			else if ((e.addChild(this._parseContainerQueryInParens()), this.peekIdent('and')))
				for (; this.acceptIdent('and'); ) e.addChild(this._parseContainerQueryInParens())
			else if (this.peekIdent('or'))
				for (; this.acceptIdent('or'); ) e.addChild(this._parseContainerQueryInParens())
			return this.finish(e)
		}
		_parseContainerQueryInParens() {
			...
			if (this.accept(o.ParenthesisL)) {
				if (
					(this.peekIdent('not') || this.peek(o.ParenthesisL)
				...
				if (this.hasWhitespace() || !this.accept(o.ParenthesisL))
					return this.finish(e, u.LeftParenthesisExpected, [], [o.CurlyL])
				if ((e.addChild(this._parseStyleQuery()), !this.accept(o.ParenthesisR)))
					return this.finish(e, u.RightParenthesisExpected, [], [o.CurlyL])
			} else return this.finish(e, u.LeftParenthesisExpected, [], [o.CurlyL])
			return this.finish(e)
		}
		_parseStyleQuery() {
			const e = this.create(b)
			if (this.acceptIdent('not')) e.addChild(this._parseStyleInParens())
			else if (this.peek(o.ParenthesisL)) {
				if ((e.addChild(this._parseStyleInParens()), this.peekIdent('and')))
					for (; this.acceptIdent('and'); ) e.addChild(this._parseStyleInParens())
				else if (this.peekIdent('or'))
					for (; this.acceptIdent('or'); ) e.addChild(this._parseStyleInParens())
			} else e.addChild(this._parseDeclaration([o.ParenthesisR]))
			return this.finish(e)
		}
		_parseStyleInParens() {
			const e = this.create(b)
		...
		_parseUnknownAtRule() {
			...
			e: for (;;) {
				switch (this.token.type) {
					...
					case o.EOF:
						return i > 0
							? this.finish(e, u.RightCurlyExpected)
							: a > 0
								? this.finish(e, u.RightSquareBracketExpected)
								: s > 0
									? this.finish(e, u.RightParenthesisExpected)
									: this.finish(e)
					case o.CurlyL:
						;(n++, i++)
						break
					case o.CurlyR:
						if ((i--, n > 0 && i === 0)) {
							if ((this.consumeToken(), a > 0)) return this.finish(e, u.RightSquareBracketExpected)
							if (s > 0) return this.finish(e, u.RightParenthesisExpected)
							break e
						}
						if (i < 0) {
							if (s === 0 && a === 0) break e
							return this.finish(e, u.LeftCurlyExpected)
						}
						break
					case o.ParenthesisL:
						s++
						break
					case o.ParenthesisR:
						if ((s--, s < 0)) return this.finish(e, u.LeftParenthesisExpected)
						break
					case o.BracketL:
						a++
						break
					case o.BracketR:
						if ((a--, a < 0)) return this.finish(e, u.LeftSquareBracketExpected)
						break
				}
				this.consumeToken()
			}
		...
		_parseUnknownAtRuleName() {
			const e = this.create(b)
			return this.accept(o.AtKeyword) ? this.finish(e) : e
		}
		_parseOperator() {
			if (
				this.peekDelim('/') ||
				...
				this.peekDelim('+') ||
				this.peekDelim('-') ||
				this.peek(o.Dashmatch) ||
				this.peek(o.Includes) ||
				this.peek(o.SubstringOperator) ||
				this.peek(o.PrefixOperator) ||
				this.peek(o.SuffixOperator) ||
				this.peekDelim('=')
			) {
				const e = this.createNode(p.Operator)
		...
		_parseCombinator() {
			if (this.peekDelim('>')) {
				...
				if (!this.hasWhitespace() && this.acceptDelim('>')) {
					if (!this.hasWhitespace() && this.acceptDelim('>'))
						return ((e.type = p.SelectorCombinatorShadowPiercingDescendant), this.finish(e))
					this.restoreAtMark(t)
				}
				return ((e.type = p.SelectorCombinatorParent), this.finish(e))
			} else if (this.peekDelim('+')) {
				const e = this.create(b)
				return (this.consumeToken(), (e.type = p.SelectorCombinatorSibling), this.finish(e))
			} else if (this.peekDelim('~')) {
				const e = this.create(b)
				return (this.consumeToken(), (e.type = p.SelectorCombinatorAllSiblings), this.finish(e))
			} else if (this.peekDelim('/')) {
				const e = this.create(b)
				this.consumeToken()
				const t = this.mark()
		...
		_parseSimpleSelector() {
			const e = this.create(he)
			let t = 0
			for (
				e.addChild(this._parseElementName() || this._parseNestingSelector()) && t++;
				(t === 0 || !this.hasWhitespace()) && e.addChild(this._parseSimpleSelectorBody());
			)
				t++
		...
		_parseNestingSelector() {
			if (this.peekDelim('&')) {
				const e = this.createNode(p.SelectorCombinator)
				return (this.consumeToken(), this.finish(e))
			}
			return null
		}
		...
		_parseHash() {
			if (!this.peek(o.Hash) && !this.peekDelim('#')) return null
			const e = this.createNode(p.IdentifierSelector)
			if (this.acceptDelim('#')) {
		...
		_parseClass() {
			...
			const e = this.createNode(p.ClassSelector)
			return (
				this.consumeToken(),
		...
		_parseElementName() {
			const e = this.mark(),
				t = this.createNode(p.ElementNameSelector)
			return (
		...
		_parseNamespacePrefix() {
			const e = this.mark(),
				t = this.createNode(p.NamespacePrefix)
			return (
				!t.addChild(this._parseIdent()) && this.acceptDelim('*'),
				this.acceptDelim('|') ? this.finish(t) : (this.restoreAtMark(e), null)
			)
		}
		_parseAttrib() {
			if (!this.peek(o.BracketL)) return null
			const e = this.create(ui)
			return (
				this.consumeToken(),
				e.setNamespacePrefix(this._parseNamespacePrefix()),
				e.setIdentifier(this._parseIdent())
					? (e.setOperator(this._parseOperator()) &&
							(e.setValue(this._parseBinaryExpr()), this.acceptIdent('i'), this.acceptIdent('s')),
						this.accept(o.BracketR) ? this.finish(e) : this.finish(e, u.RightSquareBracketExpected))
					: this.finish(e, u.IdentifierExpected)
			)
		}
		_parsePseudo() {
			const e = this._tryParsePseudoIdentifier()
			if (e) {
				if (!this.hasWhitespace() && this.accept(o.ParenthesisL)) {
					const t = () => {
						const i = this.create(b)
						if (!i.addChild(this._parseSelector(!0))) return null
						for (; this.accept(o.Comma) && i.addChild(this._parseSelector(!0)); );
						return this.peek(o.ParenthesisR) ? this.finish(i) : null
					}
					if (
						!e.addChild(this.try(t)) &&
						e.addChild(this._parseBinaryExpr()) &&
						this.acceptIdent('of') &&
						!e.addChild(this.try(t))
					)
						return this.finish(e, u.SelectorExpected)
					if (!this.accept(o.ParenthesisR)) return this.finish(e, u.RightParenthesisExpected)
				}
				return this.finish(e)
			}
			return null
		...
		_tryParsePseudoIdentifier() {
			if (!this.peek(o.Colon)) return null
			const e = this.mark(),
				t = this.createNode(p.PseudoSelector)
			return (
				this.consumeToken(),
				this.hasWhitespace()
					? (this.restoreAtMark(e), null)
					: (this.accept(o.Colon),
						this.hasWhitespace() || !t.addChild(this._parseIdent())
							? this.finish(t, u.IdentifierExpected)
							: this.finish(t))
			)
		}
		_tryParsePrio() {
		...
		_parsePrio() {
			if (!this.peek(o.Exclamation)) return null
			const e = this.createNode(p.Prio)
			return this.accept(o.Exclamation) && this.acceptIdent('important') ? this.finish(e) : null
		}
		_parseExpr(e = !1) {
			const t = this.create(Sn)
			if (!t.addChild(this._parseBinaryExpr())) return null
			for (;;) {
				if (this.peek(o.Comma)) {
		...
		_parseUnicodeRange() {
			if (!this.peekIdent('u')) return null
			const e = this.create(Br)
			return this.acceptUnicodeRange() ? this.finish(e) : null
		}
		_parseNamedLine() {
			if (!this.peek(o.BracketL)) return null
			const e = this.createNode(p.GridLine)
			for (this.consumeToken(); e.addChild(this._parseIdent()); );
			return this.accept(o.BracketR) ? this.finish(e) : this.finish(e, u.RightSquareBracketExpected)
		}
		_parseBinaryExpr(e, t) {
			let n = this.create(ft)
			if (!n.setLeft(e || this._parseTerm())) return null
			if (!n.setOperator(t || this._parseOperator())) return this.finish(n)
			if (!n.setRight(this._parseTerm())) return this.finish(n, u.TermExpected)
			n = this.finish(n)
			const i = this._parseOperator()
			return (i && (n = this._parseBinaryExpr(n, i)), this.finish(n))
		}
		_parseTerm() {
			let e = this.create(mi)
			return (
				e.setOperator(this._parseUnaryOperator()),
				e.setExpression(this._parseTermExpression()) ? this.finish(e) : null
			)
		}
		_parseTermExpression() {
			return (
				this._parseURILiteral() ||
		...
		_parseOperation() {
			if (!this.peek(o.ParenthesisL)) return null
			const e = this.create(b)
			return (
				this.consumeToken(),
				e.addChild(this._parseExpr()),
				this.accept(o.ParenthesisR) ? this.finish(e) : this.finish(e, u.RightParenthesisExpected)
			)
		}
		_parseNumeric() {
			if (
				this.peek(o.Num) ||
				this.peek(o.Percentage) ||
				this.peek(o.Resolution) ||
				this.peek(o.Length) ||
				this.peek(o.EMS) ||
				this.peek(o.EXS) ||
				this.peek(o.Angle) ||
				this.peek(o.Time) ||
				this.peek(o.Dimension) ||
				this.peek(o.ContainerQueryLength) ||
				this.peek(o.Freq)
			) {
				const e = this.create(bt)
				return (this.consumeToken(), this.finish(e))
			}
			return null
		}
		_parseStringLiteral() {
			if (!this.peek(o.String) && !this.peek(o.BadString)) return null
			const e = this.createNode(p.StringLiteral)
			return (this.consumeToken(), this.finish(e))
		}
		_parseURILiteral() {
			if (!this.peekRegExp(o.Ident, /^url(-prefix)?$/i)) return null
			const e = this.mark(),
				t = this.createNode(p.URILiteral)
			return (
				this.accept(o.Ident),
				this.hasWhitespace() || !this.peek(o.ParenthesisL)
					? (this.restoreAtMark(e), null)
					: ((this.scanner.inURL = !0),
						...
						this.accept(o.ParenthesisR)
							? this.finish(t)
							: this.finish(t, u.RightParenthesisExpected))
			)
		}
		_parseURLArgument() {
			const e = this.create(b)
			return !this.accept(o.String) && !this.accept(o.BadString) && !this.acceptUnquotedString()
				? null
				: this.finish(e)
		}
		_parseIdent(e) {
			if (!this.peek(o.Ident)) return null
			const t = this.create(U)
			return (
				e && (t.referenceTypes = e),
				(t.isCustomProperty = this.peekRegExp(o.Ident, /^--/)),
				this.consumeToken(),
				this.finish(t)
			)
		}
		_parseFunction() {
			...
			if (this.hasWhitespace() || !this.accept(o.ParenthesisL)) return (this.restoreAtMark(e), null)
			if (t.getArguments().addChild(this._parseFunctionArgument()))
				for (; this.accept(o.Comma) && !this.peek(o.ParenthesisR); )
					t.getArguments().addChild(this._parseFunctionArgument()) ||
						this.markError(t, u.ExpressionExpected)
			return this.accept(o.ParenthesisR)
				? this.finish(t)
				: this.finish(t, u.RightParenthesisExpected)
		}
		_parseFunctionIdentifier() {
			if (!this.peek(o.Ident)) return null
			const e = this.create(U)
			if (((e.referenceTypes = [S.Function]), this.acceptIdent('progid'))) {
				if (this.accept(o.Colon)) for (; this.accept(o.Ident) && this.acceptDelim('.'); );
				return this.finish(e)
			}
			return (this.consumeToken(), this.finish(e))
		}
		_parseFunctionArgument() {
			const e = this.create(de)
			return e.setValue(this._parseExpr(!0)) ? this.finish(e) : null
		}
		_parseHexColor() {
			if (
				this.peekRegExp(o.Hash, /^#([A-Fa-f0-9]{3}|[A-Fa-f0-9]{4}|[A-Fa-f0-9]{6}|[A-Fa-f0-9]{8})$/g)
			) {
				const e = this.create(gt)
				return (this.consumeToken(), this.finish(e))
			} else return null
		}
	}
	...
	function Ge(...r) {
		const e = []
		for (const t of r) for (const n of t) qn(e, n) || e.push(n)
		return e
	}
	class Gn {
		constructor(e, t) {
		...
		findScope(e, t = 0) {
			return (this.offset <= e && this.offset + this.length > e + t) ||
		...
		findInScope(e, t = 0) {
			const n = e + t,
				i = Vi(this.children, (a) => a.offset > n)
			if (i === 0) return this
			const s = this.children[i - 1]
	...
	class Ki {
		...
		addSymbol(e, t, n, i) {
			if (e.offset !== -1) {
				const s = this.scope.findScope(e.offset, e.length)
				s && s.addSymbol(new He(t, n, e, i))
			}
		}
		addScope(e) {
			if (e.offset !== -1) {
				const t = this.scope.findScope(e.offset, e.length)
				if (t && (t.offset !== e.offset || t.length !== e.length)) {
					const n = new Gn(e.offset, e.length)
		...
		addSymbolToChildScope(e, t, n, i, s) {
			if (e && e.offset !== -1) {
				const a = this.addScope(e)
				a && a.addSymbol(new He(n, i, t, s))
			}
		}
		visitNode(e) {
			switch (e.type) {
				case p.Keyframe:
					return (this.addSymbol(e, e.getName(), void 0, S.Keyframe), !0)
				case p.CustomPropertyDeclaration:
				...
				case p.MixinDeclaration:
					return (this.addSymbol(e, e.getName(), void 0, S.Mixin), !0)
				case p.FunctionDeclaration:
					return (this.addSymbol(e, e.getName(), void 0, S.Function), !0)
				...
				case p.For:
					...
					return (
						n &&
							t.variable &&
							this.addSymbolToChildScope(n, t.variable, t.variable.getName(), void 0, S.Variable),
						!0
					)
				case p.Each: {
					const i = e,
						s = i.getDeclarations()
					if (s) {
						const a = i.getVariables().getChildren()
						for (const c of a) this.addSymbolToChildScope(s, c, c.getName(), void 0, S.Variable)
					}
					return !0
				}
			}
		...
		visitRuleSet(e) {
			const t = this.scope.findScope(e.offset, e.length)
			if (t)
				for (const n of e.getSelectors().getChildren())
					n instanceof ke &&
						n.getChildren().length === 1 &&
						t.addSymbol(new He(n.getChild(0).getText(), void 0, n, S.Rule))
			return !0
		}
		visitVariableDeclarationNode(e) {
			const t = e.getValue() ? e.getValue().getText() : void 0
			return (this.addSymbol(e, e.getName(), t, S.Variable), !0)
		}
		visitFunctionParameterNode(e) {
			const t = e.getParent().getDeclarations()
			if (t) {
				const n = e.getDefaultValue(),
					i = n ? n.getText() : void 0
				this.addSymbolToChildScope(t, e, e.getName(), i, S.Variable)
			}
			return !0
		}
		visitCustomPropertyDeclarationNode(e) {
			const t = e.getValue() ? e.getValue().getText() : ''
			return (this.addCSSVariable(e.getProperty(), e.getProperty().getName(), t, S.Variable), !0)
		}
		addCSSVariable(e, t, n, i) {
			e.offset !== -1 && this.scope.addSymbol(new He(t, n, e, i))
		}
	}
	class xt {
		constructor(e) {
			;((this.global = new Bi()), e.acceptVisitor(new Ki(this.global)))
		}
		findSymbolsAtOffset(e, t) {
			let n = this.global.findScope(e, 0)
			const i = [],
				s = {}
			for (; n; ) {
				const a = n.getSymbols()
				for (let c = 0; c < a.length; c++) {
					const l = a[c]
					l.type === t && !s[l.name] && (i.push(l), (s[l.name] = !0))
				}
				n = n.parent
			}
			return i
		}
		internalFindSymbol(e, t) {
			let n = e
			if (
				(e.parent instanceof We &&
					e.parent.getParent() instanceof E &&
					(n = e.parent.getParent().getDeclarations()),
				e.parent instanceof de && e.parent.getParent() instanceof Fe)
			) {
				const a = e.parent.getParent().getIdentifier()
				if (a) {
					const c = this.internalFindSymbol(a, [S.Function])
					c && (n = c.node.getDeclarations())
				}
			}
			if (!n) return null
			const i = e.getText()
			let s = this.global.findScope(n.offset, n.length)
			for (; s; ) {
		...
		evaluateReferenceTypes(e) {
			if (e instanceof U) {
				const n = e.referenceTypes
				if (n) return n
				{
					if (e.isCustomProperty) return [S.Variable]
					const i = Vr(e)
					if (i) {
						const s = i.getNonPrefixedPropertyName()
						if (
							(s === 'animation' || s === 'animation-name') &&
							i.getValue() &&
							i.getValue().offset === e.offset
						)
							return [S.Keyframe]
					}
				}
			} else if (e instanceof vt) return [S.Variable]
			return e.findAParent(p.Selector, p.ExtendsReference) ? [S.Rule] : null
		}
		findSymbolFromNode(e) {
			if (!e) return null
			for (; e.type === p.Interpolation; ) e = e.getParent()
		...
		matchesSymbol(e, t) {
			...
			return !n || n.indexOf(t.type) === -1 ? !1 : this.internalFindSymbol(e, n) === t
		}
		findSymbol(e, t, n) {
			let i = this.global.findScope(n)
			for (; i; ) {
				const s = i.getSymbol(e, t)
				if (s) return s
				i = i.parent
			}
			return null
	...
	function Ct(r) {
		return d.Utils.dirname(d.URI.parse(r)).toString(!0)
	}
	function pe(r, ...e) {
		return d.Utils.joinPath(d.URI.parse(r), ...e).toString(!0)
	}
	class ji {
		constructor(e) {
			;((this.readDirectory = e), (this.literalCompletions = []), (this.importCompletions = []))
		}
		onCssURILiteralValue(e) {
		...
		async computeCompletions(e, t) {
			...
			for (const i of this.literalCompletions) {
				const s = i.uriValue,
					a = kt(s)
				if (a === '.' || a === '..') n.isIncomplete = !0
				else {
					const c = await this.providePathSuggestions(s, i.position, i.range, e, t)
					for (let l of c) n.items.push(l)
				}
			}
			for (const i of this.importCompletions) {
				const s = i.pathValue,
					a = kt(s)
				if (a === '.' || a === '..') n.isIncomplete = !0
				else {
					let c = await this.providePathSuggestions(s, i.position, i.range, e, t)
					e.languageId === 'scss' &&
						c.forEach((l) => {
							I(l.label, '_') &&
								pn(l.label, '.scss') &&
								(l.textEdit
									? (l.textEdit.newText = l.label.slice(1, -5))
									: (l.label = l.label.slice(1, -5)))
						})
					for (let l of c) n.items.push(l)
				}
			}
		...
		async providePathSuggestions(e, t, n, i, s) {
			const a = kt(e),
				c = I(e, "'") || I(e, '"'),
				l = c
					? a.slice(0, t.character - (n.start.character + 1))
					: a.slice(0, t.character - n.start.character),
				h = i.uri,
				m = c ? Ji(n, 1, -1) : n,
				g = Gi(l, a, m),
				w = l.substring(0, l.lastIndexOf('/') + 1)
			let v = s.resolveReference(w || '.', h)
			if (v)
				try {
					const y = [],
						N = await this.readDirectory(v)
					for (const [q, M] of N)
						q.charCodeAt(0) !== qi &&
							(M === De.Directory || pe(v, q) !== h) &&
							y.push(Hi(q, M === De.Directory, g))
					return y
				} catch {}
			return []
		}
	...
	function Gi(r, e, t) {
		...
		if (i === -1) n = t
			...
			const s = e.slice(i + 1),
				...
				c = s.indexOf(' ')
			let l
			;(c !== -1 ? (l = Ye(a, c)) : (l = t.end), (n = f.Range.create(a, l)))
		}
		return n
	}
	function Hi(r, e, t) {
		return e
			? ((r = r + '/'),
				{
					label: Je(r),
					kind: f.CompletionItemKind.Folder,
					textEdit: f.TextEdit.replace(t, Je(r)),
					command: { title: 'Suggest', command: 'editor.action.triggerSuggest' },
				})
			: { label: Je(r), kind: f.CompletionItemKind.File, textEdit: f.TextEdit.replace(t, Je(r)) }
	}
	function Je(r) {
		return r.replace(/(\s|\(|\)|,|"|')/g, '\\$1')
	}
	function Ye(r, e) {
		return f.Position.create(r.line, r.character + e)
	}
	function Ji(r, e, t) {
		const n = Ye(r.start, e),
			i = Ye(r.end, t)
		return f.Range.create(n, i)
	}
	const J = f.InsertTextFormat.Snippet,
		Hn = { title: 'Suggest', command: 'editor.action.triggerSuggest' }
	var H
	;(function (r) {
		;((r.Enums = ' '),
			(r.Normal = 'd'),
	...
	class Ft {
		...
		getSymbolContext() {
			return (
				this.symbolContext || (this.symbolContext = new xt(this.styleSheet)),
				this.symbolContext
			)
		}
		...
		async doComplete2(e, t, n, i, s = this.defaultSettings) {
			if (!this.lsOptions.fileSystemProvider || !this.lsOptions.fileSystemProvider.readDirectory)
				return this.doComplete(e, t, n, s)
			const a = new ji(this.lsOptions.fileSystemProvider.readDirectory),
				c = this.completionParticipants
			this.completionParticipants = [a].concat(c)
			const l = this.doComplete(e, t, n, s)
			try {
				const h = await a.computeCompletions(e, i)
				return {
					isIncomplete: l.isIncomplete || h.isIncomplete,
					itemDefaults: l.itemDefaults,
					items: h.items.concat(l.items),
				}
			} finally {
		...
		doComplete(e, t, n, i) {
			;((this.offset = e.offsetAt(t)),
				(this.position = t),
				(this.currentWord = Zi(e, this.offset)),
				(this.defaultReplaceRange = f.Range.create(
					f.Position.create(this.position.line, this.position.character - this.currentWord.length),
					this.position,
				)),
				(this.textDocument = e),
				(this.styleSheet = n),
				(this.documentSettings = i))
			try {
				const s = {
					isIncomplete: !1,
					itemDefaults: {
						editRange: {
							start: { line: t.line, character: t.character - this.currentWord.length },
							end: t,
						},
					},
					items: [],
				}
				this.nodePath = lt(this.styleSheet, this.offset)
				for (let a = this.nodePath.length - 1; a >= 0; a--) {
					const c = this.nodePath[a]
					if (c instanceof dt) this.getCompletionsForDeclarationProperty(c.getParent(), s)
					else if (c instanceof Sn)
						c.parent instanceof wt
							? this.getVariableProposals(null, s)
							: this.getCompletionsForExpression(c, s)
					else if (c instanceof he) {
						const l = c.findAParent(p.ExtendsReference, p.Ruleset)
						if (l)
							if (l.type === p.ExtendsReference) this.getCompletionsForExtendsReference(l, c, s)
							else {
								const h = l
								this.getCompletionsForSelector(h, h && h.isNested(), s)
							}
					} else if (c instanceof de) this.getCompletionsForFunctionArgument(c, c.getParent(), s)
					else if (c instanceof ct) this.getCompletionsForDeclarations(c, s)
					else if (c instanceof $e) this.getCompletionsForVariableDeclaration(c, s)
					else if (c instanceof oe) this.getCompletionsForRuleSet(c, s)
					else if (c instanceof wt) this.getCompletionsForInterpolation(c, s)
					else if (c instanceof Le) this.getCompletionsForFunctionDeclaration(c, s)
					else if (c instanceof Ue) this.getCompletionsForMixinReference(c, s)
					else if (c instanceof Fe) this.getCompletionsForFunctionArgument(null, c, s)
					else if (c instanceof ut) this.getCompletionsForSupports(c, s)
					else if (c instanceof Ee) this.getCompletionsForSupportsCondition(c, s)
					else if (c instanceof _e) this.getCompletionsForExtendsReference(c, null, s)
					else if (c.type === p.URILiteral) this.getCompletionForUriLiteralValue(c, s)
					else if (c.parent === null) this.getCompletionForTopLevel(s)
					else if (c.type === p.StringLiteral && this.isImportPathParent(c.parent.type))
						this.getCompletionForImportPath(c, s)
					else continue
					if (s.items.length > 0 || this.offset > c.offset) return this.finalize(s)
				}
				return (
					this.getCompletionsForStylesheet(s),
					s.items.length === 0 &&
						this.variablePrefix &&
						this.currentWord.indexOf(this.variablePrefix) === 0 &&
						this.getVariableProposals(null, s),
					this.finalize(s)
				)
			} finally {
		...
		findInNodePath(...e) {
			for (let t = this.nodePath.length - 1; t >= 0; t--) {
				const n = this.nodePath[t]
				if (e.indexOf(n.type) !== -1) return n
			}
			return null
		}
		getCompletionsForDeclarationProperty(e, t) {
			return this.getPropertyProposals(e, t)
		}
		getPropertyProposals(e, t) {
			const n = this.isTriggerPropertyValueCompletionEnabled,
				i = this.isCompletePropertyWithSemicolonEnabled
			return (
				this.cssDataManager.getProperties().forEach((a) => {
					let c,
						l,
						h = !1
					;(e
						? ((c = this.getCompletionRange(e.getProperty())),
							(l = a.name),
							B(e.colonPosition) || ((l += ': '), (h = !0)))
						: ((c = this.getCompletionRange(null)), (l = a.name + ': '), (h = !0)),
						!e && i && (l += '$0;'),
						e &&
							!e.semicolonPosition &&
							i &&
							this.offset >= this.textDocument.offsetAt(c.end) &&
							(l += '$0;'))
					const m = {
						label: a.name,
						documentation: ne(a, this.doesSupportMarkdown()),
						tags: ze(a) ? [f.CompletionItemTag.Deprecated] : [],
						textEdit: f.TextEdit.replace(c, l),
						insertTextFormat: f.InsertTextFormat.Snippet,
						kind: f.CompletionItemKind.Property,
					}
					;(a.restrictions || (h = !1), n && h && (m.command = Hn))
					const w = (
							255 - (typeof a.relevance == 'number' ? Math.min(Math.max(a.relevance, 0), 99) : 50)
						).toString(16),
						v = I(a.name, '-') ? H.VendorPrefixed : H.Normal
					;((m.sortText = v + '_' + w), t.items.push(m))
				}),
				this.completionParticipants.forEach((a) => {
					a.onCssProperty &&
						a.onCssProperty({ propertyName: this.currentWord, range: this.defaultReplaceRange })
				}),
				t
			)
		}
		get isTriggerPropertyValueCompletionEnabled() {
			return this.documentSettings?.triggerPropertyValueCompletion ?? !0
		}
		get isCompletePropertyWithSemicolonEnabled() {
			return this.documentSettings?.completePropertyWithSemicolon ?? !0
		}
		getCompletionsForDeclarationValue(e, t) {
			const n = e.getFullPropertyName(),
				i = this.cssDataManager.getProperty(n)
			let s = e.getValue() || null
			for (; s && s.hasChildren(); ) s = s.findChildAtOffset(this.offset, !1)
			if (
				(this.completionParticipants.forEach((a) => {
					a.onCssPropertyValue &&
						a.onCssPropertyValue({
							propertyName: n,
							propertyValue: this.currentWord,
							range: this.getCompletionRange(s),
						})
				}),
				i)
			) {
				if (i.restrictions)
					for (const a of i.restrictions)
						switch (a) {
							case 'color':
								this.getColorProposals(i, s, t)
								break
							case 'position':
								this.getPositionProposals(i, s, t)
								break
							case 'repeat':
								this.getRepeatStyleProposals(i, s, t)
								break
							case 'line-style':
								this.getLineStyleProposals(i, s, t)
								break
							case 'line-width':
								this.getLineWidthProposals(i, s, t)
								break
							case 'geometry-box':
								this.getGeometryBoxProposals(i, s, t)
								break
							case 'box':
								this.getBoxProposals(i, s, t)
								break
							case 'image':
								this.getImageProposals(i, s, t)
								break
							case 'timing-function':
								this.getTimingFunctionProposals(i, s, t)
								break
							case 'shape':
								this.getBasicShapeProposals(i, s, t)
								break
						}
				;(this.getValueEnumProposals(i, s, t),
					this.getCSSWideKeywordProposals(i, s, t),
					this.getUnitProposals(i, s, t))
			} else {
				const a = Yi(this.styleSheet, e)
				for (const c of a.getEntries())
					t.items.push({
						label: c,
						textEdit: f.TextEdit.replace(this.getCompletionRange(s), c),
						kind: f.CompletionItemKind.Value,
					})
			}
			return (this.getVariableProposals(s, t), this.getTermProposals(i, s, t), t)
		}
		getValueEnumProposals(e, t, n) {
			if (e.values)
				for (const i of e.values) {
					...
					if (pn(s, ')')) {
						...
						h !== -1 && ((s = s.substring(0, h + 1) + '$1' + s.substring(h + 1)), (a = J))
					}
					let c = H.Enums
					I(i.name, '-') && (c += H.VendorPrefixed)
					const l = {
						label: i.name,
						documentation: ne(i, this.doesSupportMarkdown()),
						tags: ze(e) ? [f.CompletionItemTag.Deprecated] : [],
						textEdit: f.TextEdit.replace(this.getCompletionRange(t), s),
						sortText: c,
						kind: f.CompletionItemKind.Value,
						insertTextFormat: a,
					}
		...
		getCSSWideKeywordProposals(e, t, n) {
			for (const i in $n)
				n.items.push({
					label: i,
					documentation: $n[i],
					textEdit: f.TextEdit.replace(this.getCompletionRange(t), i),
					kind: f.CompletionItemKind.Value,
				})
			for (const i in Un) {
				const s = me(i)
				n.items.push({
					...
					documentation: Un[i],
					textEdit: f.TextEdit.replace(this.getCompletionRange(t), s),
					kind: f.CompletionItemKind.Function,
					insertTextFormat: J,
					command: I(i, 'var') ? Hn : void 0,
				})
			}
			return n
		}
		...
		getVariableProposals(e, t) {
			const n = this.getSymbolContext().findSymbolsAtOffset(this.offset, S.Variable)
			for (const i of n) {
				const s = I(i.name, '--') ? `var(${i.name})` : i.name,
					a = {
						label: i.name,
						documentation: i.value ? mn(i.value) : i.value,
						textEdit: f.TextEdit.replace(this.getCompletionRange(e), s),
						kind: f.CompletionItemKind.Variable,
						sortText: H.Variable,
					}
				if (
					(typeof a.documentation == 'string' &&
						zn(a.documentation) &&
						(a.kind = f.CompletionItemKind.Color),
					i.node.type === p.FunctionParameter)
				) {
					const c = i.node.getParent()
					c.type === p.MixinDeclaration && (a.detail = d.t("argument from '{0}'", c.getName()))
				}
				t.items.push(a)
			}
			return t
		}
		getVariableProposalsForCSSVarFunction(e) {
			const t = new Et()
			this.styleSheet.acceptVisitor(new Qi(t, this.offset))
			let n = this.getSymbolContext().findSymbolsAtOffset(this.offset, S.Variable)
			for (const i of n) {
				if (I(i.name, '--')) {
					const s = {
						label: i.name,
						documentation: i.value ? mn(i.value) : i.value,
						textEdit: f.TextEdit.replace(this.getCompletionRange(null), i.name),
						kind: f.CompletionItemKind.Variable,
					}
					;(typeof s.documentation == 'string' &&
						zn(s.documentation) &&
						(s.kind = f.CompletionItemKind.Color),
						e.items.push(s))
				}
				t.remove(i.name)
			}
			for (const i of t.getEntries())
				if (I(i, '--')) {
					const s = {
						label: i,
						textEdit: f.TextEdit.replace(this.getCompletionRange(null), i),
						kind: f.CompletionItemKind.Variable,
					}
					e.items.push(s)
				}
		...
		getUnitProposals(e, t, n) {
			let i = '0'
			if (this.currentWord.length > 0) {
				const s = this.currentWord.match(/^-?\d[\.\d+]*/)
				s && ((i = s[0]), (n.isIncomplete = i.length === this.currentWord.length))
			} else this.currentWord.length === 0 && (n.isIncomplete = !0)
			if ((t && t.parent && t.parent.type === p.Term && (t = t.getParent()), e.restrictions))
				for (const s of e.restrictions) {
					...
					if (a)
						for (const c of a) {
							...
							n.items.push({
								label: l,
								textEdit: f.TextEdit.replace(this.getCompletionRange(t), l),
								kind: f.CompletionItemKind.Unit,
							})
						}
				}
			return n
		...
		getCompletionRange(e) {
			if (e && e.offset <= this.offset && this.offset <= e.end) {
				const t = e.end !== -1 ? this.textDocument.positionAt(e.end) : this.position,
					n = this.textDocument.positionAt(e.offset)
				if (n.line === t.line) return f.Range.create(n, t)
			}
			return this.defaultReplaceRange
		}
		getColorProposals(e, t, n) {
			for (const s in Be)
				n.items.push({
					label: s,
					documentation: Be[s],
					textEdit: f.TextEdit.replace(this.getCompletionRange(t), s),
					kind: f.CompletionItemKind.Color,
				})
			for (const s in St)
				n.items.push({
					label: s,
			...
			const i = new Et()
			this.styleSheet.acceptVisitor(new Xi(i, this.offset))
			...
			for (const s of _i)
				n.items.push({
					...
					textEdit: f.TextEdit.replace(this.getCompletionRange(t), s.insertText),
					insertTextFormat: J,
					kind: f.CompletionItemKind.Function,
				})
			return n
		}
		getPositionProposals(e, t, n) {
			for (const i in Tn)
				n.items.push({
					label: i,
					documentation: Tn[i],
		...
		getImageProposals(e, t, n) {
			for (const i in Vn) {
				...
				n.items.push({
					...
					textEdit: f.TextEdit.replace(this.getCompletionRange(t), s),
					kind: f.CompletionItemKind.Function,
					insertTextFormat: i !== s ? J : void 0,
				})
			}
			return n
		}
		getTimingFunctionProposals(e, t, n) {
			for (const i in Bn) {
				const s = me(i)
				n.items.push({
					label: i,
		...
		getCompletionsForStylesheet(e) {
			const t = this.styleSheet.findFirstChildBeforeOffset(this.offset)
			return t
				? t instanceof oe
		...
		getCompletionForTopLevel(e) {
			return (
				this.cssDataManager.getAtDirectives().forEach((t) => {
					e.items.push({
						label: t.name,
						textEdit: f.TextEdit.replace(this.getCompletionRange(null), t.name),
						documentation: ne(t, this.doesSupportMarkdown()),
						tags: ze(t) ? [f.CompletionItemTag.Deprecated] : [],
						kind: f.CompletionItemKind.Keyword,
					})
				}),
		...
		getCompletionsForSelector(e, t, n) {
			const i = this.findInNodePath(
				p.PseudoSelector,
				p.IdentifierSelector,
				p.ClassSelector,
				p.ElementNameSelector,
			)
			if (
				(!i &&
					this.hasCharacterAtPosition(this.offset - this.currentWord.length - 1, ':') &&
				...
				this.cssDataManager.getPseudoClasses().forEach((h) => {
					const m = me(h.name),
						g = {
							label: h.name,
							textEdit: f.TextEdit.replace(this.getCompletionRange(i), m),
							documentation: ne(h, this.doesSupportMarkdown()),
							tags: ze(h) ? [f.CompletionItemTag.Deprecated] : [],
							kind: f.CompletionItemKind.Function,
							insertTextFormat: h.name !== m ? J : void 0,
						}
					;(I(h.name, ':-') && (g.sortText = H.VendorPrefixed), n.items.push(g))
				}),
				this.cssDataManager.getPseudoElements().forEach((h) => {
					const m = me(h.name),
						g = {
							label: h.name,
							textEdit: f.TextEdit.replace(this.getCompletionRange(i), m),
				...
				for (const h of Li)
					n.items.push({
						label: h,
						textEdit: f.TextEdit.replace(this.getCompletionRange(i), h),
						kind: f.CompletionItemKind.Keyword,
					})
				for (const h of $i)
					n.items.push({
			...
			const l = this.textDocument.getText()
			if (
				(this.styleSheet.accept((h) => {
					if (h.type === p.SimpleSelector && h.length > 0) {
						const m = l.substr(h.offset, h.length)
						return (
							m.charAt(0) === '.' &&
								!c[m] &&
								((c[m] = !0),
				...
				const h = e.getSelectors().findFirstChildBeforeOffset(this.offset)
				h && e.getSelectors().getChildren().indexOf(h) === 0 && this.getPropertyProposals(null, n)
			}
			return n
		}
		getCompletionsForDeclarations(e, t) {
			if (!e || this.offset === e.offset) return t
			const n = e.findFirstChildBeforeOffset(this.offset)
			if (!n) return this.getCompletionsForDeclarationProperty(null, t)
			if (n instanceof ht) {
				const i = n
				if (!B(i.colonPosition) || this.offset <= i.colonPosition)
					return this.getCompletionsForDeclarationProperty(i, t)
				if (B(i.semicolonPosition) && i.semicolonPosition < this.offset)
					return this.offset === i.semicolonPosition + 1
						? t
						: this.getCompletionsForDeclarationProperty(null, t)
				if (i instanceof V) return this.getCompletionsForDeclarationValue(i, t)
			} else
				n instanceof _e
					? this.getCompletionsForExtendsReference(n, null, t)
					: this.currentWord && this.currentWord[0] === '@'
						? this.getCompletionsForDeclarationProperty(null, t)
						: n instanceof oe && this.getCompletionsForDeclarationProperty(null, t)
			return t
		}
		...
		getCompletionsForExpression(e, t) {
			const n = e.getParent()
			if (n instanceof de) return (this.getCompletionsForFunctionArgument(n, n.getParent(), t), t)
			const i = e.findParent(p.Declaration)
			if (!i) return (this.getTermProposals(void 0, null, t), t)
			const s = e.findChildAtOffset(this.offset, !0)
			return s
				? s instanceof bt || s instanceof U
					? this.getCompletionsForDeclarationValue(i, t)
					: t
				: this.getCompletionsForDeclarationValue(i, t)
		}
		getCompletionsForFunctionArgument(e, t, n) {
			const i = t.getIdentifier()
			return (
				i &&
					i.matches('var') &&
		...
		getCompletionsForFunctionDeclaration(e, t) {
			const n = e.getDeclarations()
			return (
				n &&
		...
		getCompletionsForMixinReference(e, t) {
			const n = this.getSymbolContext().findSymbolsAtOffset(this.offset, S.Mixin)
			for (const s of n)
				s.node instanceof Ie && t.items.push(this.makeTermProposal(s, s.node.getParameters(), null))
			const i = e.getIdentifier() || null
			return (
				this.completionParticipants.forEach((s) => {
					s.onCssMixinReference &&
						s.onCssMixinReference({
		...
		getTermProposals(e, t, n) {
			const i = this.getSymbolContext().findSymbolsAtOffset(this.offset, S.Function)
			for (const s of i)
				s.node instanceof Le && n.items.push(this.makeTermProposal(s, s.node.getParameters(), t))
			return n
		}
		makeTermProposal(e, t, n) {
			e.node
			const i = t.getChildren().map((a) => (a instanceof We ? a.getName() : a.getText())),
				s = e.name + '(' + i.map((a, c) => '${' + (c + 1) + ':' + a + '}').join(', ') + ')'
			return {
				label: e.name,
				detail: e.name + '(' + i.join(', ') + ')',
				textEdit: f.TextEdit.replace(this.getCompletionRange(n), s),
				insertTextFormat: J,
				kind: f.CompletionItemKind.Function,
				sortText: H.Term,
			}
		}
		getCompletionsForSupportsCondition(e, t) {
			const n = e.findFirstChildBeforeOffset(this.offset)
			if (n) {
				if (n instanceof V)
					return !B(n.colonPosition) || this.offset <= n.colonPosition
						? this.getCompletionsForDeclarationProperty(n, t)
						: this.getCompletionsForDeclarationValue(n, t)
				if (n instanceof Ee) return this.getCompletionsForSupportsCondition(n, t)
			}
			return B(e.lParent) && this.offset > e.lParent && (!B(e.rParent) || this.offset <= e.rParent)
				? this.getCompletionsForDeclarationProperty(null, t)
				: t
		}
		getCompletionsForSupports(e, t) {
			const n = e.getDeclarations()
			if (!n || this.offset <= n.offset) {
				const s = e.findFirstChildBeforeOffset(this.offset)
				return s instanceof Ee ? this.getCompletionsForSupportsCondition(s, t) : t
			}
			return this.getCompletionForTopLevel(t)
		}
		getCompletionsForExtendsReference(e, t, n) {
			return n
		}
		getCompletionForUriLiteralValue(e, t) {
			let n, i, s
			if (e.hasChildren()) {
				const a = e.getChild(0)
				;((n = a.getText()), (i = this.position), (s = this.getCompletionRange(a)))
			} else {
				;((n = ''), (i = this.position))
				const a = this.textDocument.positionAt(e.offset + 4)
				s = f.Range.create(a, a)
			}
			return (
				this.completionParticipants.forEach((a) => {
					a.onCssURILiteralValue && a.onCssURILiteralValue({ uriValue: n, position: i, range: s })
				}),
				t
			)
		}
		getCompletionForImportPath(e, t) {
			return (
				this.completionParticipants.forEach((n) => {
					n.onCssImportPath &&
						n.onCssImportPath({
							pathValue: e.getText(),
							position: this.position,
							range: this.getCompletionRange(e),
						})
				}),
				t
			)
		}
		hasCharacterAtPosition(e, t) {
			const n = this.textDocument.getText()
			return e >= 0 && e < n.length && n.charAt(e) === t
		}
		doesSupportMarkdown() {
			if (!B(this.supportsMarkdown)) {
				if (!B(this.lsOptions.clientCapabilities))
				...
				const e =
					this.lsOptions.clientCapabilities.textDocument?.completion?.completionItem
						?.documentationFormat
				this.supportsMarkdown = Array.isArray(e) && e.indexOf(f.MarkupKind.Markdown) !== -1
			}
	...
	function Yi(r, e) {
		const t = e.getFullPropertyName(),
			n = new Et()
		function i(c) {
			return ((c instanceof U || c instanceof bt || c instanceof gt) && n.add(c.getText()), !0)
		}
		function s(c) {
			const l = c.getFullPropertyName()
			return t === l
		}
		function a(c) {
			if (c instanceof V && c !== e && s(c)) {
				const l = c.getValue()
				l && l.accept(i)
			}
			return !0
	...
	class Xi {
		...
		visitNode(e) {
			return (
				(e instanceof gt || (e instanceof Fe && Ri(e))) &&
	...
	function Zi(r, e) {
		...
		for (
			...
			t >= 0 &&
			` 	
\r":{[()]},*>+`.indexOf(n.charAt(t)) === -1;
		)
			t--
		return n.substring(t + 1, e)
	}
	let _t = class Xt {
		constructor() {
		...
		findAttribute(e) {
			if (this.attributes) {
				for (const t of this.attributes) if (t.name === e) return t.value
			}
			return null
		}
		addChild(e) {
			;(e instanceof Xt && (e.parent = this),
				this.children || (this.children = []),
				this.children.push(e))
		}
		append(e) {
			if (this.attributes) {
				const t = this.attributes[this.attributes.length - 1]
				t.value = t.value + e
			}
		}
		prepend(e) {
			if (this.attributes) {
				const t = this.attributes[0]
				t.value = e + t.value
			}
		}
		findRoot() {
			let e = this
			for (; e.parent && !(e.parent instanceof ue); ) e = e.parent
			return e
		}
		removeChild(e) {
			if (this.children) {
				const t = this.children.indexOf(e)
				if (t !== -1) return (this.children.splice(t, 1), !0)
			}
			return !1
		}
		addAttr(e, t) {
		...
		clone(e = !0) {
			...
			if (this.attributes) {
				t.attributes = []
				for (const n of this.attributes) t.addAttr(n.name, n.value)
			}
			if (e && this.children) {
				t.children = []
				for (let n = 0; n < this.children.length; n++) t.addChild(this.children[n].clone())
			}
			return t
		}
		cloneWithParent() {
			const e = this.clone(!1)
			return (
				this.parent && !(this.parent instanceof ue) && this.parent.cloneWithParent().addChild(e),
				e
			)
		}
	}
	...
	class Jn {
		...
		print(e, t) {
			;((this.result = []),
				e instanceof ue ? e.children && this.doPrint(e.children, 0) : this.doPrint([e], 0))
			let n
			return (
				t
					? (n =
...
`))
					: (n = this.result.join(`
`)),
				[{ language: 'html', value: n }]
			)
		}
		doPrint(e, t) {
			for (const n of e) (this.doPrintElement(n, t), n.children && this.doPrint(n.children, t + 1))
		}
		writeLine(e, t) {
			const n = new Array(e + 1).join('  ')
			this.result.push(n + t)
		}
		doPrintElement(e, t) {
			const n = e.findAttribute('name')
			if (e instanceof It || n === '…') {
				this.writeLine(t, n)
				return
			}
			const i = ['<']
			if ((n ? i.push(n) : i.push('element'), e.attributes)) {
				for (const s of e.attributes)
					if (s.name !== 'name') {
						...
						const a = s.value
						a && (i.push('='), i.push(Y.ensure(a, this.quote)))
					}
			}
	...
	function Yn(r, e) {
		let t = new _t()
		for (const n of r.getChildren())
			switch (n.type) {
				case p.SelectorCombinator:
					if (e) {
						const c = n.getText().split('&')
						if (c.length === 1) {
							t.addAttr('name', c[0])
							break
						}
						;((t = e.cloneWithParent()), c[0] && t.findRoot().prepend(c[0]))
						for (let l = 1; l < c.length; l++) {
							if (l > 1) {
								const h = e.cloneWithParent()
								;(t.addChild(h.findRoot()), (t = h))
							}
							t.append(c[l])
						}
					}
					break
				case p.SelectorPlaceholder:
					if (n.matches('@at-root')) return t
				case p.ElementNameSelector:
					const i = n.getText()
					t.addAttr('name', i === '*' ? 'element' : K(i))
					break
				case p.ClassSelector:
					t.addAttr('class', K(n.getText().substring(1)))
					break
				case p.IdentifierSelector:
					t.addAttr('id', K(n.getText().substring(1)))
					break
				case p.MixinDeclaration:
					t.addAttr('class', n.getName())
					break
				case p.PseudoSelector:
					t.addAttr(K(n.getText()), '')
					break
				case p.AttributeSelector:
					const s = n,
						a = s.getIdentifier()
					if (a) {
						const c = s.getValue(),
	...
	class es {
		...
		selectorToMarkedString(e, t) {
			const n = rs(e)
			if (n) {
				const i = new Jn('"').print(n, t)
				return (i.push(this.selectorToSpecificityMarkedString(e)), i)
			} else return []
		}
		simpleSelectorToMarkedString(e) {
			const t = Yn(e),
				n = new Jn('"').print(t)
			return (n.push(this.selectorToSpecificityMarkedString(e)), n)
		}
		isPseudoElementIdentifier(e) {
			const t = e.match(/^::?([\w-]+)/)
			return t ? !!this.cssDataManager.getPseudoElement('::' + t[1]) : !1
		}
		selectorToSpecificityMarkedString(e) {
			const t = (s) => {
					...
					let c = new Dt()
					for (const l of s)
						for (const h of l.getChildren()) {
							const m = n(h)
							if (m.id > c.id) {
								c = m
								continue
							} else if (m.id < c.id) continue
							if (m.attr > c.attr) {
								c = m
								continue
							} else if (m.attr < c.attr) continue
							if (m.tag > c.tag) {
								c = m
								continue
							}
						}
					return ((a.id += c.id), (a.attr += c.attr), (a.tag += c.tag), a)
				},
				n = (s) => {
					const a = new Dt()
					e: for (const c of s.getChildren()) {
						switch (c.type) {
							case p.IdentifierSelector:
								a.id++
								break
							...
							case p.PseudoSelector:
								const l = c.getText(),
									h = c.getChildren()
								if (this.isPseudoElementIdentifier(l)) {
									if (l.match(/^::slotted/i) && h.length > 0) {
										a.tag++
										let m = t(h)
										;((a.id += m.id), (a.attr += m.attr), (a.tag += m.tag))
										continue e
									}
									a.tag++
									continue e
								}
								if (l.match(/^:where/i)) continue e
								if (l.match(/^:(?:not|has|is)/i) && h.length > 0) {
									let m = t(h)
									;((a.id += m.id), (a.attr += m.attr), (a.tag += m.tag))
									continue e
								}
								if (l.match(/^:(?:host|host-context)/i) && h.length > 0) {
									a.attr++
									let m = t(h)
									;((a.id += m.id), (a.attr += m.attr), (a.tag += m.tag))
									continue e
								}
								if (l.match(/^:(?:nth-child|nth-last-child)/i) && h.length > 0) {
									if ((a.attr++, h.length === 3 && h[1].type === 23)) {
										let y = t(h[2].getChildren())
										;((a.id += y.id), (a.attr += y.attr), (a.tag += y.tag))
										continue e
									}
									const m = new qe(),
										g = h[1].getText()
									m.scanner.setSource(g)
									const w = m.scanner.scan(),
										v = m.scanner.scan()
									if (w.text === 'n' || (w.text === '-n' && v.text === 'of')) {
										const y = [],
											q = g.slice(v.offset + 2).split(',')
										for (const D of q) {
											const C = m.internalParse(D, m._parseSelector)
											C && y.push(C)
										}
										let M = t(y)
										;((a.id += M.id), (a.attr += M.attr), (a.tag += M.tag))
						...
						if (c.getChildren().length > 0) {
							const l = n(c)
							;((a.id += l.id), (a.attr += l.attr), (a.tag += l.tag))
						}
					}
					return a
				},
				i = n(e)
			return `[${d.t('Selector Specificity')}](https://developer.mozilla.org/docs/Web/CSS/Specificity): (${i.id}, ${i.attr}, ${i.tag})`
		}
	}
	class ts {
		constructor(e) {
		...
		processSelector(e) {
			let t = null
			if (
				!(this.element instanceof ue) &&
				e.getChildren().some((n) => n.hasChildren() && n.getChild(0).type === p.SelectorCombinator)
			) {
				const n = this.element.findRoot()
				n.parent instanceof ue &&
					((t = this.element),
			...
			for (const n of e.getChildren()) {
				if (n instanceof he) {
					if (this.prev instanceof he) {
						const a = new It('…')
						;(this.element.addChild(a), (this.element = a))
					} else
						this.prev &&
							(this.prev.matches('+') || this.prev.matches('~')) &&
							this.element.parent &&
							(this.element = this.element.parent)
					this.prev && this.prev.matches('~') && this.element.addChild(new It('⋮'))
					const i = Yn(n, t),
						s = i.findRoot()
					;(this.element.addChild(s), (this.element = i))
				}
				;(n instanceof he ||
					n.type === p.SelectorCombinatorParent ||
					n.type === p.SelectorCombinatorShadowPiercingDescendant ||
					n.type === p.SelectorCombinatorSibling ||
					n.type === p.SelectorCombinatorAllSiblings) &&
					(this.prev = n)
			}
		}
	}
	...
	function rs(r) {
		if (r.matches('@at-root')) return null
		const e = new ue(),
			t = [],
			n = r.getParent()
		if (n instanceof oe) {
			...
			for (; s && !ns(s); ) {
				if (s instanceof oe) {
					if (s.getSelectors().matches('@at-root')) break
					t.push(s)
				}
				s = s.getParent()
			}
		...
		for (let s = t.length - 1; s >= 0; s--) {
			const a = t[s].getSelectors().getChild(0)
			a && i.processSelector(a)
		}
		return (i.processSelector(r), e)
	}
	class zt {
		constructor(e, t) {
			;((this.clientCapabilities = e),
				(this.cssDataManager = t),
				(this.selectorPrinting = new es(t)))
		}
		configure(e) {
			this.defaultSettings = e
		}
		doHover(e, t, n, i = this.defaultSettings) {
			function s(m) {
				return f.Range.create(e.positionAt(m.offset), e.positionAt(m.end))
			}
			const a = e.offsetAt(t),
				c = lt(n, a)
			let l = null,
				h
			for (let m = 0; m < c.length; m++) {
				...
				if (g instanceof mt) {
					const w = /@media[^\{]+/g
					h = { isMedia: !0, text: g.getText().match(w)?.[0] }
				}
				if (g instanceof ke) {
					l = { contents: this.selectorPrinting.selectorToMarkedString(g, h), range: s(g) }
					break
				}
				if (g instanceof he) {
					I(g.getText(), '@') ||
						(l = { contents: this.selectorPrinting.simpleSelectorToMarkedString(g), range: s(g) })
					break
				}
				if (g instanceof V) {
					const w = g.getFullPropertyName(),
						v = this.cssDataManager.getProperty(w)
					if (v) {
						const y = ne(v, this.doesSupportMarkdown(), i)
						y ? (l = { contents: y, range: s(g) }) : (l = null)
					}
					continue
				}
				if (g instanceof xn) {
					const w = g.getText(),
						v = this.cssDataManager.getAtDirective(w)
					if (v) {
						const y = ne(v, this.doesSupportMarkdown(), i)
						y ? (l = { contents: y, range: s(g) }) : (l = null)
					}
				...
				if (g instanceof b && g.type === p.PseudoSelector) {
					const w = g.getText(),
						v =
							w.slice(0, 2) === '::'
								? this.cssDataManager.getPseudoElement(w)
								: this.cssDataManager.getPseudoClass(w)
					if (v) {
						const y = ne(v, this.doesSupportMarkdown(), i)
						y ? (l = { contents: y, range: s(g) }) : (l = null)
					}
			...
			return (l && (l.contents = this.convertContents(l.contents)), l)
		}
		convertContents(e) {
			return this.doesSupportMarkdown() || typeof e == 'string'
				? e
				: 'kind' in e
		...
		doesSupportMarkdown() {
			if (!B(this.supportsMarkdown)) {
				if (!B(this.clientCapabilities))
					return ((this.supportsMarkdown = !0), this.supportsMarkdown)
				const e = this.clientCapabilities.textDocument && this.clientCapabilities.textDocument.hover
				this.supportsMarkdown =
					e &&
					e.contentFormat &&
					Array.isArray(e.contentFormat) &&
					e.contentFormat.indexOf(f.MarkupKind.Markdown) !== -1
			}
			return this.supportsMarkdown
		}
	}
	...
	class Rt {
		constructor(e, t) {
			;((this.fileSystemProvider = e), (this.resolveModuleReferences = t))
		}
		configure(e) {
			this.defaultSettings = e
		}
		findDefinition(e, t, n) {
			const i = new xt(n),
				s = e.offsetAt(t),
				a = at(n, s)
			if (!a) return null
			const c = i.findSymbolFromNode(a)
			return c ? { uri: e.uri, range: X(c.node, e) } : null
		}
		findReferences(e, t, n) {
			return this.findDocumentHighlights(e, t, n).map((s) => ({ uri: e.uri, range: s.range }))
		}
		getHighlightNode(e, t, n) {
			const i = e.offsetAt(t)
			let s = at(n, i)
			if (!(!s || s.type === p.Stylesheet || s.type === p.Declarations))
				return (
					s.type === p.Identifier &&
						s.parent &&
						s.parent.type === p.ClassSelector &&
						(s = s.parent),
					s
				)
		}
		findDocumentHighlights(e, t, n) {
			const i = [],
				s = this.getHighlightNode(e, t, n)
			if (!s) return i
			const a = new xt(n),
				c = a.findSymbolFromNode(s),
				l = s.getText()
			return (
				n.accept((h) => {
					if (c) {
						if (a.matchesSymbol(h, c)) return (i.push({ kind: er(h), range: X(h, e) }), !1)
					} else s && s.type === h.type && h.matches(l) && i.push({ kind: er(h), range: X(h, e) })
					return !0
				}),
				i
			)
		}
		isRawStringDocumentLinkNode(e) {
			return e.type === p.Import
		}
		findDocumentLinks(e, t, n) {
			const i = this.findUnresolvedLinks(e, t),
				s = []
			for (let a of i) {
				const c = a.link,
					l = c.target
				if (!(!l || Qn.test(l)))
					if (Xn.test(l)) s.push(c)
					else {
						const h = n.resolveReference(l, e.uri)
						;(h && (c.target = h), s.push(c))
					}
			}
			return s
		}
		async findDocumentLinks2(e, t, n) {
			const i = this.findUnresolvedLinks(e, t),
				s = []
			for (let a of i) {
				const c = a.link,
				...
				if (!(!l || Qn.test(l)))
					if (Xn.test(l)) s.push(c)
						...
						const h = await this.resolveReference(l, e.uri, n, a.isRawLink)
						h !== void 0 && ((c.target = h), s.push(c))
					}
			}
			return s
		}
		findUnresolvedLinks(e, t) {
			const n = [],
				i = (s) => {
					let a = s.getText()
					const c = X(s, e)
					if (c.start.line === c.end.line && c.start.character === c.end.character) return
					;(I(a, "'") || I(a, '"')) && (a = a.slice(1, -1))
					const l = s.parent ? this.isRawStringDocumentLinkNode(s.parent) : !1
					n.push({ link: { target: a, range: c }, isRawLink: l })
				}
			return (
				t.accept((s) => {
					if (s.type === p.URILiteral) {
						const a = s.getChild(0)
						return (a && i(a), !1)
					}
					if (s.parent && this.isRawStringDocumentLinkNode(s.parent)) {
						const a = s.getText()
						return ((I(a, "'") || I(a, '"')) && i(s), !1)
					}
					return !0
				}),
				n
		...
		findSymbolInformations(e, t) {
			const n = [],
				i = (s, a, c) => {
					const l = c instanceof b ? X(c, e) : c,
						h = { name: s || d.t('<undefined>'), kind: a, location: f.Location.create(e.uri, l) }
					n.push(h)
				}
			return (this.collectDocumentSymbols(e, t, i), n)
		}
		findDocumentSymbols(e, t) {
			const n = [],
				i = [],
				s = (a, c, l, h, m) => {
					const g = l instanceof b ? X(l, e) : l
					let w = h instanceof b ? X(h, e) : h
					;(!w || !Zn(g, w)) && (w = f.Range.create(g.start, g.start))
					const v = { name: a || d.t('<undefined>'), kind: c, range: g, selectionRange: w }
					let y = i.pop()
					for (; y && !Zn(y[1], g); ) y = i.pop()
					if (y) {
						const N = y[0]
						;(N.children || (N.children = []), N.children.push(v), i.push(y))
					} else n.push(v)
					m && i.push([v, X(m, e)])
				}
			return (this.collectDocumentSymbols(e, t, s), n)
		}
		collectDocumentSymbols(e, t, n) {
			t.accept((i) => {
				if (i instanceof oe) {
					for (const s of i.getSelectors().getChildren())
						if (s instanceof ke) {
							const a = f.Range.create(e.positionAt(s.offset), e.positionAt(i.end))
							n(s.getText(), f.SymbolKind.Class, a, s, i.getDeclarations())
						}
				} else if (i instanceof $e)
					n(i.getName(), f.SymbolKind.Variable, i, i.getVariable(), void 0)
				else if (i instanceof Ie)
					n(i.getName(), f.SymbolKind.Method, i, i.getIdentifier(), i.getDeclarations())
				else if (i instanceof Le)
					n(i.getName(), f.SymbolKind.Function, i, i.getIdentifier(), i.getDeclarations())
				else if (i instanceof bn) {
					const s = d.t('@keyframes {0}', i.getName())
					n(s, f.SymbolKind.Class, i, i.getIdentifier(), i.getDeclarations())
				} else if (i instanceof fn) {
					const s = d.t('@font-face')
					n(s, f.SymbolKind.Class, i, void 0, i.getDeclarations())
				} else if (i instanceof mt) {
					const s = i.getChild(0)
					if (s instanceof vn) {
						const a = '@media ' + s.getText()
						n(a, f.SymbolKind.Module, i, s, i.getDeclarations())
					}
				}
				return !0
			})
		}
		findDocumentColors(e, t) {
			const n = []
			return (
				t.accept((i) => {
					const s = is(i, e)
		...
		getColorPresentations(e, t, n, i) {
			...
			let h
			;(n.alpha === 1 ? (h = `rgb(${a}, ${c}, ${l})`) : (h = `rgba(${a}, ${c}, ${l}, ${n.alpha})`),
				s.push({ label: h, textEdit: f.TextEdit.replace(i, h) }),
				n.alpha === 1
					? (h = `#${ae(a)}${ae(c)}${ae(l)}`)
					: (h = `#${ae(a)}${ae(c)}${ae(l)}${ae(Math.round(n.alpha * 255))}`),
				s.push({ label: h, textEdit: f.TextEdit.replace(i, h) }))
			const m = Pn(n)
			;(m.a === 1
				? (h = `hsl(${m.h}, ${Math.round(m.s * 100)}%, ${Math.round(m.l * 100)}%)`)
				: (h = `hsla(${m.h}, ${Math.round(m.s * 100)}%, ${Math.round(m.l * 100)}%, ${m.a})`),
				s.push({ label: h, textEdit: f.TextEdit.replace(i, h) }))
			const g = Ai(n)
			return (
				g.a === 1
					? (h = `hwb(${g.h} ${Math.round(g.w * 100)}% ${Math.round(g.b * 100)}%)`)
					: (h = `hwb(${g.h} ${Math.round(g.w * 100)}% ${Math.round(g.b * 100)}% / ${g.a})`),
				s.push({ label: h, textEdit: f.TextEdit.replace(i, h) }),
				s
			)
		}
		prepareRename(e, t, n) {
			const i = this.getHighlightNode(e, t, n)
			if (i) return f.Range.create(e.positionAt(i.offset), e.positionAt(i.end))
		}
		doRename(e, t, n, i) {
			const a = this.findDocumentHighlights(e, t, i).map((c) => f.TextEdit.replace(c.range, n))
			return { changes: { [e.uri]: a } }
		}
		async resolveModuleReference(e, t, n) {
			if (I(t, 'file://')) {
				const i = ss(e)
				if (i && i !== '.' && i !== '..') {
					const s = n.resolveReference('/', t),
						a = Ct(t),
						c = await this.resolvePathToModule(i, a, s)
					if (c) {
						const l = e.substring(i.length + 1)
						return pe(c, l)
					}
				}
			}
		}
		async mapReference(e, t) {
			return e
		}
		async resolveReference(e, t, n, i = !1, s = this.defaultSettings) {
			if (e[0] === '~' && e[1] !== '/' && this.fileSystemProvider)
				return (
					(e = e.substring(1)),
					this.mapReference(await this.resolveModuleReference(e, t, n), i)
				)
			const a = await this.mapReference(n.resolveReference(e, t), i)
			if (this.resolveModuleReferences) {
				if (a && (await this.fileExists(a))) return a
				const c = await this.mapReference(await this.resolveModuleReference(e, t, n), i)
				if (c) return c
			}
			if (a && !(await this.fileExists(a))) {
				const c = n.resolveReference('/', t)
				if (s && c) {
					if (e in s) return this.mapReference(pe(c, s[e]), i)
					const l = e.indexOf('/'),
						h = `${e.substring(0, l)}/`
					if (h in s) {
						const m = s[h].slice(0, -1)
						let g = pe(c, m)
						return this.mapReference((g = pe(g, e.substring(h.length - 1))), i)
					}
				}
			}
			return a
		}
		async resolvePathToModule(e, t, n) {
			const i = pe(t, 'node_modules', e, 'package.json')
			if (await this.fileExists(i)) return Ct(i)
			if (n && t.startsWith(n) && t.length !== n.length)
				return this.resolvePathToModule(e, Ct(t), n)
		}
		async fileExists(e) {
			if (!this.fileSystemProvider) return !1
			try {
				const t = await this.fileSystemProvider.stat(e)
				return !(t.type === De.Unknown && t.size === -1)
			} catch {
				return !1
			}
		}
	...
	function is(r, e) {
		...
		if (t) {
			const n = X(r, e)
			return { color: t, range: n }
		}
		return null
	}
	function X(r, e) {
		return f.Range.create(e.positionAt(r.offset), e.positionAt(r.end))
	}
	function Zn(r, e) {
		const t = e.start.line,
			n = e.end.line,
			i = r.start.line,
			s = r.end.line
		return !(
			...
			t > s ||
			n > s ||
			(t === i && e.start.character < r.start.character) ||
			(n === s && e.end.character > r.end.character)
		)
	}
	function er(r) {
		if (
			r.type === p.Selector ||
			(r instanceof U && r.parent && r.parent instanceof dt && r.isCustomProperty)
		)
			return f.DocumentHighlightKind.Write
		if (r.parent)
		...
		return f.DocumentHighlightKind.Read
	}
	function ae(r) {
	...
	const k = {
			...
			IncludeStandardPropertyWhenUsingVendorPrefix: new z(
				'vendorPrefix',
				d.t('When using a vendor-specific prefix also include the standard property'),
				fe,
			),
			DuplicateDeclarations: new z(
				'duplicateProperties',
				d.t('Do not use duplicate style definitions'),
				j,
			),
			EmptyRuleSet: new z('emptyRules', d.t('Do not use empty rulesets'), fe),
			ImportStatemement: new z(
				'importStatement',
				d.t('Import statements do not load in parallel'),
				j,
			),
			BewareOfBoxModelSize: new z(
				'boxModel',
				d.t('Do not use width or height when using padding or border'),
				j,
			),
			UniversalSelector: new z(
				'universalSelector',
				d.t('The universal selector (*) is known to be slow'),
				j,
			),
			ZeroWithUnit: new z('zeroUnits', d.t('No unit for zero needed'), j),
			RequiredPropertiesForFontFace: new z(
				'fontFaceProperties',
				d.t("@font-face rule must define 'src' and 'font-family' properties"),
				fe,
			),
			HexColorLength: new z(
				'hexColorLength',
				d.t('Hex colors must consist of three, four, six or eight hex numbers'),
				tr,
			),
			ArgsInColorFunction: new z(
				'argumentsInColorFunction',
				d.t('Invalid number of parameters'),
				tr,
			),
			UnknownProperty: new z('unknownProperties', d.t('Unknown property.'), fe),
			UnknownAtRules: new z('unknownAtRules', d.t('Unknown at-rule.'), fe),
			IEStarHack: new z(
				'ieHack',
				d.t('IE hacks are only necessary when supporting IE7 and older'),
				j,
			),
			UnknownVendorSpecificProperty: new z(
				'unknownVendorSpecificProperties',
				d.t('Unknown vendor specific property.'),
				j,
			),
			PropertyIgnoredDueToDisplay: new z(
				'propertyIgnoredDueToDisplay',
				d.t('Property is ignored due to the display.'),
				fe,
			),
			AvoidImportant: new z(
				'important',
				d.t(
		...
		as = {
			ValidProperties: new os(
				'validProperties',
				d.t('A list of properties that are not validated against the `unknownProperties` rule.'),
				[],
			),
		}
	class ls {
	...
	class Mt {
		...
		doCodeActions(e, t, n, i) {
			return this.doCodeActions2(e, t, n, i).map((s) => {
				const a = s.edit && s.edit.documentChanges && s.edit.documentChanges[0]
				return f.Command.create(s.title, '_css.applyCodeAction', e.uri, e.version, a && a.edits)
			})
		}
		doCodeActions2(e, t, n, i) {
			const s = []
			if (n.diagnostics) for (const a of n.diagnostics) this.appendFixesForMarker(e, i, a, s)
			return s
		}
		getFixesForUnknownProperty(e, t, n, i) {
			const s = t.getName(),
				a = []
			;(this.cssDataManager.getProperties().forEach((l) => {
				const h = $r(s, l.name)
				h >= s.length / 2 && a.push({ property: l.name, score: h })
			}),
				a.sort((l, h) => h.score - l.score || l.property.localeCompare(h.property)))
			let c = 3
			for (const l of a) {
				const h = l.property,
					m = d.t("Rename to '{0}'", h),
					g = f.TextEdit.replace(n.range, h),
					w = f.VersionedTextDocumentIdentifier.create(e.uri, e.version),
					v = { documentChanges: [f.TextDocumentEdit.create(w, [g])] },
					y = f.CodeAction.create(m, v, f.CodeActionKind.QuickFix)
				if (((y.diagnostics = [n]), i.push(y), --c <= 0)) return
			}
		}
		appendFixesForMarker(e, t, n, i) {
			if (n.code !== k.UnknownProperty.id) return
			const s = e.offsetAt(n.range.start),
				a = e.offsetAt(n.range.end),
				c = lt(t, s)
			for (let l = c.length - 1; l >= 0; l--) {
				const h = c[l]
				if (h instanceof V) {
					const m = h.getProperty()
					if (m && m.offset === s && m.end === a) {
						this.getFixesForUnknownProperty(e, m, n, i)
						return
					}
				}
			}
	...
	function Re(r, e, t, n) {
		const i = r[e]
		;((i.value = t), t && (qn(i.properties, n) || i.properties.push(n)))
	}
	function ds(r, e, t) {
		;(Re(r, 'top', e, t), Re(r, 'right', e, t), Re(r, 'bottom', e, t), Re(r, 'left', e, t))
	}
	function P(r, e, t, n) {
		e === 'top' || e === 'right' || e === 'bottom' || e === 'left' ? Re(r, e, t, n) : ds(r, t, n)
	}
	function Ot(r, e, t) {
		switch (e.length) {
			case 1:
	...
	function Pt(r, e) {
		for (let t of e) if (r.matches(t)) return !0
		return !1
	}
	function Me(r, e = !0) {
		return e && Pt(r, ['initial', 'unset']) ? !1 : parseFloat(r.getText()) !== 0
	}
	function nr(r, e = !0) {
		return r.map((t) => Me(t, e))
	}
	function Xe(r, e = !0) {
		return !(Pt(r, ['none', 'hidden']) || (e && Pt(r, ['initial', 'unset'])))
	}
	function ps(r, e = !0) {
		return r.map((t) => Xe(t, e))
	}
	function ms(r) {
			...
			if (!(typeof n > 'u'))
				switch (t.fullPropertyName) {
					...
					case 'height':
						...
						break
					default:
						const i = t.fullPropertyName.split('-')
						switch (i[0]) {
							case 'border':
								switch (i[1]) {
									case void 0:
									...
									case 'left':
										...
										break
									case 'width':
										Ot(e, nr(n.getChildren(), !1), t)
										break
									case 'style':
										Ot(e, ps(n.getChildren(), !0), t)
										break
								}
								break
							case 'padding':
								i.length === 1 ? Ot(e, nr(n.getChildren(), !0), t) : P(e, i[1], Me(n, !0), t)
								break
						}
						break
				}
	...
	class ge {
		static entries(e, t, n, i, s) {
			const a = new ge(t, n, i)
			return (e.acceptVisitor(a), a.completeValidations(), a.getEntries(s))
		}
		constructor(e, t, n) {
			;((this.cssDataManager = n),
				(this.warnings = []),
				...
				(this.keyframes = new rr()),
				(this.validProperties = {}))
			const i = t.getSetting(as.ValidProperties)
			Array.isArray(i) &&
				i.forEach((s) => {
					if (typeof s == 'string') {
						const a = s.trim().toLowerCase()
						a.length && (this.validProperties[a] = !0)
					}
				})
		}
		isValidPropertyDeclaration(e) {
			const t = e.fullPropertyName
			return this.validProperties[t]
		}
		fetch(e, t) {
			const n = []
			for (const i of e) i.fullPropertyName === t && n.push(i)
			return n
		}
		fetchWithValue(e, t, n) {
			const i = []
			for (const s of e)
				if (s.fullPropertyName === t) {
					const a = s.node.getValue()
					a && this.findValueInExpression(a, n) && i.push(s)
				}
			return i
		}
		findValueInExpression(e, t) {
			let n = !1
			return (e.accept((i) => (i.type === p.Identifier && i.matches(t) && (n = !0), !n)), n)
		}
		getEntries(e = L.Warning | L.Error) {
			return this.warnings.filter((t) => (t.getLevel() & e) !== 0)
		}
		addEntry(e, t, n) {
			const i = new kn(e, t, this.settings.getRule(t), n)
			this.warnings.push(i)
		}
		getMissingNames(e, t) {
			const n = e.slice(0)
			for (let s = 0; s < t.length; s++) {
				const a = n.indexOf(t[s])
				a !== -1 && (n[a] = null)
			}
			let i = null
			for (let s = 0; s < n.length; s++) {
				const a = n[s]
				a && (i === null ? (i = d.t("'{0}'", a)) : (i = d.t("{0}, '{1}'", i, a)))
			}
			return i
		}
		visitNode(e) {
			switch (e.type) {
				case p.UnknownAtRule:
		...
		visitUnknownAtRule(e) {
			const t = e.getChild(0)
			return !t || this.cssDataManager.getAtDirective(t.getText())
				? !1
				: (this.addEntry(t, k.UnknownAtRules, `Unknown at rule ${t.getText()}`), !0)
		}
		visitKeyframe(e) {
			const t = e.getKeyword()
			if (!t) return !1
			const n = t.getText()
			return (this.keyframes.add(e.getName(), n, n !== '@keyframes' ? t : null), !0)
		}
		validateKeyframes() {
			const e = ['@-webkit-keyframes', '@-moz-keyframes', '@-o-keyframes']
			for (const t in this.keyframes.data) {
				const n = this.keyframes.data[t].names,
					i = n.indexOf('@keyframes') === -1
				if (!i && n.length === 1) continue
				const s = this.getMissingNames(e, n)
				if (s || i)
					for (const a of this.keyframes.data[t].nodes) {
						if (i) {
							const c = d.t("Always define standard rule '@keyframes' when defining keyframes.")
							this.addEntry(a, k.IncludeStandardPropertyWhenUsingVendorPrefix, c)
						}
						if (s) {
							const c = d.t('Always include all vendor specific rules: Missing: {0}', s)
							this.addEntry(a, k.AllVendorPrefixes, c)
						}
					}
			}
			return !0
		}
		visitSimpleSelector(e) {
			const t = this.documentText.charAt(e.offset)
			return (e.length === 1 && t === '*' && this.addEntry(e, k.UniversalSelector), !0)
		}
		visitIdentifierSelector(e) {
			return (this.addEntry(e, k.AvoidIdSelector), !0)
		}
		visitImport(e) {
			return (this.addEntry(e, k.ImportStatemement), !0)
		}
		visitRuleSet(e) {
			const t = e.getDeclarations()
			if (!t) return !1
			t.hasChildren() || this.addEntry(e.getSelectors(), k.EmptyRuleSet)
			const n = []
			for (const l of t.getChildren()) l instanceof V && n.push(new hs(l))
			const i = us(n)
			if (i.width) {
				let l = []
				if (
					(i.right.value && (l = Ge(l, i.right.properties)),
					i.left.value && (l = Ge(l, i.left.properties)),
					l.length !== 0)
				) {
					for (const h of l) this.addEntry(h.node, k.BewareOfBoxModelSize)
					this.addEntry(i.width.node, k.BewareOfBoxModelSize)
				}
			}
			if (i.height) {
				let l = []
				if (
					(i.top.value && (l = Ge(l, i.top.properties)),
					i.bottom.value && (l = Ge(l, i.bottom.properties)),
					l.length !== 0)
				) {
					for (const h of l) this.addEntry(h.node, k.BewareOfBoxModelSize)
					this.addEntry(i.height.node, k.BewareOfBoxModelSize)
				}
			}
			let s = this.fetchWithValue(n, 'display', 'inline-block')
			if (s.length > 0) {
				const l = this.fetch(n, 'float')
			...
			if (((s = this.fetchWithValue(n, 'display', 'block')), s.length > 0)) {
				const l = this.fetch(n, 'vertical-align')
				for (let h = 0; h < l.length; h++)
					this.addEntry(
						l[h].node,
						k.PropertyIgnoredDueToDisplay,
			...
			const a = this.fetch(n, 'float')
			for (let l = 0; l < a.length; l++) {
				const h = a[l]
				this.isValidPropertyDeclaration(h) || this.addEntry(h.node, k.AvoidFloat)
			}
			for (let l = 0; l < n.length; l++) {
				const h = n[l]
				if (h.fullPropertyName !== 'background' && !this.validProperties[h.fullPropertyName]) {
					const m = h.node.getValue()
					if (m && this.documentText.charAt(m.offset) !== '-') {
						const g = this.fetch(n, h.fullPropertyName)
						if (g.length > 1)
							for (let w = 0; w < g.length; w++) {
								const v = g[w].node.getValue()
								v &&
									this.documentText.charAt(v.offset) !== '-' &&
									g[w] !== h &&
									this.addEntry(h.node, k.DuplicateDeclarations)
							}
					}
				}
			}
			if (!e.getSelectors().matches(':export')) {
				const l = new rr()
				let h = !1
				for (const m of n) {
					const g = m.node
					if (this.isCSSDeclaration(g)) {
						let w = m.fullPropertyName
						const v = w.charAt(0)
						if (v === '-') {
							if (w.charAt(1) !== '-') {
								!this.cssDataManager.isKnownProperty(w) &&
									!this.validProperties[w] &&
									this.addEntry(g.getProperty(), k.UnknownVendorSpecificProperty)
								const y = g.getNonPrefixedPropertyName()
								l.add(y, w, g.getProperty())
							}
						} else {
							const y = w
							;((v === '*' || v === '_') &&
								(this.addEntry(g.getProperty(), k.IEStarHack), (w = w.substr(1))),
								!this.cssDataManager.isKnownProperty(y) &&
									!this.cssDataManager.isKnownProperty(w) &&
									(this.validProperties[w] ||
										this.addEntry(
											g.getProperty(),
											k.UnknownProperty,
											d.t("Unknown property: '{0}'", g.getFullPropertyName()),
										)),
								l.add(w, w, null))
						}
					} else h = !0
				...
				if (!h)
					for (const m in l.data) {
						const g = l.data[m],
							w = g.names,
							v = this.cssDataManager.isStandardProperty(m) && w.indexOf(m) === -1
						if (!v && w.length === 1) continue
						const y = new Set(v ? g.nodes : [])
						if (v) {
							const M = this.getContextualVendorSpecificPseudoElements(e)
							for (const D of g.nodes) {
								const C = D.getName(),
									O = C.substring(0, C.length - m.length)
								M.some((A) => A.startsWith(O)) && y.delete(D)
							}
						}
						const N = []
						for (let M = 0, D = ge.prefixes.length; M < D; M++) {
							const C = ge.prefixes[M]
							this.cssDataManager.isStandardProperty(C + m) && N.push(C + m)
						}
						const q = this.getMissingNames(N, w)
						if (q || v)
							for (const M of g.nodes) {
								if (v && y.has(M)) {
									const D = d.t("Also define the standard property '{0}' for compatibility", m)
									this.addEntry(M, k.IncludeStandardPropertyWhenUsingVendorPrefix, D)
								}
								if (q) {
									const D = d.t('Always include all vendor specific properties: Missing: {0}', q)
									this.addEntry(M, k.AllVendorPrefixes, D)
								}
							}
					}
			}
		...
		getContextualVendorSpecificPseudoElements(e) {
			function t(s, a) {
				for (const c of a.getChildren()) {
					if (c.type === p.PseudoSelector) {
						const l = c.getChildren()[0]?.getText()
						l && s.add(l)
					}
					t(s, c)
				}
			...
			function n(s, a) {
				if (a.type === p.Ruleset) for (const c of a.getSelectors().getChildren()) t(s, c)
				return a.parent ? n(s, a.parent) : void 0
			}
			const i = new Set()
			return (n(i, e), Array.from(i))
		}
		visitPrio(e) {
			return (this.addEntry(e, k.AvoidImportant), !0)
		}
		visitNumericValue(e) {
			const t = e.findParent(p.Function)
			if (t && t.getName() === 'calc') return !0
			const n = e.findParent(p.Declaration)
			if (n && n.getValue()) {
				const s = e.getValue()
				if (!s.unit || jn.length.indexOf(s.unit.toLowerCase()) === -1) return !0
				parseFloat(s.value) === 0 &&
					s.unit &&
					!this.validProperties[n.getFullPropertyName()] &&
					this.addEntry(e, k.ZeroWithUnit)
			}
			return !0
		}
		visitFontFace(e) {
			...
			let n = !1,
				i = !1,
				s = !1
			for (const a of t.getChildren())
				if (this.isCSSDeclaration(a)) {
					const c = a.getProperty().getName().toLowerCase()
					;(c === 'src' && (n = !0), c === 'font-family' && (i = !0))
				} else s = !0
			return (!s && (!n || !i) && this.addEntry(e, k.RequiredPropertiesForFontFace), !0)
		}
		isCSSDeclaration(e) {
			if (e instanceof V) {
				...
				if (!t) return !1
				const n = t.getIdentifier()
				return !(!n || n.containsInterpolation())
			}
			return !1
		}
		visitHexColorValue(e) {
			const t = e.length
			return (t !== 9 && t !== 7 && t !== 5 && t !== 4 && this.addEntry(e, k.HexColorLength), !1)
		}
		visitFunction(e) {
			...
			return (
				n !== -1 &&
					(e.getArguments().accept((s) => (s instanceof ft ? ((i += 1), !1) : !0)),
					i !== n && this.addEntry(e, k.ArgsInColorFunction)),
				!0
			)
		}
	}
	ge.prefixes = ['-ms-', '-moz-', '-o-', '-webkit-']
	class Tt {
		constructor(e) {
			this.cssDataManager = e
		}
		...
		doValidation(e, t, n = this.settings) {
			if (n && n.validate === !1) return []
			const i = []
			;(i.push.apply(i, yt.entries(t)),
				i.push.apply(i, ge.entries(t, e, new ls(n && n.lint), this.cssDataManager)))
			const s = []
			for (const c in k) s.push(k[c].id)
			function a(c) {
				const l = f.Range.create(
						e.positionAt(c.getOffset()),
						e.positionAt(c.getOffset() + c.getLength()),
					),
					h = e.languageId
				return {
					code: c.getRule().id,
					...
					severity:
						c.getLevel() === L.Warning ? f.DiagnosticSeverity.Warning : f.DiagnosticSeverity.Error,
					range: l,
				}
			}
			return i.filter((c) => c.getLevel() !== L.Ignore).map(a)
		}
	}
	const ir = 47,
		fs = 10,
	...
	class ar extends Ce {
		scanNext(e) {
			if (this.stream.advanceIfChar(ws)) {
				const t = ['$']
				if (this.ident(t)) return this.finishToken(e, Nt, t.join(''))
				this.stream.goBackTo(e)
			}
			return this.stream.advanceIfChars([vs, ys])
				? this.finishToken(e, Qe)
				: this.stream.advanceIfChars([Oe, Oe])
					? this.finishToken(e, sr)
					: this.stream.advanceIfChars([Ss, Oe])
						? this.finishToken(e, or)
						: this.stream.advanceIfChar(xs)
							? this.stream.advanceIfChar(Oe)
								? this.finishToken(e, Lt)
								: this.finishToken(e, o.Delim)
							: this.stream.advanceIfChar(Cs)
								? this.stream.advanceIfChar(Oe)
									? this.finishToken(e, Wt)
									: this.finishToken(e, o.Delim)
								: this.stream.advanceIfChars([At, At, At])
									? this.finishToken(e, Ze)
									: super.scanNext(e)
		}
		comment() {
			return super.comment()
				? !0
				: !this.inURL && this.stream.advanceIfChars([ir, ir])
	...
	const Ut = {
		FromExpected: new $t('scss-fromexpected', d.t("'from' expected")),
		ThroughOrToExpected: new $t('scss-throughexpected', d.t("'through' or 'to' expected")),
		InExpected: new $t('scss-fromexpected', d.t("'in' expected")),
	}
	class ks extends qe {
		constructor() {
			super(new ar())
		...
		_parseImport() {
			...
			if (
				...
				return this.finish(e, u.URIOrStringExpected)
			for (; this.accept(o.Comma); )
				if (!e.addChild(this._parseURILiteral()) && !e.addChild(this._parseStringLiteral()))
					return this.finish(e, u.URIOrStringExpected)
			return this._completeParseImport(e)
		}
		_parseVariableDeclaration(e = []) {
			if (!this.peek(Nt)) return null
			const t = this.create($e)
			if (!t.setVariable(this._parseVariable())) return null
			if (!this.accept(o.Colon)) return this.finish(t, u.ColonExpected)
			if (
				(this.prevToken && (t.colonPosition = this.prevToken.offset),
				!t.setValue(this._parseExpr()))
			)
				return this.finish(t, u.VariableValueExpected, [], e)
			for (; this.peek(o.Exclamation); )
				if (!t.addChild(this._tryParsePrio())) {
					if ((this.consumeToken(), !this.peekRegExp(o.Ident, /^(default|global)$/)))
						return this.finish(t, u.UnknownKeyword)
					this.consumeToken()
				}
			return (this.peek(o.SemiColon) && (t.semicolonPosition = this.token.offset), this.finish(t))
		}
		_parseMediaCondition() {
			return this._parseInterpolation() || super._parseMediaCondition()
		}
		_parseMediaFeatureRangeOperator() {
			return this.accept(Lt) || this.accept(Wt) || super._parseMediaFeatureRangeOperator()
		}
		_parseMediaFeatureName() {
			return (
				this._parseModuleMember() ||
				this._parseFunction() ||
				this._parseIdent() ||
				this._parseVariable()
			)
		...
		_parseVariable() {
			if (!this.peek(Nt)) return null
			const e = this.create(vt)
			return (this.consumeToken(), e)
		}
		_parseModuleMember() {
			const e = this.mark(),
				t = this.create(Cn)
			return t.setIdentifier(this._parseIdent([S.Module]))
				? this.hasWhitespace() || !this.acceptDelim('.') || this.hasWhitespace()
					? (this.restoreAtMark(e), null)
					: t.addChild(this._parseVariable() || this._parseFunction())
						? t
						: this.finish(t, u.IdentifierOrVariableExpected)
				: null
		}
		_parseIdent(e) {
			if (!this.peek(o.Ident) && !this.peek(Qe) && !this.peekDelim('-')) return null
			const t = this.create(U)
			;((t.referenceTypes = e), (t.isCustomProperty = this.peekRegExp(o.Ident, /^--/)))
			let n = !1
			const i = () => {
				const s = this.mark()
				return this.acceptDelim('-') &&
					(this.hasWhitespace() || this.acceptDelim('-'), this.hasWhitespace())
					? (this.restoreAtMark(s), null)
					: this._parseInterpolation()
			}
			for (
				;
				(this.accept(o.Ident) || t.addChild(i()) || (n && this.acceptRegexp(/^[\w-]/))) &&
				((n = !0), !this.hasWhitespace());
			);
			return n ? this.finish(t) : null
		}
		_parseTermExpression() {
		...
		_parseInterpolation() {
			if (this.peek(Qe)) {
				const e = this.create(wt)
				return (
					this.consumeToken(),
					!e.addChild(this._parseExpr()) && !this._parseNestingSelector()
						? this.accept(o.CurlyR)
							? this.finish(e)
							: this.finish(e, u.ExpressionExpected)
						: this.accept(o.CurlyR)
							? this.finish(e)
							: this.finish(e, u.RightCurlyExpected)
				)
		...
		_parseRuleSetDeclaration() {
			return this.peek(o.AtKeyword)
				? this._parseKeyframe() ||
						...
						this._parseContainer(!0) ||
						this._parseRuleSetDeclarationAtStatement()
				: this._parseVariableDeclaration() || this._tryParseRuleset(!0) || this._parseDeclaration()
		}
		_parseDeclaration(e) {
			const t = this._tryParseCustomPropertyDeclaration(e)
			if (t) return t
			...
			if (!this.accept(o.Colon))
				return this.finish(n, u.ColonExpected, [o.Colon], e || [o.SemiColon])
			this.prevToken && (n.colonPosition = this.prevToken.offset)
			let i = !1
			if (
				(n.setValue(this._parseExpr()) && ((i = !0), n.addChild(this._parsePrio())),
				this.peek(o.CurlyL))
			)
				n.setNestedProperties(this._parseNestedProperties())
			else if (!i) return this.finish(n, u.PropertyValueExpected)
			return (this.peek(o.SemiColon) && (n.semicolonPosition = this.token.offset), this.finish(n))
		}
		_parseNestedProperties() {
			const e = this.create(gn)
			return this._parseBody(e, this._parseDeclaration.bind(this))
		}
		_parseExtends() {
			if (this.peekKeyword('@extend')) {
				const e = this.create(_e)
				if ((this.consumeToken(), !e.getSelectors().addChild(this._parseSimpleSelector())))
					return this.finish(e, u.SelectorExpected)
				for (; this.accept(o.Comma); ) e.getSelectors().addChild(this._parseSimpleSelector())
				return this.accept(o.Exclamation) && !this.acceptIdent('optional')
					? this.finish(e, u.UnknownKeyword)
					: this.finish(e)
			}
			return null
		}
		...
		_parseSelectorPlaceholder() {
			if (this.peekDelim('%')) {
				const e = this.createNode(p.SelectorPlaceholder)
				return (this.consumeToken(), this._parseIdent(), this.finish(e))
			} else if (this.peekKeyword('@at-root')) {
				const e = this.createNode(p.SelectorPlaceholder)
				if ((this.consumeToken(), this.accept(o.ParenthesisL))) {
					if (!this.acceptIdent('with') && !this.acceptIdent('without'))
						return this.finish(e, u.IdentifierExpected)
					if (!this.accept(o.Colon)) return this.finish(e, u.ColonExpected)
					if (!e.addChild(this._parseIdent())) return this.finish(e, u.IdentifierExpected)
					if (!this.accept(o.ParenthesisR))
						return this.finish(e, u.RightParenthesisExpected, [o.CurlyR])
				}
				return this.finish(e)
			}
			return null
		...
		_parseElementName() {
			const e = this.mark(),
				t = super._parseElementName()
			return t && !this.hasWhitespace() && this.peek(o.ParenthesisL)
				? (this.restoreAtMark(e), null)
				: t
		}
		_tryParsePseudoIdentifier() {
		...
		_parseWarnAndDebug() {
			if (!this.peekKeyword('@debug') && !this.peekKeyword('@warn') && !this.peekKeyword('@error'))
				return null
			const e = this.createNode(p.Debug)
					...
					? this.acceptIdent('from')
						? t.addChild(this._parseBinaryExpr())
							? !this.acceptIdent('to') && !this.acceptIdent('through')
								? this.finish(t, Ut.ThroughOrToExpected, [o.CurlyR])
								: t.addChild(this._parseBinaryExpr())
									? this._parseBody(t, e)
									: this.finish(t, u.ExpressionExpected, [o.CurlyR])
							: this.finish(t, u.ExpressionExpected, [o.CurlyR])
						: this.finish(t, Ut.FromExpected, [o.CurlyR])
					: this.finish(t, u.VariableNameExpected, [o.CurlyR])
			)
		}
		_parseEachStatement(e) {
			if (!this.peekKeyword('@each')) return null
			const t = this.create(Yr)
			this.consumeToken()
			const n = t.getVariables()
			if (!n.addChild(this._parseVariable()))
				return this.finish(t, u.VariableNameExpected, [o.CurlyR])
			for (; this.accept(o.Comma); )
				if (!n.addChild(this._parseVariable()))
					return this.finish(t, u.VariableNameExpected, [o.CurlyR])
			return (
				...
				this.acceptIdent('in')
					? t.addChild(this._parseExpr())
						? this._parseBody(t, e)
						: this.finish(t, u.ExpressionExpected, [o.CurlyR])
					: this.finish(t, Ut.InExpected, [o.CurlyR])
			)
		}
		_parseWhileStatement(e) {
			if (!this.peekKeyword('@while')) return null
			const t = this.create(Xr)
			return (
				this.consumeToken(),
				t.addChild(this._parseBinaryExpr())
					? this._parseBody(t, e)
		...
		_parseFunctionDeclaration() {
			...
			const e = this.create(Le)
			if ((this.consumeToken(), !e.setIdentifier(this._parseIdent([S.Function]))))
				return this.finish(e, u.IdentifierExpected, [o.CurlyR])
			if (!this.accept(o.ParenthesisL)) return this.finish(e, u.LeftParenthesisExpected, [o.CurlyR])
			if (e.getParameters().addChild(this._parseParameterDeclaration())) {
				for (; this.accept(o.Comma) && !this.peek(o.ParenthesisR); )
					if (!e.getParameters().addChild(this._parseParameterDeclaration()))
						return this.finish(e, u.VariableNameExpected)
			}
			return this.accept(o.ParenthesisR)
				? this._parseBody(e, this._parseFunctionBodyDeclaration.bind(this))
				: this.finish(e, u.RightParenthesisExpected, [o.CurlyR])
		}
		_parseReturnStatement() {
			if (!this.peekKeyword('@return')) return null
			const e = this.createNode(p.ReturnStatement)
			return (
				this.consumeToken(),
				e.addChild(this._parseExpr()) ? this.finish(e) : this.finish(e, u.ExpressionExpected)
			)
		}
		_parseMixinDeclaration() {
			if (!this.peekKeyword('@mixin')) return null
			const e = this.create(Ie)
			if ((this.consumeToken(), !e.setIdentifier(this._parseIdent([S.Mixin]))))
				return this.finish(e, u.IdentifierExpected, [o.CurlyR])
			if (this.accept(o.ParenthesisL)) {
				if (e.getParameters().addChild(this._parseParameterDeclaration())) {
					for (; this.accept(o.Comma) && !this.peek(o.ParenthesisR); )
		...
		_parseParameterDeclaration() {
			const e = this.create(We)
			return e.setIdentifier(this._parseVariable())
				? (this.accept(Ze),
					this.accept(o.Colon) && !e.setDefaultValue(this._parseExpr(!0))
						? this.finish(e, u.VariableValueExpected, [], [o.Comma, o.ParenthesisR])
						: this.finish(e))
				: null
		}
		_parseMixinContent() {
			if (!this.peekKeyword('@content')) return null
			const e = this.create(vi)
			if ((this.consumeToken(), this.accept(o.ParenthesisL))) {
				if (e.getArguments().addChild(this._parseFunctionArgument())) {
					for (; this.accept(o.Comma) && !this.peek(o.ParenthesisR); )
						if (!e.getArguments().addChild(this._parseFunctionArgument()))
							return this.finish(e, u.ExpressionExpected)
				}
				if (!this.accept(o.ParenthesisR)) return this.finish(e, u.RightParenthesisExpected)
			}
			return this.finish(e)
		...
		_parseMixinReference() {
			...
			const e = this.create(Ue)
			this.consumeToken()
			const t = this._parseIdent([S.Mixin])
			if (!e.setIdentifier(t)) return this.finish(e, u.IdentifierExpected, [o.CurlyR])
			if (!this.hasWhitespace() && this.acceptDelim('.') && !this.hasWhitespace()) {
				const n = this._parseIdent([S.Mixin])
				if (!n) return this.finish(e, u.IdentifierExpected, [o.CurlyR])
				const i = this.create(Cn)
				;((t.referenceTypes = [S.Module]), i.setIdentifier(t), e.setIdentifier(n), e.addChild(i))
			}
			if (this.accept(o.ParenthesisL)) {
				if (e.getArguments().addChild(this._parseFunctionArgument())) {
					for (; this.accept(o.Comma) && !this.peek(o.ParenthesisR); )
		...
		_parseMixinContentDeclaration() {
			...
			return (
				this.peek(o.CurlyL) &&
					this._parseBody(e, this._parseMixinReferenceBodyStatement.bind(this)),
				this.finish(e)
			)
		}
		...
		_parseFunctionArgument() {
			...
			if (n)
				if (this.accept(o.Colon)) e.setIdentifier(n)
				else {
					if (this.accept(Ze)) return (e.setValue(n), this.finish(e))
					this.restoreAtMark(t)
				}
			return e.setValue(this._parseExpr(!0))
				? (this.accept(Ze), e.addChild(this._parsePrio()), this.finish(e))
		...
		_parseURLArgument() {
			const e = this.mark(),
				t = super._parseURLArgument()
			if (!t || !this.peek(o.ParenthesisR)) {
				this.restoreAtMark(e)
				const n = this.create(b)
		...
		_parseOperation() {
			if (!this.peek(o.ParenthesisL)) return null
			const e = this.create(b)
			for (this.consumeToken(); e.addChild(this._parseListElement()); ) this.accept(o.Comma)
			return this.accept(o.ParenthesisR)
				? this.finish(e)
				: this.finish(e, u.RightParenthesisExpected)
		}
		_parseListElement() {
			const e = this.create(Si),
		...
		_parseUse() {
			...
			const e = this.create(ei)
			if ((this.consumeToken(), !e.addChild(this._parseStringLiteral())))
				return this.finish(e, u.StringLiteralExpected)
			if (!this.peek(o.SemiColon) && !this.peek(o.EOF)) {
				if (!this.peekRegExp(o.Ident, /as|with/)) return this.finish(e, u.UnknownKeyword)
				if (
					this.acceptIdent('as') &&
					!e.setIdentifier(this._parseIdent([S.Module])) &&
					!this.acceptDelim('*')
				)
					return this.finish(e, u.IdentifierOrWildcardExpected)
				if (this.acceptIdent('with')) {
					if (!this.accept(o.ParenthesisL))
						return this.finish(e, u.LeftParenthesisExpected, [o.ParenthesisR])
					if (!e.getParameters().addChild(this._parseModuleConfigDeclaration()))
						return this.finish(e, u.VariableNameExpected)
					for (; this.accept(o.Comma) && !this.peek(o.ParenthesisR); )
						if (!e.getParameters().addChild(this._parseModuleConfigDeclaration()))
							return this.finish(e, u.VariableNameExpected)
			...
			return !this.accept(o.SemiColon) && !this.accept(o.EOF)
				? this.finish(e, u.SemiColonExpected)
				: this.finish(e)
		}
		_parseModuleConfigDeclaration() {
			const e = this.create(ti)
			return e.setIdentifier(this._parseVariable())
				? !this.accept(o.Colon) || !e.setValue(this._parseExpr(!0))
					? this.finish(e, u.VariableValueExpected, [], [o.Comma, o.ParenthesisR])
					: this.accept(o.Exclamation) && (this.hasWhitespace() || !this.acceptIdent('default'))
						? this.finish(e, u.UnknownKeyword)
						: this.finish(e)
				: null
		}
		_parseForward() {
			...
			const e = this.create(ni)
			if ((this.consumeToken(), !e.addChild(this._parseStringLiteral())))
				return this.finish(e, u.StringLiteralExpected)
			if (this.acceptIdent('as')) {
				const t = this._parseIdent([S.Forward])
				if (!e.setIdentifier(t)) return this.finish(e, u.IdentifierExpected)
				if (this.hasWhitespace() || !this.acceptDelim('*'))
					return this.finish(e, u.WildcardExpected)
			}
			if (this.acceptIdent('with')) {
				if (!this.accept(o.ParenthesisL))
					return this.finish(e, u.LeftParenthesisExpected, [o.ParenthesisR])
				...
				(this.peekIdent('hide') || this.peekIdent('show')) &&
				!e.addChild(this._parseForwardVisibility())
			)
				return this.finish(e, u.IdentifierOrVariableExpected)
			return !this.accept(o.SemiColon) && !this.accept(o.EOF)
				? this.finish(e, u.SemiColonExpected)
				: this.finish(e)
		}
		_parseForwardVisibility() {
			const e = this.create(ri)
			for (
				e.setIdentifier(this._parseIdent());
				e.addChild(this._parseVariable() || this._parseIdent());
			)
				this.accept(o.Comma)
	...
	const Z = d.t('Sass documentation')
	class R extends Ft {
		constructor(e, t) {
			;(super('$', e, t), lr(R.scssModuleLoaders), lr(R.scssModuleBuiltIns))
		}
		isImportPathParent(e) {
			return e === p.Forward || e === p.Use || super.isImportPathParent(e)
		}
		getCompletionForImportPath(e, t) {
			const n = e.getParent().type
			if (n === p.Forward || n === p.Use)
				for (let i of R.scssModuleBuiltIns) {
					const s = {
						label: i.label,
						documentation: i.documentation,
						textEdit: f.TextEdit.replace(this.getCompletionRange(e), `'${i.label}'`),
						kind: f.CompletionItemKind.Module,
					}
					t.items.push(s)
				}
			return super.getCompletionForImportPath(e, t)
		}
		createReplaceFunction() {
			let e = 1
			return (t, n) => '\\' + n + ': ${' + e++ + ':' + (R.variableDefaults[n] || '') + '}'
		}
		createFunctionProposals(e, t, n, i) {
			for (const s of e) {
				const a = s.func.replace(/\[?(\$\w+)\]?/g, this.createReplaceFunction()),
					l = {
						label: s.func.substr(0, s.func.indexOf('(')),
						detail: s.func,
						documentation: s.desc,
						textEdit: f.TextEdit.replace(this.getCompletionRange(t), a),
						insertTextFormat: f.InsertTextFormat.Snippet,
						kind: f.CompletionItemKind.Function,
					}
		...
		getCompletionsForSelector(e, t, n) {
			return (
				this.createFunctionProposals(R.selectorFuncs, null, !0, n),
				super.getCompletionsForSelector(e, t, n)
			)
		}
		getTermProposals(e, t, n) {
			let i = R.builtInFuncs
			return (
				e &&
					(i = i.filter(
						(s) => !s.type || !e.restrictions || e.restrictions.indexOf(s.type) !== -1,
					)),
				this.createFunctionProposals(i, t, !0, n),
				super.getTermProposals(e, t, n)
			)
		}
		getColorProposals(e, t, n) {
			return (
				this.createFunctionProposals(R.colorProposals, t, !1, n),
				super.getColorProposals(e, t, n)
			)
		}
		getCompletionsForDeclarationProperty(e, t) {
			return (
				...
				super.getCompletionsForDeclarationProperty(e, t)
			)
		}
		getCompletionsForExtendsReference(e, t, n) {
			const i = this.getSymbolContext().findSymbolsAtOffset(this.offset, S.Rule)
			for (const s of i) {
				const a = {
					label: s.name,
					textEdit: f.TextEdit.replace(this.getCompletionRange(t), s.name),
					kind: f.CompletionItemKind.Function,
				}
				n.items.push(a)
			}
		...
		getCompletionForAtDirectives(e) {
			return (e.items.push(...R.scssAtDirectives), e)
		}
		getCompletionForTopLevel(e) {
			return (
				this.getCompletionForAtDirectives(e),
				this.getCompletionForModuleLoaders(e),
				super.getCompletionForTopLevel(e),
				e
			)
		}
		getCompletionForModuleLoaders(e) {
			return (e.items.push(...R.scssModuleLoaders), e)
		}
	}
	;((R.variableDefaults = {
		$red: '1',
		...
		(R.colorProposals = [
			{ func: 'red($color)', desc: d.t('Gets the red component of a color.') },
			{ func: 'green($color)', desc: d.t('Gets the green component of a color.') },
			{ func: 'blue($color)', desc: d.t('Gets the blue component of a color.') },
			{ func: 'mix($color, $color, [$weight])', desc: d.t('Mixes two colors together.') },
			{ func: 'hue($color)', desc: d.t('Gets the hue component of a color.') },
			{ func: 'saturation($color)', desc: d.t('Gets the saturation component of a color.') },
			{ func: 'lightness($color)', desc: d.t('Gets the lightness component of a color.') },
			{ func: 'adjust-hue($color, $degrees)', desc: d.t('Changes the hue of a color.') },
			{ func: 'lighten($color, $amount)', desc: d.t('Makes a color lighter.') },
			{ func: 'darken($color, $amount)', desc: d.t('Makes a color darker.') },
			{ func: 'saturate($color, $amount)', desc: d.t('Makes a color more saturated.') },
			{ func: 'desaturate($color, $amount)', desc: d.t('Makes a color less saturated.') },
			{ func: 'grayscale($color)', desc: d.t('Converts a color to grayscale.') },
			{ func: 'complement($color)', desc: d.t('Returns the complement of a color.') },
			{ func: 'invert($color)', desc: d.t('Returns the inverse of a color.') },
			{ func: 'alpha($color)', desc: d.t('Gets the opacity component of a color.') },
			{ func: 'opacity($color)', desc: 'Gets the alpha component (opacity) of a color.' },
			{ func: 'rgba($color, $alpha)', desc: d.t('Changes the alpha component for a color.') },
			{ func: 'opacify($color, $amount)', desc: d.t('Makes a color more opaque.') },
			{ func: 'fade-in($color, $amount)', desc: d.t('Makes a color more opaque.') },
			{ func: 'transparentize($color, $amount)', desc: d.t('Makes a color more transparent.') },
			{ func: 'fade-out($color, $amount)', desc: d.t('Makes a color more transparent.') },
			{
				func: 'adjust-color($color, [$red], [$green], [$blue], [$hue], [$saturation], [$lightness], [$alpha])',
				desc: d.t('Increases or decreases one or more components of a color.'),
			},
			{
				func: 'scale-color($color, [$red], [$green], [$blue], [$saturation], [$lightness], [$alpha])',
				desc: d.t('Fluidly scales one or more properties of a color.'),
			},
			{
				func: 'change-color($color, [$red], [$green], [$blue], [$hue], [$saturation], [$lightness], [$alpha])',
				desc: d.t('Changes one or more properties of a color.'),
			},
			{
				func: 'ie-hex-str($color)',
				desc: d.t('Converts a color into the format understood by IE filters.'),
			},
		]),
		(R.selectorFuncs = [
			{
			...
			},
			{
				...
				desc: d.t('Appends selectors to one another without spaces in between.'),
			},
			{
				func: 'selector-extend($selector, $extendee, $extender)',
				desc: d.t('Extends $extendee with $extender within $selector.'),
			},
			{
				func: 'selector-replace($selector, $original, $replacement)',
				desc: d.t('Replaces $original with $replacement within $selector.'),
			},
			{
			...
			},
			{
				...
				desc: d.t('Returns whether $super matches all the elements $sub does, and possibly more.'),
			},
			{
				func: 'simple-selectors($selector)',
				desc: d.t('Returns the simple selectors that comprise a compound selector.'),
			},
			{
				func: 'selector-parse($selector)',
				desc: d.t('Parses a selector into the format returned by &.'),
			},
		]),
		(R.builtInFuncs = [
			{ func: 'unquote($string)', desc: d.t('Removes quotes from a string.') },
			{ func: 'quote($string)', desc: d.t('Adds quotes to a string.') },
			{ func: 'str-length($string)', desc: d.t('Returns the number of characters in a string.') },
			{
				func: 'str-insert($string, $insert, $index)',
				desc: d.t('Inserts $insert into $string at $index.'),
			},
			{
				func: 'str-index($string, $substring)',
				desc: d.t('Returns the index of the first occurance of $substring in $string.'),
			},
			{
				func: 'str-slice($string, $start-at, [$end-at])',
				desc: d.t('Extracts a substring from $string.'),
			},
			{ func: 'to-upper-case($string)', desc: d.t('Converts a string to upper case.') },
			{ func: 'to-lower-case($string)', desc: d.t('Converts a string to lower case.') },
			{
				func: 'percentage($number)',
				desc: d.t('Converts a unitless number to a percentage.'),
				type: 'percentage',
			},
			{ func: 'round($number)', desc: d.t('Rounds a number to the nearest whole number.') },
			{ func: 'ceil($number)', desc: d.t('Rounds a number up to the next whole number.') },
			{ func: 'floor($number)', desc: d.t('Rounds a number down to the previous whole number.') },
			{ func: 'abs($number)', desc: d.t('Returns the absolute value of a number.') },
			{ func: 'min($numbers)', desc: d.t('Finds the minimum of several numbers.') },
			{ func: 'max($numbers)', desc: d.t('Finds the maximum of several numbers.') },
			{ func: 'random([$limit])', desc: d.t('Returns a random number.') },
			{ func: 'length($list)', desc: d.t('Returns the length of a list.') },
			{ func: 'nth($list, $n)', desc: d.t('Returns a specific item in a list.') },
			{ func: 'set-nth($list, $n, $value)', desc: d.t('Replaces the nth item in a list.') },
			{
				func: 'join($list1, $list2, [$separator])',
				desc: d.t('Joins together two lists into one.'),
			},
			{
				func: 'append($list1, $val, [$separator])',
				desc: d.t('Appends a single value onto the end of a list.'),
			},
			{
				func: 'zip($lists)',
				desc: d.t('Combines several lists into a single multidimensional list.'),
			},
			{ func: 'index($list, $value)', desc: d.t('Returns the position of a value within a list.') },
			{ func: 'list-separator(#list)', desc: d.t('Returns the separator of a list.') },
			{
				func: 'map-get($map, $key)',
				desc: d.t('Returns the value in a map associated with a given key.'),
			},
			{ func: 'map-merge($map1, $map2)', desc: d.t('Merges two maps together into a new map.') },
			{ func: 'map-remove($map, $keys)', desc: d.t('Returns a new map with keys removed.') },
			{ func: 'map-keys($map)', desc: d.t('Returns a list of all keys in a map.') },
			{ func: 'map-values($map)', desc: d.t('Returns a list of all values in a map.') },
			{
				func: 'map-has-key($map, $key)',
				desc: d.t('Returns whether a map has a value associated with a given key.'),
			},
			{
				func: 'keywords($args)',
				desc: d.t('Returns the keywords passed to a function that takes variable arguments.'),
			},
			{
				func: 'feature-exists($feature)',
				desc: d.t('Returns whether a feature exists in the current Sass runtime.'),
			},
			{
				func: 'variable-exists($name)',
				desc: d.t('Returns whether a variable with the given name exists in the current scope.'),
			},
			{
				func: 'global-variable-exists($name)',
				desc: d.t('Returns whether a variable with the given name exists in the global scope.'),
			},
			{
				func: 'function-exists($name)',
				desc: d.t('Returns whether a function with the given name exists.'),
			},
			{
				func: 'mixin-exists($name)',
				desc: d.t('Returns whether a mixin with the given name exists.'),
			},
			{
				func: 'inspect($value)',
				desc: d.t(
			...
			{ func: 'type-of($value)', desc: d.t('Returns the type of a value.') },
			{ func: 'unit($number)', desc: d.t('Returns the unit(s) associated with a number.') },
			{ func: 'unitless($number)', desc: d.t('Returns whether a number has units.') },
			{
				func: 'comparable($number1, $number2)',
				desc: d.t('Returns whether two numbers can be added, subtracted, or compared.'),
			},
			{ func: 'call($name, $args…)', desc: d.t('Dynamically calls a Sass function.') },
		]),
		(R.scssAtDirectives = [
			{
				label: '@extend',
				documentation: d.t('Inherits the styles of another selector.'),
				kind: f.CompletionItemKind.Keyword,
			},
			{
				label: '@at-root',
				documentation: d.t('Causes one or more rules to be emitted at the root of the document.'),
				kind: f.CompletionItemKind.Keyword,
			},
			{
				label: '@debug',
	...
	$0
			...
			{
				label: '@include',
				documentation: d.t('Includes the styles defined by another mixin into the current rule.'),
				kind: f.CompletionItemKind.Keyword,
			},
			{
				label: '@function',
		...
		(R.scssModuleLoaders = [
			{
				...
				references: [{ name: Z, url: 'https://sass-lang.com/documentation/at-rules/use' }],
				insertText: '@use $0;',
				insertTextFormat: f.InsertTextFormat.Snippet,
				kind: f.CompletionItemKind.Keyword,
			},
			{
				...
				references: [{ name: Z, url: 'https://sass-lang.com/documentation/at-rules/forward' }],
				insertText: '@forward $0;',
				insertTextFormat: f.InsertTextFormat.Snippet,
				kind: f.CompletionItemKind.Keyword,
			},
		]),
		(R.scssModuleBuiltIns = [
			{
				label: 'sass:math',
				documentation: d.t('Provides functions that operate on numbers.'),
				references: [{ name: Z, url: 'https://sass-lang.com/documentation/modules/math' }],
			},
			{
				label: 'sass:string',
				documentation: d.t('Makes it easy to combine, search, or split apart strings.'),
				references: [{ name: Z, url: 'https://sass-lang.com/documentation/modules/string' }],
			},
			{
				label: 'sass:color',
				documentation: d.t(
				...
				references: [{ name: Z, url: 'https://sass-lang.com/documentation/modules/color' }],
			},
			{
				label: 'sass:list',
				documentation: d.t('Lets you access and modify values in lists.'),
				references: [{ name: Z, url: 'https://sass-lang.com/documentation/modules/list' }],
			},
			{
				label: 'sass:map',
				documentation: d.t(
				...
				references: [{ name: Z, url: 'https://sass-lang.com/documentation/modules/map' }],
			},
			{
				label: 'sass:selector',
				documentation: d.t('Provides access to Sass’s powerful selector engine.'),
				references: [{ name: Z, url: 'https://sass-lang.com/documentation/modules/selector' }],
			},
			{
				label: 'sass:meta',
				documentation: d.t('Exposes the details of Sass’s inner workings.'),
				references: [{ name: Z, url: 'https://sass-lang.com/documentation/modules/meta' }],
			},
		]))
	function lr(r) {
		r.forEach((e) => {
			if (e.documentation && e.references && e.references.length > 0) {
				const t =
					typeof e.documentation == 'string'
						? { kind: 'markdown', value: e.documentation }
						: { kind: 'markdown', value: e.documentation.value }
				;((t.value += `

`),
					(t.value += e.references.map((n) => `[${n.name}](${n.url})`).join(' | ')),
					(e.documentation = t))
			}
		})
	}
	const cr = 47,
		...
		Vt = 96,
		Bt = 46
	let Is = o.CustomToken
	const Kt = Is++
	class hr extends Ce {
		scanNext(e) {
			const t = this.escapedJavaScript()
			return t !== null
				? this.finishToken(e, t)
				: this.stream.advanceIfChars([Bt, Bt, Bt])
					? this.finishToken(e, Kt)
					: super.scanNext(e)
		}
		comment() {
			return super.comment()
				? !0
				: !this.inURL && this.stream.advanceIfChars([cr, cr])
					? (this.stream.advanceWhileChar((e) => {
							switch (e) {
								case Fs:
								case Es:
		...
		escapedJavaScript() {
			return this.stream.peekChar() === Vt
				? (this.stream.advance(1),
					this.stream.advanceWhileChar((t) => t !== Vt),
					this.stream.advanceIfChar(Vt) ? o.EscapedJavaScript : o.BadEscapedJavaScript)
				: null
		}
	}
	class Ds extends qe {
		...
		_parseImport() {
			...
			const e = this.create(pt)
			if ((this.consumeToken(), this.accept(o.ParenthesisL))) {
				if (!this.accept(o.Ident)) return this.finish(e, u.IdentifierExpected, [o.SemiColon])
				do if (!this.accept(o.Comma)) break
				while (this.accept(o.Ident))
				if (!this.accept(o.ParenthesisR))
					return this.finish(e, u.RightParenthesisExpected, [o.SemiColon])
			}
			return !e.addChild(this._parseURILiteral()) && !e.addChild(this._parseStringLiteral())
				? this.finish(e, u.URIOrStringExpected, [o.SemiColon])
				: (!this.peek(o.SemiColon) &&
						!this.peek(o.EOF) &&
						e.setMedialist(this._parseMediaQueryList()),
					this._completeParseImport(e))
		...
		_parsePlugin() {
			...
			const e = this.createNode(p.Plugin)
			return (
				this.consumeToken(),
				e.addChild(this._parseStringLiteral())
					? this.accept(o.SemiColon)
						? this.finish(e)
						: this.finish(e, u.SemiColonExpected)
					: this.finish(e, u.StringLiteralExpected)
			)
		}
		_parseMediaQuery() {
			const e = super._parseMediaQuery()
			if (!e) {
				const t = this.create(yn)
				return t.addChild(this._parseVariable()) ? this.finish(t) : null
			}
			return e
		}
		_parseMediaDeclaration(e = !1) {
		...
		_parseVariableDeclaration(e = []) {
			...
			if (this.accept(o.Colon)) {
				if (
					...
					return this.finish(t, u.VariableValueExpected, [], e)
				t.addChild(this._parsePrio())
			} else return (this.restoreAtMark(n), null)
			return (this.peek(o.SemiColon) && (t.semicolonPosition = this.token.offset), this.finish(t))
		}
		_parseDetachedRuleSet() {
			...
			if (this.peekDelim('#') || this.peekDelim('.'))
				if ((this.consumeToken(), !this.hasWhitespace() && this.accept(o.ParenthesisL))) {
					let n = this.create(Ie)
					if (n.getParameters().addChild(this._parseMixinParameter()))
						for (
							;
							(this.accept(o.Comma) || this.accept(o.SemiColon)) && !this.peek(o.ParenthesisR);
						)
							n.getParameters().addChild(this._parseMixinParameter()) ||
								this.markError(n, u.IdentifierExpected, [], [o.ParenthesisR])
					if (!this.accept(o.ParenthesisR)) return (this.restoreAtMark(e), null)
				} else return (this.restoreAtMark(e), null)
			if (!this.peek(o.CurlyL)) return null
			const t = this.create(E)
			return (this._parseBody(t, this._parseDetachedRuleSetBody.bind(this)), this.finish(t))
		}
		_parseDetachedRuleSetBody() {
			return this._tryParseKeyframeSelector() || this._parseRuleSetDeclaration()
		}
		_addLookupChildren(e) {
			if (!e.addChild(this._parseLookupValue())) return !1
			let t = !1
			for (; this.peek(o.BracketL) && (t = !0), !!e.addChild(this._parseLookupValue()); ) t = !1
			return !t
		}
		_parseLookupValue() {
			const e = this.create(b),
				t = this.mark()
			return this.accept(o.BracketL)
				? ((e.addChild(this._parseVariable(!1, !0)) ||
						e.addChild(this._parsePropertyIdentifier())) &&
						this.accept(o.BracketR)) ||
					this.accept(o.BracketR)
					? e
					: (this.restoreAtMark(t), null)
				: (this.restoreAtMark(t), null)
		}
		_parseVariable(e = !1, t = !1) {
			const n = !e && this.peekDelim('$')
			if (!this.peekDelim('@') && !n && !this.peek(o.AtKeyword)) return null
			const i = this.create(vt),
				s = this.mark()
			for (; this.acceptDelim('@') || (!e && this.acceptDelim('$')); )
				if (this.hasWhitespace()) return (this.restoreAtMark(s), null)
			return !this.accept(o.AtKeyword) && !this.accept(o.Ident)
				? (this.restoreAtMark(s), null)
				: !t && this.peek(o.BracketL) && !this._addLookupChildren(i)
					? (this.restoreAtMark(s), null)
					: i
		}
		_parseTermExpression() {
		...
		_parseEscaped() {
			if (this.peek(o.EscapedJavaScript) || this.peek(o.BadEscapedJavaScript)) {
				const e = this.createNode(p.EscapedValue)
				return (this.consumeToken(), this.finish(e))
			}
			if (this.peekDelim('~')) {
				const e = this.createNode(p.EscapedValue)
				return (
					this.consumeToken(),
					this.accept(o.String) || this.accept(o.EscapedJavaScript)
						? this.finish(e)
						: this.finish(e, u.TermExpected)
				)
			}
			return null
		}
		_parseOperator() {
			const e = this._parseGuardOperator()
			return e || super._parseOperator()
		}
		_parseGuardOperator() {
			if (this.peekDelim('>')) {
				const e = this.createNode(p.Operator)
		...
		_parseKeyframeIdent() {
			return this._parseIdent([S.Keyframe]) || this._parseVariable()
		}
		_parseKeyframeSelector() {
		...
		_parseSelector(e) {
			...
			for (
				...
				n = !0
				const i = this.mark()
				if (t.addChild(this._parseGuard()) && this.peek(o.CurlyL)) break
		...
		_parseSelectorIdent() {
			...
			const e = this.createNode(p.SelectorInterpolation)
			return this._acceptInterpolatedIdent(e) ? this.finish(e) : null
		}
		_parsePropertyIdentifier(e = !1) {
			const t = /^[\w-]+/
			if (!this.peekInterpolatedIdent() && !this.peekRegExp(this.token.type, t)) return null
			const n = this.mark(),
				i = this.create(U)
			i.isCustomProperty = this.acceptDelim('-') && this.acceptDelim('-')
			let s = !1
			return (
				e
					? i.isCustomProperty
						? (s = i.addChild(this._parseIdent()))
						: (s = i.addChild(this._parseRegexp(t)))
					: i.isCustomProperty
						? (s = this._acceptInterpolatedIdent(i))
						: (s = this._acceptInterpolatedIdent(i, t)),
				s
					? (!e &&
							!this.hasWhitespace() &&
							(this.acceptDelim('+'), this.hasWhitespace() || this.acceptIdent('_')),
						this.finish(i))
					: (this.restoreAtMark(n), null)
			)
		}
		peekInterpolatedIdent() {
			return this.peek(o.Ident) || this.peekDelim('@') || this.peekDelim('$') || this.peekDelim('-')
		}
		_acceptInterpolatedIdent(e, t) {
			...
			const i = () => {
					...
					return this.acceptDelim('-') &&
						(this.hasWhitespace() || this.acceptDelim('-'), this.hasWhitespace())
						? (this.restoreAtMark(a), null)
						: this._parseInterpolation()
				},
				s = t ? () => this.acceptRegexp(t) : () => this.accept(o.Ident)
			for (
				;
				(s() || e.addChild(this._parseInterpolation() || this.try(i))) &&
				((n = !0), !this.hasWhitespace());
			);
			return n
		}
		_parseInterpolation() {
			const e = this.mark()
			if (this.peekDelim('@') || this.peekDelim('$')) {
				const t = this.createNode(p.Interpolation)
				return (
					this.consumeToken(),
					this.hasWhitespace() || !this.accept(o.CurlyL)
						? (this.restoreAtMark(e), null)
						: t.addChild(this._parseIdent())
							? this.accept(o.CurlyR)
								? this.finish(t)
								: this.finish(t, u.RightCurlyExpected)
							: this.finish(t, u.IdentifierExpected)
				)
			}
			return null
		...
		_tryParseMixinDeclaration() {
			const e = this.mark(),
				t = this.create(Ie)
			if (!t.setIdentifier(this._parseMixinDeclarationIdentifier()) || !this.accept(o.ParenthesisL))
				return (this.restoreAtMark(e), null)
			if (t.getParameters().addChild(this._parseMixinParameter()))
				for (; (this.accept(o.Comma) || this.accept(o.SemiColon)) && !this.peek(o.ParenthesisR); )
					t.getParameters().addChild(this._parseMixinParameter()) ||
						this.markError(t, u.IdentifierExpected, [], [o.ParenthesisR])
			return this.accept(o.ParenthesisR)
		...
		_parseMixinDeclarationIdentifier() {
			...
			if (this.peekDelim('#') || this.peekDelim('.')) {
				if (
					...
					return null
			} else if (this.peek(o.Hash)) ((e = this.create(U)), this.consumeToken())
			else return null
			return ((e.referenceTypes = [S.Mixin]), this.finish(e))
		}
		_parsePseudo() {
			if (!this.peek(o.Colon)) return null
			const e = this.mark(),
			...
			return (
				...
				this.acceptIdent('extend')
					...
					: (this.restoreAtMark(e), super._parsePseudo())
			)
		}
		_parseExtend() {
			if (!this.peekDelim('&')) return null
			...
			return (
				this.consumeToken(),
				this.hasWhitespace() || !this.accept(o.Colon) || !this.acceptIdent('extend')
					? (this.restoreAtMark(e), null)
					: this._completeExtends(t)
			)
		}
		_completeExtends(e) {
			if (!this.accept(o.ParenthesisL)) return this.finish(e, u.LeftParenthesisExpected)
			const t = e.getSelectors()
			if (!t.addChild(this._parseSelector(!0))) return this.finish(e, u.SelectorExpected)
			for (; this.accept(o.Comma); )
				if (!t.addChild(this._parseSelector(!0))) return this.finish(e, u.SelectorExpected)
			return this.accept(o.ParenthesisR)
				? this.finish(e)
		...
		_parseDetachedRuleSetMixin() {
			...
			const e = this.mark(),
				t = this.create(Ue)
			return t.addChild(this._parseVariable(!0)) &&
				(this.hasWhitespace() || !this.accept(o.ParenthesisL))
				? (this.restoreAtMark(e), null)
				: this.accept(o.ParenthesisR)
					? this.finish(t)
					: this.finish(t, u.RightParenthesisExpected)
		}
		_tryParseMixinReference(e = !0) {
			const t = this.mark(),
				n = this.create(Ue)
			let i = this._parseMixinDeclarationIdentifier()
			for (; i; ) {
				this.acceptDelim('>')
				const a = this._parseMixinDeclarationIdentifier()
				if (a) (n.getNamespaces().addChild(i), (i = a))
				else break
			}
			if (!n.setIdentifier(i)) return (this.restoreAtMark(t), null)
			let s = !1
			if (this.accept(o.ParenthesisL)) {
				if (((s = !0), n.getArguments().addChild(this._parseMixinArgument()))) {
					for (; (this.accept(o.Comma) || this.accept(o.SemiColon)) && !this.peek(o.ParenthesisR); )
						if (!n.getArguments().addChild(this._parseMixinArgument()))
							return this.finish(n, u.ExpressionExpected)
				}
				if (!this.accept(o.ParenthesisR)) return this.finish(n, u.RightParenthesisExpected)
				i.referenceTypes = [S.Mixin]
			} else i.referenceTypes = [S.Mixin, S.Rule]
			return (
				this.peek(o.BracketL) ? e || this._addLookupChildren(n) : n.addChild(this._parsePrio()),
				!s && !this.peek(o.SemiColon) && !this.peek(o.CurlyR) && !this.peek(o.EOF)
					? (this.restoreAtMark(t), null)
					: this.finish(n)
			)
		}
		_parseMixinArgument() {
			const e = this.create(de),
				...
				n = this._parseVariable()
			return (
				n && (this.accept(o.Colon) ? e.setIdentifier(n) : this.restoreAtMark(t)),
		...
		_parseMixinParameter() {
			...
			if (this.peekKeyword('@rest')) {
				...
				return (
					this.consumeToken(),
					this.accept(Kt)
						? (e.setIdentifier(this.finish(n)), this.finish(e))
						: this.finish(e, u.DotExpected, [], [o.Comma, o.ParenthesisR])
				)
			}
			if (this.peek(Kt)) {
				const n = this.create(b)
			...
			let t = !1
			return (
				e.setIdentifier(this._parseVariable()) && (this.accept(o.Colon), (t = !0)),
				!e.setDefaultValue(this._parseDetachedRuleSet() || this._parseExpr(!0)) && !t
					? null
					: this.finish(e)
			)
		}
		_parseGuard() {
			...
			const e = this.create(xi)
			if ((this.consumeToken(), !e.getConditions().addChild(this._parseGuardCondition())))
				return this.finish(e, u.ConditionExpected)
			for (; this.acceptIdent('and') || this.accept(o.Comma); )
				...
				this.accept(o.ParenthesisL)
					? (e.addChild(this._parseExpr()),
						this.accept(o.ParenthesisR)
							...
							: this.finish(e, u.RightParenthesisExpected))
					: e.isNegated
						? this.finish(e, u.LeftParenthesisExpected)
						: null
			)
		}
		_parseFunction() {
		...
		_parseFunctionIdentifier() {
			if (this.peekDelim('%')) {
				const e = this.create(U)
				return ((e.referenceTypes = [S.Function]), this.consumeToken(), this.finish(e))
			}
	...
	class be extends Ft {
		...
		createFunctionProposals(e, t, n, i) {
			for (const s of e) {
				const a = {
					...
					textEdit: f.TextEdit.replace(this.getCompletionRange(t), s.name + '($0)'),
					insertTextFormat: f.InsertTextFormat.Snippet,
					kind: f.CompletionItemKind.Function,
				}
		...
		getColorProposals(e, t, n) {
			return (
				this.createFunctionProposals(be.colorProposals, t, !1, n),
				super.getColorProposals(e, t, n)
			)
		}
		getCompletionsForDeclarationProperty(e, t) {
	...
	;((be.builtInProposals = [
		{
			...
			description: d.t('returns one of two values depending on a condition.'),
		},
		{
			name: 'boolean',
			example: 'boolean(condition);',
			description: d.t('"store" a boolean test for later evaluation in a guard or if().'),
		},
		{
			name: 'length',
			example: 'length(@list);',
			description: d.t('returns the number of elements in a value list'),
		},
		{
			name: 'extract',
			example: 'extract(@list, index);',
			description: d.t('returns a value at the specified position in the list'),
		},
		{
			name: 'range',
			example: 'range([start, ] end [, step]);',
			description: d.t('generate a list spanning a range of values'),
		},
		{
			name: 'each',
			example: 'each(@list, ruleset);',
			description: d.t('bind the evaluation of a ruleset to each member of a list.'),
		},
		{ name: 'escape', example: 'escape(@string);', description: d.t('URL encodes a string') },
		{ name: 'e', example: 'e(@string);', description: d.t('escape string content') },
		{
			name: 'replace',
			example: 'replace(@string, @pattern, @replacement[, @flags]);',
			description: d.t('string replace'),
		},
		{
			name: 'unit',
			example: "unit(@dimension, [@unit: '']);",
			description: d.t('remove or change the unit of a dimension'),
		},
		{
			name: 'color',
			example: 'color(@string);',
			description: d.t('parses a string to a color'),
			type: 'color',
		},
		{
			name: 'convert',
			example: 'convert(@value, unit);',
			description: d.t('converts numbers from one type into another'),
		},
		{
			name: 'data-uri',
			example: 'data-uri([mimetype,] url);',
			description: d.t('inlines a resource and falls back to `url()`'),
			type: 'url',
		},
		{ name: 'abs', description: d.t('absolute value of a number'), example: 'abs(number);' },
		{
			name: 'acos',
			description: d.t('arccosine - inverse of cosine function'),
			example: 'acos(number);',
		},
		{
			name: 'asin',
			description: d.t('arcsine - inverse of sine function'),
			example: 'asin(number);',
		},
		{ name: 'ceil', example: 'ceil(@number);', description: d.t('rounds up to an integer') },
		{ name: 'cos', description: d.t('cosine function'), example: 'cos(number);' },
		{ name: 'floor', description: d.t('rounds down to an integer'), example: 'floor(@number);' },
		{
			name: 'percentage',
			description: d.t('converts to a %, e.g. 0.5 > 50%'),
			example: 'percentage(@number);',
			type: 'percentage',
		},
		{
			name: 'round',
			description: d.t('rounds a number to a number of places'),
			example: 'round(number, [places: 0]);',
		},
		{
			name: 'sqrt',
			description: d.t('calculates square root of a number'),
			example: 'sqrt(number);',
		},
		{ name: 'sin', description: d.t('sine function'), example: 'sin(number);' },
		{ name: 'tan', description: d.t('tangent function'), example: 'tan(number);' },
		{
			name: 'atan',
			description: d.t('arctangent - inverse of tangent function'),
			example: 'atan(number);',
		},
		{ name: 'pi', description: d.t('returns pi'), example: 'pi();' },
		{
			name: 'pow',
			description: d.t('first argument raised to the power of the second argument'),
			example: 'pow(@base, @exponent);',
		},
		{
			name: 'mod',
			description: d.t('first argument modulus second argument'),
			example: 'mod(number, number);',
		},
		{
			name: 'min',
			description: d.t('returns the lowest of one or more values'),
			example: 'min(@x, @y);',
		},
		{
			name: 'max',
		...
		(be.colorProposals = [
			{ name: 'argb', example: 'argb(@color);', description: d.t('creates a #AARRGGBB') },
			{
				name: 'hsl',
				example: 'hsl(@hue, @saturation, @lightness);',
				description: d.t('creates a color'),
			},
			{
				name: 'hsla',
			...
			},
			{
				name: 'hue',
				example: 'hue(@color);',
				description: d.t('returns the `hue` channel of `@color` in the HSL space'),
			},
			{
				name: 'saturation',
				example: 'saturation(@color);',
				description: d.t('returns the `saturation` channel of `@color` in the HSL space'),
			},
			{
				name: 'lightness',
				example: 'lightness(@color);',
				description: d.t('returns the `lightness` channel of `@color` in the HSL space'),
			},
			{
				name: 'hsvhue',
				example: 'hsvhue(@color);',
				description: d.t('returns the `hue` channel of `@color` in the HSV space'),
			},
			{
				name: 'hsvsaturation',
				example: 'hsvsaturation(@color);',
				description: d.t('returns the `saturation` channel of `@color` in the HSV space'),
			},
			{
				name: 'hsvvalue',
				example: 'hsvvalue(@color);',
				description: d.t('returns the `value` channel of `@color` in the HSV space'),
			},
			{
				name: 'red',
				example: 'red(@color);',
				description: d.t('returns the `red` channel of `@color`'),
			},
			{
				name: 'green',
				example: 'green(@color);',
				description: d.t('returns the `green` channel of `@color`'),
			},
			{
				name: 'blue',
				example: 'blue(@color);',
				description: d.t('returns the `blue` channel of `@color`'),
			},
			{
				name: 'alpha',
				example: 'alpha(@color);',
				description: d.t('returns the `alpha` channel of `@color`'),
			},
			{
				name: 'luma',
				example: 'luma(@color);',
				description: d.t('returns the `luma` value (perceptual brightness) of `@color`'),
			},
			{
				name: 'saturate',
				example: 'saturate(@color, 10%);',
				description: d.t('return `@color` 10% points more saturated'),
			},
			{
				name: 'desaturate',
				example: 'desaturate(@color, 10%);',
				description: d.t('return `@color` 10% points less saturated'),
			},
			{
				name: 'lighten',
				example: 'lighten(@color, 10%);',
				description: d.t('return `@color` 10% points lighter'),
			},
			{
				name: 'darken',
				example: 'darken(@color, 10%);',
				description: d.t('return `@color` 10% points darker'),
			},
			{
				name: 'fadein',
				example: 'fadein(@color, 10%);',
				description: d.t('return `@color` 10% points less transparent'),
			},
			{
				name: 'fadeout',
				example: 'fadeout(@color, 10%);',
				description: d.t('return `@color` 10% points more transparent'),
			},
			{
				name: 'fade',
				example: 'fade(@color, 50%);',
				description: d.t('return `@color` with 50% transparency'),
			},
			{
				name: 'spin',
				example: 'spin(@color, 10);',
				description: d.t('return `@color` with a 10 degree larger in hue'),
			},
			{
				name: 'mix',
				example: 'mix(@color1, @color2, [@weight: 50%]);',
				description: d.t('return a mix of `@color1` and `@color2`'),
			},
			{
				name: 'greyscale',
				example: 'greyscale(@color);',
				description: d.t('returns a grey, 100% desaturated color'),
			},
			{
				name: 'contrast',
	...
	function Rs(r) {
		function e(m) {
			return r.positionAt(m.offset).line
		}
		function t(m) {
			return r.positionAt(m.offset + m.len).line
		}
		function n() {
			switch (r.languageId) {
				case 'scss':
		...
		function i(m, g) {
			const w = e(m),
				v = t(m)
			return w !== v ? { startLine: w, endLine: v, kind: g } : null
		}
		const s = [],
			a = [],
			c = n()
		;((c.ignoreComment = !1), c.setSource(r.getText()))
		let l = c.scan(),
			h = null
		for (; l.type !== o.EOF; ) {
			switch (l.type) {
				case o.CurlyL:
				case Qe: {
					a.push({ line: e(l), type: 'brace', isStart: !0 })
					break
				}
				case o.CurlyR: {
					if (a.length !== 0) {
						...
						m.type === 'brace' &&
							(h && t(h) !== g && g--,
							m.line !== g && s.push({ startLine: m.line, endLine: g, kind: void 0 }))
					}
					break
				}
				case o.Comment: {
					const m = (v) =>
							v === '#region'
								? { line: e(l), type: 'comment', isStart: !0 }
								: { line: t(l), type: 'comment', isStart: !1 },
						w = ((v) => {
							const y = v.text.match(/^\s*\/\*\s*(#region|#endregion)\b\s*(.*?)\s*\*\//)
							if (y) return m(y[1])
							if (r.languageId === 'scss' || r.languageId === 'less') {
								const N = v.text.match(/^\s*\/\/\s*(#region|#endregion)\b\s*(.*?)\s*/)
								if (N) return m(N[1])
							}
							return null
						})(l)
					if (w)
						if (w.isStart) a.push(w)
						else {
							const v = dr(a, 'comment')
							if (!v) break
							v.type === 'comment' &&
								v.line !== w.line &&
								s.push({ startLine: v.line, endLine: w.line, kind: 'region' })
						}
					else {
						const v = i(l, 'comment')
						v && s.push(v)
	...
	function dr(r, e) {
		...
		for (let t = r.length - 1; t >= 0; t--)
			if (r[t].type === e && r[t].isStart) return r.splice(t, 1)[0]
		return null
	}
	function Ms(r, e) {
		const t = (e && e.rangeLimit) || Number.MAX_VALUE,
			n = r.sort((a, c) => {
				let l = a.startLine - c.startLine
				return (l === 0 && (l = a.endLine - c.endLine), l)
			}),
			i = []
		let s = -1
		return (
			n.forEach((a) => {
				;(a.startLine < s && s < a.endLine) || (i.push(a), (s = a.endLine))
			}),
		...
		var r = [
				...
				function (i) {
					...
					;((s.prototype.clone_empty = function () {
						var l = new s(this.__parent)
						return (l.set_indent(this.__indent_count, this.__alignment_count), l)
					}),
						(s.prototype.item = function (l) {
							return l < 0 ? this.__items[this.__items.length + l] : this.__items[l]
						}),
						(s.prototype.has_match = function (l) {
							for (var h = this.__items.length - 1; h >= 0; h--)
								if (this.__items[h].match(l)) return !0
							return !1
						}),
						(s.prototype.set_indent = function (l, h) {
							this.is_empty() &&
								((this.__indent_count = l || 0),
								(this.__alignment_count = h || 0),
						...
						(s.prototype._allow_wrap = function () {
							if (this._should_wrap()) {
								...
								return (
									l.set_indent(this.__wrap_point_indent_count, this.__wrap_point_alignment_count),
									(l.__items = this.__items.slice(this.__wrap_point_index)),
									(this.__items = this.__items.slice(0, this.__wrap_point_index)),
									(l.__character_count +=
										this.__character_count - this.__wrap_point_character_count),
									(this.__character_count = this.__wrap_point_character_count),
									l.__items[0] === ' ' && (l.__items.splice(0, 1), (l.__character_count -= 1)),
									!0
								)
							}
							return !1
...
`)
							h !== -1
								? (this.__character_count = l.length - h)
								: (this.__character_count += l.length)
						}),
						(s.prototype.pop = function () {
							var l = null
							return (
								this.is_empty() || ((l = this.__items.pop()), (this.__character_count -= l.length)),
								l
							)
						}),
					...
					function a(l, h) {
						;((this.__cache = ['']),
							...
							l.indent_with_tabs ||
								(this.__indent_string = new Array(l.indent_size + 1).join(l.indent_char)),
							(h = h || ''),
							l.indent_level > 0 && (h = new Array(l.indent_level + 1).join(this.__indent_string)),
							(this.__base_string = h),
							(this.__base_string_length = h.length))
					}
					;((a.prototype.get_indent_size = function (l, h) {
						var m = this.__base_string_length
						return ((h = h || 0), l < 0 && (m = 0), (m += l * this.__indent_size), (m += h), m)
					}),
						(a.prototype.get_indent_string = function (l, h) {
							var m = this.__base_string
							return (
								(h = h || 0),
								l < 0 && ((l = 0), (m = '')),
								(h += l * this.__indent_size),
								this.__ensure_cache(h),
								(m += this.__cache[h]),
								m
							)
						}),
						(a.prototype.__ensure_cache = function (l) {
						...
						(a.prototype.__add_column = function () {
							...
							;(this.__indent_size &&
								...
								((h = Math.floor(l / this.__indent_size)),
								(l -= h * this.__indent_size),
								(m = new Array(h + 1).join(this.__indent_string))),
								l && (m += new Array(l + 1).join(' ')),
								this.__cache.push(m))
						}))
					function c(l, h) {
						;((this.__indent_cache = new a(l, h)),
							(this.raw = !1),
					...
					;((c.prototype.__add_outputline = function () {
						...
						(c.prototype.get_indent_string = function (l, h) {
							return this.__indent_cache.get_indent_string(l, h)
						}),
						(c.prototype.get_indent_size = function (l, h) {
							return this.__indent_cache.get_indent_size(l, h)
						}),
						(c.prototype.is_empty = function () {
							return !this.previous_line && this.current_line.is_empty()
						}),
						(c.prototype.add_new_line = function (l) {
							return this.is_empty() || (!l && this.just_added_newline())
								? !1
								: (this.raw || this.__add_outputline(), !0)
						}),
						(c.prototype.get_code = function (l) {
							this.trim(!0)
							var h = this.current_line.pop()
							;(h &&
								(h[h.length - 1] ===
									`
` && (h = h.replace(/\n+$/g, '')),
								this.current_line.push(h)),
								this._end_with_newline && this.__add_outputline())
							var m = this.__lines.join(`
`)
							return (
								l !==
									`
` && (m = m.replace(/[\n]/g, l)),
						...
						(c.prototype.set_indent = function (l, h) {
							return (
								(l = l || 0),
								(h = h || 0),
								this.next_line.set_indent(l, h),
								this.__lines.length > 1
									? (this.current_line.set_indent(l, h), !0)
									: (this.current_line.set_indent(), !1)
							)
						}),
						(c.prototype.add_raw_token = function (l) {
							for (var h = 0; h < l.newlines; h++) this.__add_outputline()
							;(this.current_line.set_indent(-1),
						...
						(c.prototype.remove_indent = function (l) {
							for (var h = this.__lines.length; l < h; ) (this.__lines[l]._remove_indent(), l++)
							this.current_line._remove_wrap_indent()
						}),
						(c.prototype.trim = function (l) {
							for (
								l = l === void 0 ? !1 : l, this.current_line.trim();
						...
						(c.prototype.ensure_empty_line_above = function (l, h) {
							for (var m = this.__lines.length - 2; m >= 0; ) {
								var g = this.__lines[m]
								if (g.is_empty()) break
								if (g.item(0).indexOf(l) !== 0 && g.item(-1) !== h) {
									;(this.__lines.splice(m + 1, 0, new s(this)),
				...
				function (i) {
					...
					;((s.prototype._get_array = function (l, h) {
						var m = this.raw_options[l],
							g = h || []
						return (
							typeof m == 'object'
								? m !== null && typeof m.concat == 'function' && (g = m.concat())
								: typeof m == 'string' && (g = m.split(/[^a-zA-Z0-9_\/\-]+/)),
							g
						)
					}),
						(s.prototype._get_boolean = function (l, h) {
							var m = this.raw_options[l],
								g = m === void 0 ? !!h : !!m
							return g
						}),
						(s.prototype._get_characters = function (l, h) {
							var m = this.raw_options[l],
								g = h || ''
							return (
								typeof m == 'string' &&
...
`,
						...
						(s.prototype._get_number = function (l, h) {
							var m = this.raw_options[l]
							;((h = parseInt(h, 10)), isNaN(h) && (h = 0))
							var g = parseInt(m, 10)
							return (isNaN(g) && (g = h), g)
						}),
						(s.prototype._get_selection = function (l, h, m) {
							var g = this._get_selection_list(l, h, m)
							if (g.length !== 1)
								throw new Error(
...
You passed in: '` +
						...
						(s.prototype._get_selection_list = function (l, h, m) {
							if (!h || h.length === 0) throw new Error('Selection list cannot be empty.')
							if (((m = m || [h[0]]), !this._is_valid_selection(m, h)))
								throw new Error('Invalid Default Value!')
							var g = this._get_array(l, m)
							if (!this._is_valid_selection(g, h))
								throw new Error(
									"Invalid Option Value: The option '" +
										l +
...
You passed in: '` +
						...
						(s.prototype._is_valid_selection = function (l, h) {
							return (
								l.length &&
								h.length &&
								!l.some(function (m) {
					...
					function a(l, h) {
						...
						l = c(l)
						var g
						for (g in l) g !== h && (m[g] = l[g])
						if (h && l[h]) for (g in l[h]) m[g] = l[h][g]
						return m
					}
					function c(l) {
						var h = {},
					...
					;((i.exports.Options = s), (i.exports.normalizeOpts = c), (i.exports.mergeOpts = a))
				},
				,
				function (i) {
					...
					;((a.prototype.restart = function () {
						...
						(a.prototype.peek = function (c) {
							...
							return (
								(c = c || 0),
								(c += this.__position),
								c >= 0 && c < this.__input_length && (l = this.__input.charAt(c)),
								l
							)
						}),
						(a.prototype.__match = function (c, l) {
							c.lastIndex = l
							var h = c.exec(this.__input)
							return (h && !(s && c.sticky) && h.index !== l && (h = null), h)
						}),
						(a.prototype.test = function (c, l) {
							return (
								(l = l || 0),
								(l += this.__position),
								l >= 0 && l < this.__input_length ? !!this.__match(c, l) : !1
							)
						}),
						(a.prototype.testChar = function (c, l) {
							var h = this.peek(l)
							return ((c.lastIndex = 0), h !== null && c.test(h))
						}),
						(a.prototype.match = function (c) {
							var l = this.__match(c, this.__position)
							return (l ? (this.__position += l[0].length) : (l = null), l)
						}),
						(a.prototype.read = function (c, l, h) {
							var m = '',
								g
							return (
								c && ((g = this.match(c)), g && (m += g[0])),
								l && (g || !c) && (m += this.readUntil(l, h)),
								m
							)
						}),
						(a.prototype.readUntil = function (c, l) {
							var h = '',
								m = this.__position
							c.lastIndex = this.__position
							var g = c.exec(this.__input)
							return (
								g ? ((m = g.index), l && (m += g[0].length)) : (m = this.__input_length),
								(h = this.__input.substring(this.__position, m)),
								(this.__position = m),
								h
							)
						}),
						(a.prototype.readUntilAfter = function (c) {
							return this.readUntil(c, !0)
						}),
						(a.prototype.get_regexp = function (c, l) {
							var h = null,
								m = 'g'
							return (
								l && s && (m = 'y'),
								typeof c == 'string' && c !== ''
									? (h = new RegExp(c, m))
									: c && (h = new RegExp(c.source, m)),
								h
							)
						}),
						(a.prototype.get_literal_regexp = function (c) {
							return RegExp(c.replace(/[-\/\\^$*+?.()|[\]{}]/g, '\\$&'))
						}),
						(a.prototype.peekUntilAfter = function (c) {
							var l = this.__position,
								h = this.readUntilAfter(c)
							return ((this.__position = l), h)
						}),
						(a.prototype.lookBack = function (c) {
							var l = this.__position - 1
							return l >= c.length && this.__input.substring(l - c.length, l).toLowerCase() === c
						}),
						(i.exports.InputScanner = a))
				},
				,
				,
				,
				...
				function (i) {
					function s(a, c) {
						;((a = typeof a == 'string' ? a : a.source),
							...
							(this.__directives_block_pattern = new RegExp(
								a + / beautify( \w+[:]\w+)+ /.source + c,
								'g',
							)),
							(this.__directive_pattern = / (\w+)[:](\w+)/g),
							(this.__directives_end_ignore_pattern = new RegExp(
								a + /\sbeautify\signore:end\s/.source + c,
								'g',
							)))
					}
					;((s.prototype.get_directives = function (a) {
						...
						for (var l = this.__directive_pattern.exec(a); l; )
							((c[l[1]] = l[2]), (l = this.__directive_pattern.exec(a)))
						return c
					}),
				...
				function (i, s, a) {
					...
					;((D.prototype.eatString = function (C) {
						var O = ''
						for (this._ch = this._input.next(); this._ch; ) {
							if (((O += this._ch), this._ch === '\\')) O += this._input.next()
							else if (
								C.indexOf(this._ch) !== -1 ||
								this._ch ===
									`
`
							)
						...
						(D.prototype.eatWhitespace = function (C) {
							for (var O = y.test(this._input.peek()), A = 0; y.test(this._input.peek()); )
								((this._ch = this._input.next()),
									C &&
										this._ch ===
											`
` &&
										(A === 0 || A < this._options.max_preserve_newlines) &&
										(A++, this._output.add_new_line(!0)))
							return O
						}),
						(D.prototype.foundNestedPseudoClass = function () {
							for (var C = 0, O = 1, A = this._input.peek(O); A; ) {
								if (A === '{') return !0
								if (A === '(') C += 1
								else if (A === ')') {
									if (C === 0) return !1
						...
						(D.prototype.print_string = function (C) {
							;(this._output.set_indent(this._indentLevel),
								(this._output.non_breaking_space = !0),
								this._output.add_token(C))
						}),
						(D.prototype.preserveSingleSpace = function (C) {
						...
						(D.prototype.beautify = function () {
							...
							var C = this._source_text,
								O = this._options.eol
							;(O === 'auto' &&
								((O = `
`),
								C && w.test(C || '') && (O = C.match(w)[0])),
								(C = C.replace(
									v,
									`
`,
							...
							var A = C.match(/^[\t ]*/)[0]
							;((this._output = new l(this._options, A)),
								(this._input = new h(C)),
								(this._indentLevel = 0),
								(this._nestedLevel = 0),
								(this._ch = null))
							for (
								...
								if (this._ch === '/' && this._input.peek() === '*') {
									...
									var Jt = this._input.read(q),
										vr = g.get_directives(Jt)
									;(vr && vr.ignore === 'start' && (Jt += g.readIgnored(this._input)),
										this.print_string(Jt),
										this.eatWhitespace(!0),
										this._output.add_new_line())
								} else if (this._ch === '/' && this._input.peek() === '/')
									((this._output.space_before_token = !0),
										this._input.back(),
										this.print_string(this._input.read(M)),
										this.eatWhitespace(!0))
								else if (this._ch === '$') {
									;(this.preserveSingleSpace(ie), this.print_string(this._ch))
									var nt = this._input.peekUntilAfter(/[: ,;{}()[\]\/='"]/g)
									;(nt.match(/[ :]$/) &&
										((nt = this.eatString(': ').replace(/\s+$/, '')),
										this.print_string(nt),
										(this._output.space_before_token = !0)),
										$ === 0 && nt.indexOf(':') !== -1 && ((W = !0), this.indent()))
								} else if (this._ch === '@')
									if ((this.preserveSingleSpace(ie), this._input.peek() === '{'))
										this.print_string(this._ch + this.eatString('}'))
									else {
										this.print_string(this._ch)
										var we = this._input.peekUntilAfter(/[: ,;{}()[\]\/='"]/g)
										;(we.match(/[ :]$/) &&
											((we = this.eatString(': ').replace(/\s+$/, '')),
											this.print_string(we),
											(this._output.space_before_token = !0)),
											$ === 0 && we.indexOf(':') !== -1
												? ((W = !0), this.indent())
												: we in this.NESTED_AT_RULE
													? ((this._nestedLevel += 1),
														we in this.CONDITIONAL_GROUP_RULE && (et = !0))
													: $ === 0 && !W && (Te = !0))
									}
								else if (this._ch === '#' && this._input.peek() === '{')
									(this.preserveSingleSpace(ie), this.print_string(this._ch + this.eatString('}')))
								else if (this._ch === '{')
									(W && ((W = !1), this.outdent()),
										(Te = !1),
										et
											? ((et = !1), (Pe = this._indentLevel >= this._nestedLevel))
											: (Pe = this._indentLevel >= this._nestedLevel - 1),
									...
									for (var Yt = 0; Yt < this.NON_SEMICOLON_NEWLINE_PROPERTY.length; Yt++)
										if (this._input.lookBack(this.NON_SEMICOLON_NEWLINE_PROPERTY[Yt])) {
											Ht = !0
											break
										}
									;(Pe || et) &&
									...
									var Qs = te === '"' || te === "'"
									;(this.preserveSingleSpace(Qs || ie),
									...
									if (this._input.lookBack('url'))
										...
										var yr = !1
										;(this._input.lookBack('with') && (yr = !0),
											this.preserveSingleSpace(ie || yr),
											this.print_string(this._ch),
											W && te === '$' && this._options.selector_separator_newline
												? (this._output.add_new_line(), (tt = !0))
												: (this.eatWhitespace(), $++, this.indent()))
									}
								else if (this._ch === ')')
									($ && ($--, this.outdent()),
										tt &&
											...
											((tt = !1), this.outdent(), this._output.add_new_line()),
										this.print_string(this._ch))
								else if (this._ch === ',')
									(this.print_string(this._ch),
										this.eatWhitespace(!0),
										this._options.selector_separator_newline && (!W || tt) && $ === 0 && !Te
											? this._output.add_new_line()
											: (this._output.space_before_token = !0))
								else if (
									(this._ch === '>' || this._ch === '+' || this._ch === '~') &&
									...
									var Zs = te === '"' || te === "'"
									;(this.preserveSingleSpace(Zs || ie),
										this.print_string(this._ch),
...
` &&
							...
							var eo = this._output.get_code(O)
							return eo
						}),
						(i.exports.Beautifier = D))
				},
				function (i, s, a) {
					var c = a(6).Options
					function l(h) {
						...
						var m = this._get_boolean('space_around_selector_separator')
						this.space_around_combinator = this._get_boolean('space_around_combinator') || m
						var g = this._get_selection_list('brace_style', [
							'collapse',
							'expand',
							'end-expand',
							'none',
						...
						for (var w = 0; w < g.length; w++)
							g[w] !== 'expand' ? (this.brace_style = 'collapse') : (this.brace_style = g[w])
					}
	...
	function Ps(r, e, t) {
		...
		const c = t.tabSize || 4
		if (e) {
			let m = r.offsetAt(e.start),
				g = m
			for (; g > 0 && fr(n, g - 1); ) g--
			g === 0 || ur(n, g - 1) ? (m = g) : g < m && (m = g + 1)
			let w = r.offsetAt(e.end),
				v = w
			for (; v < n.length && fr(n, v); ) v++
			if (
				((v === n.length || ur(n, v)) && (w = v),
				(e = f.Range.create(r.positionAt(m), r.positionAt(w))),
				(a = Ns(n, m)),
				(i = w === n.length),
				(n = n.substring(m, w)),
				m !== 0)
			) {
				const y = r.offsetAt(f.Position.create(e.start.line, 0))
				s = Ws(r.getText(), y, t)
			}
			a &&
				(n = `{
${mr(n)}`)
		} else e = f.Range.create(f.Position.create(0, 0), r.positionAt(n.length))
		const l = {
			indent_size: c,
			indent_char: t.insertSpaces ? ' ' : '	',
			end_with_newline: i && ee(t, 'insertFinalNewline', !1),
			selector_separator_newline: ee(t, 'newlineBetweenSelectors', !0),
			newline_between_rules: ee(t, 'newlineBetweenRules', !0),
			space_around_selector_separator: ee(t, 'spaceAroundSelectorSeparator', !1),
			brace_style: ee(t, 'braceStyle', 'collapse'),
			indent_empty_lines: ee(t, 'indentEmptyLines', !1),
			max_preserve_newlines: ee(t, 'maxPreserveNewLines', void 0),
			preserve_newlines: ee(t, 'preserveNewLines', !0),
			wrap_line_length: ee(t, 'wrapLineLength', void 0),
			eol: `
`,
		}
		let h = Os(n, l)
		if ((a && (h = mr(h.substring(2))), s > 0)) {
			const m = t.insertSpaces ? un(' ', c * s) : un('	', s)
			;((h = h
				.split(
					`
`,
...
` + m,
				...
				e.start.character === 0 && (h = m + h))
		}
		return [{ range: e, newText: h }]
	}
	function mr(r) {
		return r.replace(/^\s+/, '')
	}
	...
	function ur(r, e) {
		return (
			`\r
`.indexOf(r.charAt(e)) !== -1
		)
	}
	function fr(r, e) {
		return ' 	'.indexOf(r.charAt(e)) !== -1
	}
	const Ls = {
		version: 1.1,
		properties: [
			...
			},
			{
				...
				values: [
					...
					{ name: 'stretch', description: 'Lines stretch to take up the remaining space.' },
					{ name: 'start' },
					{ name: 'end' },
					{ name: 'normal' },
					{ name: 'baseline' },
			...
			},
			{
				...
				relevance: 87,
				references: [
					{ name: 'MDN Reference', url: 'https://developer.mozilla.org/docs/Web/CSS/align-items' },
				],
				description:
			...
			},
			{
				...
				values: [
					...
					{ name: 'end' },
					{ name: 'start' },
					{ name: 'flex-end', description: '"Flex items are packed toward the end of the line."' },
					{
						name: 'flex-start',
			...
			},
			{
				...
				relevance: 55,
				references: [
					{ name: 'MDN Reference', url: 'https://developer.mozilla.org/docs/Web/CSS/justify-self' },
				],
				description:
			...
			},
			{
				...
				relevance: 73,
				references: [
					{ name: 'MDN Reference', url: 'https://developer.mozilla.org/docs/Web/CSS/align-self' },
				],
				description:
			...
			},
			{
				...
				relevance: 53,
				references: [
					{ name: 'MDN Reference', url: 'https://developer.mozilla.org/docs/Web/CSS/all' },
				],
			...
			},
			{
				...
				relevance: 50,
				references: [
					{ name: 'MDN Reference', url: 'https://developer.mozilla.org/docs/Web/CSS/alt' },
				],
				description:
			...
			},
			{
				...
				values: [
					...
					{ name: 'both', description: 'Both forwards and backwards fill modes are applied.' },
					{
						name: 'forwards',
						description:
							'The final property value (as defined in the last @keyframes at-rule) is maintained after the animation completes.',
					},
					{ name: 'infinite', description: 'Causes the animation to repeat forever.' },
				...
				relevance: 82,
				references: [
					{ name: 'MDN Reference', url: 'https://developer.mozilla.org/docs/Web/CSS/animation' },
				],
				description:
			...
			},
			{
				...
				browsers: ['E12', 'FF16', 'S9', 'C43', 'IE10', 'O30'],
				values: [{ name: 'infinite', description: 'Causes the animation to repeat forever.' }],
			...
			},
			{
				name: 'animation-name',
				browsers: ['E12', 'FF16', 'S9', 'C43', 'IE10', 'O30'],
				values: [{ name: 'none', description: 'No animation is performed' }],
			...
			},
			{
				...
				browsers: ['E12', 'FF16', 'S9', 'C43', 'IE10', 'O30'],
				values: [
					{ name: 'paused', description: 'A running animation will be paused.' },
					{ name: 'running', description: 'Resume playback of a paused animation.' },
				],
			...
			},
			{
				...
				relevance: 93,
				references: [
					{ name: 'MDN Reference', url: 'https://developer.mozilla.org/docs/Web/CSS/background' },
				],
				description:
			...
			},
			{
				...
				values: [
					{ name: 'normal', description: 'Default attribute which specifies no blending' },
					{
						name: 'multiply',
						description:
					...
					{ name: 'darken', description: 'Selects the darker of the backdrop and source colors.' },
					{
						name: 'lighten',
			...
			},
			{
				...
				browsers: ['E12', 'FF1', 'S1', 'C1', 'IE4', 'O3.5'],
				values: [{ name: 'none', description: 'Counts as an image layer but draws nothing.' }],
				syntax: '<bg-image>#',
				relevance: 88,
				references: [
					{
			...
			},
			{
				...
				values: [{ name: 'auto', description: 'Depends on the values of other properties.' }],
				syntax: "<'width'>",
				relevance: 53,
				references: [
					{ name: 'MDN Reference', url: 'https://developer.mozilla.org/docs/Web/CSS/block-size' },
				],
				description:
			...
			},
			{
				...
				relevance: 95,
				references: [
					{ name: 'MDN Reference', url: 'https://developer.mozilla.org/docs/Web/CSS/border' },
				],
			...
			},
			{
				...
				values: [
					{ name: 'collapse', description: 'Selects the collapsing borders model.' },
					{ name: 'separate', description: 'Selects the separated borders border model.' },
				],
			...
			},
			{
				...
				relevance: 86,
				references: [
					{ name: 'MDN Reference', url: 'https://developer.mozilla.org/docs/Web/CSS/border-color' },
				],
			...
			},
			{
				...
				values: [
					...
					{ name: 'repeat', description: 'The image is tiled (repeated) to fill the area.' },
					{
						name: 'round',
						description:
					...
					{ name: 'stretch', description: 'The image is stretched to fill the area.' },
					{ name: 'url()' },
				],
				syntax:
				...
				relevance: 52,
				references: [
					{ name: 'MDN Reference', url: 'https://developer.mozilla.org/docs/Web/CSS/border-image' },
				],
				description:
			...
			},
			{
				...
				relevance: 81,
				references: [
					{ name: 'MDN Reference', url: 'https://developer.mozilla.org/docs/Web/CSS/border-left' },
				],
				description: 'Shorthand property for setting border width, style and color',
				restrictions: ['length', 'line-width', 'line-style', 'color'],
			},
			...
			},
			{
				...
				relevance: 80,
				references: [
					{ name: 'MDN Reference', url: 'https://developer.mozilla.org/docs/Web/CSS/border-right' },
				],
				description: 'Shorthand property for setting border width, style and color',
				restrictions: ['length', 'line-width', 'line-style', 'color'],
			},
			...
			},
			{
				...
				relevance: 79,
				references: [
					{ name: 'MDN Reference', url: 'https://developer.mozilla.org/docs/Web/CSS/border-style' },
				],
			...
			},
			{
				...
				relevance: 86,
				references: [
					{ name: 'MDN Reference', url: 'https://developer.mozilla.org/docs/Web/CSS/border-top' },
				],
				description: 'Shorthand property for setting border width, style and color',
				restrictions: ['length', 'line-width', 'line-style', 'color'],
			},
			...
			},
			{
				...
				relevance: 82,
				references: [
					{ name: 'MDN Reference', url: 'https://developer.mozilla.org/docs/Web/CSS/border-width' },
				],
				description:
			...
			},
			{
				...
				relevance: 90,
				references: [
					{ name: 'MDN Reference', url: 'https://developer.mozilla.org/docs/Web/CSS/bottom' },
				],
				description:
			...
			},
			{
				...
				relevance: 90,
				references: [
					{ name: 'MDN Reference', url: 'https://developer.mozilla.org/docs/Web/CSS/box-shadow' },
				],
				description:
			...
			},
			{
				...
				relevance: 92,
				references: [
					{ name: 'MDN Reference', url: 'https://developer.mozilla.org/docs/Web/CSS/box-sizing' },
				],
			...
			},
			{
				...
				values: [
					...
					{ name: 'avoid', description: 'Avoid a break before/after the principal box.' },
					{
						name: 'avoid-column',
						description: 'Avoid a column break before/after the principal box.',
					},
					{ name: 'avoid-page', description: 'Avoid a page break before/after the principal box.' },
					{
						name: 'column',
				...
				relevance: 50,
				references: [
					{ name: 'MDN Reference', url: 'https://developer.mozilla.org/docs/Web/CSS/break-after' },
				],
			...
			},
			{
				...
				relevance: 50,
				references: [
					{ name: 'MDN Reference', url: 'https://developer.mozilla.org/docs/Web/CSS/break-before' },
				],
			...
			},
			{
				...
				values: [
					...
					{ name: 'avoid-column', description: 'Avoid a column break within the box.' },
					{ name: 'avoid-page', description: 'Avoid a page break within the box.' },
				],
				syntax: 'auto | avoid | avoid-page | avoid-column | avoid-region',
				relevance: 51,
				references: [
					{ name: 'MDN Reference', url: 'https://developer.mozilla.org/docs/Web/CSS/break-inside' },
				],
			...
			},
			{
				...
				browsers: ['E12', 'FF1', 'S1', 'C1', 'IE8', 'O4'],
				values: [
					{ name: 'bottom', description: 'Positions the caption box below the table box.' },
					{ name: 'top', description: 'Positions the caption box above the table box.' },
				],
				syntax: 'top | bottom | block-start | block-end | inline-start | inline-end',
				relevance: 52,
				references: [
					{ name: 'MDN Reference', url: 'https://developer.mozilla.org/docs/Web/CSS/caption-side' },
				],
			...
			},
			{
				...
				relevance: 53,
				references: [
					{ name: 'MDN Reference', url: 'https://developer.mozilla.org/docs/Web/CSS/caret-color' },
				],
			...
			},
			{
				...
				relevance: 83,
				references: [
					{ name: 'MDN Reference', url: 'https://developer.mozilla.org/docs/Web/CSS/clear' },
				],
				description:
			...
			},
			{
				...
				values: [
					...
					{ name: 'rect()', description: 'Specifies offsets from the edges of the border box.' },
				],
				syntax: '<shape> | auto',
				relevance: 74,
				references: [
					{ name: 'MDN Reference', url: 'https://developer.mozilla.org/docs/Web/CSS/clip' },
				],
				description:
			...
			},
			{
				...
				relevance: 64,
				references: [
					{ name: 'MDN Reference', url: 'https://developer.mozilla.org/docs/Web/CSS/clip-path' },
				],
				description:
			...
			},
			{
				...
				relevance: 94,
				references: [
					{ name: 'MDN Reference', url: 'https://developer.mozilla.org/docs/Web/CSS/color' },
				],
			...
			},
			{
				...
				values: [
					...
					{ name: 'sRGB', description: 'Color operations should occur in the sRGB color space.' },
				],
				relevance: 50,
				description:
			...
			},
			{
				...
				relevance: 53,
				references: [
					{ name: 'MDN Reference', url: 'https://developer.mozilla.org/docs/Web/CSS/column-count' },
				],
				description:
			...
			},
			{
				...
				relevance: 50,
				references: [
					{ name: 'MDN Reference', url: 'https://developer.mozilla.org/docs/Web/CSS/column-fill' },
				],
				description:
			...
			},
			{
				...
				values: [
					{ name: 'normal', description: 'User agent specific and typically equivalent to 1em.' },
				],
				syntax: 'normal | <length-percentage>',
				relevance: 60,
				references: [
					{ name: 'MDN Reference', url: 'https://developer.mozilla.org/docs/Web/CSS/column-gap' },
				],
				description:
			...
			},
			{
				...
				relevance: 51,
				references: [
					{ name: 'MDN Reference', url: 'https://developer.mozilla.org/docs/Web/CSS/column-rule' },
				],
				description:
			...
			},
			{
				...
				browsers: ['E12', 'FF52', 'S9', 'C50', 'IE10', 'O11.1'],
				values: [
					{ name: 'auto', description: 'The width depends on the values of other properties.' },
				],
				syntax: "<'column-width'> || <'column-count'>",
				relevance: 51,
				references: [
					{ name: 'MDN Reference', url: 'https://developer.mozilla.org/docs/Web/CSS/columns' },
				],
			...
			{
				name: 'column-span',
				browsers: ['E12', 'FF71', 'S9', 'C50', 'IE10', 'O11.1'],
				values: [
					{
						name: 'all',
						description:
					...
					{ name: 'none', description: 'The element does not span multiple columns.' },
				],
				syntax: 'none | all',
				relevance: 50,
				references: [
					{ name: 'MDN Reference', url: 'https://developer.mozilla.org/docs/Web/CSS/column-span' },
				],
			...
			},
			{
				...
				relevance: 51,
				references: [
					{ name: 'MDN Reference', url: 'https://developer.mozilla.org/docs/Web/CSS/column-width' },
				],
			...
			},
			{
				...
				values: [
					{ name: 'none', description: 'Indicates that the property has no effect.' },
					{ name: 'strict', description: 'Turns on all forms of containment for the element.' },
					{
						name: 'content',
					...
					{ name: 'layout', description: 'Turns on layout containment for the element.' },
					{ name: 'style', description: 'Turns on style containment for the element.' },
					{ name: 'paint', description: 'Turns on paint containment for the element.' },
				],
				syntax: 'none | strict | content | [ [ size || inline-size ] || layout || style || paint ]',
				relevance: 58,
				references: [
					{ name: 'MDN Reference', url: 'https://developer.mozilla.org/docs/Web/CSS/contain' },
				],
				description:
			...
			},
			{
				...
				relevance: 89,
				references: [
					{ name: 'MDN Reference', url: 'https://developer.mozilla.org/docs/Web/CSS/content' },
				],
				description:
			...
			},
			{
				...
				values: [
					{ name: 'none', description: 'This element does not alter the value of any counters.' },
				],
			...
			},
			{
				name: 'counter-reset',
				browsers: ['E12', 'FF1', 'S3', 'C2', 'IE8', 'O9.2'],
				values: [{ name: 'none', description: 'The counter is not modified.' }],
			...
			},
			{
				...
				values: [
					...
					{ name: 'e-resize', description: 'Indicates that east edge is to be moved.' },
					{ name: 'ew-resize', description: 'Indicates a bidirectional east-west resize cursor.' },
					{
						name: 'grab',
						browsers: ['E12', 'FF1', 'S1.2', 'C1', 'IE4', 'O7'],
					...
					{ name: 'move', description: 'Indicates something is to be moved.' },
					{
						name: '-moz-grab',
						browsers: ['E12', 'FF1', 'S1.2', 'C1', 'IE4', 'O7'],
						description: 'Indicates that something can be grabbed.',
					...
					{ name: 'none', description: 'No cursor is rendered for the element.' },
					{
						name: 'not-allowed',
						description:
							'Indicates that the requested action will not be carried out. Often rendered as a circle with a line through it.',
					},
					{ name: 'n-resize', description: 'Indicates that north edge is to be moved.' },
					{ name: 'ns-resize', description: 'Indicates a bidirectional north-south cursor.' },
					{
						name: 'nw-resize',
					...
					{ name: 'pointer', description: 'The cursor is a pointer that indicates a link.' },
					{
						name: 'progress',
						description:
					...
					{ name: 's-resize', description: 'Indicates that south edge is to be moved.' },
					{
						name: 'sw-resize',
					...
					{ name: 'w-resize', description: 'Indicates that west edge is to be moved.' },
					{
						name: 'zoom-in',
						browsers: ['E12', 'FF1', 'S1.2', 'C1', 'IE4', 'O7'],
						description: 'Indicates that something can be zoomed (magnified) in.',
				...
				relevance: 91,
				references: [
					{ name: 'MDN Reference', url: 'https://developer.mozilla.org/docs/Web/CSS/cursor' },
				],
			...
			},
			{
				...
				values: [
					{ name: 'ltr', description: 'Left-to-right direction.' },
					{ name: 'rtl', description: 'Right-to-left direction.' },
				],
				syntax: 'ltr | rtl',
				relevance: 71,
				references: [
					{ name: 'MDN Reference', url: 'https://developer.mozilla.org/docs/Web/CSS/direction' },
				],
				description:
			...
			},
			{
				...
				browsers: ['E12', 'FF1', 'S1', 'C1', 'IE4', 'O7'],
				values: [
					{ name: 'block', description: 'The element generates a block-level box' },
					{
						name: 'contents',
						browsers: ['E12', 'FF1', 'S1', 'C1', 'IE4', 'O7'],
						description:
					...
					{ name: 'inline', description: 'The element generates an inline-level box.' },
					{
						name: 'inline-block',
						description:
					...
					{ name: 'list-item', description: 'One or more block boxes and one marker box.' },
					{
						name: '-moz-box',
						browsers: ['E12', 'FF1', 'S1', 'C1', 'IE4', 'O7'],
						description:
					...
					{ name: '-moz-deck', browsers: ['E12', 'FF1', 'S1', 'C1', 'IE4', 'O7'] },
					{ name: '-moz-grid', browsers: ['E12', 'FF1', 'S1', 'C1', 'IE4', 'O7'] },
					{ name: '-moz-grid-group', browsers: ['E12', 'FF1', 'S1', 'C1', 'IE4', 'O7'] },
					{ name: '-moz-grid-line', browsers: ['E12', 'FF1', 'S1', 'C1', 'IE4', 'O7'] },
					{ name: '-moz-groupbox', browsers: ['E12', 'FF1', 'S1', 'C1', 'IE4', 'O7'] },
					{
						name: '-moz-inline-box',
						browsers: ['E12', 'FF1', 'S1', 'C1', 'IE4', 'O7'],
						description: "Inline-level flex container. Standardized as 'inline-flex'",
					},
					{ name: '-moz-inline-grid', browsers: ['E12', 'FF1', 'S1', 'C1', 'IE4', 'O7'] },
					{ name: '-moz-inline-stack', browsers: ['E12', 'FF1', 'S1', 'C1', 'IE4', 'O7'] },
					{ name: '-moz-marker', browsers: ['E12', 'FF1', 'S1', 'C1', 'IE4', 'O7'] },
					{ name: '-moz-popup', browsers: ['E12', 'FF1', 'S1', 'C1', 'IE4', 'O7'] },
					{ name: '-moz-stack', browsers: ['E12', 'FF1', 'S1', 'C1', 'IE4', 'O7'] },
					{
						name: '-ms-flexbox',
						browsers: ['E12', 'FF1', 'S1', 'C1', 'IE4', 'O7'],
						description:
					...
					{ name: 'none', description: 'The element and its descendants generates no boxes.' },
					{
						name: 'ruby',
						description:
				...
				relevance: 96,
				references: [
					{ name: 'MDN Reference', url: 'https://developer.mozilla.org/docs/Web/CSS/display' },
				],
				description:
			...
			},
			{
				...
				values: [
					...
					{ name: '-moz-show-background', browsers: ['E12', 'FF1', 'S1.2', 'C1', 'IE8', 'O4'] },
					{
						name: 'show',
						description:
				...
				relevance: 51,
				references: [
					{ name: 'MDN Reference', url: 'https://developer.mozilla.org/docs/Web/CSS/empty-cells' },
				],
				description:
			...
			},
			{
				...
				values: [
					...
					{ name: 'none', description: 'No paint is applied in this layer.' },
				],
				relevance: 77,
			...
			},
			{
				...
				values: [
					...
					{ name: 'blur()', description: 'Applies a Gaussian blur to the input image.' },
					{
						name: 'brightness()',
						description:
							'Applies a linear multiplier to input image, making it appear more or less bright.',
					},
					{ name: 'contrast()', description: 'Adjusts the contrast of the input.' },
					{
						name: 'drop-shadow()',
						description: 'Applies a drop shadow effect to the input image.',
					},
					{ name: 'grayscale()', description: 'Converts the input image to grayscale.' },
					{ name: 'hue-rotate()', description: 'Applies a hue rotation on the input image. ' },
					{ name: 'invert()', description: 'Inverts the samples in the input image.' },
					{
						name: 'opacity()',
						description: 'Applies transparency to the samples in the input image.',
					},
					{ name: 'saturate()', description: 'Saturates the input image.' },
					{ name: 'sepia()', description: 'Converts the input image to sepia.' },
					{
						name: 'url()',
						browsers: ['E12', 'FF35', 'S9.1', 'C53', 'O40'],
				...
				relevance: 70,
				references: [
					{ name: 'MDN Reference', url: 'https://developer.mozilla.org/docs/Web/CSS/filter' },
				],
				description:
			...
			},
			{
				...
				relevance: 81,
				references: [
					{ name: 'MDN Reference', url: 'https://developer.mozilla.org/docs/Web/CSS/flex' },
				],
				description:
			...
			},
			{
				...
				relevance: 70,
				references: [
					{ name: 'MDN Reference', url: 'https://developer.mozilla.org/docs/Web/CSS/flex-basis' },
				],
			...
			{
				name: 'flex-direction',
				browsers: ['E12', 'FF81', 'S9', 'C29', 'IE11', 'O12.1'],
				values: [
					{
						name: 'column',
						description:
			...
			},
			{
				...
				values: [
					...
					{ name: 'nowrap', description: 'The flex container is single-line.' },
					{
						name: 'row',
						description:
							"The flex container's main axis has the same orientation as the inline axis of the current writing mode.",
				...
				relevance: 64,
				references: [
					{ name: 'MDN Reference', url: 'https://developer.mozilla.org/docs/Web/CSS/flex-flow' },
				],
			...
			},
			{
				...
				relevance: 77,
				references: [
					{ name: 'MDN Reference', url: 'https://developer.mozilla.org/docs/Web/CSS/flex-grow' },
				],
			...
			},
			{
				...
				relevance: 76,
				references: [
					{ name: 'MDN Reference', url: 'https://developer.mozilla.org/docs/Web/CSS/flex-shrink' },
				],
			...
			{
				name: 'flex-wrap',
				browsers: ['E12', 'FF28', 'S9', 'C29', 'IE11', 'O17'],
				values: [
					{ name: 'nowrap', description: 'The flex container is single-line.' },
					{ name: 'wrap', description: 'The flexbox is multi-line.' },
					{
				...
				relevance: 82,
				references: [
					{ name: 'MDN Reference', url: 'https://developer.mozilla.org/docs/Web/CSS/flex-wrap' },
				],
				description:
			...
			},
			{
				...
				relevance: 89,
				references: [
					{ name: 'MDN Reference', url: 'https://developer.mozilla.org/docs/Web/CSS/float' },
				],
				description:
			...
			},
			{
				...
				browsers: ['E12', 'FF1', 'S1', 'C1', 'IE3', 'O3.5'],
				values: [
					{ name: '100', description: 'Thin' },
					{ name: '200', description: 'Extra Light (Ultra Light)' },
					{ name: '300', description: 'Light' },
					{ name: '400', description: 'Normal' },
					{ name: '500', description: 'Medium' },
					{ name: '600', description: 'Semi Bold (Demi Bold)' },
					{ name: '700', description: 'Bold' },
					{ name: '800', description: 'Extra Bold (Ultra Bold)' },
					{ name: '900', description: 'Black (Heavy)' },
					{ name: 'bold', description: 'Same as 700' },
					{
						name: 'bolder',
					...
					{ name: 'message-box', description: 'The font used in dialog boxes.' },
					{
						name: 'normal',
						description: 'Specifies a face that is not labeled as a small-caps font.',
					},
					{ name: 'oblique', description: "Selects a font that is labeled 'oblique'." },
					{ name: 'small' },
					{
						name: 'small-caps',
						description:
					...
					{ name: 'small-caption', description: 'The font used for labeling small controls.' },
					{ name: 'smaller' },
					{ name: 'status-bar', description: 'The font used in window status bars.' },
					{ name: 'x-large' },
					{ name: 'x-small' },
					{ name: 'xx-large' },
					{ name: 'xx-small' },
				...
				relevance: 83,
				references: [
					{ name: 'MDN Reference', url: 'https://developer.mozilla.org/docs/Web/CSS/font' },
				],
				description:
			...
			},
			{
				...
				relevance: 93,
				references: [
					{ name: 'MDN Reference', url: 'https://developer.mozilla.org/docs/Web/CSS/font-family' },
				],
				description:
			...
			},
			{
				...
				values: [
					{ name: '"aalt"', description: 'Access All Alternates.' },
					{ name: '"abvf"', description: 'Above-base Forms. Required in Khmer script.' },
					{
						name: '"abvm"',
						description: 'Above-base Mark Positioning. Required in Indic scripts.',
					},
					{ name: '"abvs"', description: 'Above-base Substitutions. Required in Indic scripts.' },
					{ name: '"afrc"', description: 'Alternative Fractions.' },
					{ name: '"akhn"', description: 'Akhand. Required in most Indic scripts.' },
					{
						name: '"blwf"',
					...
					{ name: '"blws"', description: 'Below-base Substitutions. Required in Indic scripts.' },
					...
					{ name: '"ccmp"', description: 'Glyph Composition/Decomposition.' },
					{ name: '"cfar"', description: 'Conjunct Form After Ro. Required in Khmer scripts.' },
					{
						name: '"cjct"',
						description:
							'Conjunct Forms. Required in Indic scripts that show similarity to Devanagari.',
					},
					{ name: '"clig"', description: 'Contextual Ligatures.' },
					{
						name: '"cpct"',
					...
					{ name: '"cswh"', description: 'Contextual Swash.' },
					{
						name: '"curs"',
					...
					{ name: '"dist"', description: 'Distances. Required in Indic scripts.' },
					{ name: '"dlig"', description: 'Discretionary ligatures.' },
					{ name: '"dnom"', description: 'Denominators.' },
					{ name: '"dtls"', description: 'Dotless Forms. Applied to math formula layout.' },
					{ name: '"expt"', description: 'Expert Forms. Applies only to Japanese.' },
					{
						name: '"falt"',
						description: 'Final Glyph on Line Alternates. Can be used in any cursive script.',
					},
					{ name: '"fin2"', description: 'Terminal Form #2. Used only with the Syriac script.' },
					{ name: '"fin3"', description: 'Terminal Form #3. Used only with the Syriac script.' },
					{ name: '"fina"', description: 'Terminal Forms. Can be used in any alphabetic script.' },
					{
						name: '"flac"',
						description: 'Flattened ascent forms. Applied to math formula layout.',
					},
					{ name: '"frac"', description: 'Fractions.' },
					{
						name: '"fwid"',
					...
					{ name: '"haln"', description: 'Halant Forms. Required in Indic scripts.' },
					{ name: '"halt"', description: 'Alternate Half Widths. Used only in CJKV fonts.' },
					{ name: '"hist"', description: 'Historical Forms.' },
					{
						name: '"hkna"',
						description:
							'Horizontal Kana Alternates. Applies only to fonts that support kana (hiragana and katakana).',
					},
					{ name: '"hlig"', description: 'Historical Ligatures.' },
					{ name: '"hngl"', description: 'Hangul. Korean only.' },
					{
						name: '"hojo"',
						description:
							'Hojo Kanji Forms (JIS X 0212-1990 Kanji Forms). Used only with Kanji script.',
					},
					{ name: '"hwid"', description: 'Half Widths. Generally used only in CJKV fonts.' },
					{ name: '"init"', description: 'Initial Forms. Can be used in any alphabetic script.' },
					{ name: '"isol"', description: 'Isolated Forms. Can be used in any cursive script.' },
					{
						name: '"ital"',
						description:
					...
					{ name: '"jp78"', description: 'JIS78 Forms. Applies only to Japanese.' },
					{ name: '"jp83"', description: 'JIS83 Forms. Applies only to Japanese.' },
					{ name: '"jp90"', description: 'JIS90 Forms. Applies only to Japanese.' },
					{ name: '"jp04"', description: 'JIS2004 Forms. Applies only to Japanese.' },
					{ name: '"kern"', description: 'Kerning.' },
					{ name: '"lfbd"', description: 'Left Bounds.' },
					...
					{ name: '"locl"', description: 'Localized Forms.' },
					{ name: '"ltra"', description: 'Left-to-right glyph alternates.' },
					{ name: '"ltrm"', description: 'Left-to-right mirrored forms.' },
					{ name: '"mark"', description: 'Mark Positioning.' },
					{ name: '"med2"', description: 'Medial Form #2. Used only with the Syriac script.' },
					{ name: '"medi"', description: 'Medial Forms.' },
					{ name: '"mgrk"', description: 'Mathematical Greek.' },
					{ name: '"mkmk"', description: 'Mark to Mark Positioning.' },
					{ name: '"nalt"', description: 'Alternate Annotation Forms.' },
					{ name: '"nlck"', description: 'NLC Kanji Forms. Used only with Kanji script.' },
					{ name: '"nukt"', description: 'Nukta Forms. Required in Indic scripts..' },
					{ name: '"numr"', description: 'Numerators.' },
					{ name: '"onum"', description: 'Oldstyle Figures.' },
					{ name: '"opbd"', description: 'Optical Bounds.' },
					{ name: '"ordn"', description: 'Ordinals. Applies mostly to Latin script.' },
					{ name: '"ornm"', description: 'Ornaments.' },
					{
						name: '"palt"',
						description: 'Proportional Alternate Widths. Used mostly in CJKV fonts.',
					},
					{ name: '"pcap"', description: 'Petite Capitals.' },
					{
						name: '"pkna"',
						description: 'Proportional Kana. Generally used only in Japanese fonts.',
					},
					{ name: '"pnum"', description: 'Proportional Figures.' },
					{
						name: '"pref"',
						description:
					...
					{ name: '"pres"', description: 'Pre-base Substitutions. Required in Indic scripts.' },
					{
						name: '"pstf"',
						description:
					...
					{ name: '"psts"', description: 'Post-base Substitutions.' },
					{ name: '"pwid"', description: 'Proportional Widths.' },
					{ name: '"qwid"', description: 'Quarter Widths. Generally used only in CJKV fonts.' },
					{ name: '"rand"', description: 'Randomize.' },
					{
						name: '"rclt"',
						description:
					...
					{ name: '"rtbd"', description: 'Right Bounds.' },
					{ name: '"rtla"', description: 'Right-to-left alternates.' },
					{ name: '"rtlm"', description: 'Right-to-left mirrored forms.' },
					{ name: '"ruby"', description: 'Ruby Notation Forms. Applies only to Japanese.' },
					{ name: '"salt"', description: 'Stylistic Alternates.' },
					{ name: '"sinf"', description: 'Scientific Inferiors.' },
					{ name: '"size"', description: 'Optical size.' },
					{ name: '"smcp"', description: 'Small Capitals. Applies only to bicameral scripts.' },
					{
						name: '"smpl"',
						description: 'Simplified Forms. Applies only to Chinese and Japanese.',
					},
					{ name: '"ssty"', description: 'Math script style alternates.' },
					{ name: '"stch"', description: 'Stretching Glyph Decomposition.' },
					{ name: '"subs"', description: 'Subscript.' },
					{ name: '"sups"', description: 'Superscript.' },
					{ name: '"swsh"', description: 'Swash. Does not apply to ideographic scripts.' },
					{ name: '"titl"', description: 'Titling.' },
					{
						name: '"tjmo"',
						description:
							'Trailing Jamo Forms. Required for Hangul script when Ancient Hangul writing system is supported.',
					},
					{ name: '"tnam"', description: 'Traditional Name Forms. Applies only to Japanese.' },
					{ name: '"tnum"', description: 'Tabular Figures.' },
					{
						name: '"trad"',
						description: 'Traditional Forms. Applies only to Chinese and Japanese.',
					},
					{ name: '"twid"', description: 'Third Widths. Generally used only in CJKV fonts.' },
					{ name: '"unic"', description: 'Unicase.' },
					{
						name: '"valt"',
						description:
					...
					{ name: '"vkrn"', description: 'Vertical Kerning.' },
					{
						name: '"vpal"',
					...
					{ name: 'normal', description: 'No change in glyph substitution or positioning occurs.' },
			...
			},
			{
				...
				values: [
					...
					{ name: 'none', description: 'Specifies that kerning is not applied.' },
					{ name: 'normal', description: 'Specifies that kerning is applied.' },
				],
				syntax: 'auto | normal | none',
				relevance: 50,
				references: [
					{ name: 'MDN Reference', url: 'https://developer.mozilla.org/docs/Web/CSS/font-kerning' },
				],
				description:
			...
			},
			{
				...
				relevance: 94,
				references: [
					{ name: 'MDN Reference', url: 'https://developer.mozilla.org/docs/Web/CSS/font-size' },
				],
				description:
			...
			},
			{
				...
				browsers: ['FF3', 'S16.4'],
				values: [{ name: 'none', description: "Do not preserve the font's x-height." }],
				syntax:
			...
			},
			{
				...
				relevance: 56,
				references: [
					{ name: 'MDN Reference', url: 'https://developer.mozilla.org/docs/Web/CSS/font-stretch' },
				],
			...
			},
			{
				...
				values: [
					...
					{ name: 'normal', description: "Selects a face that is classified as 'normal'." },
					{
						name: 'oblique',
						description:
				...
				relevance: 89,
				references: [
					{ name: 'MDN Reference', url: 'https://developer.mozilla.org/docs/Web/CSS/font-style' },
				],
				description:
			...
			},
			{
				...
				values: [
					...
					{ name: 'weight', description: 'Allow synthetic bold faces.' },
				],
			...
			},
			{
				...
				relevance: 64,
				references: [
					{ name: 'MDN Reference', url: 'https://developer.mozilla.org/docs/Web/CSS/font-variant' },
				],
			...
			},
			{
				...
				values: [
					{ name: 'annotation()', description: 'Enables display of alternate annotation forms.' },
					{
						name: 'character-variant()',
						description: 'Enables display of specific character variants.',
					},
					{ name: 'historical-forms', description: 'Enables display of historical forms.' },
					{ name: 'normal', description: 'None of the features are enabled.' },
					{
						name: 'ornaments()',
						description:
							'Enables replacement of default glyphs with ornaments, if provided in the font.',
					},
					{ name: 'styleset()', description: 'Enables display with stylistic sets.' },
					{ name: 'stylistic()', description: 'Enables display of stylistic alternates.' },
					{ name: 'swash()', description: 'Enables display of swash glyphs.' },
				],
				syntax:
			...
			},
			{
				...
				values: [
					...
					{ name: 'normal', description: 'None of the features are enabled.' },
					{ name: 'petite-caps', description: 'Enables display of petite capitals.' },
					{
						name: 'small-caps',
						description:
					...
					{ name: 'titling-caps', description: 'Enables display of titling capitals.' },
					{
						name: 'unicase',
						description:
			...
			},
			{
				...
				values: [
					{ name: 'full-width', description: 'Enables rendering of full-width variants.' },
					{ name: 'jis04', description: 'Enables rendering of JIS04 forms.' },
					{ name: 'jis78', description: 'Enables rendering of JIS78 forms.' },
					{ name: 'jis83', description: 'Enables rendering of JIS83 forms.' },
					{ name: 'jis90', description: 'Enables rendering of JIS90 forms.' },
					{ name: 'normal', description: 'None of the features are enabled.' },
					{
						name: 'proportional-width',
						description: 'Enables rendering of proportionally-spaced variants.',
					},
					{ name: 'ruby', description: 'Enables display of ruby variant glyphs.' },
					{ name: 'simplified', description: 'Enables rendering of simplified forms.' },
					{ name: 'traditional', description: 'Enables rendering of traditional forms.' },
				],
			...
			},
			{
				...
				values: [
					{ name: 'additional-ligatures', description: 'Enables display of additional ligatures.' },
					{ name: 'common-ligatures', description: 'Enables display of common ligatures.' },
					{
						name: 'contextual',
						browsers: ['E79', 'FF34', 'S9.1', 'C34', 'O21'],
					...
					{ name: 'historical-ligatures', description: 'Enables display of historical ligatures.' },
					{
						name: 'no-additional-ligatures',
						description: 'Disables display of additional ligatures.',
					},
					{ name: 'no-common-ligatures', description: 'Disables display of common ligatures.' },
					{
						name: 'no-contextual',
						browsers: ['E79', 'FF34', 'S9.1', 'C34', 'O21'],
					...
					{ name: 'normal', description: 'Implies that the defaults set by the font are used.' },
				],
				syntax:
			...
			},
			{
				...
				values: [
					...
					{ name: 'lining-nums', description: 'Enables display of lining numerals.' },
					{ name: 'normal', description: 'None of the features are enabled.' },
					{ name: 'oldstyle-nums', description: 'Enables display of old-style numerals.' },
					{
						name: 'ordinal',
						description: 'Enables display of letter forms used with ordinal numbers.',
					},
					{ name: 'proportional-nums', description: 'Enables display of proportional numerals.' },
					{ name: 'slashed-zero', description: 'Enables display of slashed zeros.' },
					{
						name: 'stacked-fractions',
						description: 'Enables display of lining stacked fractions.',
					},
					{ name: 'tabular-nums', description: 'Enables display of tabular numerals.' },
				],
				syntax:
			...
			},
			{
				...
				relevance: 93,
				references: [
					{ name: 'MDN Reference', url: 'https://developer.mozilla.org/docs/Web/CSS/font-weight' },
				],
				description:
			...
			},
			{
				...
				relevance: 57,
				references: [
					{ name: 'MDN Reference', url: 'https://developer.mozilla.org/docs/Web/CSS/grid-area' },
				],
				description:
			...
			},
			{
				...
				relevance: 50,
				references: [
					{ name: 'MDN Reference', url: 'https://developer.mozilla.org/docs/Web/CSS/grid' },
				],
				description:
			...
			},
			{
				...
				relevance: 56,
				references: [
					{ name: 'MDN Reference', url: 'https://developer.mozilla.org/docs/Web/CSS/grid-column' },
				],
			...
			},
			{
				...
				relevance: 54,
				references: [
					{ name: 'MDN Reference', url: 'https://developer.mozilla.org/docs/Web/CSS/grid-row' },
				],
			...
			},
			{
				...
				relevance: 51,
				references: [
					{ name: 'MDN Reference', url: 'https://developer.mozilla.org/docs/Web/CSS/grid-row-end' },
				],
				description:
					"Determine a grid item's size and location within the grid by contributing a line, a span, or nothing (automatic) to its grid placement.",
				restrictions: ['identifier', 'integer', 'enum'],
			...
			},
			{
				...
				browsers: ['E16', 'FF52', 'S10.1', 'C57', 'O44'],
				values: [
					{ name: 'none', description: 'Sets all three properties to their initial values.' },
					{
						name: 'min-content',
						description:
							'Represents the largest min-content contribution of the grid items occupying the grid track.',
			...
			},
			{
				...
				browsers: ['E16', 'FF52', 'S10.1', 'C57', 'O44'],
				values: [
					{ name: 'none', description: "The grid container doesn't define any named grid areas." },
				],
				syntax: 'none | <string>+',
				relevance: 54,
				references: [
			...
			},
			{
				...
				browsers: ['E12', 'FF1', 'S1', 'C1', 'IE4', 'O7'],
				values: [
					{ name: 'auto', description: 'The height depends on the values of other properties.' },
					{
						name: 'fit-content',
						browsers: ['E12', 'FF1', 'S1', 'C1', 'IE4', 'O7'],
						description:
				...
				relevance: 96,
				references: [
					{ name: 'MDN Reference', url: 'https://developer.mozilla.org/docs/Web/CSS/height' },
				],
				description:
			...
			},
			{
				...
				relevance: 56,
				references: [
					{ name: 'MDN Reference', url: 'https://developer.mozilla.org/docs/Web/CSS/hyphens' },
				],
				description:
			...
			},
			{
				...
				values: [
					...
					{ name: '-moz-crisp-edges', browsers: ['E79', 'FF3.6', 'S6', 'C13', 'O15'] },
					{ name: 'optimizeQuality', description: 'Deprecated.' },
			...
			},
			{
				...
				relevance: 0,
				references: [
					{ name: 'MDN Reference', url: 'https://developer.mozilla.org/docs/Web/CSS/ime-mode' },
				],
			...
			},
			{
				...
				relevance: 54,
				references: [
					{ name: 'MDN Reference', url: 'https://developer.mozilla.org/docs/Web/CSS/inline-size' },
				],
			...
			},
			{
				...
				values: [
					...
					{ name: 'isolate', description: 'In CSS will turn the element into a stacking context.' },
				],
				syntax: 'auto | isolate',
				relevance: 54,
				references: [
					{ name: 'MDN Reference', url: 'https://developer.mozilla.org/docs/Web/CSS/isolation' },
				],
				description:
			...
			},
			{
				...
				browsers: ['E12', 'FF20', 'S9', 'C29', 'IE11', 'O12.1'],
				values: [
					{ name: 'center', description: 'Flex items are packed toward the center of the line.' },
					{
						name: 'start',
						description:
					...
					{ name: 'space-between', description: 'Flex items are evenly distributed in the line.' },
					{ name: 'baseline', description: 'Specifies participation in first-baseline alignment.' },
					{
						name: 'first baseline',
			...
			},
			{
				...
				relevance: 94,
				references: [
					{ name: 'MDN Reference', url: 'https://developer.mozilla.org/docs/Web/CSS/left' },
				],
				description:
			...
			},
			{
				...
				relevance: 52,
				references: [
					{ name: 'MDN Reference', url: 'https://developer.mozilla.org/docs/Web/CSS/line-break' },
				],
				description:
			...
			},
			{
				...
				relevance: 92,
				references: [
					{ name: 'MDN Reference', url: 'https://developer.mozilla.org/docs/Web/CSS/line-height' },
				],
				description:
			...
			},
			{
				...
				values: [
					{ name: 'armenian' },
					{ name: 'circle', description: 'A hollow circle.' },
					{ name: 'decimal' },
					{ name: 'decimal-leading-zero' },
					{ name: 'disc', description: 'A filled circle.' },
					{ name: 'georgian' },
					{
						name: 'inside',
						description:
				...
				relevance: 83,
				references: [
					{ name: 'MDN Reference', url: 'https://developer.mozilla.org/docs/Web/CSS/list-style' },
				],
				description:
			...
			},
			{
				...
				browsers: ['E12', 'FF1', 'S1', 'C1', 'IE4', 'O3.5'],
				values: [
					{ name: 'armenian', description: 'Traditional uppercase Armenian numbering.' },
					{ name: 'circle', description: 'A hollow circle.' },
					{ name: 'decimal', description: 'Western decimal numbers.' },
					{ name: 'decimal-leading-zero', description: 'Decimal numbers padded by initial zeros.' },
					{ name: 'disc', description: 'A filled circle.' },
					{ name: 'georgian', description: 'Traditional Georgian numbering.' },
					{ name: 'lower-alpha', description: 'Lowercase ASCII letters.' },
					{ name: 'lower-greek', description: 'Lowercase classical Greek.' },
					{ name: 'lower-latin', description: 'Lowercase ASCII letters.' },
					{ name: 'lower-roman', description: 'Lowercase ASCII Roman numerals.' },
					...
					{ name: 'upper-roman', description: 'Uppercase ASCII Roman numerals.' },
				],
			...
			},
			{
				...
				relevance: 95,
				references: [
					{ name: 'MDN Reference', url: 'https://developer.mozilla.org/docs/Web/CSS/margin' },
				],
				description:
			...
			},
			{
				...
				relevance: 91,
				references: [
					{ name: 'MDN Reference', url: 'https://developer.mozilla.org/docs/Web/CSS/margin-left' },
				],
				description:
					'Shorthand property to set values for the thickness of the margin area. If left is omitted, it is the same as right. If bottom is omitted it is the same as top, if right is omitted it is the same as top. Negative values for margin properties are allowed, but there may be implementation-specific limits..',
				restrictions: ['length', 'percentage'],
			},
			{
				...
				relevance: 91,
				references: [
					{ name: 'MDN Reference', url: 'https://developer.mozilla.org/docs/Web/CSS/margin-right' },
				],
				description:
					'Shorthand property to set values for the thickness of the margin area. If left is omitted, it is the same as right. If bottom is omitted it is the same as top, if right is omitted it is the same as top. Negative values for margin properties are allowed, but there may be implementation-specific limits..',
				restrictions: ['length', 'percentage'],
			},
			{
				...
				relevance: 94,
				references: [
					{ name: 'MDN Reference', url: 'https://developer.mozilla.org/docs/Web/CSS/margin-top' },
				],
				description:
					'Shorthand property to set values for the thickness of the margin area. If left is omitted, it is the same as right. If bottom is omitted it is the same as top, if right is omitted it is the same as top. Negative values for margin properties are allowed, but there may be implementation-specific limits..',
				restrictions: ['length', 'percentage'],
			...
			{
				name: 'mask-image',
				browsers: ['E79', 'FF53', 'S15.4', 'C120', 'O15'],
				values: [
					{ name: 'none', description: 'Counts as a transparent black image layer.' },
					{ name: 'url()', description: 'Reference to a <mask element or to a CSS image.' },
				],
				syntax: '<mask-reference>#',
				relevance: 57,
				references: [
					{ name: 'MDN Reference', url: 'https://developer.mozilla.org/docs/Web/CSS/mask-image' },
				],
			...
			},
			{
				...
				relevance: 50,
				references: [
					{ name: 'MDN Reference', url: 'https://developer.mozilla.org/docs/Web/CSS/mask-mode' },
				],
				description:
			...
			},
			{
				...
				relevance: 50,
				references: [
					{ name: 'MDN Reference', url: 'https://developer.mozilla.org/docs/Web/CSS/mask-origin' },
				],
			...
			{
				name: 'mask-position',
				browsers: ['E79', 'FF53', 'S15.4', 'C120', 'O106'],
				syntax: '<position>#',
				relevance: 52,
				references: [
					{
			...
			},
			{
				...
				relevance: 53,
				references: [
					{ name: 'MDN Reference', url: 'https://developer.mozilla.org/docs/Web/CSS/mask-repeat' },
				],
				description:
			...
			},
			{
				...
				relevance: 54,
				references: [
					{ name: 'MDN Reference', url: 'https://developer.mozilla.org/docs/Web/CSS/mask-size' },
				],
			...
			},
			{
				...
				relevance: 50,
				references: [
					{ name: 'MDN Reference', url: 'https://developer.mozilla.org/docs/Web/CSS/mask-type' },
				],
				description:
			...
			},
			{
				name: 'max-block-size',
				browsers: ['E79', 'FF41', 'S12.1', 'C57', 'O44'],
				values: [{ name: 'none', description: 'No limit on the width of the box.' }],
				syntax: "<'max-width'>",
				relevance: 53,
				references: [
					{
			...
			},
			{
				...
				values: [
					{ name: 'none', description: 'No limit on the height of the box.' },
					{
						name: 'fit-content',
						browsers: ['E12', 'FF1', 'S1.3', 'C18', 'IE7', 'O7'],
						description:
				...
				relevance: 85,
				references: [
					{ name: 'MDN Reference', url: 'https://developer.mozilla.org/docs/Web/CSS/max-height' },
				],
			...
			},
			{
				...
				browsers: ['E79', 'FF41', 'S12.1', 'C57', 'O44'],
				values: [{ name: 'none', description: 'No limit on the height of the box.' }],
				syntax: "<'max-width'>",
				relevance: 54,
				references: [
					{
			...
			},
			{
				...
				values: [
					{ name: 'none', description: 'No limit on the width of the box.' },
					{
						name: 'fit-content',
						browsers: ['E12', 'FF1', 'S1', 'C1', 'IE7', 'O4'],
						description:
				...
				relevance: 91,
				references: [
					{ name: 'MDN Reference', url: 'https://developer.mozilla.org/docs/Web/CSS/max-width' },
				],
			...
			},
			{
				...
				values: [
					{ name: 'auto', browsers: ['E12', 'FF3', 'S1.3', 'C1', 'IE7', 'O4'] },
					{
						name: 'fit-content',
						browsers: ['E12', 'FF3', 'S1.3', 'C1', 'IE7', 'O4'],
						description:
				...
				relevance: 89,
				references: [
					{ name: 'MDN Reference', url: 'https://developer.mozilla.org/docs/Web/CSS/min-height' },
				],
				description: 'Allows authors to constrain content height to a certain range.',
				restrictions: ['length', 'percentage'],
			},
			...
			},
			{
				...
				browsers: ['E12', 'FF1', 'S1', 'C1', 'IE7', 'O4'],
				values: [
					{ name: 'auto', browsers: ['E12', 'FF1', 'S1', 'C1', 'IE7', 'O4'] },
					{
						name: 'fit-content',
						browsers: ['E12', 'FF1', 'S1', 'C1', 'IE7', 'O4'],
						description:
				...
				relevance: 88,
				references: [
					{ name: 'MDN Reference', url: 'https://developer.mozilla.org/docs/Web/CSS/min-width' },
				],
				description: 'Allows authors to constrain content width to a certain range.',
				restrictions: ['length', 'percentage'],
			},
			...
			},
			{
				...
				browsers: ['FF1'],
				values: [
					{ name: 'block-axis', description: "Elements are oriented along the box's axis." },
					{
						name: 'horizontal',
						description: 'The box displays its children from left to right in a horizontal line.',
					},
					{ name: 'inline-axis', description: 'Elements are oriented vertically.' },
					{
						name: 'vertical',
						description:
			...
			},
			{
				...
				browsers: ['FF10'],
				values: [{ name: 'none', description: 'No perspective transform is applied.' }],
				relevance: 50,
				description:
			...
			},
			{
				...
				values: [
					{ name: 'auto' },
					{ name: 'center', description: 'The inline contents are centered within the line box.' },
					{
						name: 'justify',
						description:
			...
			},
			{
				...
				browsers: ['FF6'],
				values: [
					{ name: 'line-through', description: 'Each line of text has a line through the middle.' },
					{ name: 'none', description: 'Neither produces nor inhibits text decoration.' },
					{ name: 'overline', description: 'Each line of text has a line above it.' },
					{ name: 'underline', description: 'Each line of text is underlined.' },
				],
				relevance: 50,
			...
			},
			{
				...
				browsers: ['FF6'],
				values: [
					{ name: 'dashed', description: 'Produces a dashed line style.' },
					{ name: 'dotted', description: 'Produces a dotted line.' },
					{ name: 'double', description: 'Produces a double line.' },
					{ name: 'none', description: 'Produces no line.' },
					{ name: 'solid', description: 'Produces a solid line.' },
					{ name: 'wavy', description: 'Produces a wavy line.' },
				],
				relevance: 50,
				description:
			...
			},
			{
				...
				values: [
					...
					{ name: 'none' },
					{ name: 'perspective', description: 'Specifies a perspective projection matrix.' },
					{
						name: 'rotate()',
						description:
			...
			},
			{
				...
				values: [
					...
					{ name: 'true', description: 'The element contains an accelerator key sequence.' },
				],
				status: 'nonstandard',
				syntax: 'false | true',
				relevance: 0,
			...
			},
			{
				...
				browsers: ['IE8'],
				values: [
					{ name: 'bt', description: 'Bottom-to-top block flow. Layout is horizontal.' },
					{ name: 'lr', description: 'Left-to-right direction. The flow orientation is vertical.' },
					{ name: 'rl', description: 'Right-to-left direction. The flow orientation is vertical.' },
					{
						name: 'tb',
			...
			},
			{
				...
				values: [
					...
					{ name: 'zoom', description: 'The element is zoomable.' },
				],
				status: 'nonstandard',
				syntax: 'none | zoom',
				relevance: 0,
			...
			},
			{
				...
				values: [
					...
					{ name: 'end', description: 'Lines are packed toward the end of the flex container.' },
					{ name: 'justify', description: 'Lines are evenly distributed in the flex container.' },
					{
						name: 'start',
						description: 'Lines are packed toward the start of the flex container.',
					},
			...
			},
			{
				...
				values: [
					...
					{ name: 'end', description: 'Flex items are packed toward the end of the line.' },
					{ name: 'justify', description: 'Flex items are evenly distributed in the line.' },
					{ name: 'start', description: 'Flex items are packed toward the start of the line.' },
				],
				relevance: 50,
				description:
					'Aligns flex items along the main axis of the current line of the flex container.',
			...
			},
			{
				name: '-ms-flow-from',
				browsers: ['E', 'IE10'],
				values: [{ name: 'none', description: 'The block container is not a CSS Region.' }],
				status: 'nonstandard',
			...
			},
			{
				...
				browsers: ['E', 'IE10'],
				values: [
					{ name: 'auto', description: 'Properties will be adjusted as applicable.' },
			...
			},
			{
				...
				browsers: ['E', 'IE10'],
				values: [{ name: 'no-limit', description: 'There is no limit.' }],
				status: 'nonstandard',
			...
			},
			{
				...
				values: [
					...
					{ name: 'none', description: 'Default. No character grid is set.' },
				],
				relevance: 50,
				description:
			...
			},
			{
				...
				values: [
					...
					{ name: 'loose', description: 'Default. Grid used for Japanese and Korean characters.' },
					{
						name: 'strict',
						description:
			...
			},
			{
				...
				values: [
					...
					{ name: 'double-tap-zoom', description: 'The element will zoom on double-tap.' },
					{ name: 'manipulation', description: 'The element is a manipulation-causing element.' },
					{ name: 'none', description: 'The element is a manipulation-blocking element.' },
					{
						name: 'pan-x',
						description:
			...
			},
			{
				...
				browsers: ['E', 'IE10'],
				values: [
					{ name: 'grippers', description: 'Grippers are always on.' },
			...
			},
			{
				...
				values: [
					...
					{ name: 'normal', description: 'Breaks non-CJK scripts according to their own rules.' },
				],
				relevance: 50,
			...
			},
			{
				...
				values: [
					...
					{ name: 'normal', description: 'Lines may break only at allowed break points.' },
				],
				relevance: 50,
				description:
			...
			},
			{
				...
				relevance: 72,
				references: [
					{ name: 'MDN Reference', url: 'https://developer.mozilla.org/docs/Web/CSS/object-fit' },
				],
				description:
			...
			},
			{
				...
				relevance: 92,
				references: [
					{ name: 'MDN Reference', url: 'https://developer.mozilla.org/docs/Web/CSS/opacity' },
				],
				description:
			...
			},
			{
				...
				relevance: 67,
				references: [
					{ name: 'MDN Reference', url: 'https://developer.mozilla.org/docs/Web/CSS/order' },
				],
				description:
					'Controls the order in which children of a flex container appear within the flex container, by assigning them to ordinal groups.',
				restrictions: ['integer'],
			},
			{
				...
				relevance: 51,
				references: [
					{ name: 'MDN Reference', url: 'https://developer.mozilla.org/docs/Web/CSS/orphans' },
				],
				description:
			...
			},
			{
				...
				relevance: 88,
				references: [
					{ name: 'MDN Reference', url: 'https://developer.mozilla.org/docs/Web/CSS/outline' },
				],
				description:
			...
			},
			{
				...
				relevance: 93,
				references: [
					{ name: 'MDN Reference', url: 'https://developer.mozilla.org/docs/Web/CSS/overflow' },
				],
			...
			},
			{
				...
				relevance: 81,
				references: [
					{ name: 'MDN Reference', url: 'https://developer.mozilla.org/docs/Web/CSS/overflow-x' },
				],
			...
			},
			{
				...
				relevance: 82,
				references: [
					{ name: 'MDN Reference', url: 'https://developer.mozilla.org/docs/Web/CSS/overflow-y' },
				],
			...
			},
			{
				...
				relevance: 95,
				references: [
					{ name: 'MDN Reference', url: 'https://developer.mozilla.org/docs/Web/CSS/padding' },
				],
				description:
			...
			},
			{
				...
				relevance: 89,
				references: [
					{ name: 'MDN Reference', url: 'https://developer.mozilla.org/docs/Web/CSS/padding-left' },
				],
				description:
					'Shorthand property to set values for the thickness of the padding area. If left is omitted, it is the same as right. If bottom is omitted it is the same as top, if right is omitted it is the same as top. The value may not be negative.',
				restrictions: ['length', 'percentage'],
			...
			},
			{
				...
				relevance: 89,
				references: [
					{ name: 'MDN Reference', url: 'https://developer.mozilla.org/docs/Web/CSS/padding-top' },
				],
				description:
					'Shorthand property to set values for the thickness of the padding area. If left is omitted, it is the same as right. If bottom is omitted it is the same as top, if right is omitted it is the same as top. The value may not be negative.',
				restrictions: ['length', 'percentage'],
			},
			{
				...
				browsers: ['E12', 'FF1', 'S1.2', 'C1', 'IE4', 'O7'],
				values: [
					{ name: 'always', description: 'Always force a page break after the generated box.' },
					{
						name: 'auto',
						description: 'Neither force nor forbid a page break after generated box.',
					},
					{ name: 'avoid', description: 'Avoid a page break after the generated box.' },
					{
						name: 'left',
						description:
			...
			},
			{
				...
				browsers: ['E12', 'FF1', 'S1.2', 'C1', 'IE4', 'O7'],
				values: [
					{ name: 'always', description: 'Always force a page break before the generated box.' },
					{
						name: 'auto',
						description: 'Neither force nor forbid a page break before the generated box.',
					},
					{ name: 'avoid', description: 'Avoid a page break before the generated box.' },
					{
						name: 'left',
						description:
			...
			},
			{
				...
				values: [
					...
					{ name: 'avoid', description: 'Avoid a page break inside the generated box.' },
				],
				syntax: 'auto | avoid',
				relevance: 53,
				references: [
			...
			},
			{
				...
				relevance: 50,
				references: [
					{ name: 'MDN Reference', url: 'https://developer.mozilla.org/docs/Web/CSS/paint-order' },
				],
				description:
			...
			},
			{
				...
				relevance: 55,
				references: [
					{ name: 'MDN Reference', url: 'https://developer.mozilla.org/docs/Web/CSS/perspective' },
				],
				description:
					'Applies the same transform as the perspective(<number>) transform function, except that it applies only to the positioned or transformed children of the element, not to the transform on the element itself.',
				restrictions: ['length', 'enum'],
			...
			},
			{
				...
				values: [
					...
					{ name: 'none', description: 'The given element does not receive pointer events.' },
					{
						name: 'painted',
						description:
			...
			},
			{
				...
				relevance: 53,
				references: [
					{ name: 'MDN Reference', url: 'https://developer.mozilla.org/docs/Web/CSS/quotes' },
				],
			...
			},
			{
				...
				browsers: ['FF33'],
				values: [
					{ name: 'auto', description: 'The range depends on the counter system.' },
					{
						name: 'infinite',
						description:
			...
			},
			{
				...
				relevance: 66,
				references: [
					{ name: 'MDN Reference', url: 'https://developer.mozilla.org/docs/Web/CSS/resize' },
				],
				description:
			...
			},
			{
				...
				relevance: 91,
				references: [
					{ name: 'MDN Reference', url: 'https://developer.mozilla.org/docs/Web/CSS/right' },
				],
				description:
			...
			},
			{
				...
				values: [
					...
					{ name: 'center', description: 'The ruby content is centered within its box.' },
					{
				...
				relevance: 50,
				references: [
					{ name: 'MDN Reference', url: 'https://developer.mozilla.org/docs/Web/CSS/ruby-align' },
				],
				description:
			...
			},
			{
				...
				values: [
					...
					{ name: 'end', description: 'The ruby text can overhang the text that follows it.' },
					{
						name: 'none',
						description:
							'The ruby text cannot overhang any text adjacent to its base, only its own base.',
					},
					{ name: 'start', description: 'The ruby text can overhang the text that precedes it.' },
				],
				relevance: 50,
				description:
			...
			},
			{
				...
				values: [
					...
					{ name: 'none', description: "No spanning. The computed value is '1'." },
				],
				relevance: 50,
				description:
					'Determines whether, and on which side, ruby text is allowed to partially overhang any adjacent text in addition to its own base, when the ruby text is wider than the ruby base.',
			...
			},
			{
				...
				browsers: ['FF39'],
				values: [
					{ name: 'none', description: 'No snap points are defined by this scroll container.' },
					{
						name: 'repeat()',
						description:
			...
			},
			{
				...
				relevance: 50,
				references: [
					{ name: 'MDN Reference', url: 'https://developer.mozilla.org/docs/Web/CSS/shape-margin' },
				],
				description:
			...
			},
			{
				...
				browsers: ['E80', 'FF72', 'S13.1', 'C80', 'O67'],
				values: [{ name: 'none', description: 'Indicates that no dashing is used.' }],
				relevance: 61,
			...
			},
			{
				...
				values: [
					{ name: 'auto', description: 'Use any automatic table layout algorithm.' },
					{ name: 'fixed', description: 'Use the fixed table layout algorithm.' },
				],
				syntax: 'auto | fixed',
				relevance: 58,
				references: [
					{ name: 'MDN Reference', url: 'https://developer.mozilla.org/docs/Web/CSS/table-layout' },
				],
			...
			},
			{
				...
				relevance: 53,
				references: [
					{ name: 'MDN Reference', url: 'https://developer.mozilla.org/docs/Web/CSS/tab-size' },
				],
				description:
			...
			},
			{
				...
				relevance: 93,
				references: [
					{ name: 'MDN Reference', url: 'https://developer.mozilla.org/docs/Web/CSS/text-align' },
				],
				description:
			...
			},
			{
				...
				relevance: 67,
				references: [
					{ name: 'MDN Reference', url: 'https://developer.mozilla.org/docs/Web/CSS/text-indent' },
				],
				description:
			...
			},
			{
				...
				relevance: 50,
				references: [
					{ name: 'MDN Reference', url: 'https://developer.mozilla.org/docs/Web/CSS/text-justify' },
				],
				description:
					"Selects the justification algorithm used when 'text-align' is set to 'justify'. The property applies to block containers, but the UA may (but is not required to) also support it on inline elements.",
				restrictions: ['enum'],
			...
			},
			{
				...
				relevance: 73,
				references: [
					{ name: 'MDN Reference', url: 'https://developer.mozilla.org/docs/Web/CSS/text-shadow' },
				],
			...
			},
			{
				...
				values: [
					...
					{ name: 'lowercase', description: 'Puts all letters in lowercase.' },
					{ name: 'none', description: 'No effects.' },
					{ name: 'uppercase', description: 'Puts all letters in uppercase.' },
				],
			...
			},
			{
				...
				relevance: 95,
				references: [
					{ name: 'MDN Reference', url: 'https://developer.mozilla.org/docs/Web/CSS/top' },
				],
				description:
			...
			},
			{
				...
				values: [
					...
					{ name: 'cross-slide-x', browsers: ['E12', 'FF52', 'S13', 'C36', 'IE11', 'O23'] },
					{ name: 'cross-slide-y', browsers: ['E12', 'FF52', 'S13', 'C36', 'IE11', 'O23'] },
					{ name: 'double-tap-zoom', browsers: ['E12', 'FF52', 'S13', 'C36', 'IE11', 'O23'] },
					{
						name: 'manipulation',
						description:
					...
					{ name: 'pinch-zoom', browsers: ['E12', 'FF52', 'S13', 'C36', 'IE11', 'O23'] },
				],
				syntax:
					'auto | none | [ [ pan-x | pan-left | pan-right ] || [ pan-y | pan-up | pan-down ] || pinch-zoom ] | manipulation',
				relevance: 69,
				references: [
					{ name: 'MDN Reference', url: 'https://developer.mozilla.org/docs/Web/CSS/touch-action' },
				],
				description:
			...
			},
			{
				...
				relevance: 90,
				references: [
					{ name: 'MDN Reference', url: 'https://developer.mozilla.org/docs/Web/CSS/transform' },
				],
				description:
					"A two-dimensional transformation is applied to an element through the 'transform' property. This property contains a list of transform functions similar to those allowed by SVG.",
				restrictions: ['enum'],
			...
			},
			{
				...
				relevance: 89,
				references: [
					{ name: 'MDN Reference', url: 'https://developer.mozilla.org/docs/Web/CSS/transition' },
				],
				description:
					'Shorthand property combines four of the transition properties into a single property.',
				restrictions: ['time', 'property', 'timing-function', 'enum'],
			...
			},
			{
				...
				relevance: 56,
				references: [
					{ name: 'MDN Reference', url: 'https://developer.mozilla.org/docs/Web/CSS/unicode-bidi' },
				],
			...
			},
			{
				name: 'unicode-range',
				values: [
					{ name: 'U+26', description: 'Ampersand.' },
					{
					...
					{ name: 'U+00-7F', description: 'Basic Latin (ASCII).' },
					{
						name: 'U+80-FF',
						description:
					...
					{ name: 'U+250-2AF', description: 'International Phonetic Alphabet Extensions.' },
					{ name: 'U+370-3FF', description: 'Greek and Coptic.' },
					{
						name: 'U+1F00-1FFF',
						description: 'Greek Extended. Accented characters for polytonic Greek.',
					},
					{ name: 'U+400-4FF', description: 'Cyrillic.' },
					{
						name: 'U+500-52F',
						description:
					...
					{ name: 'U+530-58F', description: 'Armenian.' },
					{ name: 'U+590-5FF', description: 'Hebrew.' },
					{ name: 'U+600-6FF', description: 'Arabic.' },
					{
						name: 'U+750-77F',
						description:
					...
					{ name: 'U+700-74F', description: 'Syriac.' },
					{ name: 'U+900-97F', description: 'Devanagari.' },
					{ name: 'U+980-9FF', description: 'Bengali.' },
					{ name: 'U+A00-A7F', description: 'Gurmukhi.' },
					{ name: 'U+A80-AFF', description: 'Gujarati.' },
					{ name: 'U+B00-B7F', description: 'Oriya.' },
					{ name: 'U+B80-BFF', description: 'Tamil.' },
					{ name: 'U+C00-C7F', description: 'Telugu.' },
					{ name: 'U+C80-CFF', description: 'Kannada.' },
					{ name: 'U+D00-D7F', description: 'Malayalam.' },
					{ name: 'U+D80-DFF', description: 'Sinhala.' },
					{ name: 'U+118A0-118FF', description: 'Warang Citi.' },
					{ name: 'U+E00-E7F', description: 'Thai.' },
					{ name: 'U+1A20-1AAF', description: 'Tai Tham.' },
					{ name: 'U+AA80-AADF', description: 'Tai Viet.' },
					{ name: 'U+E80-EFF', description: 'Lao.' },
					{ name: 'U+F00-FFF', description: 'Tibetan.' },
					{ name: 'U+1000-109F', description: 'Myanmar (Burmese).' },
					{ name: 'U+10A0-10FF', description: 'Georgian.' },
					{ name: 'U+1200-137F', description: 'Ethiopic.' },
					{
						name: 'U+1380-139F',
					...
					{ name: 'U+1780-17FF', description: 'Khmer.' },
					{ name: 'U+1800-18AF', description: 'Mongolian.' },
					{ name: 'U+1B80-1BBF', description: 'Sundanese.' },
					{ name: 'U+1CC0-1CCF', description: 'Sundanese Supplement. Punctuation.' },
					{
						name: 'U+4E00-9FD5',
						description:
					...
					{ name: 'U+2F00-2FDF', description: 'Kangxi Radicals.' },
					{
						name: 'U+2E80-2EFF',
						description: 'CJK Radicals Supplement. Alternative forms of Kangxi Radicals.',
					},
					{ name: 'U+1100-11FF', description: 'Hangul Jamo.' },
					{ name: 'U+AC00-D7AF', description: 'Hangul Syllables.' },
					{ name: 'U+3040-309F', description: 'Hiragana.' },
					{ name: 'U+30A0-30FF', description: 'Katakana.' },
					{
						name: 'U+A5, U+4E00-9FFF, U+30??, U+FF00-FF9F',
						description: 'Japanese Kanji, Hiragana and Katakana characters plus Yen/Yuan symbol.',
					},
					{ name: 'U+A4D0-A4FF', description: 'Lisu.' },
					{ name: 'U+A000-A48F', description: 'Yi Syllables.' },
					{ name: 'U+A490-A4CF', description: 'Yi Radicals.' },
					{ name: 'U+2000-206F', description: 'General Punctuation.' },
					{ name: 'U+3000-303F', description: 'CJK Symbols and Punctuation.' },
					{ name: 'U+2070-209F', description: 'Superscripts and Subscripts.' },
					{ name: 'U+20A0-20CF', description: 'Currency Symbols.' },
					{ name: 'U+2100-214F', description: 'Letterlike Symbols.' },
					{ name: 'U+2150-218F', description: 'Number Forms.' },
					{ name: 'U+2190-21FF', description: 'Arrows.' },
					{ name: 'U+2200-22FF', description: 'Mathematical Operators.' },
					{ name: 'U+2300-23FF', description: 'Miscellaneous Technical.' },
					{ name: 'U+E000-F8FF', description: 'Private Use Area.' },
					{
						name: 'U+FB00-FB4F',
						description:
					...
					{ name: 'U+1F600-1F64F', description: 'Emoji: Emoticons.' },
					{ name: 'U+2600-26FF', description: 'Emoji: Miscellaneous Symbols.' },
					{ name: 'U+1F300-1F5FF', description: 'Emoji: Miscellaneous Symbols and Pictographs.' },
					{ name: 'U+1F900-1F9FF', description: 'Emoji: Supplemental Symbols and Pictographs.' },
					{ name: 'U+1F680-1F6FF', description: 'Emoji: Transport and Map Symbols.' },
				],
				atRule: '@font-face',
			...
			},
			{
				...
				values: [
					{ name: 'all', description: 'The content of the element must be selected atomically' },
					{ name: 'auto' },
					{
						name: 'contain',
						description:
					...
					{ name: 'text', description: 'The element imposes no constraint on the selection.' },
				],
				syntax: 'auto | text | none | contain | all',
				relevance: 82,
				references: [
					{ name: 'MDN Reference', url: 'https://developer.mozilla.org/docs/Web/CSS/user-select' },
				],
				description: 'Controls the appearance of selection.',
				restrictions: ['enum'],
			},
			{
				...
				values: [
					...
					{ name: '-webkit-baseline-middle', browsers: ['E12', 'FF1', 'S1', 'C1', 'IE4', 'O4'] },
				],
				syntax:
			...
			},
			{
				...
				relevance: 87,
				references: [
					{ name: 'MDN Reference', url: 'https://developer.mozilla.org/docs/Web/CSS/visibility' },
				],
				description:
			...
			},
			{
				...
				values: [
					...
					{ name: 'saturate()', description: 'Saturates the input image.' },
					{ name: 'sepia()', description: 'Converts the input image to sepia.' },
					{ name: 'url()', description: 'A filter reference to a <filter> element.' },
				],
				relevance: 50,
				description:
			...
			},
			{
				...
				values: [
					{ name: 'above', description: 'The reflection appears above the border box.' },
					{ name: 'below', description: 'The reflection appears below the border box.' },
					{ name: 'left', description: 'The reflection appears to the left of the border box.' },
					{ name: 'right', description: 'The reflection appears to the right of the border box.' },
				],
				status: 'nonstandard',
			...
			},
			{
				...
				values: [
					...
					{ name: 'avoid-page', description: 'Avoid a page break before/after the generated box.' },
					{ name: 'avoid-region' },
					{
						name: 'column',
			...
			},
			{
				...
				values: [
					...
					{ name: 'avoid', description: 'Avoid a page/column break inside the generated box.' },
					{ name: 'avoid-column', description: 'Avoid a column break inside the generated box.' },
					{ name: 'avoid-page', description: 'Avoid a page break inside the generated box.' },
					{ name: 'avoid-region' },
				],
				relevance: 50,
			...
			},
			{
				...
				browsers: ['S7'],
				values: [
					{ name: 'auto', description: 'Content flows as it would in a regular content box.' },
					{
						name: 'break',
						description:
			...
			},
			{
				...
				relevance: 51,
				references: [
					{ name: 'MDN Reference', url: 'https://developer.mozilla.org/docs/Web/CSS/widows' },
				],
				description:
			...
			},
			{
				...
				relevance: 96,
				references: [
					{ name: 'MDN Reference', url: 'https://developer.mozilla.org/docs/Web/CSS/width' },
				],
				description:
			...
			},
			{
				...
				relevance: 65,
				references: [
					{ name: 'MDN Reference', url: 'https://developer.mozilla.org/docs/Web/CSS/will-change' },
				],
				description:
			...
			},
			{
				...
				relevance: 76,
				references: [
					{ name: 'MDN Reference', url: 'https://developer.mozilla.org/docs/Web/CSS/word-break' },
				],
				description: 'Specifies line break opportunities for non-CJK scripts.',
				restrictions: ['enum'],
			},
			{
				...
				values: [
					{ name: 'normal', description: 'No additional spacing is applied. Computes to zero.' },
				],
				syntax: 'normal | <length>',
				relevance: 57,
				references: [
					{ name: 'MDN Reference', url: 'https://developer.mozilla.org/docs/Web/CSS/word-spacing' },
				],
			...
			},
			{
				...
				relevance: 50,
				references: [
					{ name: 'MDN Reference', url: 'https://developer.mozilla.org/docs/Web/CSS/writing-mode' },
				],
			...
			},
			{
				...
				relevance: 92,
				references: [
					{ name: 'MDN Reference', url: 'https://developer.mozilla.org/docs/Web/CSS/z-index' },
				],
				description:
			...
			{
				name: 'zoom',
				browsers: ['E12', 'FFpreview', 'S3.1', 'C1', 'IE5.5', 'O15'],
				values: [{ name: 'normal' }],
				status: 'nonstandard',
				syntax: 'normal | reset | <number> | <percentage>',
				relevance: 15,
				references: [
					{ name: 'MDN Reference', url: 'https://developer.mozilla.org/docs/Web/CSS/zoom' },
				],
				description:
...
This feature is available since Firefox 55, but is only currently supported with SVG images loaded via chrome:// or resource:// URLs. To experiment with the feature in SVG on the Web it is necessary to set the svg.context-properties.content.enabled pref to true.`,
			...
			},
			{
				...
				browsers: ['FF6'],
				references: [
					{ name: 'MDN Reference', url: 'https://developer.mozilla.org/docs/Web/CSS/-moz-orient' },
				],
				description:
			...
			},
			{
				...
				values: [{ name: 'ignore' }, { name: 'stretch-to-fit' }],
				relevance: 0,
				description:
			...
			},
			{
				...
				values: [{ name: 'auto' }, { name: 'none' }, { name: 'enabled' }, { name: 'disabled' }],
				relevance: 0,
				browsers: ['FF1'],
				references: [
					{
			...
			},
			{
				...
				values: [{ name: 'read-only' }, { name: 'read-write' }, { name: 'write-only' }],
				relevance: 0,
				description:
			...
			},
			{
				...
				values: [{ name: 'repeat' }, { name: 'no-repeat' }, { name: 'space' }, { name: 'round' }],
				relevance: 0,
			...
			},
			{
				...
				references: [
					{ name: 'MDN Reference', url: 'https://developer.mozilla.org/docs/Web/CSS/accent-color' },
				],
			...
			},
			{
				...
				browsers: ['FF77'],
				references: [
					{ name: 'MDN Reference', url: 'https://developer.mozilla.org/docs/Web/CSS/align-tracks' },
				],
				description:
			...
			},
			{
				...
				references: [
					{ name: 'MDN Reference', url: 'https://developer.mozilla.org/docs/Web/CSS/appearance' },
				],
				description:
					'Changes the appearance of buttons and other controls to resemble native controls.',
			},
			{
				...
				references: [
					{ name: 'MDN Reference', url: 'https://developer.mozilla.org/docs/Web/CSS/aspect-ratio' },
				],
				description:
			...
			},
			{
				...
				references: [
					{ name: 'MDN Reference', url: 'https://developer.mozilla.org/docs/Web/CSS/border-block' },
				],
				description:
			...
			},
			{
				...
				browsers: ['E12', 'FF49', 'S3', 'C1', 'O15'],
				references: [
					{ name: 'MDN Reference', url: 'https://developer.mozilla.org/docs/Web/CSS/box-align' },
				],
				description:
			...
			},
			{
				...
				values: [{ name: 'normal' }, { name: 'reverse' }, { name: 'inherit' }],
				relevance: 0,
				browsers: ['E12', 'FF49', 'S3', 'C1', 'O15'],
				references: [
					{
			...
			},
			{
				...
				browsers: ['E12', 'FF49', 'S3', 'C1', 'O15'],
				references: [
					{ name: 'MDN Reference', url: 'https://developer.mozilla.org/docs/Web/CSS/box-flex' },
				],
				description:
			...
			},
			{
				...
				browsers: ['S3', 'C1', 'O15'],
				references: [
					{ name: 'MDN Reference', url: 'https://developer.mozilla.org/docs/Web/CSS/box-lines' },
				],
				description:
			...
			},
			{
				...
				browsers: ['E12', 'FF49', 'S3', 'C1', 'O15'],
				references: [
					{ name: 'MDN Reference', url: 'https://developer.mozilla.org/docs/Web/CSS/box-orient' },
				],
				description:
			...
			},
			{
				...
				values: [{ name: 'start' }, { name: 'center' }, { name: 'end' }, { name: 'justify' }],
				relevance: 0,
				browsers: ['E12', 'FF49', 'S3', 'C1', 'O15'],
				references: [
					{ name: 'MDN Reference', url: 'https://developer.mozilla.org/docs/Web/CSS/box-pack' },
				],
				description:
			...
			},
			{
				...
				values: [{ name: 'auto' }, { name: 'bar' }, { name: 'block' }, { name: 'underscore' }],
				relevance: 50,
			...
			},
			{
				...
				references: [
					{ name: 'MDN Reference', url: 'https://developer.mozilla.org/docs/Web/CSS/color-scheme' },
				],
				description:
			...
			},
			{
				...
				references: [
					{ name: 'MDN Reference', url: 'https://developer.mozilla.org/docs/Web/CSS/container' },
				],
				description:
			...
			},
			{
				...
				values: [{ name: 'normal' }, { name: 'size' }, { name: 'inline-size' }],
				relevance: 50,
				browsers: ['E105', 'FF110', 'S16', 'C105', 'O91'],
				references: [
					{
			...
			},
			{
				...
				values: [{ name: 'visible' }, { name: 'auto' }, { name: 'hidden' }],
				relevance: 52,
				browsers: ['E85', 'FFpreview', 'Spreview', 'C85', 'O71'],
				references: [
					{
						name: 'MDN Reference',
			...
			},
			{
				...
				references: [
					{ name: 'MDN Reference', url: 'https://developer.mozilla.org/docs/Web/CSS/counter-set' },
				],
				description:
			...
			},
			{
				...
				references: [
					{ name: 'MDN Reference', url: 'https://developer.mozilla.org/docs/Web/CSS/font-palette' },
				],
				description:
			...
			},
			{
				...
				references: [
					{ name: 'MDN Reference', url: 'https://developer.mozilla.org/docs/Web/CSS/font-smooth' },
				],
				description:
			...
			},
			{
				...
				values: [{ name: 'normal' }, { name: 'text' }, { name: 'emoji' }, { name: 'unicode' }],
				relevance: 50,
				browsers: ['FF108'],
				references: [
					{
			...
			},
			{
				...
				browsers: ['E16', 'FF52', 'S10.1', 'C57', 'O44'],
				references: [
					{ name: 'MDN Reference', url: 'https://developer.mozilla.org/docs/Web/CSS/gap' },
				],
				description:
			...
			},
			{
				...
				browsers: ['E87', 'FF66', 'S14.1', 'C87', 'O73'],
				references: [
					{ name: 'MDN Reference', url: 'https://developer.mozilla.org/docs/Web/CSS/inset' },
				],
				description:
			...
			},
			{
				...
				references: [
					{ name: 'MDN Reference', url: 'https://developer.mozilla.org/docs/Web/CSS/inset-block' },
				],
				description:
			...
			},
			{
				...
				browsers: ['E87', 'FF63', 'S14.1', 'C87', 'O73'],
				references: [
					{ name: 'MDN Reference', url: 'https://developer.mozilla.org/docs/Web/CSS/inset-inline' },
				],
				description:
			...
			},
			{
				...
				browsers: ['E87', 'FF66', 'S14.1', 'C87', 'O73'],
				references: [
					{ name: 'MDN Reference', url: 'https://developer.mozilla.org/docs/Web/CSS/margin-block' },
				],
				description:
			...
			},
			{
				...
				values: [{ name: 'none' }, { name: 'in-flow' }, { name: 'all' }],
				relevance: 50,
				browsers: ['S16.4'],
				references: [
					{ name: 'MDN Reference', url: 'https://developer.mozilla.org/docs/Web/CSS/margin-trim' },
				],
				description:
			...
			},
			{
				...
				syntax: '<mask-layer>#',
				relevance: 55,
				browsers: ['E79', 'FF53', 'S15.4', 'C1', 'O15'],
				references: [
					{ name: 'MDN Reference', url: 'https://developer.mozilla.org/docs/Web/CSS/mask' },
				],
				description:
					'The mask CSS property alters the visibility of an element by either partially or fully hiding it. This is accomplished by either masking or clipping the image at specific points.',
			},
			{
				...
				references: [
					{ name: 'MDN Reference', url: 'https://developer.mozilla.org/docs/Web/CSS/mask-border' },
				],
...
This property is a shorthand for mask-border-source, mask-border-slice, mask-border-width, mask-border-outset, mask-border-repeat, and mask-border-mode. As with all shorthand properties, any omitted sub-values will be set to their initial value.`,
			},
			{
				...
				syntax: 'luminance | alpha',
				values: [{ name: 'luminance' }, { name: 'alpha' }],
				relevance: 50,
				description:
...
The mask-border-slice property is used to divide the source image into regions, which are then dynamically applied to the final mask border.`,
			...
			},
			{
				...
				browsers: ['E120', 'FF53', 'S15.4', 'C120', 'O106'],
				references: [
					{ name: 'MDN Reference', url: 'https://developer.mozilla.org/docs/Web/CSS/mask-clip' },
				],
				description:
			...
			},
			{
				...
				relevance: 50,
				browsers: ['E18', 'FF53', 'S15.4', 'C120', 'O106'],
				references: [
					{
						name: 'MDN Reference',
			...
			},
			{
				...
				references: [
					{ name: 'MDN Reference', url: 'https://developer.mozilla.org/docs/Web/CSS/math-depth' },
				],
				description:
			...
			},
			{
				...
				values: [{ name: 'normal' }, { name: 'compact' }],
				relevance: 50,
				browsers: ['E109', 'C109', 'O95'],
				references: [
					{ name: 'MDN Reference', url: 'https://developer.mozilla.org/docs/Web/CSS/math-shift' },
				],
				description:
			...
			},
			{
				...
				references: [
					{ name: 'MDN Reference', url: 'https://developer.mozilla.org/docs/Web/CSS/math-style' },
				],
				description:
			...
			},
			{
				...
				references: [
					{ name: 'MDN Reference', url: 'https://developer.mozilla.org/docs/Web/CSS/offset' },
				],
				description:
			...
			},
			{
				...
				references: [
					{ name: 'MDN Reference', url: 'https://developer.mozilla.org/docs/Web/CSS/offset-path' },
				],
...
In this specification, a direction (or rotation) of 0 degrees is equivalent to the direction of the positive x-axis in the object’s local coordinate system. In other words, a rotation of 0 degree points to the right side of the UA if the object and its ancestors have no transformation applied.`,
			...
			},
			{
				...
				values: [{ name: 'padding-box' }, { name: 'content-box' }],
				relevance: 0,
				description:
			...
			},
			{
				...
				status: 'experimental',
				syntax: 'none | auto',
				values: [{ name: 'none' }, { name: 'auto' }],
				relevance: 50,
				browsers: ['E117', 'C117', 'O103'],
				references: [
					{ name: 'MDN Reference', url: 'https://developer.mozilla.org/docs/Web/CSS/overlay' },
				],
				description:
			...
			},
			{
				...
				values: [{ name: 'contain' }, { name: 'none' }, { name: 'auto' }],
				relevance: 50,
			...
			},
			{
				...
				references: [
					{ name: 'MDN Reference', url: 'https://developer.mozilla.org/docs/Web/CSS/page' },
				],
				description:
			...
			},
			{
				...
				references: [
					{ name: 'MDN Reference', url: 'https://developer.mozilla.org/docs/Web/CSS/place-items' },
				],
				description:
			...
			},
			{
				...
				browsers: ['E79', 'FF45', 'S11', 'C59', 'O46'],
				references: [
					{ name: 'MDN Reference', url: 'https://developer.mozilla.org/docs/Web/CSS/place-self' },
				],
				description:
			...
			},
			{
				...
				references: [
					{ name: 'MDN Reference', url: 'https://developer.mozilla.org/docs/Web/CSS/rotate' },
				],
				description:
			...
			},
			{
				...
				references: [
					{ name: 'MDN Reference', url: 'https://developer.mozilla.org/docs/Web/CSS/row-gap' },
				],
			...
			},
			{
				...
				values: [{ name: 'separate' }, { name: 'collapse' }, { name: 'auto' }],
				relevance: 50,
				description:
			...
			},
			{
				...
				browsers: ['E104', 'FF72', 'S14.1', 'C104', 'O90'],
				references: [
					{ name: 'MDN Reference', url: 'https://developer.mozilla.org/docs/Web/CSS/scale' },
				],
				description:
			...
			},
			{
				...
				values: [{ name: 'auto' }, { name: 'thin' }, { name: 'none' }],
				relevance: 63,
				browsers: ['E121', 'FF64', 'C121'],
				references: [
					{
			...
			},
			{
				...
				values: [{ name: 'normal' }, { name: 'always' }],
				relevance: 51,
			...
			},
			{
				...
				values: [{ name: 'none' }, { name: 'mandatory' }, { name: 'proximity' }],
				relevance: 0,
...
This is used to produce an effect that is known as tate-chū-yoko (縦中横) in Japanese, or as 直書橫向 in Chinese.`,
			...
			},
			{
				...
				values: [{ name: 'auto' }, { name: 'all' }, { name: 'none' }],
				relevance: 51,
			...
			},
			{
				...
				relevance: 54,
				browsers: ['E114', 'FF121', 'Spreview', 'C114', 'O100'],
				references: [
					{ name: 'MDN Reference', url: 'https://developer.mozilla.org/docs/Web/CSS/text-wrap' },
				],
			...
			},
			{
				...
				browsers: ['E104', 'FF72', 'S14.1', 'C104', 'O90'],
				references: [
					{ name: 'MDN Reference', url: 'https://developer.mozilla.org/docs/Web/CSS/translate' },
				],
				description:
			...
			},
			{
				...
				references: [
					{ name: 'MDN Reference', url: 'https://developer.mozilla.org/docs/Web/CSS/white-space' },
				],
			...
			},
			{
				...
				relevance: 50,
				browsers: ['E114', 'Spreview', 'C114', 'O100'],
				references: [
					{
						name: 'MDN Reference',
		...
		atDirectives: [
			{
				...
				references: [
					{ name: 'MDN Reference', url: 'https://developer.mozilla.org/docs/Web/CSS/@charset' },
				],
			...
			},
			{
				...
				references: [
					{ name: 'MDN Reference', url: 'https://developer.mozilla.org/docs/Web/CSS/@font-face' },
				],
				description:
			...
			},
			{
				...
				references: [
					{ name: 'MDN Reference', url: 'https://developer.mozilla.org/docs/Web/CSS/@import' },
				],
			...
			},
			{
				...
				browsers: ['E12', 'FF16', 'S9', 'C43', 'IE10', 'O30'],
				references: [
					{ name: 'MDN Reference', url: 'https://developer.mozilla.org/docs/Web/CSS/@keyframes' },
				],
			...
			},
			{
				...
				references: [
					{ name: 'MDN Reference', url: 'https://developer.mozilla.org/docs/Web/CSS/@layer' },
				],
				description:
					'Declare a cascade layer and the order of precedence in case of multiple cascade layers.',
			},
			{
				name: '@media',
				browsers: ['E12', 'FF1', 'S3', 'C1', 'IE6', 'O9.2'],
				references: [
					{ name: 'MDN Reference', url: 'https://developer.mozilla.org/docs/Web/CSS/@media' },
				],
			...
			},
			{
				...
				references: [
					{ name: 'MDN Reference', url: 'https://developer.mozilla.org/docs/Web/CSS/@namespace' },
				],
			...
			{
				name: '@property',
				browsers: ['E85', 'FFpreview', 'S16.4', 'C85', 'O71'],
				references: [
					{ name: 'MDN Reference', url: 'https://developer.mozilla.org/docs/Web/CSS/@property' },
				],
			...
			},
			{
				...
				references: [
					{ name: 'MDN Reference', url: 'https://developer.mozilla.org/docs/Web/CSS/@supports' },
				],
				description:
		...
		pseudoClasses: [
			{
				...
				references: [
					{ name: 'MDN Reference', url: 'https://developer.mozilla.org/docs/Web/CSS/:active' },
				],
				description:
			...
			},
			{
				...
				references: [
					{ name: 'MDN Reference', url: 'https://developer.mozilla.org/docs/Web/CSS/:any-link' },
				],
				description:
			...
			},
			{
				...
				references: [
					{ name: 'MDN Reference', url: 'https://developer.mozilla.org/docs/Web/CSS/:checked' },
				],
				description:
			...
			},
			{
				...
				references: [
					{ name: 'MDN Reference', url: 'https://developer.mozilla.org/docs/Web/CSS/:default' },
				],
				description:
			...
			},
			{
				...
				browsers: ['E12', 'FF1', 'S3.1', 'C1', 'IE9', 'O9'],
				references: [
					{ name: 'MDN Reference', url: 'https://developer.mozilla.org/docs/Web/CSS/:disabled' },
				],
				description:
			...
			},
			{
				...
				references: [
					{ name: 'MDN Reference', url: 'https://developer.mozilla.org/docs/Web/CSS/:empty' },
				],
			...
			},
			{
				...
				browsers: ['E12', 'FF1', 'S3.1', 'C1', 'IE9', 'O9'],
				references: [
					{ name: 'MDN Reference', url: 'https://developer.mozilla.org/docs/Web/CSS/:enabled' },
				],
				description:
			...
			},
			{
				...
				references: [
					{ name: 'MDN Reference', url: 'https://developer.mozilla.org/docs/Web/CSS/:first' },
				],
				description:
			...
			},
			{
				...
				references: [
					{ name: 'MDN Reference', url: 'https://developer.mozilla.org/docs/Web/CSS/:first-child' },
				],
				description:
			...
			},
			{
				...
				references: [
					{ name: 'MDN Reference', url: 'https://developer.mozilla.org/docs/Web/CSS/:focus' },
				],
				description:
			...
			},
			{
				...
				references: [
					{ name: 'MDN Reference', url: 'https://developer.mozilla.org/docs/Web/CSS/:fullscreen' },
				],
			...
			},
			{
				...
				references: [
					{ name: 'MDN Reference', url: 'https://developer.mozilla.org/docs/Web/CSS/:future' },
				],
				description:
			...
			},
			{
				...
				references: [
					{ name: 'MDN Reference', url: 'https://developer.mozilla.org/docs/Web/CSS/:host' },
				],
				description:
			...
			},
			{
				...
				references: [
					{ name: 'MDN Reference', url: 'https://developer.mozilla.org/docs/Web/CSS/:hover' },
				],
				description:
			...
			},
			{
				...
				references: [
					{ name: 'MDN Reference', url: 'https://developer.mozilla.org/docs/Web/CSS/:in-range' },
				],
				description:
			...
			},
			{
				...
				references: [
					{ name: 'MDN Reference', url: 'https://developer.mozilla.org/docs/Web/CSS/:invalid' },
				],
				description:
			...
			},
			{
				...
				browsers: ['E12', 'FF1', 'S3.1', 'C1', 'IE9', 'O9.5'],
				references: [
					{ name: 'MDN Reference', url: 'https://developer.mozilla.org/docs/Web/CSS/:last-child' },
				],
				description:
			...
			},
			{
				...
				browsers: ['E12', 'FF1', 'S1', 'C1', 'IE3', 'O3.5'],
				references: [
					{ name: 'MDN Reference', url: 'https://developer.mozilla.org/docs/Web/CSS/:link' },
				],
			...
			},
			{
				...
				browsers: ['FF3'],
				references: [
					{ name: 'MDN Reference', url: 'https://developer.mozilla.org/docs/Web/CSS/:-moz-broken' },
				],
			...
			},
			{
				...
				references: [
					{ name: 'MDN Reference', url: 'https://developer.mozilla.org/docs/Web/CSS/:only-child' },
				],
				description:
			...
			},
			{
				...
				browsers: ['E12', 'FF4', 'S5', 'C10', 'IE10', 'O10'],
				references: [
					{ name: 'MDN Reference', url: 'https://developer.mozilla.org/docs/Web/CSS/:optional' },
				],
				description:
			...
			},
			{
				...
				browsers: ['E79', 'S7', 'C23', 'O15'],
				references: [
					{ name: 'MDN Reference', url: 'https://developer.mozilla.org/docs/Web/CSS/:past' },
				],
				description:
			...
			},
			{
				...
				references: [
					{ name: 'MDN Reference', url: 'https://developer.mozilla.org/docs/Web/CSS/:read-only' },
				],
				description:
			...
			},
			{
				...
				browsers: ['E13', 'FF78', 'S4', 'C1', 'O9'],
				references: [
					{ name: 'MDN Reference', url: 'https://developer.mozilla.org/docs/Web/CSS/:read-write' },
				],
				description:
					'An element whose contents are not user-alterable is :read-only. However, elements whose contents are user-alterable (such as text input fields) are considered to be in a :read-write state. In typical documents, most elements are :read-only.',
			},
			{
				...
				browsers: ['E12', 'FF4', 'S5', 'C10', 'IE10', 'O10'],
				references: [
					{ name: 'MDN Reference', url: 'https://developer.mozilla.org/docs/Web/CSS/:required' },
				],
				description:
					'A form element is :required or :optional if a value for it is, respectively, required or optional before the form it belongs to is submitted. Elements that are not form elements are neither required nor optional.',
			},
			...
			},
			{
				...
				references: [
					{ name: 'MDN Reference', url: 'https://developer.mozilla.org/docs/Web/CSS/:root' },
				],
				description:
			...
			},
			{
				...
				references: [
					{ name: 'MDN Reference', url: 'https://developer.mozilla.org/docs/Web/CSS/:scope' },
				],
			...
			},
			{
				...
				references: [
					{ name: 'MDN Reference', url: 'https://developer.mozilla.org/docs/Web/CSS/:target' },
				],
				description:
			...
			},
			{
				...
				browsers: ['E12', 'FF4', 'S5', 'C10', 'IE10', 'O10'],
				references: [
					{ name: 'MDN Reference', url: 'https://developer.mozilla.org/docs/Web/CSS/:valid' },
				],
				description:
					'An element is :valid or :invalid when it is, respectively, valid or invalid with respect to data validity semantics defined by a different specification.',
			},
			...
			},
			{
				...
				browsers: ['E12', 'FF1', 'S1', 'C1', 'IE4', 'O3.5'],
				references: [
					{ name: 'MDN Reference', url: 'https://developer.mozilla.org/docs/Web/CSS/:visited' },
				],
			...
			},
			{
				...
				status: 'experimental',
				references: [
					{ name: 'MDN Reference', url: 'https://developer.mozilla.org/docs/Web/CSS/:blank' },
				],
				description:
			...
			},
			{
				...
				browsers: ['E79', 'FF63', 'S10', 'C54', 'O41'],
				references: [
					{ name: 'MDN Reference', url: 'https://developer.mozilla.org/docs/Web/CSS/:defined' },
				],
				description:
			...
			},
			{
				...
				references: [
					{ name: 'MDN Reference', url: 'https://developer.mozilla.org/docs/Web/CSS/:dir' },
				],
				description:
			...
			},
			{
				...
				references: [
					{ name: 'MDN Reference', url: 'https://developer.mozilla.org/docs/Web/CSS/:has' },
				],
				description:
			...
			},
			{
				...
				references: [
					{ name: 'MDN Reference', url: 'https://developer.mozilla.org/docs/Web/CSS/:is' },
				],
				description:
			...
			},
			{
				...
				browsers: ['S15.4'],
				references: [
					{ name: 'MDN Reference', url: 'https://developer.mozilla.org/docs/Web/CSS/:paused' },
				],
				description:
			...
			},
			{
				...
				browsers: ['S15.4'],
				references: [
					{ name: 'MDN Reference', url: 'https://developer.mozilla.org/docs/Web/CSS/:playing' },
				],
				description:
			...
			},
			{
				...
				browsers: ['E119', 'FF88', 'S16.5', 'C119', 'O105'],
				references: [
					{ name: 'MDN Reference', url: 'https://developer.mozilla.org/docs/Web/CSS/:user-valid' },
				],
				description:
			...
			},
			{
				...
				browsers: ['E88', 'FF78', 'S14', 'C88', 'O74'],
				references: [
					{ name: 'MDN Reference', url: 'https://developer.mozilla.org/docs/Web/CSS/:where' },
				],
				description:
		...
		pseudoElements: [
			{
				...
				references: [
					{ name: 'MDN Reference', url: 'https://developer.mozilla.org/docs/Web/CSS/::after' },
				],
				description:
			...
			},
			{
				...
				references: [
					{ name: 'MDN Reference', url: 'https://developer.mozilla.org/docs/Web/CSS/::backdrop' },
				],
				description:
			...
			},
			{
				...
				browsers: ['E12', 'FF1.5', 'S4', 'C1', 'IE9', 'O7'],
				references: [
					{ name: 'MDN Reference', url: 'https://developer.mozilla.org/docs/Web/CSS/::before' },
				],
				description:
			...
			},
			{
				...
				references: [
					{ name: 'MDN Reference', url: 'https://developer.mozilla.org/docs/Web/CSS/::cue' },
				],
			},
			...
			},
			{
				...
				browsers: ['E12', 'FF1', 'S1', 'C1', 'IE9', 'O7'],
				references: [
					{ name: 'MDN Reference', url: 'https://developer.mozilla.org/docs/Web/CSS/::first-line' },
				],
				description:
					'Describes the contents of the first formatted line of its originating element.',
			},
			{ name: '::-moz-focus-inner', browsers: ['FF72'] },
			...
			},
			{
				...
				references: [
					{ name: 'MDN Reference', url: 'https://developer.mozilla.org/docs/Web/CSS/::selection' },
				],
				description: 'Represents the portion of a document that has been highlighted by the user.',
			},
			{
			...
			{ name: '::-webkit-slider-runnable-track', browsers: ['E83', 'C83', 'O69'] },
			{ name: '::-webkit-slider-thumb', browsers: ['E83', 'C83', 'O69'] },
...
In order to let ::-webkit-progress-value take effect, -webkit-appearance needs to be set to none on the <progress> element.`,
			...
			},
			{
				...
				references: [
					{ name: 'MDN Reference', url: 'https://developer.mozilla.org/docs/Web/CSS/::marker' },
				],
				description:
			...
			},
			{
				...
				references: [
					{ name: 'MDN Reference', url: 'https://developer.mozilla.org/docs/Web/CSS/::part' },
				],
				description:
			...
			},
			{
				...
				references: [
					{ name: 'MDN Reference', url: 'https://developer.mozilla.org/docs/Web/CSS/::slotted' },
				],
				description:
	...
	class gr {
		...
		addData(e) {
			if (Array.isArray(e.properties))
				for (const t of e.properties) $s(t) && this._properties.push(t)
			if (Array.isArray(e.atDirectives))
				for (const t of e.atDirectives) Us(t) && this._atDirectives.push(t)
			if (Array.isArray(e.pseudoClasses))
				for (const t of e.pseudoClasses) Vs(t) && this._pseudoClasses.push(t)
			if (Array.isArray(e.pseudoElements))
				for (const t of e.pseudoElements) Bs(t) && this._pseudoElements.push(t)
		}
	}
	function $s(r) {
	...
	class jt {
		...
		setDataProviders(e, t) {
			;((this.dataProviders = []),
				e && this.dataProviders.push(new gr(Ls)),
		...
		collectData() {
			;((this._propertySet = {}),
				...
				(this._pseudoClassSet = {}),
				(this._pseudoElementSet = {}),
				this.dataProviders.forEach((e) => {
					;(e.provideProperties().forEach((t) => {
						this._propertySet[t.name] || (this._propertySet[t.name] = t)
					}),
						e.provideAtDirectives().forEach((t) => {
							this._atDirectiveSet[t.name] || (this._atDirectiveSet[t.name] = t)
						}),
						e.providePseudoClasses().forEach((t) => {
							this._pseudoClassSet[t.name] || (this._pseudoClassSet[t.name] = t)
						}),
						e.providePseudoElements().forEach((t) => {
							this._pseudoElementSet[t.name] || (this._pseudoElementSet[t.name] = t)
						}))
				}),
				(this._properties = je(this._propertySet)),
				(this._atDirectives = je(this._atDirectiveSet)),
				(this._pseudoClasses = je(this._pseudoClassSet)),
				(this._pseudoElements = je(this._pseudoElementSet)))
		}
		getProperty(e) {
		...
		isStandardProperty(e) {
			return (
				this.isKnownProperty(e) &&
				(!this._propertySet[e.toLowerCase()].status ||
					this._propertySet[e.toLowerCase()].status === 'standard')
			)
		}
	}
	function Ks(r, e, t) {
		function n(s) {
			...
			for (let l = a.length - 1; l >= 0; l--)
				c = f.SelectionRange.create(f.Range.create(r.positionAt(a[l][0]), r.positionAt(a[l][1])), c)
			return (c || (c = f.SelectionRange.create(f.Range.create(s, s))), c)
		}
		return e.map(n)
		function i(s) {
			const a = r.offsetAt(s)
			let c = t.findChildAtOffset(a, !0)
			if (!c) return []
			const l = []
			for (; c; ) {
				if (c.parent && c.offset === c.parent.offset && c.end === c.parent.end) {
					c = c.parent
					continue
				}
				;(c.type === p.Declarations &&
					a > c.offset &&
					a < c.end &&
					l.push([c.offset + 1, c.end - 1]),
					l.push([c.offset, c.end]),
					(c = c.parent))
			}
			return l
		}
	...
	class js extends Rt {
		...
		isRawStringDocumentLinkNode(e) {
			return super.isRawStringDocumentLinkNode(e) || e.type === p.Use || e.type === p.Forward
		}
		async mapReference(e, t) {
			if (this.fileSystemProvider && e && t) {
				const n = qs(e)
				for (const i of n) if (await this.fileExists(i)) return i
			}
			return e
		}
		async resolveReference(e, t, n, i = !1) {
			if (!I(e, 'sass:')) return super.resolveReference(e, t, n, i)
		}
	}
	function qs(r) {
		if (r.endsWith('.css')) return [r]
		if (r.endsWith('/')) return [r + 'index.scss', r + '_index.scss']
		const e = d.URI.parse(r.replace(/\.scss$/, '')),
			t = d.Utils.basename(e),
			n = d.Utils.dirname(e)
		return t.startsWith('_')
			? [d.Utils.joinPath(n, t + '.scss').toString(!0)]
			: [
					d.Utils.joinPath(n, t + '.scss').toString(!0),
					d.Utils.joinPath(n, '_' + t + '.scss').toString(!0),
					r + '/index.scss',
					r + '/_index.scss',
					d.Utils.joinPath(n, t + '.css').toString(!0),
				]
	}
	function Gs(r) {
		return new gr(r)
	}
	function qt(r, e, t, n, i, s, a) {
		return {
			configure: (c) => {
				;(s.configure(c),
					e.configure(c?.completion),
					t.configure(c?.hover),
					n.configure(c?.importAliases))
			},
			setDataProviders: a.setDataProviders.bind(a),
			doValidation: s.doValidation.bind(s),
			parseStylesheet: r.parseStylesheet.bind(r),
			doComplete: e.doComplete.bind(e),
			doComplete2: e.doComplete2.bind(e),
			setCompletionParticipants: e.setCompletionParticipants.bind(e),
			doHover: t.doHover.bind(t),
			format: Ps,
			findDefinition: n.findDefinition.bind(n),
			findReferences: n.findReferences.bind(n),
			findDocumentHighlights: n.findDocumentHighlights.bind(n),
			findDocumentLinks: n.findDocumentLinks.bind(n),
			findDocumentLinks2: n.findDocumentLinks2.bind(n),
			findDocumentSymbols: n.findSymbolInformations.bind(n),
			findDocumentSymbols2: n.findDocumentSymbols.bind(n),
			doCodeActions: i.doCodeActions.bind(i),
			doCodeActions2: i.doCodeActions2.bind(i),
			findDocumentColors: n.findDocumentColors.bind(n),
			getColorPresentations: n.getColorPresentations.bind(n),
			prepareRename: n.prepareRename.bind(n),
			doRename: n.doRename.bind(n),
			getFoldingRanges: zs,
			getSelectionRanges: Ks,
		}
	}
	const Gt = {}
	function Hs(r = Gt) {
		...
		return qt(
			new qe(),
			new Ft(null, r, e),
			new zt(r && r.clientCapabilities, e),
			new Rt(r && r.fileSystemProvider, !1),
			new Mt(e),
			new Tt(e),
			e,
		)
	...
	function Ys(r = Gt) {
		...
		return qt(
			...
			new be(r, e),
			new zt(r && r.clientCapabilities, e),
			new Rt(r && r.fileSystemProvider, !0),
			new Mt(e),
			new Tt(e),
			e,
		)
	...
	class Xs {
		constructor(e, t) {
			;((this._ctx = e), (this._languageSettings = t.options), (this._languageId = t.languageId))
			const n = t.options.data,
				i = n?.useDefaultDataProvider,
				s = []
			if (n?.dataProviders) for (const c in n.dataProviders) s.push(Gs(n.dataProviders[c]))
			const a = { customDataProviders: s, useDefaultDataProvider: i }
			switch (this._languageId) {
				case 'css':
					this._languageService = Hs(a)
					break
				case 'less':
					this._languageService = Ys(a)
					break
				case 'scss':
					this._languageService = Js(a)
					break
				default:
		...
		async doValidation(e) {
			...
			if (t) {
				const n = this._languageService.parseStylesheet(t),
		...
		async doComplete(e, t) {
			...
			if (!n) return null
			const i = this._languageService.parseStylesheet(n),
				s = this._languageService.doComplete(n, t, i)
		...
		async doHover(e, t) {
			...
			if (!n) return null
			const i = this._languageService.parseStylesheet(n),
				s = this._languageService.doHover(n, t, i)
			return Promise.resolve(s)
		}
		async findDefinition(e, t) {
			const n = this._getTextDocument(e)
			if (!n) return null
			const i = this._languageService.parseStylesheet(n),
				s = this._languageService.findDefinition(n, t, i)
			return Promise.resolve(s)
		}
		async findReferences(e, t) {
			const n = this._getTextDocument(e)
			if (!n) return []
			const i = this._languageService.parseStylesheet(n),
				s = this._languageService.findReferences(n, t, i)
			return Promise.resolve(s)
		}
		async findDocumentHighlights(e, t) {
			...
			if (!n) return []
			const i = this._languageService.parseStylesheet(n),
				s = this._languageService.findDocumentHighlights(n, t, i)
			return Promise.resolve(s)
		}
		...
		async doCodeActions(e, t, n) {
			const i = this._getTextDocument(e)
			if (!i) return []
			const s = this._languageService.parseStylesheet(i),
				a = this._languageService.doCodeActions(i, t, n, s)
		...
		async getColorPresentations(e, t, n) {
			...
			if (!i) return []
			const s = this._languageService.parseStylesheet(i),
				a = this._languageService.getColorPresentations(i, s, t, n)
			return Promise.resolve(a)
		}
		...
		async getSelectionRanges(e, t) {
			...
			if (!n) return []
			const i = this._languageService.parseStylesheet(n),
				s = this._languageService.getSelectionRanges(n, t, i)
			return Promise.resolve(s)
		}
		async doRename(e, t, n) {
			...
			if (!i) return null
			const s = this._languageService.parseStylesheet(i),
				a = this._languageService.doRename(i, t, n, s)
			return Promise.resolve(a)
		}
		async format(e, t, n) {
			const i = this._getTextDocument(e)
			if (!i) return []
			const s = { ...this._languageSettings.format, ...n },
				a = this._languageService.format(i, t, s)
			return Promise.resolve(a)
		}
		_getTextDocument(e) {
			...
			for (const n of t)
				if (n.uri.toString() === e)
					return d.TextDocument.create(e, this._languageId, n.version, n.getValue())
			return null
		}
	}
	self.onmessage = () => {
		Sr.initialize((r, e) => new Xs(r, e))
	}
})
