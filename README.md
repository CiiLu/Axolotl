...
**Axolotl Launcher** 是一款开源第三方 Minecraft 客户端。基于 [Modrinth APP](https://github.com/modrinth/code) 构建，我们剔除了多余的商业化模块，专注于为你带来更为强大、纯净且无广告的桌面端启动体验。
...
- **All in one 全新体验**：启动器内置 “实验室” 功能，带来海量使用工具，带来全新原生轮椅体验。
